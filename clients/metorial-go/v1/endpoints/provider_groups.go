...
func (e *ProviderGroupsEndpoint) List(params *ProviderGroupsEndpointListParams) (*providergroups.ProviderGroupsListOutput, error) {
	var query map[string]any
	if params != nil {
		query = endpoint.StructToQuery(params)
	}
	req := &endpoint.Request{
		Path:  []string{"provider-groups"},
		Query: query,
	}
...
func (e *ProviderGroupsEndpoint) Get(providerGroupId string) (*providergroups.ProviderGroupsGetOutput, error) {
	req := &endpoint.Request{
		Path: []string{"provider-groups", providerGroupId},
	}
...
func (e *ProviderGroupsEndpoint) Create(body *ProviderGroupsEndpointCreateBody) (*providergroups.ProviderGroupsCreateOutput, error) {
	req := &endpoint.Request{
		Path: []string{"provider-groups"},
		Body: body,
	}
...
func (e *ProviderGroupsEndpoint) Update(providerGroupId string, body *ProviderGroupsEndpointUpdateBody) (*providergroups.ProviderGroupsUpdateOutput, error) {
	req := &endpoint.Request{
		Path: []string{"provider-groups", providerGroupId},
		Body: body,
	}
...
func (e *ProviderGroupsEndpoint) AddListing(providerGroupId string, body *ProviderGroupsEndpointAddListingBody) (*providergroups.ProviderGroupsAddListingOutput, error) {
	req := &endpoint.Request{
		Path: []string{"provider-groups", providerGroupId, "listings"},
		Body: body,
	}
...
func (e *ProviderGroupsEndpoint) RemoveListing(providerGroupId string, providerListingId string) (*providergroups.ProviderGroupsRemoveListingOutput, error) {
	req := &endpoint.Request{
		Path: []string{"provider-groups", providerGroupId, "listings", providerListingId},
	}
