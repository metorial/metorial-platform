...
func (e *ProviderRunsEndpoint) List(params *ProviderRunsEndpointListParams) (*providerruns.ProviderRunsListOutput, error) {
	var query map[string]any
	if params != nil {
		query = endpoint.StructToQuery(params)
	}
	req := &endpoint.Request{
		Path:  []string{"provider-runs"},
		Query: query,
	}
...
func (e *ProviderRunsEndpoint) Get(providerRunId string) (*providerruns.ProviderRunsGetOutput, error) {
	req := &endpoint.Request{
		Path: []string{"provider-runs", providerRunId},
	}
...
func (e *ProviderRunsEndpoint) GetLogs(providerRunId string) (*providerruns.ProviderRunsGetLogsOutput, error) {
	req := &endpoint.Request{
		Path: []string{"provider-runs", providerRunId, "logs"},
	}
