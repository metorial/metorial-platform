...
func (e *ProvidersAuthMethodsEndpoint) List(params *ProvidersAuthMethodsEndpointListParams) (*authmethods.ProvidersAuthMethodsListOutput, error) {
	var query map[string]any
	if params != nil {
		query = endpoint.StructToQuery(params)
	}
	req := &endpoint.Request{
		Path:  []string{"provider-auth-methods"},
		Query: query,
	}
...
func (e *ProvidersAuthMethodsEndpoint) Get(providerAuthMethodId string) (*authmethods.ProvidersAuthMethodsGetOutput, error) {
	req := &endpoint.Request{
		Path: []string{"provider-auth-methods", providerAuthMethodId},
	}
