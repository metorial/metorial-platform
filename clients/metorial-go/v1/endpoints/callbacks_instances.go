...
func (e *CallbacksInstancesEndpoint) List(callbackId string, params *CallbacksInstancesEndpointListParams) (*instances.CallbacksInstancesListOutput, error) {
	var query map[string]any
	if params != nil {
		query = endpoint.StructToQuery(params)
	}
	req := &endpoint.Request{
		Path:  []string{"callbacks", callbackId, "instances"},
		Query: query,
	}
...
func (e *CallbacksInstancesEndpoint) Delete(callbackId string, callbackInstanceId string) (*instances.CallbacksInstancesDeleteOutput, error) {
	req := &endpoint.Request{
