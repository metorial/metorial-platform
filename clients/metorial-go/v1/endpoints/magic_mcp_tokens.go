...
func (e *MagicMcpTokensEndpoint) List(params *MagicMcpTokensEndpointListParams) (*magicmcptokens.MagicMcpTokensListOutput, error) {
	var query map[string]any
	if params != nil {
		query = endpoint.StructToQuery(params)
	}
	req := &endpoint.Request{
		Path:  []string{"magic-mcp-tokens"},
		Query: query,
	}
...
func (e *MagicMcpTokensEndpoint) Get(magicMcpTokenId string) (*magicmcptokens.MagicMcpTokensGetOutput, error) {
	req := &endpoint.Request{
		Path: []string{"magic-mcp-tokens", magicMcpTokenId},
	}
...
func (e *MagicMcpTokensEndpoint) Create(body *MagicMcpTokensEndpointCreateBody) (*magicmcptokens.MagicMcpTokensCreateOutput, error) {
	req := &endpoint.Request{
		Path: []string{"magic-mcp-tokens"},
		Body: body,
	}
...
func (e *MagicMcpTokensEndpoint) Delete(magicMcpTokenId string) (*magicmcptokens.MagicMcpTokensDeleteOutput, error) {
	req := &endpoint.Request{
		Path: []string{"magic-mcp-tokens", magicMcpTokenId},
	}
...
func (e *MagicMcpTokensEndpoint) Update(magicMcpTokenId string, body *MagicMcpTokensEndpointUpdateBody) (*magicmcptokens.MagicMcpTokensUpdateOutput, error) {
	req := &endpoint.Request{
		Path: []string{"magic-mcp-tokens", magicMcpTokenId},
		Body: body,
	}
...
func (e *MagicMcpTokensEndpoint) AddGroups(magicMcpTokenId string, body *MagicMcpTokensEndpointAddGroupsBody) (*magicmcptokens.MagicMcpTokensAddGroupsOutput, error) {
	req := &endpoint.Request{
		Path: []string{"magic-mcp-tokens", magicMcpTokenId, "add-groups"},
		Body: body,
	}
...
func (e *MagicMcpTokensEndpoint) RemoveGroups(magicMcpTokenId string, body *MagicMcpTokensEndpointRemoveGroupsBody) (*magicmcptokens.MagicMcpTokensRemoveGroupsOutput, error) {
	req := &endpoint.Request{
		Path: []string{"magic-mcp-tokens", magicMcpTokenId, "remove-groups"},
		Body: body,
	}
