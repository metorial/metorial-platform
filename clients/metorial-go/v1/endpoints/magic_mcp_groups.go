...
func (e *MagicMcpGroupsEndpoint) List(params *MagicMcpGroupsEndpointListParams) (*magicmcpgroups.MagicMcpGroupsListOutput, error) {
	var query map[string]any
	if params != nil {
		query = endpoint.StructToQuery(params)
	}
	req := &endpoint.Request{
		Path:  []string{"magic-mcp-groups"},
		Query: query,
	}
...
func (e *MagicMcpGroupsEndpoint) Get(magicMcpGroupId string) (*magicmcpgroups.MagicMcpGroupsGetOutput, error) {
	req := &endpoint.Request{
		Path: []string{"magic-mcp-groups", magicMcpGroupId},
	}
...
func (e *MagicMcpGroupsEndpoint) Create(body *MagicMcpGroupsEndpointCreateBody) (*magicmcpgroups.MagicMcpGroupsCreateOutput, error) {
	req := &endpoint.Request{
		Path: []string{"magic-mcp-groups"},
		Body: body,
	}
...
func (e *MagicMcpGroupsEndpoint) Delete(magicMcpGroupId string) (*magicmcpgroups.MagicMcpGroupsDeleteOutput, error) {
	req := &endpoint.Request{
		Path: []string{"magic-mcp-groups", magicMcpGroupId},
	}
...
func (e *MagicMcpGroupsEndpoint) Update(magicMcpGroupId string, body *MagicMcpGroupsEndpointUpdateBody) (*magicmcpgroups.MagicMcpGroupsUpdateOutput, error) {
	req := &endpoint.Request{
		Path: []string{"magic-mcp-groups", magicMcpGroupId},
		Body: body,
	}
...
func (e *MagicMcpGroupsEndpoint) AddServers(magicMcpGroupId string, body *MagicMcpGroupsEndpointAddServersBody) (*magicmcpgroups.MagicMcpGroupsAddServersOutput, error) {
	req := &endpoint.Request{
		Path: []string{"magic-mcp-groups", magicMcpGroupId, "add-servers"},
		Body: body,
	}
...
func (e *MagicMcpGroupsEndpoint) RemoveServers(magicMcpGroupId string, body *MagicMcpGroupsEndpointRemoveServersBody) (*magicmcpgroups.MagicMcpGroupsRemoveServersOutput, error) {
	req := &endpoint.Request{
		Path: []string{"magic-mcp-groups", magicMcpGroupId, "remove-servers"},
		Body: body,
	}
