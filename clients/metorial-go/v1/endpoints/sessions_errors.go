...
func (e *SessionsErrorsEndpoint) List(params *SessionsErrorsEndpointListParams) (*errors.SessionsErrorsListOutput, error) {
	var query map[string]any
	if params != nil {
		query = endpoint.StructToQuery(params)
	}
	req := &endpoint.Request{
		Path:  []string{"session-errors"},
		Query: query,
	}
...
func (e *SessionsErrorsEndpoint) Get(sessionErrorId string) (*errors.SessionsErrorsGetOutput, error) {
	req := &endpoint.Request{
		Path: []string{"session-errors", sessionErrorId},
	}
