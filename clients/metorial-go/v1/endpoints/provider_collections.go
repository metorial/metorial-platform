...
func (e *ProviderCollectionsEndpoint) List(params *ProviderCollectionsEndpointListParams) (*providercollections.ProviderCollectionsListOutput, error) {
	var query map[string]any
	if params != nil {
		query = endpoint.StructToQuery(params)
	}
	req := &endpoint.Request{
		Path:  []string{"provider-collections"},
		Query: query,
	}
...
func (e *ProviderCollectionsEndpoint) Get(providerCollectionId string) (*providercollections.ProviderCollectionsGetOutput, error) {
	req := &endpoint.Request{
		Path: []string{"provider-collections", providerCollectionId},
	}
