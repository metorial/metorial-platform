...
func (e *ProvidersVersionsEndpoint) List(instanceId string, params *ProvidersVersionsEndpointListParams) (*versions.ProvidersVersionsListOutput, error) {
	var query map[string]any
	if params != nil {
		query = endpoint.StructToQuery(params)
	}
	req := &endpoint.Request{
		Path:  []string{"instances", instanceId, "provider-versions"},
		Query: query,
	}
...
func (e *ProvidersVersionsEndpoint) Get(instanceId string, providerVersionId string) (*versions.ProvidersVersionsGetOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "provider-versions", providerVersionId},
	}
