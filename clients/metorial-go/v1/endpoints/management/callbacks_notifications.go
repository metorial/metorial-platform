...
func (e *CallbacksNotificationsEndpoint) List(instanceId string, callbackId string, params *CallbacksNotificationsEndpointListParams) (*notifications.CallbacksNotificationsListOutput, error) {
	var query map[string]any
	if params != nil {
		query = endpoint.StructToQuery(params)
	}
	req := &endpoint.Request{
		Path:  []string{"instances", instanceId, "callbacks", callbackId, "notifications"},
		Query: query,
	}
...
func (e *CallbacksNotificationsEndpoint) Get(instanceId string, callbackId string, callbackNotificationId string) (*notifications.CallbacksNotificationsGetOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "callbacks", callbackId, "notifications", callbackNotificationId},
	}
