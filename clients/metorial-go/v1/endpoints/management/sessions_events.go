...
func (e *SessionsEventsEndpoint) List(instanceId string, params *SessionsEventsEndpointListParams) (*events.SessionsEventsListOutput, error) {
	var query map[string]any
	if params != nil {
		query = endpoint.StructToQuery(params)
	}
	req := &endpoint.Request{
		Path:  []string{"instances", instanceId, "session-events"},
		Query: query,
	}
...
func (e *SessionsEventsEndpoint) Get(instanceId string, sessionEventId string) (*events.SessionsEventsGetOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "session-events", sessionEventId},
	}
