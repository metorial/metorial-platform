...
func (e *MagicMcpSessionsEndpoint) List(instanceId string, params *MagicMcpSessionsEndpointListParams) (*magicmcpsessions.MagicMcpSessionsListOutput, error) {
	var query map[string]any
	if params != nil {
		query = endpoint.StructToQuery(params)
	}
	req := &endpoint.Request{
		Path:  []string{"instances", instanceId, "magic-mcp-sessions"},
		Query: query,
	}
...
func (e *MagicMcpSessionsEndpoint) Get(instanceId string, magicMcpSessionId string) (*magicmcpsessions.MagicMcpSessionsGetOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "magic-mcp-sessions", magicMcpSessionId},
	}
