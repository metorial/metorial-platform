...
func (e *ProviderCategoriesEndpoint) List(instanceId string, params *ProviderCategoriesEndpointListParams) (*providercategories.ProviderCategoriesListOutput, error) {
	var query map[string]any
	if params != nil {
		query = endpoint.StructToQuery(params)
	}
	req := &endpoint.Request{
		Path:  []string{"instances", instanceId, "provider-categories"},
		Query: query,
	}
...
func (e *ProviderCategoriesEndpoint) Get(instanceId string, providerCategoryId string) (*providercategories.ProviderCategoriesGetOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "provider-categories", providerCategoryId},
	}
