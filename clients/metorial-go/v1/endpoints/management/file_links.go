...
func (e *FileLinksEndpoint) List(instanceId string, params *FileLinksEndpointListParams) (*filelinks.FileLinksListOutput, error) {
...
func (e *FileLinksEndpoint) Get(instanceId string, linkId string) (*filelinks.FileLinksGetOutput, error) {
	req := &endpoint.Request{
...
func (e *FileLinksEndpoint) Create(instanceId string, body *FileLinksEndpointCreateBody) (*filelinks.FileLinksCreateOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "file-links"},
		Body: body,
	}
...
func (e *FileLinksEndpoint) Delete(instanceId string, linkId string) (*filelinks.FileLinksDeleteOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "file-links", linkId},
	}
