...
func (e *ProvidersToolsEndpoint) List(instanceId string, params *ProvidersToolsEndpointListParams) (*tools.ProvidersToolsListOutput, error) {
	var query map[string]any
	if params != nil {
		query = endpoint.StructToQuery(params)
	}
	req := &endpoint.Request{
		Path:  []string{"instances", instanceId, "providers-tools"},
		Query: query,
	}
...
func (e *ProvidersToolsEndpoint) Get(instanceId string, providerToolId string) (*tools.ProvidersToolsGetOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "providers-tools", providerToolId},
	}
