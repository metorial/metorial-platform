...
func (e *ToolCallsEndpoint) List(instanceId string, params *ToolCallsEndpointListParams) (*toolcalls.ToolCallsListOutput, error) {
	var query map[string]any
	if params != nil {
		query = endpoint.StructToQuery(params)
	}
	req := &endpoint.Request{
		Path:  []string{"instances", instanceId, "tool-calls"},
		Query: query,
	}
...
func (e *ToolCallsEndpoint) Get(instanceId string, toolCallId string) (*toolcalls.ToolCallsGetOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "tool-calls", toolCallId},
	}
...
func (e *ToolCallsEndpoint) Create(instanceId string, body *ToolCallsEndpointCreateBody) (*toolcalls.ToolCallsCreateOutput, error) {
	req := &endpoint.Request{
		Path: []string{"instances", instanceId, "tool-calls"},
		Body: body,
	}
