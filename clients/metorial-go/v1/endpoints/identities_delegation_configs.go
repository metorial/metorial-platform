...
func (e *IdentitiesDelegationConfigsEndpoint) List(params *IdentitiesDelegationConfigsEndpointListParams) (*delegationconfigs.IdentitiesDelegationConfigsListOutput, error) {
	var query map[string]any
	if params != nil {
		query = endpoint.StructToQuery(params)
	}
	req := &endpoint.Request{
		Path:  []string{"identity-delegation-configs"},
		Query: query,
	}
...
func (e *IdentitiesDelegationConfigsEndpoint) Get(identityDelegationConfigId string) (*delegationconfigs.IdentitiesDelegationConfigsGetOutput, error) {
	req := &endpoint.Request{
		Path: []string{"identity-delegation-configs", identityDelegationConfigId},
	}
...
func (e *IdentitiesDelegationConfigsEndpoint) Create(body *IdentitiesDelegationConfigsEndpointCreateBody) (*delegationconfigs.IdentitiesDelegationConfigsCreateOutput, error) {
	req := &endpoint.Request{
		Path: []string{"identity-delegation-configs"},
		Body: body,
	}
...
func (e *IdentitiesDelegationConfigsEndpoint) Update(identityDelegationConfigId string, body *IdentitiesDelegationConfigsEndpointUpdateBody) (*delegationconfigs.IdentitiesDelegationConfigsUpdateOutput, error) {
	req := &endpoint.Request{
		Path: []string{"identity-delegation-configs", identityDelegationConfigId},
		Body: body,
	}
...
func (e *IdentitiesDelegationConfigsEndpoint) Delete(identityDelegationConfigId string) (*delegationconfigs.IdentitiesDelegationConfigsDeleteOutput, error) {
	req := &endpoint.Request{
		Path: []string{"identity-delegation-configs", identityDelegationConfigId},
	}
