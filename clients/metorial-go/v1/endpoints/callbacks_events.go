...
func (e *CallbacksEventsEndpoint) List(callbackId string, params *CallbacksEventsEndpointListParams) (*events.CallbacksEventsListOutput, error) {
	var query map[string]any
	if params != nil {
		query = endpoint.StructToQuery(params)
	}
	req := &endpoint.Request{
		Path:  []string{"callbacks", callbackId, "events"},
		Query: query,
	}
...
func (e *CallbacksEventsEndpoint) Get(callbackId string, callbackEventId string) (*events.CallbacksEventsGetOutput, error) {
	req := &endpoint.Request{
		Path: []string{"callbacks", callbackId, "events", callbackEventId},
	}
