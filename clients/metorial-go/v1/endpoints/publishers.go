...
func (e *PublishersEndpoint) List(params *PublishersEndpointListParams) (*publishers.PublishersListOutput, error) {
...
func (e *PublishersEndpoint) Get(publisherId string) (*publishers.PublishersGetOutput, error) {
	req := &endpoint.Request{
		Path: []string{"publishers", publisherId},
	}
