...
// IdentitiesCredentialsGetOutput represents the identities credentials get output type.
type IdentitiesCredentialsGetOutput struct {
...
// MapIdentitiesCredentialsGetOutputFromJSON deserializes JSON data into a IdentitiesCredentialsGetOutput.
func MapIdentitiesCredentialsGetOutputFromJSON(data []byte) (*IdentitiesCredentialsGetOutput, error) {
	var v IdentitiesCredentialsGetOutput
...
// MapIdentitiesCredentialsGetOutputToJSON serializes a IdentitiesCredentialsGetOutput to JSON.
func MapIdentitiesCredentialsGetOutputToJSON(v *IdentitiesCredentialsGetOutput) ([]byte, error) {
