...
export type SessionTemplatesProvidersDeleteOutput = {
...
export let mapSessionTemplatesProvidersDeleteOutput =
  mtMap.object<SessionTemplatesProvidersDeleteOutput>({
