...
export type ProviderRunsListOutput = {
  items: {
...
export let mapProviderRunsListOutput = mtMap.object<ProviderRunsListOutput>({
...
export type ProviderRunsListQuery = {
...
export let mapProviderRunsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
