...
export type CustomProvidersCommitsCreateOutput = {
...
export let mapCustomProvidersCommitsCreateOutput =
  mtMap.object<CustomProvidersCommitsCreateOutput>({
...
export type CustomProvidersCommitsCreateBody = {
  message: string;
  action:
    | {
...
export let mapCustomProvidersCommitsCreateBody =
  mtMap.object<CustomProvidersCommitsCreateBody>({
    message: mtMap.objectField('message', mtMap.passthrough()),
