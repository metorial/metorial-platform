...
export type DashboardOrganizationsAccessPoliciesDeleteOutput = {
...
export let mapDashboardOrganizationsAccessPoliciesDeleteOutput =
  mtMap.object<DashboardOrganizationsAccessPoliciesDeleteOutput>({
