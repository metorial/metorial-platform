...
export type DashboardOrganizationsOauthAuthorizationsGetOutput = {
...
export let mapDashboardOrganizationsOauthAuthorizationsGetOutput =
  mtMap.object<DashboardOrganizationsOauthAuthorizationsGetOutput>({
