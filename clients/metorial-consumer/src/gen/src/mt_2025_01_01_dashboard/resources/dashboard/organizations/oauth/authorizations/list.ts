...
export type DashboardOrganizationsOauthAuthorizationsListOutput = {
  items: {
    object: 'machine_access.oauth_authorization';
    id: string;
    status: 'active' | 'revoked';
    type: 'user' | 'server_side';
...
export let mapDashboardOrganizationsOauthAuthorizationsListOutput =
  mtMap.object<DashboardOrganizationsOauthAuthorizationsListOutput>({
    items: mtMap.objectField(
      ...
      mtMap.array(
        mtMap.object({
          ...
          requestingIp: mtMap.objectField('requesting_ip', mtMap.passthrough()),
          acceptingIp: mtMap.objectField('accepting_ip', mtMap.passthrough()),
          lastUsedAt: mtMap.objectField('last_used_at', mtMap.date()),
...
export type DashboardOrganizationsOauthAuthorizationsListQuery = {
...
export let mapDashboardOrganizationsOauthAuthorizationsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
      ...
      installationId: mtMap.objectField(
        'installation_id',
        mtMap.union([
