...
export type DashboardInstanceSessionTemplatesProvidersGetOutput = {
...
export let mapDashboardInstanceSessionTemplatesProvidersGetOutput =
  mtMap.object<DashboardInstanceSessionTemplatesProvidersGetOutput>({
