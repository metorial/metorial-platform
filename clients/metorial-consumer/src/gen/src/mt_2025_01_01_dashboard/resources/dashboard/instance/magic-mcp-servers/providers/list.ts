...
export type DashboardInstanceMagicMcpServersProvidersListOutput = {
  items: {
...
export let mapDashboardInstanceMagicMcpServersProvidersListOutput =
  mtMap.object<DashboardInstanceMagicMcpServersProvidersListOutput>({
...
export type DashboardInstanceMagicMcpServersProvidersListQuery = {
...
export let mapDashboardInstanceMagicMcpServersProvidersListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
