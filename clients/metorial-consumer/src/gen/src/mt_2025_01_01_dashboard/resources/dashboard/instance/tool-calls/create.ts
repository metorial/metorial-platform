...
export type DashboardInstanceToolCallsCreateOutput = {
...
export let mapDashboardInstanceToolCallsCreateOutput =
  mtMap.object<DashboardInstanceToolCallsCreateOutput>({
...
export type DashboardInstanceToolCallsCreateBody = {
  toolId: string;
...
export let mapDashboardInstanceToolCallsCreateBody =
  mtMap.object<DashboardInstanceToolCallsCreateBody>({
