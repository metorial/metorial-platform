...
export type DashboardOrganizationsOauthInstallationsListOutput = {
  items: {
...
export let mapDashboardOrganizationsOauthInstallationsListOutput =
  mtMap.object<DashboardOrganizationsOauthInstallationsListOutput>({
...
export type DashboardOrganizationsOauthInstallationsListQuery = {
...
export let mapDashboardOrganizationsOauthInstallationsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
