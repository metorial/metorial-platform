...
export type DashboardOauthAuthorizationRequestsRejectOutput = {
...
export let mapDashboardOauthAuthorizationRequestsRejectOutput =
  mtMap.object<DashboardOauthAuthorizationRequestsRejectOutput>({
