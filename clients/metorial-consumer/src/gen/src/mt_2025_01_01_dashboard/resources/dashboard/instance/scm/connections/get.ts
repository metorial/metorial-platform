...
export type DashboardInstanceScmConnectionsGetOutput = {
...
export let mapDashboardInstanceScmConnectionsGetOutput =
  mtMap.object<DashboardInstanceScmConnectionsGetOutput>({
