...
export type DashboardOrganizationsMembersPoliciesDeleteOutput = {
...
export let mapDashboardOrganizationsMembersPoliciesDeleteOutput =
  mtMap.object<DashboardOrganizationsMembersPoliciesDeleteOutput>({
