...
export type DashboardInstanceIdentitiesDelegationRequestsApproveOutput = {
...
export let mapDashboardInstanceIdentitiesDelegationRequestsApproveOutput =
  mtMap.object<DashboardInstanceIdentitiesDelegationRequestsApproveOutput>({
...
export type DashboardInstanceIdentitiesDelegationRequestsApproveQuery = {
  allowDeleted?: boolean | undefined;
};

export let mapDashboardInstanceIdentitiesDelegationRequestsApproveQuery =
  mtMap.object<DashboardInstanceIdentitiesDelegationRequestsApproveQuery>({
