...
export type DashboardInstanceSessionsProvidersGetOutput = {
...
export let mapDashboardInstanceSessionsProvidersGetOutput =
  mtMap.object<DashboardInstanceSessionsProvidersGetOutput>({
