...
export type DashboardInstanceCustomProvidersDeploymentsListOutput = {
  items: {
...
export let mapDashboardInstanceCustomProvidersDeploymentsListOutput =
  mtMap.object<DashboardInstanceCustomProvidersDeploymentsListOutput>({
...
export type DashboardInstanceCustomProvidersDeploymentsListQuery = {
...
export let mapDashboardInstanceCustomProvidersDeploymentsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
