...
export type DashboardInstanceProviderDeploymentsCreateOutput = {
...
export let mapDashboardInstanceProviderDeploymentsCreateOutput =
  mtMap.object<DashboardInstanceProviderDeploymentsCreateOutput>({
...
export let mapDashboardInstanceProviderDeploymentsCreateBody =
  mtMap.object<DashboardInstanceProviderDeploymentsCreateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    metadata: mtMap.objectField('metadata', mtMap.passthrough()),
    providerId: mtMap.objectField('provider_id', mtMap.passthrough()),
