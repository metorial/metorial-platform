...
export type DashboardInstanceSessionsProvidersUpdateOutput = {
...
export let mapDashboardInstanceSessionsProvidersUpdateOutput =
  mtMap.object<DashboardInstanceSessionsProvidersUpdateOutput>({
...
export type DashboardInstanceSessionsProvidersUpdateBody = {
  toolFilters?:
    | (
        | { type: 'tool_keys'; keys: string[] }
        | { type: 'tool_regex'; pattern: string }
...
export let mapDashboardInstanceSessionsProvidersUpdateBody =
  mtMap.object<DashboardInstanceSessionsProvidersUpdateBody>({
