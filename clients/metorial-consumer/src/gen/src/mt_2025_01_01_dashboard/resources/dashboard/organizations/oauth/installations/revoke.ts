...
export type DashboardOrganizationsOauthInstallationsRevokeOutput = {
...
export let mapDashboardOrganizationsOauthInstallationsRevokeOutput =
  mtMap.object<DashboardOrganizationsOauthInstallationsRevokeOutput>({
