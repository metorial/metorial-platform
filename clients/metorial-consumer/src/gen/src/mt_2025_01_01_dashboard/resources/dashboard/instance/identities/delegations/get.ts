...
export type DashboardInstanceIdentitiesDelegationsGetOutput = {
...
export let mapDashboardInstanceIdentitiesDelegationsGetOutput =
  mtMap.object<DashboardInstanceIdentitiesDelegationsGetOutput>({
