...
export type DashboardInstanceCallbacksInstancesCreateOutput = {
...
export let mapDashboardInstanceCallbacksInstancesCreateOutput =
  mtMap.object<DashboardInstanceCallbacksInstancesCreateOutput>({
...
export type DashboardInstanceCallbacksInstancesCreateBody = {
  providerConfigId: string;
  providerAuthConfigId?: string | undefined;
};

export let mapDashboardInstanceCallbacksInstancesCreateBody =
  mtMap.object<DashboardInstanceCallbacksInstancesCreateBody>({
