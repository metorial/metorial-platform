...
export type DashboardInstancePortalsConsumerAccessListingsListOutput = {
  items: {
...
export let mapDashboardInstancePortalsConsumerAccessListingsListOutput =
  mtMap.object<DashboardInstancePortalsConsumerAccessListingsListOutput>({
...
export type DashboardInstancePortalsConsumerAccessListingsListQuery = {
...
export let mapDashboardInstancePortalsConsumerAccessListingsListQuery =
  mtMap.union([
    mtMap.unionOption(
      'object',
      mtMap.object({
