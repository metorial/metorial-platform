...
export type DashboardInstanceCallbacksEventsListOutput = {
  items: {
...
export let mapDashboardInstanceCallbacksEventsListOutput =
  mtMap.object<DashboardInstanceCallbacksEventsListOutput>({
...
export type DashboardInstanceCallbacksEventsListQuery = {
