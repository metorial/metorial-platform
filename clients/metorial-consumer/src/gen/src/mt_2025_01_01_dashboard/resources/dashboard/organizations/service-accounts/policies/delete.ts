...
export type DashboardOrganizationsServiceAccountsPoliciesDeleteOutput = {
...
export let mapDashboardOrganizationsServiceAccountsPoliciesDeleteOutput =
  mtMap.object<DashboardOrganizationsServiceAccountsPoliciesDeleteOutput>({
