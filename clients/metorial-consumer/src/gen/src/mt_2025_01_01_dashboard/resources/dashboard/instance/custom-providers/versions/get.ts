...
export type DashboardInstanceCustomProvidersVersionsGetOutput = {
...
export let mapDashboardInstanceCustomProvidersVersionsGetOutput =
  mtMap.object<DashboardInstanceCustomProvidersVersionsGetOutput>({
