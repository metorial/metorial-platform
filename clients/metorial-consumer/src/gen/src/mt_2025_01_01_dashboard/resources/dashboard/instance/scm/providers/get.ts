...
export type DashboardInstanceScmProvidersGetOutput = {
  object: 'scm.provider';
  id: string;
...
export let mapDashboardInstanceScmProvidersGetOutput =
  mtMap.object<DashboardInstanceScmProvidersGetOutput>({
