...
export type DashboardOrganizationsServiceAccountsDeleteOutput = {
...
export let mapDashboardOrganizationsServiceAccountsDeleteOutput =
  mtMap.object<DashboardOrganizationsServiceAccountsDeleteOutput>({
