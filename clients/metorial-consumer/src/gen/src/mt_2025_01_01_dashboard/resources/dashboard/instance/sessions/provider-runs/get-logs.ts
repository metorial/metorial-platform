...
export type DashboardInstanceSessionsProviderRunsGetLogsOutput = {
  object: 'session.provider_run.logs';
  logs: { type: string; line: string; timestamp: Date | null }[];
};

export let mapDashboardInstanceSessionsProviderRunsGetLogsOutput =
  mtMap.object<DashboardInstanceSessionsProviderRunsGetLogsOutput>({
