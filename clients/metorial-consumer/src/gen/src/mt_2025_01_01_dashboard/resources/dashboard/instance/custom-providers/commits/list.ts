...
export type DashboardInstanceCustomProvidersCommitsListOutput = {
  items: {
...
export let mapDashboardInstanceCustomProvidersCommitsListOutput =
  mtMap.object<DashboardInstanceCustomProvidersCommitsListOutput>({
...
export type DashboardInstanceCustomProvidersCommitsListQuery = {
  ...
  customProviderEnvironmentIds?: string | string[] | undefined;
};

export let mapDashboardInstanceCustomProvidersCommitsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
      ...
      customProviderEnvironmentIds: mtMap.objectField(
