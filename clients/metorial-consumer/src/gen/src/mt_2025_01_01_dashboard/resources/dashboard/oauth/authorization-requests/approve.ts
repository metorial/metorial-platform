...
export type DashboardOauthAuthorizationRequestsApproveOutput = {
...
export let mapDashboardOauthAuthorizationRequestsApproveOutput =
  mtMap.object<DashboardOauthAuthorizationRequestsApproveOutput>({
    object: mtMap.objectField('object', mtMap.passthrough()),
    id: mtMap.objectField('id', mtMap.passthrough()),
    status: mtMap.objectField('status', mtMap.passthrough()),
    type: mtMap.objectField('type', mtMap.passthrough()),
    userCode: mtMap.objectField('user_code', mtMap.passthrough()),
