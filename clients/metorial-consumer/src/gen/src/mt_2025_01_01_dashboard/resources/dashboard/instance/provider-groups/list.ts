...
export let mapDashboardInstanceProviderGroupsListOutput =
  mtMap.object<DashboardInstanceProviderGroupsListOutput>({
...
export type DashboardInstanceProviderGroupsListQuery = {
