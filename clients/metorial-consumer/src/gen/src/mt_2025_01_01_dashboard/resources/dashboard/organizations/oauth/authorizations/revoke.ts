...
export type DashboardOrganizationsOauthAuthorizationsRevokeOutput = {
...
export let mapDashboardOrganizationsOauthAuthorizationsRevokeOutput =
  mtMap.object<DashboardOrganizationsOauthAuthorizationsRevokeOutput>({
