...
export type DashboardOrganizationsOauthInstallationsGetOutput = {
...
export let mapDashboardOrganizationsOauthInstallationsGetOutput =
  mtMap.object<DashboardOrganizationsOauthInstallationsGetOutput>({
