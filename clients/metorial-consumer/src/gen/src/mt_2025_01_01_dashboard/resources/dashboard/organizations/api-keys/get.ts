...
export type DashboardOrganizationsApiKeysGetOutput = {
...
export let mapDashboardOrganizationsApiKeysGetOutput =
  mtMap.object<DashboardOrganizationsApiKeysGetOutput>({
