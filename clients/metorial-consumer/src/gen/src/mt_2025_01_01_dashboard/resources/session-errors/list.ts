...
export type SessionErrorsListOutput = {
  items: {
...
export let mapSessionErrorsListOutput = mtMap.object<SessionErrorsListOutput>({
...
export type SessionErrorsListQuery = {
...
export let mapSessionErrorsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
