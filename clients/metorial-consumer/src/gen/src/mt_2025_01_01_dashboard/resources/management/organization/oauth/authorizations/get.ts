...
export type ManagementOrganizationOauthAuthorizationsGetOutput = {
...
export let mapManagementOrganizationOauthAuthorizationsGetOutput =
  mtMap.object<ManagementOrganizationOauthAuthorizationsGetOutput>({
