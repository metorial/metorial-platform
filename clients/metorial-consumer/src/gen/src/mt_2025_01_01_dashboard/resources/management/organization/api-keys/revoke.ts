...
export type ManagementOrganizationApiKeysRevokeOutput = {
...
export let mapManagementOrganizationApiKeysRevokeOutput =
  mtMap.object<ManagementOrganizationApiKeysRevokeOutput>({
