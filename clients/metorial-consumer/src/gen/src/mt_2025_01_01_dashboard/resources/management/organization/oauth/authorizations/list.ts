...
export type ManagementOrganizationOauthAuthorizationsListOutput = {
  items: {
...
export let mapManagementOrganizationOauthAuthorizationsListOutput =
  mtMap.object<ManagementOrganizationOauthAuthorizationsListOutput>({
...
export type ManagementOrganizationOauthAuthorizationsListQuery = {
...
export let mapManagementOrganizationOauthAuthorizationsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
