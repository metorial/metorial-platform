...
export type ManagementInstanceIdentitiesCredentialsListOutput = {
  items: {
...
export let mapManagementInstanceIdentitiesCredentialsListOutput =
  mtMap.object<ManagementInstanceIdentitiesCredentialsListOutput>({
...
export type ManagementInstanceIdentitiesCredentialsListQuery = {
...
export let mapManagementInstanceIdentitiesCredentialsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
