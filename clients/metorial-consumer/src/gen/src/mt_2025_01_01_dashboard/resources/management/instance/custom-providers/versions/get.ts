...
export type ManagementInstanceCustomProvidersVersionsGetOutput = {
...
export let mapManagementInstanceCustomProvidersVersionsGetOutput =
  mtMap.object<ManagementInstanceCustomProvidersVersionsGetOutput>({
