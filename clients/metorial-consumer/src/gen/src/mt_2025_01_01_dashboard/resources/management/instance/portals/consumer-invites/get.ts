...
export type ManagementInstancePortalsConsumerInvitesGetOutput = {
...
export let mapManagementInstancePortalsConsumerInvitesGetOutput =
  mtMap.object<ManagementInstancePortalsConsumerInvitesGetOutput>({
