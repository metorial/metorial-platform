...
export type ManagementInstanceScmConnectionsCreateOutput = {
...
export let mapManagementInstanceScmConnectionsCreateOutput =
  mtMap.object<ManagementInstanceScmConnectionsCreateOutput>({
...
export type ManagementInstanceScmConnectionsCreateBody = {
  redirectUrl?: string | undefined;
};

export let mapManagementInstanceScmConnectionsCreateBody =
  mtMap.object<ManagementInstanceScmConnectionsCreateBody>({
