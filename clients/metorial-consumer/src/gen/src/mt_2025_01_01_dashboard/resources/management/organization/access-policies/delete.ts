...
export type ManagementOrganizationAccessPoliciesDeleteOutput = {
...
export let mapManagementOrganizationAccessPoliciesDeleteOutput =
  mtMap.object<ManagementOrganizationAccessPoliciesDeleteOutput>({
