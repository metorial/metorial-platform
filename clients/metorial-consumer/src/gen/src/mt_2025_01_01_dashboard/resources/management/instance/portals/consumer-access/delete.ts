...
export type ManagementInstancePortalsConsumerAccessDeleteOutput = {
...
export let mapManagementInstancePortalsConsumerAccessDeleteOutput =
  mtMap.object<ManagementInstancePortalsConsumerAccessDeleteOutput>({
