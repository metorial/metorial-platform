...
export type ManagementOrganizationOauthAuthorizationsRevokeOutput = {
...
export let mapManagementOrganizationOauthAuthorizationsRevokeOutput =
  mtMap.object<ManagementOrganizationOauthAuthorizationsRevokeOutput>({
