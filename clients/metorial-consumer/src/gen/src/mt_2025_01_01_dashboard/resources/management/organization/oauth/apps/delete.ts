...
export type ManagementOrganizationOauthAppsDeleteOutput = {
...
export let mapManagementOrganizationOauthAppsDeleteOutput =
  mtMap.object<ManagementOrganizationOauthAppsDeleteOutput>({
