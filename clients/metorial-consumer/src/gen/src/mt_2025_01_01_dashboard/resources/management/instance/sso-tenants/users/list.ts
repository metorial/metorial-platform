...
export type ManagementInstanceSsoTenantsUsersListOutput = {
  items: {
    object: 'sso.tenant';
    id: string;
    ssoTenant: {
...
export let mapManagementInstanceSsoTenantsUsersListOutput =
  mtMap.object<ManagementInstanceSsoTenantsUsersListOutput>({
...
export type ManagementInstanceSsoTenantsUsersListQuery = {
...
export let mapManagementInstanceSsoTenantsUsersListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
