...
export type ManagementOrganizationOauthCliDevicesGetOutput = {
...
export let mapManagementOrganizationOauthCliDevicesGetOutput =
  mtMap.object<ManagementOrganizationOauthCliDevicesGetOutput>({
