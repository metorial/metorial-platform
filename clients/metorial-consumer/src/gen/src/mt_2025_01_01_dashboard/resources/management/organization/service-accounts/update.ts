...
export type ManagementOrganizationServiceAccountsUpdateOutput = {
...
export let mapManagementOrganizationServiceAccountsUpdateOutput =
  mtMap.object<ManagementOrganizationServiceAccountsUpdateOutput>({
...
export type ManagementOrganizationServiceAccountsUpdateBody = {
  name?: string | undefined;
  description?: string | null | undefined;
  scopes?: string[] | undefined;
};

export let mapManagementOrganizationServiceAccountsUpdateBody =
  mtMap.object<ManagementOrganizationServiceAccountsUpdateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
