...
export type ManagementInstanceToolCallsListOutput = {
  items: {
...
export let mapManagementInstanceToolCallsListOutput =
  mtMap.object<ManagementInstanceToolCallsListOutput>({
...
export type ManagementInstanceToolCallsListQuery = {
...
export let mapManagementInstanceToolCallsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
