...
export type ManagementInstanceProviderDeploymentsAuthConfigsDeleteOutput = {
...
export let mapManagementInstanceProviderDeploymentsAuthConfigsDeleteOutput =
  mtMap.object<ManagementInstanceProviderDeploymentsAuthConfigsDeleteOutput>({
