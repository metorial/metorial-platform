...
export type ManagementInstanceIdentitiesListOutput = {
  items: {
    object: 'identity';
    id: string;
...
export let mapManagementInstanceIdentitiesListOutput =
  mtMap.object<ManagementInstanceIdentitiesListOutput>({
...
export type ManagementInstanceIdentitiesListQuery = {
...
export let mapManagementInstanceIdentitiesListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
