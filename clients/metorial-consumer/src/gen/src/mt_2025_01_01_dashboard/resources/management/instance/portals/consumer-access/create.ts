...
export type ManagementInstancePortalsConsumerAccessCreateOutput = {
...
export let mapManagementInstancePortalsConsumerAccessCreateOutput =
  mtMap.object<ManagementInstancePortalsConsumerAccessCreateOutput>({
...
export type ManagementInstancePortalsConsumerAccessCreateBody = {
  consumerGroupId: string;
  access:
    | { type: 'magic_mcp_group'; magicMcpGroupId: string }
    | {
        type: 'server_deployment_template';
