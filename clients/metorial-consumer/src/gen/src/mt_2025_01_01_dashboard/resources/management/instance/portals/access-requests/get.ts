...
export type ManagementInstancePortalsAccessRequestsGetOutput = {
...
export let mapManagementInstancePortalsAccessRequestsGetOutput =
  mtMap.object<ManagementInstancePortalsAccessRequestsGetOutput>({
