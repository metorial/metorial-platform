...
export type ManagementInstanceProviderDeploymentsAuthConfigsImportsListOutput =
  {
    items: {
...
export let mapManagementInstanceProviderDeploymentsAuthConfigsImportsListOutput =
  mtMap.object<ManagementInstanceProviderDeploymentsAuthConfigsImportsListOutput>(
    {
      items: mtMap.objectField(
        ...
        mtMap.array(
          mtMap.object({
            ...
            credentialsId: mtMap.objectField(
              'credentials_id',
              mtMap.passthrough()
            ),
            createdAt: mtMap.objectField('created_at', mtMap.date()),
...
export type ManagementInstanceProviderDeploymentsAuthConfigsImportsListQuery = {
...
export let mapManagementInstanceProviderDeploymentsAuthConfigsImportsListQuery =
  mtMap.union([
    mtMap.unionOption(
      'object',
      mtMap.object({
