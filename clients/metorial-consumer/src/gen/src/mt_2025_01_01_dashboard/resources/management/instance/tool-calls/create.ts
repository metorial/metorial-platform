...
export type ManagementInstanceToolCallsCreateOutput = {
...
export let mapManagementInstanceToolCallsCreateOutput =
  mtMap.object<ManagementInstanceToolCallsCreateOutput>({
...
export type ManagementInstanceToolCallsCreateBody = {
  toolId: string;
...
export let mapManagementInstanceToolCallsCreateBody =
  mtMap.object<ManagementInstanceToolCallsCreateBody>({
