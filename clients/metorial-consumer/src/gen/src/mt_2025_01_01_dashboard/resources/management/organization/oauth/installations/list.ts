...
export type ManagementOrganizationOauthInstallationsListOutput = {
  items: {
...
export let mapManagementOrganizationOauthInstallationsListOutput =
  mtMap.object<ManagementOrganizationOauthInstallationsListOutput>({
...
export type ManagementOrganizationOauthInstallationsListQuery = {
...
export let mapManagementOrganizationOauthInstallationsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
