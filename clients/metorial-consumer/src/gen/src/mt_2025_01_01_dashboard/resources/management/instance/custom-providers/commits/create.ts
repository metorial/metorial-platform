...
export type ManagementInstanceCustomProvidersCommitsCreateOutput = {
...
export let mapManagementInstanceCustomProvidersCommitsCreateOutput =
  mtMap.object<ManagementInstanceCustomProvidersCommitsCreateOutput>({
...
export type ManagementInstanceCustomProvidersCommitsCreateBody = {
  message: string;
  action:
    | {
...
export let mapManagementInstanceCustomProvidersCommitsCreateBody =
  mtMap.object<ManagementInstanceCustomProvidersCommitsCreateBody>({
    message: mtMap.objectField('message', mtMap.passthrough()),
    action: mtMap.objectField(
      ...
      mtMap.union([
        mtMap.unionOption(
          ...
          mtMap.object({
            type: mtMap.objectField('type', mtMap.passthrough()),
            fromEnvironmentId: mtMap.objectField('from_environment_id', mtMap.passthrough()),
            toEnvironmentId: mtMap.objectField('to_environment_id', mtMap.passthrough()),
            environmentId: mtMap.objectField('environment_id', mtMap.passthrough()),
