...
export type ProviderDeploymentsAuthConfigsUpdateOutput = {
...
export let mapProviderDeploymentsAuthConfigsUpdateOutput =
  mtMap.object<ProviderDeploymentsAuthConfigsUpdateOutput>({
...
export type ProviderDeploymentsAuthConfigsUpdateBody = {
  name?: string | undefined;
  description?: string | undefined;
  metadata?: Record<string, any> | undefined;
};

export let mapProviderDeploymentsAuthConfigsUpdateBody =
  mtMap.object<ProviderDeploymentsAuthConfigsUpdateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    metadata: mtMap.objectField('metadata', mtMap.passthrough())
  });
