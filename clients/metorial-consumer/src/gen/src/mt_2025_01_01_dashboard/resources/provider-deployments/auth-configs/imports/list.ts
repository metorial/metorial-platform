...
export type ProviderDeploymentsAuthConfigsImportsListOutput = {
  items: {
...
export let mapProviderDeploymentsAuthConfigsImportsListOutput =
  mtMap.object<ProviderDeploymentsAuthConfigsImportsListOutput>({
...
export type ProviderDeploymentsAuthConfigsImportsListQuery = {
...
export let mapProviderDeploymentsAuthConfigsImportsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
