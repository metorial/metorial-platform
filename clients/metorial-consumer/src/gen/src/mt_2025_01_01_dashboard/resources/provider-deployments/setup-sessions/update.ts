...
export type ProviderDeploymentsSetupSessionsUpdateOutput = {
...
export let mapProviderDeploymentsSetupSessionsUpdateOutput =
  mtMap.object<ProviderDeploymentsSetupSessionsUpdateOutput>({
...
export type ProviderDeploymentsSetupSessionsUpdateBody = {
  name?: string | undefined;
  description?: string | undefined;
  metadata?: Record<string, any> | undefined;
};

export let mapProviderDeploymentsSetupSessionsUpdateBody =
  mtMap.object<ProviderDeploymentsSetupSessionsUpdateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    metadata: mtMap.objectField('metadata', mtMap.passthrough())
  });
