...
export type ProviderDeploymentsAuthConfigsImportsGetOutput = {
...
export let mapProviderDeploymentsAuthConfigsImportsGetOutput =
  mtMap.object<ProviderDeploymentsAuthConfigsImportsGetOutput>({
