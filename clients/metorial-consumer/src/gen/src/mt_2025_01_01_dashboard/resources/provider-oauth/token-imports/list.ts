...
export type ProviderOauthTokenImportsListOutput = {
  items: {
...
export let mapProviderOauthTokenImportsListOutput =
  mtMap.object<ProviderOauthTokenImportsListOutput>({
...
export type ProviderOauthTokenImportsListQuery = {
...
export let mapProviderOauthTokenImportsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
