...
export type CallbacksInstancesCreateOutput = {
...
export let mapCallbacksInstancesCreateOutput =
  mtMap.object<CallbacksInstancesCreateOutput>({
...
export type CallbacksInstancesCreateBody = {
  providerConfigId: string;
  providerAuthConfigId?: string | undefined;
};

export let mapCallbacksInstancesCreateBody =
  mtMap.object<CallbacksInstancesCreateBody>({
