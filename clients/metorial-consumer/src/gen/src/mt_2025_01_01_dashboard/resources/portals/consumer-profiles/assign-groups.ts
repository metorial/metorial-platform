...
export type PortalsConsumerProfilesAssignGroupsOutput = {
...
export let mapPortalsConsumerProfilesAssignGroupsOutput =
  mtMap.object<PortalsConsumerProfilesAssignGroupsOutput>({
...
export type PortalsConsumerProfilesAssignGroupsBody = { groupIds: string[] };

export let mapPortalsConsumerProfilesAssignGroupsBody =
  mtMap.object<PortalsConsumerProfilesAssignGroupsBody>({
