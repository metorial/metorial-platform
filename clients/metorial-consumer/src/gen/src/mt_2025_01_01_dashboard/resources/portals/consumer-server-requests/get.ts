...
export type PortalsConsumerServerRequestsGetOutput = {
...
export let mapPortalsConsumerServerRequestsGetOutput =
  mtMap.object<PortalsConsumerServerRequestsGetOutput>({
