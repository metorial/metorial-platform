...
export type PortalsConsumerProfilesUnassignGroupsOutput = {
...
export let mapPortalsConsumerProfilesUnassignGroupsOutput = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
...
export let mapPortalsConsumerProfilesUnassignGroupsBody =
  mtMap.object<PortalsConsumerProfilesUnassignGroupsBody>({
