...
export type PortalsConsumerProfilesListOutput = {
  items: {
...
export let mapPortalsConsumerProfilesListOutput =
  mtMap.object<PortalsConsumerProfilesListOutput>({
...
export type PortalsConsumerProfilesListQuery = {
