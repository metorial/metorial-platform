...
export type PortalsConsumerAccessUpdateOutput = {
...
export let mapPortalsConsumerAccessUpdateOutput =
  mtMap.object<PortalsConsumerAccessUpdateOutput>({
...
export type PortalsConsumerAccessUpdateBody = {
