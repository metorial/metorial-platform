 ...
 */
export class MetorialDashboardInstanceProviderCategoriesEndpoint {
  ...
  list(
    ...
    let path = `dashboard/instances/${instanceId}/provider-categories`;
    ...
    return this._get(request).transform(mapDashboardInstanceProviderCategoriesListOutput);
  }
  ...
  get(
    ...
    let path = `dashboard/instances/${instanceId}/provider-categories/${providerCategoryId}`;
    ...
    return this._get(request).transform(mapDashboardInstanceProviderCategoriesGetOutput);
  }
}
