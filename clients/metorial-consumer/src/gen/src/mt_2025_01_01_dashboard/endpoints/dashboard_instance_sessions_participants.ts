 ...
 */
export class MetorialDashboardInstanceSessionsParticipantsEndpoint {
  ...
  list(
    ...
    let path = `dashboard/instances/${instanceId}/sessions/${sessionId}/participants`;
    ...
    return this._get(request).transform(mapDashboardInstanceSessionsParticipantsListOutput);
  }
  ...
  get(
    ...
    let path = `dashboard/instances/${instanceId}/sessions/${sessionId}/participants/${sessionParticipantId}`;
    ...
    return this._get(request).transform(mapDashboardInstanceSessionsParticipantsGetOutput);
  }
}
