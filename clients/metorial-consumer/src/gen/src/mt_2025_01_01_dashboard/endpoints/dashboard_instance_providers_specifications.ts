 ...
 */
export class MetorialDashboardInstanceProvidersSpecificationsEndpoint {
  ...
  list(
    ...
    let path = `dashboard/instances/${instanceId}/providers/${providerId}/specifications`;

    let request = {
      path,

      query: query
        ? mapDashboardInstanceProvidersSpecificationsListQuery.transformTo(query)
        : undefined,
      ...(opts?.headers ? { headers: opts.headers } : {})
    } as any;

    return this._get(request).transform(mapDashboardInstanceProvidersSpecificationsListOutput);
  }
  ...
  get(
    ...
    let path = `dashboard/instances/${instanceId}/providers/${providerId}/specifications/${providerSpecificationId}`;
    ...
    return this._get(request).transform(mapDashboardInstanceProvidersSpecificationsGetOutput);
  }
}
