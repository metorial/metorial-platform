 ...
 */
export class MetorialDashboardInstanceProvidersAuthMethodsEndpoint {
  ...
  list(
    ...
    let path = `dashboard/instances/${instanceId}/providers/${providerId}/auth-methods`;
    ...
    return this._get(request).transform(mapDashboardInstanceProvidersAuthMethodsListOutput);
  }
  ...
  get(
    ...
    let path = `dashboard/instances/${instanceId}/providers/${providerId}/auth-methods/${providerAuthMethodId}`;
    ...
    return this._get(request).transform(mapDashboardInstanceProvidersAuthMethodsGetOutput);
  }
}
