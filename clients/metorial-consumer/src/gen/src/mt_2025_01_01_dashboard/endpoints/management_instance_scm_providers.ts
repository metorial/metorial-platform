 ...
 */
export class MetorialManagementInstanceScmProvidersEndpoint {
  ...
  list(
    ...
    let path = `instances/${instanceId}/scm/providers`;
  ...
  get(
    ...
    let path = `instances/${instanceId}/scm/providers/${scmProviderId}`;
