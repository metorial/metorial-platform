 ...
 */
export class MetorialDashboardInstanceSessionErrorGroupsEndpoint {
  ...
  list(
    ...
    let path = `dashboard/instances/${instanceId}/session-error-groups`;
    ...
    return this._get(request).transform(mapDashboardInstanceSessionErrorGroupsListOutput);
  }
  ...
  get(
    ...
    let path = `dashboard/instances/${instanceId}/session-error-groups/${sessionErrorGroupId}`;
    ...
    return this._get(request).transform(mapDashboardInstanceSessionErrorGroupsGetOutput);
  }
}
