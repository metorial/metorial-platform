 ...
 */
export class MetorialManagementInstanceMagicMcpSessionsEndpoint {
  ...
  list(
    ...
    let path = `instances/${instanceId}/magic-mcp-sessions`;
  ...
  get(
    ...
    let path = `instances/${instanceId}/magic-mcp-sessions/${magicMcpSessionId}`;
