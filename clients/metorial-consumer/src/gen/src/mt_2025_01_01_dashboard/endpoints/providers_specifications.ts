 ...
 */
export class MetorialProvidersSpecificationsEndpoint {
  ...
  list(
    ...
    let path = `providers/${providerId}/specifications`;
  ...
  get(
    ...
    let path = `providers/${providerId}/specifications/${providerSpecificationId}`;
