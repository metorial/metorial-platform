...
export class MetorialDashboardInstanceProviderDeploymentsAuthConfigsImportsEndpoint {
  ...
  list(
    ...
    let path = `dashboard/instances/${instanceId}/provider-deployments/${providerDeploymentId}/auth-configs/${providerAuthConfigId}/imports`;
  ...
  get(
    ...
    let path = `dashboard/instances/${instanceId}/provider-deployments/${providerDeploymentId}/auth-configs/${providerAuthConfigId}/imports/${providerAuthImportId}`;
  ...
  getSchema(
    ...
    let path = `dashboard/instances/${instanceId}/provider-deployments/${providerDeploymentId}/auth-configs/${providerAuthConfigId}/imports/schema`;
