 ...
 */
export class MetorialPortalsAccessRequestsEndpoint {
  ...
  list(
    ...
    let path = `portals/${portalId}/access-requests`;
  ...
  get(
    ...
    let path = `portals/${portalId}/access-requests/${consumerAccessRequestId}`;
