 ...
 */
export class MetorialDashboardInstanceSessionsErrorsEndpoint {
  ...
  list(
    ...
    let path = `dashboard/instances/${instanceId}/sessions/${sessionId}/errors`;
    ...
    return this._get(request).transform(mapDashboardInstanceSessionsErrorsListOutput);
  }
  ...
  get(
    ...
    let path = `dashboard/instances/${instanceId}/sessions/${sessionId}/errors/${sessionErrorId}`;
    ...
    return this._get(request).transform(mapDashboardInstanceSessionsErrorsGetOutput);
  }
}
