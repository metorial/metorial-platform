...
export class MetorialDashboardInstanceCustomProvidersVersionsEndpoint {
  ...
  list(
    ...
    let path = `dashboard/instances/${instanceId}/custom-providers/${customProviderId}/versions`;

    let request = {
      path,

      query: query
        ? mapDashboardInstanceCustomProvidersVersionsListQuery.transformTo(query)
        : undefined,
      ...(opts?.headers ? { headers: opts.headers } : {})
    } as any;

    return this._get(request).transform(mapDashboardInstanceCustomProvidersVersionsListOutput);
  }
  ...
  get(
    ...
    let path = `dashboard/instances/${instanceId}/custom-providers/${customProviderId}/versions/${customProviderVersionId}`;
    ...
    return this._get(request).transform(mapDashboardInstanceCustomProvidersVersionsGetOutput);
  }
  ...
  create(
    ...
    let request = {
      path,
      body: mapDashboardInstanceCustomProvidersVersionsCreateBody.transformTo(body),
