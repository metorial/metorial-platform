 ...
 */
export class MetorialManagementOrganizationTeamsPoliciesEndpoint {
  ...
  create(
    ...
    let path = `organization/teams/${teamId}/policies`;
  ...
  delete(
    ...
    let path = `organization/teams/${teamId}/policies/${accessPolicyId}`;
