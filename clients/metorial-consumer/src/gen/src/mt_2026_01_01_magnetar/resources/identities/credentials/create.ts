...
export type IdentitiesCredentialsCreateOutput = {
...
export let mapIdentitiesCredentialsCreateOutput =
  mtMap.object<IdentitiesCredentialsCreateOutput>({
...
export type IdentitiesCredentialsCreateBody = {
  identityId: string;
...
export let mapIdentitiesCredentialsCreateBody =
  mtMap.object<IdentitiesCredentialsCreateBody>({
    identityId: mtMap.objectField('identity_id', mtMap.passthrough()),
    deploymentId: mtMap.objectField('deployment_id', mtMap.passthrough()),
    configId: mtMap.objectField('config_id', mtMap.passthrough()),
    authConfigId: mtMap.objectField('auth_config_id', mtMap.passthrough()),
