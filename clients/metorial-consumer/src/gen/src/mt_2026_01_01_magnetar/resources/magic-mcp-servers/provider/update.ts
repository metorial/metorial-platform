...
export type MagicMcpServersProviderUpdateOutput = {
...
export let mapMagicMcpServersProviderUpdateOutput =
  mtMap.object<MagicMcpServersProviderUpdateOutput>({
...
export type MagicMcpServersProviderUpdateBody = {
  toolFilters?:
    | (
        | { type: 'tool_keys'; keys: string[] }
        | { type: 'tool_regex'; pattern: string }
...
export let mapMagicMcpServersProviderUpdateBody =
  mtMap.object<MagicMcpServersProviderUpdateBody>({
