...
export type DashboardOrganizationsApiKeysCreateOutput = {
...
export let mapDashboardOrganizationsApiKeysCreateOutput =
  mtMap.object<DashboardOrganizationsApiKeysCreateOutput>({
...
export type DashboardOrganizationsApiKeysCreateBody = (
...
export let mapDashboardOrganizationsApiKeysCreateBody = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
      type: mtMap.objectField('type', mtMap.passthrough()),
