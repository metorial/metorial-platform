...
export type DashboardOrganizationsApiKeysListOutput = {
  items: {
...
export let mapDashboardOrganizationsApiKeysListOutput =
  mtMap.object<DashboardOrganizationsApiKeysListOutput>({
...
export type DashboardOrganizationsApiKeysListQuery = {
...
export let mapDashboardOrganizationsApiKeysListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
