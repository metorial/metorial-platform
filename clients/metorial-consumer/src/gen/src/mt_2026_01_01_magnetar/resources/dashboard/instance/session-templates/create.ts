...
export type DashboardInstanceSessionTemplatesCreateOutput = {
...
export let mapDashboardInstanceSessionTemplatesCreateOutput =
  mtMap.object<DashboardInstanceSessionTemplatesCreateOutput>({
...
export type DashboardInstanceSessionTemplatesCreateBody = {
  name: string;
...
export let mapDashboardInstanceSessionTemplatesCreateBody =
  mtMap.object<DashboardInstanceSessionTemplatesCreateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    metadata: mtMap.objectField('metadata', mtMap.passthrough()),
