...
export type DashboardInstanceCallbacksDeleteOutput = {
  object: 'callback';
  id: string;
...
export let mapDashboardInstanceCallbacksDeleteOutput =
  mtMap.object<DashboardInstanceCallbacksDeleteOutput>({
