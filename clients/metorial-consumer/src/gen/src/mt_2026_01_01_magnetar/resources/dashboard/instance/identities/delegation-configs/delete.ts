...
export type DashboardInstanceIdentitiesDelegationConfigsDeleteOutput = {
...
export let mapDashboardInstanceIdentitiesDelegationConfigsDeleteOutput =
  mtMap.object<DashboardInstanceIdentitiesDelegationConfigsDeleteOutput>({
