...
export type DashboardInstanceSessionTemplatesListToolsOutput = {
...
export let mapDashboardInstanceSessionTemplatesListToolsOutput =
  mtMap.object<DashboardInstanceSessionTemplatesListToolsOutput>({
