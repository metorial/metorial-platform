...
export type DashboardInstanceProvidersSpecificationsGetOutput = {
...
export let mapDashboardInstanceProvidersSpecificationsGetOutput =
  mtMap.object<DashboardInstanceProvidersSpecificationsGetOutput>({
