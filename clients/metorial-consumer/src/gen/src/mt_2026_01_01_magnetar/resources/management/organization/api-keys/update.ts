...
export type ManagementOrganizationApiKeysUpdateOutput = {
...
export let mapManagementOrganizationApiKeysUpdateOutput =
  mtMap.object<ManagementOrganizationApiKeysUpdateOutput>({
...
export type ManagementOrganizationApiKeysUpdateBody = {
...
export let mapManagementOrganizationApiKeysUpdateBody =
  mtMap.object<ManagementOrganizationApiKeysUpdateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    expiresAt: mtMap.objectField('expires_at', mtMap.date()),
