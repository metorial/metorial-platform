...
export type ManagementInstanceIdentitiesDelegationsCreateOutput = {
...
export let mapManagementInstanceIdentitiesDelegationsCreateOutput =
  mtMap.object<ManagementInstanceIdentitiesDelegationsCreateOutput>({
    object: mtMap.objectField('object', mtMap.passthrough()),
    id: mtMap.objectField('id', mtMap.passthrough()),
    status: mtMap.objectField('status', mtMap.passthrough()),
    deniedReason: mtMap.objectField('denied_reason', mtMap.passthrough()),
    delegationLevel: mtMap.objectField('delegation_level', mtMap.passthrough()),
...
export type ManagementInstanceIdentitiesDelegationsCreateBody = {
  identityId: string;
...
export let mapManagementInstanceIdentitiesDelegationsCreateBody =
  mtMap.object<ManagementInstanceIdentitiesDelegationsCreateBody>({
    identityId: mtMap.objectField('identity_id', mtMap.passthrough()),
