...
export type ManagementInstanceIdentitiesCredentialsGetOutput = {
...
export let mapManagementInstanceIdentitiesCredentialsGetOutput =
  mtMap.object<ManagementInstanceIdentitiesCredentialsGetOutput>({
