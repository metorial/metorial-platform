...
export type ManagementOrganizationApiKeysCreateOutput = {
...
export let mapManagementOrganizationApiKeysCreateOutput =
  mtMap.object<ManagementOrganizationApiKeysCreateOutput>({
...
export type ManagementOrganizationApiKeysCreateBody = (
...
export let mapManagementOrganizationApiKeysCreateBody = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
      type: mtMap.objectField('type', mtMap.passthrough()),
