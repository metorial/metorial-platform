...
export type ManagementInstanceProviderTemplatesGetOutput = {
...
export let mapManagementInstanceProviderTemplatesGetOutput =
  mtMap.object<ManagementInstanceProviderTemplatesGetOutput>({
