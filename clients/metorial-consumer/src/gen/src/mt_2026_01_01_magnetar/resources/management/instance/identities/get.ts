...
export type ManagementInstanceIdentitiesGetOutput = {
  object: 'identity';
  id: string;
...
export let mapManagementInstanceIdentitiesGetOutput =
  mtMap.object<ManagementInstanceIdentitiesGetOutput>({
