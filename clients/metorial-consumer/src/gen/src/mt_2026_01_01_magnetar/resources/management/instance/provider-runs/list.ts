...
export type ManagementInstanceProviderRunsListOutput = {
  items: {
...
export let mapManagementInstanceProviderRunsListOutput =
  mtMap.object<ManagementInstanceProviderRunsListOutput>({
...
export type ManagementInstanceProviderRunsListQuery = {
