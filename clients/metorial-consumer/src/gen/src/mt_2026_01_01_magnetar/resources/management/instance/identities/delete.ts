...
export type ManagementInstanceIdentitiesDeleteOutput = {
  object: 'identity';
  id: string;
...
export let mapManagementInstanceIdentitiesDeleteOutput =
  mtMap.object<ManagementInstanceIdentitiesDeleteOutput>({
