...
export type ManagementInstanceMagicMcpServersProviderListOutput = {
  items: {
...
export let mapManagementInstanceMagicMcpServersProviderListOutput =
  mtMap.object<ManagementInstanceMagicMcpServersProviderListOutput>({
...
export type ManagementInstanceMagicMcpServersProviderListQuery = {
...
export let mapManagementInstanceMagicMcpServersProviderListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
