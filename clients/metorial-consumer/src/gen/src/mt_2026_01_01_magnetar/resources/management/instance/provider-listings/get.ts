...
export type ManagementInstanceProviderListingsGetOutput = {
...
export let mapManagementInstanceProviderListingsGetOutput =
  mtMap.object<ManagementInstanceProviderListingsGetOutput>({
