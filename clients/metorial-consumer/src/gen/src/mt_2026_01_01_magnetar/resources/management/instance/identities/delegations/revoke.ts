...
export type ManagementInstanceIdentitiesDelegationsRevokeOutput = {
...
export let mapManagementInstanceIdentitiesDelegationsRevokeOutput =
  mtMap.object<ManagementInstanceIdentitiesDelegationsRevokeOutput>({
