...
export type ManagementInstanceIdentitiesDelegationRequestsCreateOutput = {
...
export let mapManagementInstanceIdentitiesDelegationRequestsCreateOutput =
  mtMap.object<ManagementInstanceIdentitiesDelegationRequestsCreateOutput>({
...
export type ManagementInstanceIdentitiesDelegationRequestsCreateBody = {
  identityId: string;
  requesterActorId: string;
  delegatorActorId?: string | undefined;
  permissions?: ('provider:call' | 'provider:read')[] | undefined;
  expiresAt: Date;
...
export let mapManagementInstanceIdentitiesDelegationRequestsCreateBody =
  mtMap.object<ManagementInstanceIdentitiesDelegationRequestsCreateBody>({
    identityId: mtMap.objectField('identity_id', mtMap.passthrough()),
    requesterActorId: mtMap.objectField(
      'requester_actor_id',
      mtMap.passthrough()
    ),
    ...
    credentialOverrides: mtMap.objectField(
      ...
      mtMap.array(
        mtMap.object({
          credentialId: mtMap.objectField('credential_id', mtMap.passthrough()),
          permissions: mtMap.objectField(
            'permissions',
            mtMap.array(mtMap.passthrough())
          ),
