...
export type ManagementInstanceMagicMcpServersProviderGetOutput = {
...
export let mapManagementInstanceMagicMcpServersProviderGetOutput =
  mtMap.object<ManagementInstanceMagicMcpServersProviderGetOutput>({
