...
export type ManagementInstanceProviderDeploymentsSetupSessionsListOutput = {
  items: {
...
export let mapManagementInstanceProviderDeploymentsSetupSessionsListOutput =
  mtMap.object<ManagementInstanceProviderDeploymentsSetupSessionsListOutput>({
...
export type ManagementInstanceProviderDeploymentsSetupSessionsListQuery = {
