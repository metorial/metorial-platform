...
export type ManagementInstanceIdentitiesDelegationRequestsGetOutput = {
...
export let mapManagementInstanceIdentitiesDelegationRequestsGetOutput =
  mtMap.object<ManagementInstanceIdentitiesDelegationRequestsGetOutput>({
...
export type ManagementInstanceIdentitiesDelegationRequestsGetQuery = {
  allowDeleted?: boolean | undefined;
};

export let mapManagementInstanceIdentitiesDelegationRequestsGetQuery =
  mtMap.object<ManagementInstanceIdentitiesDelegationRequestsGetQuery>({
