...
export type ManagementOrganizationApiKeysRevealOutput = {
...
export let mapManagementOrganizationApiKeysRevealOutput =
  mtMap.object<ManagementOrganizationApiKeysRevealOutput>({
