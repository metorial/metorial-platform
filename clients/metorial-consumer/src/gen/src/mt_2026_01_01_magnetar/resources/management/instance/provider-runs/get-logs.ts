...
export type ManagementInstanceProviderRunsGetLogsOutput = {
  object: 'session.provider_run.logs';
  logs: { type: string; line: string; timestamp: Date | null }[];
};

export let mapManagementInstanceProviderRunsGetLogsOutput =
  mtMap.object<ManagementInstanceProviderRunsGetLogsOutput>({
