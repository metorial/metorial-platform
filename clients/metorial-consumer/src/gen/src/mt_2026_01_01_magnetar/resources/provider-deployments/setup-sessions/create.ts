...
export type ProviderDeploymentsSetupSessionsCreateOutput = {
...
export let mapProviderDeploymentsSetupSessionsCreateOutput =
  mtMap.object<ProviderDeploymentsSetupSessionsCreateOutput>({
...
export type ProviderDeploymentsSetupSessionsCreateBody = {
...
export let mapProviderDeploymentsSetupSessionsCreateBody =
  mtMap.object<ProviderDeploymentsSetupSessionsCreateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    metadata: mtMap.objectField('metadata', mtMap.passthrough()),
    providerAuthMethodId: mtMap.objectField(
