...
export type ProviderDeploymentsAuthConfigsCreateOutput = {
...
export let mapProviderDeploymentsAuthConfigsCreateOutput =
  mtMap.object<ProviderDeploymentsAuthConfigsCreateOutput>({
...
export type ProviderDeploymentsAuthConfigsCreateBody = {
  name: string;
...
export let mapProviderDeploymentsAuthConfigsCreateBody =
  mtMap.object<ProviderDeploymentsAuthConfigsCreateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    metadata: mtMap.objectField('metadata', mtMap.passthrough()),
    providerAuthMethodId: mtMap.objectField(
