...
export type ProviderDeploymentsAuthConfigsExportsGetOutput = {
...
export let mapProviderDeploymentsAuthConfigsExportsGetOutput =
  mtMap.object<ProviderDeploymentsAuthConfigsExportsGetOutput>({
