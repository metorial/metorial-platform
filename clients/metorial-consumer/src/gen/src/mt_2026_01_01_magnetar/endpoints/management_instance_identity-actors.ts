 ...
 */
export class MetorialManagementInstanceIdentityActorsEndpoint {
  ...
  list(
    ...
    let path = `instances/${instanceId}/identity-actors`;
  ...
  get(
    ...
    let path = `instances/${instanceId}/identity-actors/${identityActorId}`;
