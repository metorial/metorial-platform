 ...
 */
export class MetorialManagementInstanceProviderDeploymentsEndpoint {
  ...
  list(
    ...
    let path = `instances/${instanceId}/provider-deployments`;
  ...
  get(
    ...
    let path = `instances/${instanceId}/provider-deployments/${providerDeploymentId}`;
