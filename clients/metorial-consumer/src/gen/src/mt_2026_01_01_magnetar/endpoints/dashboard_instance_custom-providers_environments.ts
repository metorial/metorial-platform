 ...
 */
export class MetorialDashboardInstanceCustomProvidersEnvironmentsEndpoint {
  ...
  list(
    ...
    let path = `dashboard/instances/${instanceId}/custom-providers/${customProviderId}/environments`;

    let request = {
      path,

      query: query
        ? mapDashboardInstanceCustomProvidersEnvironmentsListQuery.transformTo(
            query
          )
        : undefined,
  ...
  get(
    ...
    let path = `dashboard/instances/${instanceId}/custom-providers/${customProviderId}/environments/${customProviderEnvironmentId}`;
