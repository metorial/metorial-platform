...
export type DashboardInstancePortalsFeaturedServersRemoveListingOutput = {
...
export let mapDashboardInstancePortalsFeaturedServersRemoveListingOutput =
  mtMap.object<DashboardInstancePortalsFeaturedServersRemoveListingOutput>({
...
export type DashboardInstancePortalsFeaturedServersRemoveListingBody = {
  serverId: string;
};

export let mapDashboardInstancePortalsFeaturedServersRemoveListingBody =
  mtMap.object<DashboardInstancePortalsFeaturedServersRemoveListingBody>({
