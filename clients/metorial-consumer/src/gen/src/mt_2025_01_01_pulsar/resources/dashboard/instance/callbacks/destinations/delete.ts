...
export type DashboardInstanceCallbacksDestinationsDeleteOutput = {
...
export let mapDashboardInstanceCallbacksDestinationsDeleteOutput =
  mtMap.object<DashboardInstanceCallbacksDestinationsDeleteOutput>({
