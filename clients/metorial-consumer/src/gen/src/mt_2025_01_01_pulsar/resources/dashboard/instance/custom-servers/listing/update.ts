...
export type DashboardInstanceCustomServersListingUpdateOutput = {
...
export let mapDashboardInstanceCustomServersListingUpdateOutput =
  mtMap.object<DashboardInstanceCustomServersListingUpdateOutput>({
