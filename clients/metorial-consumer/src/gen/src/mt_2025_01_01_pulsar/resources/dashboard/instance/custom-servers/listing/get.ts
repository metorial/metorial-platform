...
export type DashboardInstanceCustomServersListingGetOutput = {
...
export let mapDashboardInstanceCustomServersListingGetOutput =
  mtMap.object<DashboardInstanceCustomServersListingGetOutput>({
