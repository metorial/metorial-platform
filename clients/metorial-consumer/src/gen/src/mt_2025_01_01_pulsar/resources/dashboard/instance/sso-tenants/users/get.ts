...
export type DashboardInstanceSsoTenantsUsersGetOutput = {
  object: 'sso.tenant';
  id: string;
  ssoTenant: {
    object: 'sso.tenant';
...
export let mapDashboardInstanceSsoTenantsUsersGetOutput =
  mtMap.object<DashboardInstanceSsoTenantsUsersGetOutput>({
