...
export type ConsumerMagicMcpServersListOutput = {
  items: {
...
export let mapConsumerMagicMcpServersListOutput =
  mtMap.object<ConsumerMagicMcpServersListOutput>({
...
export type ConsumerMagicMcpServersListQuery = {
...
export let mapConsumerMagicMcpServersListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
