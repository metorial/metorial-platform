...
export type ConsumerMagicMcpTokensListOutput = {
  items: {
...
export let mapConsumerMagicMcpTokensListOutput =
  mtMap.object<ConsumerMagicMcpTokensListOutput>({
...
export type ConsumerMagicMcpTokensListQuery = {
...
export let mapConsumerMagicMcpTokensListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
