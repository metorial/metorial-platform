...
export type ManagementInstancePortalsFeaturedServersGetOutput = {
...
export let mapManagementInstancePortalsFeaturedServersGetOutput =
  mtMap.object<ManagementInstancePortalsFeaturedServersGetOutput>({
