...
export type ManagementInstancePortalsConsumerAccessGetOutput = {
...
export let mapManagementInstancePortalsConsumerAccessGetOutput =
  mtMap.object<ManagementInstancePortalsConsumerAccessGetOutput>({
