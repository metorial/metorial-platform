...
export type ManagementInstancePortalsFeaturedServersAddListingOutput = {
...
export let mapManagementInstancePortalsFeaturedServersAddListingOutput =
  mtMap.object<ManagementInstancePortalsFeaturedServersAddListingOutput>({
...
export type ManagementInstancePortalsFeaturedServersAddListingBody = {
  serverId: string;
};

export let mapManagementInstancePortalsFeaturedServersAddListingBody =
  mtMap.object<ManagementInstancePortalsFeaturedServersAddListingBody>({
