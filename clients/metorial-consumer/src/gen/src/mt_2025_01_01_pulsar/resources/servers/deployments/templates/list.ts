...
export type ServersDeploymentsTemplatesListOutput = {
  items: {
...
export let mapServersDeploymentsTemplatesListOutput =
  mtMap.object<ServersDeploymentsTemplatesListOutput>({
...
export type ServersDeploymentsTemplatesListQuery = {
...
export let mapServersDeploymentsTemplatesListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
