...
export type ServersDeploymentsTemplatesCreateOutput = {
...
export let mapServersDeploymentsTemplatesCreateOutput =
  mtMap.object<ServersDeploymentsTemplatesCreateOutput>({
...
export type ServersDeploymentsTemplatesCreateBody = {
  name: string;
...
export let mapServersDeploymentsTemplatesCreateBody =
  mtMap.object<ServersDeploymentsTemplatesCreateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    serverId: mtMap.objectField('server_id', mtMap.passthrough()),
    oauth: mtMap.objectField(
