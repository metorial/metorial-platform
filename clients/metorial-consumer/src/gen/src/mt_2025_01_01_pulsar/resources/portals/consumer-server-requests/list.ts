...
export type PortalsConsumerServerRequestsListOutput = {
  items: {
...
export let mapPortalsConsumerServerRequestsListOutput =
  mtMap.object<PortalsConsumerServerRequestsListOutput>({
...
export type PortalsConsumerServerRequestsListQuery = {
...
export let mapPortalsConsumerServerRequestsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
