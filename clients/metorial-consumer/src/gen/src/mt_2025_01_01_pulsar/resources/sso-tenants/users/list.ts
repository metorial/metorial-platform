...
export type SsoTenantsUsersListOutput = {
  items: {
    object: 'sso.tenant';
    id: string;
    ssoTenant: {
...
export let mapSsoTenantsUsersListOutput =
  mtMap.object<SsoTenantsUsersListOutput>({
...
export type SsoTenantsUsersListQuery = {
...
export let mapSsoTenantsUsersListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
