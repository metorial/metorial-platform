 ...
 */
export class MetorialDashboardInstanceProviderOauthTokenExportsEndpoint {
  ...
  list(
    ...
    let path = `dashboard/instances/${instanceId}/provider-oauth/token-exports`;
  ...
  get(
    ...
    let path = `dashboard/instances/${instanceId}/provider-oauth/token-exports/${takeoutId}`;
