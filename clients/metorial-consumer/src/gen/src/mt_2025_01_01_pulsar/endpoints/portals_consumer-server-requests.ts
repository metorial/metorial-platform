 ...
 */
export class MetorialPortalsConsumerServerRequestsEndpoint {
  ...
  list(
    ...
    let path = `portals/${portalId}/consumer-server-requests`;
  ...
  get(
    ...
    let path = `portals/${portalId}/consumer-server-requests/${consumerServerRequestId}`;
  ...
  accept(
    ...
    let path = `portals/${portalId}/consumer-server-requests/${consumerServerRequestId}/accept`;
  ...
  reject(
    ...
    let path = `portals/${portalId}/consumer-server-requests/${consumerServerRequestId}/reject`;
