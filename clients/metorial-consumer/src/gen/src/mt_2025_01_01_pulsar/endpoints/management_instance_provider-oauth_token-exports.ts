 ...
 */
export class MetorialManagementInstanceProviderOauthTokenExportsEndpoint {
  ...
  list(
    ...
    let path = `instances/${instanceId}/provider-oauth/token-exports`;
  ...
  get(
    ...
    let path = `instances/${instanceId}/provider-oauth/token-exports/${takeoutId}`;
