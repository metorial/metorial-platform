 ...
 */
export class MetorialDashboardInstanceMagicMcpGroupsEndpoint {
  ...
  list(
    ...
    let path = `dashboard/instances/${instanceId}/magic-mcp-groups`;
  ...
  get(
    ...
    let path = `dashboard/instances/${instanceId}/magic-mcp-groups/${magicMcpGroupId}`;
