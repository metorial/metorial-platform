 ...
 */
export class MetorialConversationsMessagesEndpoint {
  ...
  list(
    ...
    let path = `conversations/${assistantConversationId}/messages`;
  ...
  get(
    ...
    let path = `conversations/${assistantConversationId}/messages/${assistantMessageId}`;
