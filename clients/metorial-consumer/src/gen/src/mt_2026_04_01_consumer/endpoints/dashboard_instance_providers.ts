 ...
 */
export class MetorialDashboardInstanceProvidersEndpoint {
  ...
  list(
    ...
    let path = `dashboard/instances/${instanceId}/providers`;
  ...
  get(
    ...
    let path = `dashboard/instances/${instanceId}/providers/${providerId}`;
