...
export type ManagementInstanceMagicMcpEndpointsGetOutput = {
...
export let mapManagementInstanceMagicMcpEndpointsGetOutput =
  mtMap.object<ManagementInstanceMagicMcpEndpointsGetOutput>({
