...
export type ManagementInstanceMagicMcpSessionsGetOutput = {
  ...
  consumerIntegrationSessions: {
    object: 'consumer.integration_session';
    id: string;
    consumerId: string;
...
export let mapManagementInstanceMagicMcpSessionsGetOutput = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
      ...
      createdAt: mtMap.objectField('created_at', mtMap.date()),
      updatedAt: mtMap.objectField('updated_at', mtMap.date()),
      consumerIntegrationSessions: mtMap.objectField(
        'consumer_integration_sessions',
        mtMap.array(
          mtMap.object({
            object: mtMap.objectField('object', mtMap.passthrough()),
            id: mtMap.objectField('id', mtMap.passthrough()),
            ...
            consumerIntegration: mtMap.objectField(
