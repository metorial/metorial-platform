...
export let mapManagementInstanceMagicMcpServersListOutput =
  mtMap.object<ManagementInstanceMagicMcpServersListOutput>({
        ...
        mtMap.union([
          mtMap.unionOption(
            ...
            mtMap.object({
              ...
              createdAt: mtMap.objectField('created_at', mtMap.date()),
              updatedAt: mtMap.objectField('updated_at', mtMap.date()),
              consumerIntegrations: mtMap.objectField(
                'consumer_integrations',
                mtMap.array(
                  mtMap.object({
                    object: mtMap.objectField('object', mtMap.passthrough()),
                    id: mtMap.objectField('id', mtMap.passthrough()),
...
export type ManagementInstanceMagicMcpServersListQuery = {
...
export let mapManagementInstanceMagicMcpServersListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
