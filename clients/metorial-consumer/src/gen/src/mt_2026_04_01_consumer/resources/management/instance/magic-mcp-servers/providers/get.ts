...
export type ManagementInstanceMagicMcpServersProvidersGetOutput = {
...
export let mapManagementInstanceMagicMcpServersProvidersGetOutput =
  mtMap.object<ManagementInstanceMagicMcpServersProvidersGetOutput>({
