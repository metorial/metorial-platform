...
export type ManagementInstanceAssistantsGetOutput = {
  object: 'assistant';
  id: string;
  slug: string;
  name: string;
...
export let mapManagementInstanceAssistantsGetOutput =
  mtMap.object<ManagementInstanceAssistantsGetOutput>({
