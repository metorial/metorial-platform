...
export type ManagementInstanceMagicMcpServersProvidersUpdateOutput = {
...
export let mapManagementInstanceMagicMcpServersProvidersUpdateOutput =
  mtMap.object<ManagementInstanceMagicMcpServersProvidersUpdateOutput>({
...
export type ManagementInstanceMagicMcpServersProvidersUpdateBody = {
  toolFilters?:
    | (
        | { type: 'tool_keys'; keys: string[] }
        | { type: 'tool_regex'; pattern: string }
...
export let mapManagementInstanceMagicMcpServersProvidersUpdateBody =
  mtMap.object<ManagementInstanceMagicMcpServersProvidersUpdateBody>({
