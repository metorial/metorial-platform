...
export type ManagementInstanceConversationsMessagesHandoffResponsesOutput = {
...
export let mapManagementInstanceConversationsMessagesHandoffResponsesOutput =
  mtMap.object<ManagementInstanceConversationsMessagesHandoffResponsesOutput>({
...
export type ManagementInstanceConversationsMessagesHandoffResponsesBody = {
  responses: { toolCallId: string; output: any }[];
};

export let mapManagementInstanceConversationsMessagesHandoffResponsesBody =
  mtMap.object<ManagementInstanceConversationsMessagesHandoffResponsesBody>({
