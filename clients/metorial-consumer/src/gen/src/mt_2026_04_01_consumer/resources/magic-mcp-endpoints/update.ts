...
export type MagicMcpEndpointsUpdateOutput = {
...
export let mapMagicMcpEndpointsUpdateOutput =
  mtMap.object<MagicMcpEndpointsUpdateOutput>({
...
export type MagicMcpEndpointsUpdateBody = {
  name?: string | undefined;
  description?: string | undefined;
  metadata?: Record<string, any> | undefined;
};

export let mapMagicMcpEndpointsUpdateBody =
  mtMap.object<MagicMcpEndpointsUpdateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    metadata: mtMap.objectField('metadata', mtMap.passthrough())
  });
