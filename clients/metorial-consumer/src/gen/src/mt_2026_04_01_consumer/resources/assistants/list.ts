...
export type AssistantsListOutput = {
  items: {
    object: 'assistant';
    id: string;
    slug: string;
...
export let mapAssistantsListOutput = mtMap.object<AssistantsListOutput>({
...
export type AssistantsListQuery = {
...
export let mapAssistantsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
