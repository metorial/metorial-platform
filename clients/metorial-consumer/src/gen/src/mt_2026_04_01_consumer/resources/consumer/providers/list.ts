...
export let mapConsumerProvidersListOutput = mtMap.object<ConsumerProvidersListOutput>({
      ...
      mtMap.union([
        mtMap.unionOption(
          ...
          mtMap.object({
            ...
            availability: mtMap.objectField('availability', mtMap.passthrough()),
...
} & { search?: string | undefined; providerGroupId?: string | string[] | undefined };
...
export let mapConsumerProvidersListQuery = mtMap.union([
  mtMap.unionOption(
    ...
    mtMap.object({
      ...
      providerGroupId: mtMap.objectField('provider_group_id', mtMap.passthrough())
    })
  )
]);
