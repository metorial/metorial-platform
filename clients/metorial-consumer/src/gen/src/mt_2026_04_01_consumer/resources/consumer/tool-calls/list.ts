...
export type ConsumerToolCallsListOutput = {
  items: {
...
export let mapConsumerToolCallsListOutput =
  mtMap.object<ConsumerToolCallsListOutput>({
...
export type ConsumerToolCallsListQuery = {
...
export let mapConsumerToolCallsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
