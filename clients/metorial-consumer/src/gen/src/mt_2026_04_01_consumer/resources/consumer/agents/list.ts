...
export type ConsumerAgentsListOutput = {
  items: {
...
export let mapConsumerAgentsListOutput = mtMap.object<ConsumerAgentsListOutput>(
  {
...
export type ConsumerAgentsListQuery = {
...
export let mapConsumerAgentsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
