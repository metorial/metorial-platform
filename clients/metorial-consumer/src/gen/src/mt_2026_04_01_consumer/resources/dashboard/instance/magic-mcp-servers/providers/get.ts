...
export type DashboardInstanceMagicMcpServersProvidersGetOutput = {
...
export let mapDashboardInstanceMagicMcpServersProvidersGetOutput =
  mtMap.object<DashboardInstanceMagicMcpServersProvidersGetOutput>({
