...
export type DashboardInstanceMagicMcpEndpointsAddServersOutput = {
...
export let mapDashboardInstanceMagicMcpEndpointsAddServersOutput =
  mtMap.object<DashboardInstanceMagicMcpEndpointsAddServersOutput>({
