...
export type DashboardInstanceConversationsGetOutput = {
...
export let mapDashboardInstanceConversationsGetOutput =
  mtMap.object<DashboardInstanceConversationsGetOutput>({
