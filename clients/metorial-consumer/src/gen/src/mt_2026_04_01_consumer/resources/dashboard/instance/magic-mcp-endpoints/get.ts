...
export type DashboardInstanceMagicMcpEndpointsGetOutput = {
...
export let mapDashboardInstanceMagicMcpEndpointsGetOutput =
  mtMap.object<DashboardInstanceMagicMcpEndpointsGetOutput>({
