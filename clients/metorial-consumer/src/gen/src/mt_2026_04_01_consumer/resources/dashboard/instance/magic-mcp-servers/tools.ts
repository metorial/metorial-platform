...
export type DashboardInstanceMagicMcpServersToolsOutput = {
...
export let mapDashboardInstanceMagicMcpServersToolsOutput =
  mtMap.object<DashboardInstanceMagicMcpServersToolsOutput>({
