...
export type DashboardInstanceMagicMcpServersUpdateOutput = {
...
export let mapDashboardInstanceMagicMcpServersUpdateOutput = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
...
export type DashboardInstanceMagicMcpServersUpdateBody = {
...
export let mapDashboardInstanceMagicMcpServersUpdateBody =
  mtMap.object<DashboardInstanceMagicMcpServersUpdateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    metadata: mtMap.objectField('metadata', mtMap.passthrough()),
