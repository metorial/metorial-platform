...
export type DashboardInstanceMagicMcpServersProvidersDeleteOutput = {
...
export let mapDashboardInstanceMagicMcpServersProvidersDeleteOutput =
  mtMap.object<DashboardInstanceMagicMcpServersProvidersDeleteOutput>({
