...
export type DashboardInstanceConversationsListOutput = {
  items: {
...
export let mapDashboardInstanceConversationsListOutput =
  mtMap.object<DashboardInstanceConversationsListOutput>({
...
export type DashboardInstanceConversationsListQuery = {
...
export let mapDashboardInstanceConversationsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
