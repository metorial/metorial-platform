...
export type ConversationsMessagesCreateOutput = {
...
export let mapConversationsMessagesCreateOutput =
  mtMap.object<ConversationsMessagesCreateOutput>({
...
export type ConversationsMessagesCreateBody = {
  message: {
    parts: (
...
export let mapConversationsMessagesCreateBody =
  mtMap.object<ConversationsMessagesCreateBody>({
