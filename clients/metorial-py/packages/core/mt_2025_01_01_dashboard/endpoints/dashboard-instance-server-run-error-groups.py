...
class MetorialDashboardInstanceServerRunErrorGroupsEndpoint(BaseMetorialEndpoint):
    ...
    """
        request = MetorialRequest(
            path=['dashboard', 'instances', instanceId, 'server-run-error-groups', serverRunErrorGroupId]
        )
