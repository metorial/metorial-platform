...
def mapManagementOrganizationInstancesCreateOutput(data: Dict[str, Any]) -> ManagementOrganizationInstancesCreateOutput:
...
def mapManagementOrganizationInstancesCreateBody(data: Dict[str, Any]) -> ManagementOrganizationInstancesCreateBody:
