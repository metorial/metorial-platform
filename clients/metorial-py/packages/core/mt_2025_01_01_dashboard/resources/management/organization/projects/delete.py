...
@dataclass
class ManagementOrganizationProjectsDeleteOutput:
    object: str
    id: str
    status: str
    slug: str
...
def mapManagementOrganizationProjectsDeleteOutput(data: Dict[str, Any]) -> ManagementOrganizationProjectsDeleteOutput:
