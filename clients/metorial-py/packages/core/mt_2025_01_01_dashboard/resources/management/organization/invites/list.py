...
def mapManagementOrganizationInvitesListOutput(data: Dict[str, Any]) -> ManagementOrganizationInvitesListOutput:
...
def mapManagementOrganizationInvitesListQuery(data: Dict[str, Any]) -> ManagementOrganizationInvitesListQuery:
    data
