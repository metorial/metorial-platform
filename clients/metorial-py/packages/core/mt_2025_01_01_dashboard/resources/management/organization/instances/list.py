...
def mapManagementOrganizationInstancesListOutput(data: Dict[str, Any]) -> ManagementOrganizationInstancesListOutput:
...
def mapManagementOrganizationInstancesListQuery(data: Dict[str, Any]) -> ManagementOrganizationInstancesListQuery:
    data
