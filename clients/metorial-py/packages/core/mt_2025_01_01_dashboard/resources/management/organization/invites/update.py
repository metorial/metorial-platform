...
def mapManagementOrganizationInvitesUpdateOutput(data: Dict[str, Any]) -> ManagementOrganizationInvitesUpdateOutput:
...
def mapManagementOrganizationInvitesUpdateBody(data: Dict[str, Any]) -> ManagementOrganizationInvitesUpdateBody:
    return ManagementOrganizationInvitesUpdateBody(
    role=data.get('role')
    )
