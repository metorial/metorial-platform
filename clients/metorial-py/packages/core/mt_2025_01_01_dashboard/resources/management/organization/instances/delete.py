...
@dataclass
class ManagementOrganizationInstancesDeleteOutput:
    object: str
    id: str
    status: str
    slug: str
...
def mapManagementOrganizationInstancesDeleteOutput(data: Dict[str, Any]) -> ManagementOrganizationInstancesDeleteOutput:
    return ManagementOrganizationInstancesDeleteOutput(
