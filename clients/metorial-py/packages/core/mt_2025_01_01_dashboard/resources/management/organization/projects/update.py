...
def mapManagementOrganizationProjectsUpdateOutput(data: Dict[str, Any]) -> ManagementOrganizationProjectsUpdateOutput:
...
def mapManagementOrganizationProjectsUpdateBody(data: Dict[str, Any]) -> ManagementOrganizationProjectsUpdateBody:
    return ManagementOrganizationProjectsUpdateBody(
    name=data.get('name')
    )
