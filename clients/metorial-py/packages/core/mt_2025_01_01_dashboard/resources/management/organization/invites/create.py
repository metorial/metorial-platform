...
def mapManagementOrganizationInvitesCreateOutput(data: Dict[str, Any]) -> ManagementOrganizationInvitesCreateOutput:
...
ManagementOrganizationInvitesCreateBody = Union[Dict[str, Any], Dict[str, Any]]


from typing import Any, Dict
from datetime import datetime

def mapManagementOrganizationInvitesCreateBody(data: Dict[str, Any]) -> ManagementOrganizationInvitesCreateBody:
    data
