...
def mapManagementOrganizationInstancesUpdateOutput(data: Dict[str, Any]) -> ManagementOrganizationInstancesUpdateOutput:
...
def mapManagementOrganizationInstancesUpdateBody(data: Dict[str, Any]) -> ManagementOrganizationInstancesUpdateBody:
    return ManagementOrganizationInstancesUpdateBody(
    name=data.get('name')
    )
