...
def mapManagementInstanceServerRunErrorGroupsListOutput(data: Dict[str, Any]) -> ManagementInstanceServerRunErrorGroupsListOutput:
...
ManagementInstanceServerRunErrorGroupsListQuery = Any


from typing import Any, Dict
from datetime import datetime

def mapManagementInstanceServerRunErrorGroupsListQuery(data: Dict[str, Any]) -> ManagementInstanceServerRunErrorGroupsListQuery:
  data
