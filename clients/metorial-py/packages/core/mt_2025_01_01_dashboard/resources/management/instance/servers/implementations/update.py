...
@dataclass
class ManagementInstanceServersImplementationsUpdateOutput:
    object: str
    id: str
    status: str
    name: str
...
def mapManagementInstanceServersImplementationsUpdateOutput(data: Dict[str, Any]) -> ManagementInstanceServersImplementationsUpdateOutput:
    return ManagementInstanceServersImplementationsUpdateOutput(
...
@dataclass
class ManagementInstanceServersImplementationsUpdateBody:
...
def mapManagementInstanceServersImplementationsUpdateBody(data: Dict[str, Any]) -> ManagementInstanceServersImplementationsUpdateBody:
    return ManagementInstanceServersImplementationsUpdateBody(
    name=data.get('name'),
    description=data.get('description'),
    metadata=data.get('metadata'),
    get_launch_params=data.get('get_launch_params')
