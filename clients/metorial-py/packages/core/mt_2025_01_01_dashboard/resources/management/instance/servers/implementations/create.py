...
def mapManagementInstanceServersImplementationsCreateOutput(data: Dict[str, Any]) -> ManagementInstanceServersImplementationsCreateOutput:
...
ManagementInstanceServersImplementationsCreateBody = Any


from typing import Any, Dict
from datetime import datetime

def mapManagementInstanceServersImplementationsCreateBody(data: Dict[str, Any]) -> ManagementInstanceServersImplementationsCreateBody:
    data
