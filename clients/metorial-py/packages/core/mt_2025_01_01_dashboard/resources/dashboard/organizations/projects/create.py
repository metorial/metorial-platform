...
def mapDashboardOrganizationsProjectsCreateOutput(data: Dict[str, Any]) -> DashboardOrganizationsProjectsCreateOutput:
...
def mapDashboardOrganizationsProjectsCreateBody(data: Dict[str, Any]) -> DashboardOrganizationsProjectsCreateBody:
    return DashboardOrganizationsProjectsCreateBody(
    name=data.get('name')
    )
