...
def mapDashboardOrganizationsInstancesUpdateOutput(data: Dict[str, Any]) -> DashboardOrganizationsInstancesUpdateOutput:
...
def mapDashboardOrganizationsInstancesUpdateBody(data: Dict[str, Any]) -> DashboardOrganizationsInstancesUpdateBody:
    return DashboardOrganizationsInstancesUpdateBody(
    name=data.get('name')
    )
