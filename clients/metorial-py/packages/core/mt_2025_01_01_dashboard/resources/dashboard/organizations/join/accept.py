...
def mapDashboardOrganizationsJoinAcceptOutput(data: Dict[str, Any]) -> DashboardOrganizationsJoinAcceptOutput:
...
def mapDashboardOrganizationsJoinAcceptBody(data: Dict[str, Any]) -> DashboardOrganizationsJoinAcceptBody:
    return DashboardOrganizationsJoinAcceptBody(
