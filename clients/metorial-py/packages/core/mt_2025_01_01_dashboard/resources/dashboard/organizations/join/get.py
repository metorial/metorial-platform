...
def mapDashboardOrganizationsJoinGetOutput(data: Dict[str, Any]) -> DashboardOrganizationsJoinGetOutput:
...
def mapDashboardOrganizationsJoinGetQuery(data: Dict[str, Any]) -> DashboardOrganizationsJoinGetQuery:
    return DashboardOrganizationsJoinGetQuery(
