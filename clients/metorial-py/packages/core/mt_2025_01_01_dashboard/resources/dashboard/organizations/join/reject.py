...
def mapDashboardOrganizationsJoinRejectOutput(data: Dict[str, Any]) -> DashboardOrganizationsJoinRejectOutput:
...
def mapDashboardOrganizationsJoinRejectBody(data: Dict[str, Any]) -> DashboardOrganizationsJoinRejectBody:
    return DashboardOrganizationsJoinRejectBody(
