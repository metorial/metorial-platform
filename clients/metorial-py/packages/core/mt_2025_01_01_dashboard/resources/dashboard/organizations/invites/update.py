...
def mapDashboardOrganizationsInvitesUpdateOutput(data: Dict[str, Any]) -> DashboardOrganizationsInvitesUpdateOutput:
...
def mapDashboardOrganizationsInvitesUpdateBody(data: Dict[str, Any]) -> DashboardOrganizationsInvitesUpdateBody:
