...
def mapDashboardInstanceSessionsEventsListOutput(data: Dict[str, Any]) -> DashboardInstanceSessionsEventsListOutput:
...
DashboardInstanceSessionsEventsListQuery = Any


from typing import Any, Dict
from datetime import datetime

def mapDashboardInstanceSessionsEventsListQuery(data: Dict[str, Any]) -> DashboardInstanceSessionsEventsListQuery:
  data
