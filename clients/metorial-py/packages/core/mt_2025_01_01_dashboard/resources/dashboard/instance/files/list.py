...
def mapDashboardInstanceFilesListOutput(data: Dict[str, Any]) -> DashboardInstanceFilesListOutput:
...
DashboardInstanceFilesListQuery = Any


from typing import Any, Dict
from datetime import datetime

def mapDashboardInstanceFilesListQuery(data: Dict[str, Any]) -> DashboardInstanceFilesListQuery:
    data
