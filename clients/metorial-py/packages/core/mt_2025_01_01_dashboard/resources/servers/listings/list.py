...
def mapServersListingsListOutput(data: Dict[str, Any]) -> ServersListingsListOutput:
...
def mapServersListingsListQuery(data: Dict[str, Any]) -> ServersListingsListQuery:
    data
