...
def mapServersImplementationsListOutput(data: Dict[str, Any]) -> ServersImplementationsListOutput:
...
def mapServersImplementationsListQuery(data: Dict[str, Any]) -> ServersImplementationsListQuery:
    data
