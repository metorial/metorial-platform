...
def mapManagementInstanceSessionsServerSessionsListOutput(data: Dict[str, Any]) -> ManagementInstanceSessionsServerSessionsListOutput:
...
ManagementInstanceSessionsServerSessionsListQuery = Any


from typing import Any, Dict
from datetime import datetime

def mapManagementInstanceSessionsServerSessionsListQuery(data: Dict[str, Any]) -> ManagementInstanceSessionsServerSessionsListQuery:
    data
