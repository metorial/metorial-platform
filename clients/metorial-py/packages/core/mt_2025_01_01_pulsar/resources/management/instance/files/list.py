...
def mapManagementInstanceFilesListOutput(data: Dict[str, Any]) -> ManagementInstanceFilesListOutput:
...
ManagementInstanceFilesListQuery = Any


from typing import Any, Dict
from datetime import datetime

def mapManagementInstanceFilesListQuery(data: Dict[str, Any]) -> ManagementInstanceFilesListQuery:
    data
