...
def mapManagementInstanceServerRunErrorsListOutput(data: Dict[str, Any]) -> ManagementInstanceServerRunErrorsListOutput:
...
ManagementInstanceServerRunErrorsListQuery = Any


from typing import Any, Dict
from datetime import datetime

def mapManagementInstanceServerRunErrorsListQuery(data: Dict[str, Any]) -> ManagementInstanceServerRunErrorsListQuery:
    data
