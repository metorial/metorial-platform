...
def mapDashboardInstanceSessionsCreateOutput(data: Dict[str, Any]) -> DashboardInstanceSessionsCreateOutput:
...
def mapDashboardInstanceSessionsCreateBody(data: Dict[str, Any]) -> DashboardInstanceSessionsCreateBody:
