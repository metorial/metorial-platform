...
def mapDashboardInstanceSessionsListOutput(data: Dict[str, Any]) -> DashboardInstanceSessionsListOutput:
...
DashboardInstanceSessionsListQuery = Any


from typing import Any, Dict
from datetime import datetime

def mapDashboardInstanceSessionsListQuery(data: Dict[str, Any]) -> DashboardInstanceSessionsListQuery:
  data
