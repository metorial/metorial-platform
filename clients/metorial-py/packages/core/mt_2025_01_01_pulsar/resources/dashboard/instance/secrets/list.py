...
def mapDashboardInstanceSecretsListOutput(data: Dict[str, Any]) -> DashboardInstanceSecretsListOutput:
...
DashboardInstanceSecretsListQuery = Any


from typing import Any, Dict
from datetime import datetime

def mapDashboardInstanceSecretsListQuery(data: Dict[str, Any]) -> DashboardInstanceSecretsListQuery:
    data
