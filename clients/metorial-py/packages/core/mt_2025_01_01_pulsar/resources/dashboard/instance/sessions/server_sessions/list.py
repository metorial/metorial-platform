...
def mapDashboardInstanceSessionsServerSessionsListOutput(data: Dict[str, Any]) -> DashboardInstanceSessionsServerSessionsListOutput:
...
DashboardInstanceSessionsServerSessionsListQuery = Any


from typing import Any, Dict
from datetime import datetime

def mapDashboardInstanceSessionsServerSessionsListQuery(data: Dict[str, Any]) -> DashboardInstanceSessionsServerSessionsListQuery:
    data
