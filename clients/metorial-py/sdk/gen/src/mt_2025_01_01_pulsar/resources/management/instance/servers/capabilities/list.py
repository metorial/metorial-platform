...
def mapManagementInstanceServersCapabilitiesListOutput(data: Dict[str, Any]) -> ManagementInstanceServersCapabilitiesListOutput:
...
ManagementInstanceServersCapabilitiesListQuery = Any


from typing import Any, Dict
from datetime import datetime

def mapManagementInstanceServersCapabilitiesListQuery(data: Dict[str, Any]) -> ManagementInstanceServersCapabilitiesListQuery:
  data
