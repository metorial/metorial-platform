...
def mapDashboardInstanceServerRunErrorsListOutput(data: Dict[str, Any]) -> DashboardInstanceServerRunErrorsListOutput:
...
DashboardInstanceServerRunErrorsListQuery = Any


from typing import Any, Dict
from datetime import datetime

def mapDashboardInstanceServerRunErrorsListQuery(data: Dict[str, Any]) -> DashboardInstanceServerRunErrorsListQuery:
  data
