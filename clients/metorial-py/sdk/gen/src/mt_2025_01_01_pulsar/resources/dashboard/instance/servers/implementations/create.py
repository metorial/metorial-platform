...
def mapDashboardInstanceServersImplementationsCreateOutput(data: Dict[str, Any]) -> DashboardInstanceServersImplementationsCreateOutput:
...
DashboardInstanceServersImplementationsCreateBody = Any


from typing import Any, Dict
from datetime import datetime

def mapDashboardInstanceServersImplementationsCreateBody(data: Dict[str, Any]) -> DashboardInstanceServersImplementationsCreateBody:
  data
