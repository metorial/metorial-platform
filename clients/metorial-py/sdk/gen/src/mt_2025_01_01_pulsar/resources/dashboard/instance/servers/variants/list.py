...
def mapDashboardInstanceServersVariantsListOutput(data: Dict[str, Any]) -> DashboardInstanceServersVariantsListOutput:
...
DashboardInstanceServersVariantsListQuery = Any


from typing import Any, Dict
from datetime import datetime

def mapDashboardInstanceServersVariantsListQuery(data: Dict[str, Any]) -> DashboardInstanceServersVariantsListQuery:
  data
