...
def mapManagementInstanceSessionsEventsListOutput(data: Dict[str, Any]) -> ManagementInstanceSessionsEventsListOutput:
...
ManagementInstanceSessionsEventsListQuery = Any


from typing import Any, Dict
from datetime import datetime

def mapManagementInstanceSessionsEventsListQuery(data: Dict[str, Any]) -> ManagementInstanceSessionsEventsListQuery:
  data
