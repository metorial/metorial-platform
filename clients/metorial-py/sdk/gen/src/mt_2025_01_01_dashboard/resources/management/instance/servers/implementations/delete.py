...
@dataclass
class ManagementInstanceServersImplementationsDeleteOutput:
  object: str
  id: str
  status: str
  is_default: bool
...
def mapManagementInstanceServersImplementationsDeleteOutput(data: Dict[str, Any]) -> ManagementInstanceServersImplementationsDeleteOutput:
  return ManagementInstanceServersImplementationsDeleteOutput(
