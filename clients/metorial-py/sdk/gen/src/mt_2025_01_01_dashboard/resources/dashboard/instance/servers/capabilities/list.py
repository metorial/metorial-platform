...
def mapDashboardInstanceServersCapabilitiesListOutput(data: Dict[str, Any]) -> DashboardInstanceServersCapabilitiesListOutput:
...
DashboardInstanceServersCapabilitiesListQuery = Any


from typing import Any, Dict
from datetime import datetime

def mapDashboardInstanceServersCapabilitiesListQuery(data: Dict[str, Any]) -> DashboardInstanceServersCapabilitiesListQuery:
  data
