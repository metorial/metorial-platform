...
def mapDashboardInstanceServersImplementationsUpdateOutput(data: Dict[str, Any]) -> DashboardInstanceServersImplementationsUpdateOutput:
...
def mapDashboardInstanceServersImplementationsUpdateBody(data: Dict[str, Any]) -> DashboardInstanceServersImplementationsUpdateBody:
