...
def mapDashboardInstanceServerRunErrorGroupsListOutput(data: Dict[str, Any]) -> DashboardInstanceServerRunErrorGroupsListOutput:
...
DashboardInstanceServerRunErrorGroupsListQuery = Any


from typing import Any, Dict
from datetime import datetime

def mapDashboardInstanceServerRunErrorGroupsListQuery(data: Dict[str, Any]) -> DashboardInstanceServerRunErrorGroupsListQuery:
  data
