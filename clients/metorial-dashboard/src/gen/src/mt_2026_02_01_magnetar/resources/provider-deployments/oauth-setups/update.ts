...
export type ProviderDeploymentsOauthSetupsUpdateOutput = {
...
export let mapProviderDeploymentsOauthSetupsUpdateOutput =
  mtMap.object<ProviderDeploymentsOauthSetupsUpdateOutput>({
...
export type ProviderDeploymentsOauthSetupsUpdateBody = {
  name?: string | undefined;
  description?: string | undefined;
  metadata?: Record<string, any> | undefined;
};

export let mapProviderDeploymentsOauthSetupsUpdateBody =
  mtMap.object<ProviderDeploymentsOauthSetupsUpdateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    metadata: mtMap.objectField('metadata', mtMap.passthrough())
  });
