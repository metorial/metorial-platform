...
export type DashboardInstanceProviderDeploymentsOauthSetupsListOutput = {
  items: {
...
export let mapDashboardInstanceProviderDeploymentsOauthSetupsListOutput =
  mtMap.object<DashboardInstanceProviderDeploymentsOauthSetupsListOutput>({
...
export type DashboardInstanceProviderDeploymentsOauthSetupsListQuery = {
...
export let mapDashboardInstanceProviderDeploymentsOauthSetupsListQuery =
  mtMap.union([
    mtMap.unionOption(
      'object',
      mtMap.object({
