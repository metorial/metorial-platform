...
export type ManagementInstanceCustomProvidersCommitsGetOutput = {
...
export let mapManagementInstanceCustomProvidersCommitsGetOutput =
  mtMap.object<ManagementInstanceCustomProvidersCommitsGetOutput>({
