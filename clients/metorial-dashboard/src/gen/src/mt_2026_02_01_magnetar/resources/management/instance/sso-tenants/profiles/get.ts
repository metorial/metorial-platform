...
export type ManagementInstanceSsoTenantsProfilesGetOutput = {
...
export let mapManagementInstanceSsoTenantsProfilesGetOutput =
  mtMap.object<ManagementInstanceSsoTenantsProfilesGetOutput>({
