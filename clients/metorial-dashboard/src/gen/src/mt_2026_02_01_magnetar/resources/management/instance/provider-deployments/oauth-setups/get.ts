...
export type ManagementInstanceProviderDeploymentsOauthSetupsGetOutput = {
...
export let mapManagementInstanceProviderDeploymentsOauthSetupsGetOutput =
  mtMap.object<ManagementInstanceProviderDeploymentsOauthSetupsGetOutput>({
