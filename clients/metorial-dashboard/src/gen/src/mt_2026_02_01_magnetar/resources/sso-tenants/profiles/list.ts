...
export type SsoTenantsProfilesListOutput = {
  items: {
...
export let mapSsoTenantsProfilesListOutput =
  mtMap.object<SsoTenantsProfilesListOutput>({
...
export type SsoTenantsProfilesListQuery = {
...
export let mapSsoTenantsProfilesListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
