 ...
 */
export class MetorialManagementInstancePortalsConsumerAuthFactorsEndpoint {
  ...
  list(
    ...
    let path = `instances/${instanceId}/portals/${portalId}/auth-factors`;
  ...
  get(
    ...
    let path = `instances/${instanceId}/portals/${portalId}/auth-factors/${consumerAuthFactorId}`;
