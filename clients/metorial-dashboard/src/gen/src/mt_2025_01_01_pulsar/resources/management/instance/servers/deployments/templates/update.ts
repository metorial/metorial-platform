...
export type ManagementInstanceServersDeploymentsTemplatesUpdateOutput = {
...
export let mapManagementInstanceServersDeploymentsTemplatesUpdateOutput =
  mtMap.object<ManagementInstanceServersDeploymentsTemplatesUpdateOutput>({
...
export type ManagementInstanceServersDeploymentsTemplatesUpdateBody = {
  name?: string | undefined;
  description?: string | undefined;
  oauth?: { clientId: string; clientSecret: string } | undefined;
};

export let mapManagementInstanceServersDeploymentsTemplatesUpdateBody =
  mtMap.object<ManagementInstanceServersDeploymentsTemplatesUpdateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    oauth: mtMap.objectField(
      'oauth',
