...
export type ManagementInstanceCallbacksDestinationsGetOutput = {
...
export let mapManagementInstanceCallbacksDestinationsGetOutput =
  mtMap.object<ManagementInstanceCallbacksDestinationsGetOutput>({
