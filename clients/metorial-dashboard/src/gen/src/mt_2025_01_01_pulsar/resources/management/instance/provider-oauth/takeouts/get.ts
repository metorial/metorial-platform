...
export type ManagementInstanceProviderOauthTakeoutsGetOutput = {
...
export let mapManagementInstanceProviderOauthTakeoutsGetOutput =
  mtMap.object<ManagementInstanceProviderOauthTakeoutsGetOutput>({
