...
export type ManagementInstanceCustomServersListingUpdateOutput = {
...
export let mapManagementInstanceCustomServersListingUpdateOutput =
  mtMap.object<ManagementInstanceCustomServersListingUpdateOutput>({
