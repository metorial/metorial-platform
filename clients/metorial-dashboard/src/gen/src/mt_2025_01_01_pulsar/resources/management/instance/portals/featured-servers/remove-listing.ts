...
export type ManagementInstancePortalsFeaturedServersRemoveListingOutput = {
...
export let mapManagementInstancePortalsFeaturedServersRemoveListingOutput =
  mtMap.object<ManagementInstancePortalsFeaturedServersRemoveListingOutput>({
...
export type ManagementInstancePortalsFeaturedServersRemoveListingBody = {
  serverId: string;
};

export let mapManagementInstancePortalsFeaturedServersRemoveListingBody =
  mtMap.object<ManagementInstancePortalsFeaturedServersRemoveListingBody>({
