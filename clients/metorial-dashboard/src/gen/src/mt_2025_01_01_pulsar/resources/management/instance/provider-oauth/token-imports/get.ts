...
export type ManagementInstanceProviderOauthTokenImportsGetOutput = {
...
export let mapManagementInstanceProviderOauthTokenImportsGetOutput =
  mtMap.object<ManagementInstanceProviderOauthTokenImportsGetOutput>({
