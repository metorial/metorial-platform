...
export type ManagementInstanceServersDeploymentsTemplatesCreateOutput = {
...
export let mapManagementInstanceServersDeploymentsTemplatesCreateOutput =
  mtMap.object<ManagementInstanceServersDeploymentsTemplatesCreateOutput>({
...
export type ManagementInstanceServersDeploymentsTemplatesCreateBody = {
  name: string;
