...
export type ProviderOauthTokenImportsCreateOutput = {
...
export let mapProviderOauthTokenImportsCreateOutput =
  mtMap.object<ProviderOauthTokenImportsCreateOutput>({
...
export type ProviderOauthTokenImportsCreateBody = {
...
export let mapProviderOauthTokenImportsCreateBody = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
      note: mtMap.objectField('note', mtMap.passthrough()),
