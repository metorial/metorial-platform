...
export type ProviderOauthTokenExportsListOutput = {
  items: {
...
export let mapProviderOauthTokenExportsListOutput =
  mtMap.object<ProviderOauthTokenExportsListOutput>({
...
export type ProviderOauthTokenExportsListQuery = {
...
export let mapProviderOauthTokenExportsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
