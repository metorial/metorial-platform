...
export type CallbacksDestinationsListOutput = {
  items: {
...
export let mapCallbacksDestinationsListOutput =
  mtMap.object<CallbacksDestinationsListOutput>({
...
export type CallbacksDestinationsListQuery = {
...
export let mapCallbacksDestinationsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
