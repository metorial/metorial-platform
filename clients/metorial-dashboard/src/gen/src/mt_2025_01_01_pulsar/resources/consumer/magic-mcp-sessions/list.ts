...
export type ConsumerMagicMcpSessionsListOutput = {
  items: {
...
export let mapConsumerMagicMcpSessionsListOutput =
  mtMap.object<ConsumerMagicMcpSessionsListOutput>({
...
export type ConsumerMagicMcpSessionsListQuery = {
...
export let mapConsumerMagicMcpSessionsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
