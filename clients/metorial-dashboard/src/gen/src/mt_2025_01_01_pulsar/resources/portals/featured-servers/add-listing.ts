...
export type PortalsFeaturedServersAddListingOutput = {
...
export let mapPortalsFeaturedServersAddListingOutput =
  mtMap.object<PortalsFeaturedServersAddListingOutput>({
...
export type PortalsFeaturedServersAddListingBody = { serverId: string };

export let mapPortalsFeaturedServersAddListingBody =
  mtMap.object<PortalsFeaturedServersAddListingBody>({
