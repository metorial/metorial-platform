...
export type PortalsFeaturedServersRemoveListingOutput = {
...
export let mapPortalsFeaturedServersRemoveListingOutput =
  mtMap.object<PortalsFeaturedServersRemoveListingOutput>({
...
export type PortalsFeaturedServersRemoveListingBody = { serverId: string };

export let mapPortalsFeaturedServersRemoveListingBody =
  mtMap.object<PortalsFeaturedServersRemoveListingBody>({
