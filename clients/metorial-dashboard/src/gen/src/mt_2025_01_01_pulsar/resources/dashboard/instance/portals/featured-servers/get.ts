...
export type DashboardInstancePortalsFeaturedServersGetOutput = {
...
export let mapDashboardInstancePortalsFeaturedServersGetOutput =
  mtMap.object<DashboardInstancePortalsFeaturedServersGetOutput>({
