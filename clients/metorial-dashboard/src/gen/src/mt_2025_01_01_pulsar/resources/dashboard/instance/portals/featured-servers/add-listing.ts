...
export type DashboardInstancePortalsFeaturedServersAddListingOutput = {
...
export let mapDashboardInstancePortalsFeaturedServersAddListingOutput =
  mtMap.object<DashboardInstancePortalsFeaturedServersAddListingOutput>({
...
export type DashboardInstancePortalsFeaturedServersAddListingBody = {
  serverId: string;
};

export let mapDashboardInstancePortalsFeaturedServersAddListingBody =
  mtMap.object<DashboardInstancePortalsFeaturedServersAddListingBody>({
