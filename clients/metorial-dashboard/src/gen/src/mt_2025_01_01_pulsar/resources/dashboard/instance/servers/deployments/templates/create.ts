...
export type DashboardInstanceServersDeploymentsTemplatesCreateOutput = {
...
export let mapDashboardInstanceServersDeploymentsTemplatesCreateOutput =
  mtMap.object<DashboardInstanceServersDeploymentsTemplatesCreateOutput>({
...
export type DashboardInstanceServersDeploymentsTemplatesCreateBody = {
  name: string;
...
export let mapDashboardInstanceServersDeploymentsTemplatesCreateBody =
  mtMap.object<DashboardInstanceServersDeploymentsTemplatesCreateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    serverId: mtMap.objectField('server_id', mtMap.passthrough()),
    oauth: mtMap.objectField(
