...
export type DashboardInstanceServersDeploymentsTemplatesGetOutput = {
...
export let mapDashboardInstanceServersDeploymentsTemplatesGetOutput =
  mtMap.object<DashboardInstanceServersDeploymentsTemplatesGetOutput>({
