...
export type DashboardInstanceServersDeploymentsTemplatesUpdateOutput = {
...
export let mapDashboardInstanceServersDeploymentsTemplatesUpdateOutput =
  mtMap.object<DashboardInstanceServersDeploymentsTemplatesUpdateOutput>({
...
export type DashboardInstanceServersDeploymentsTemplatesUpdateBody = {
  name?: string | undefined;
  description?: string | undefined;
  oauth?: { clientId: string; clientSecret: string } | undefined;
};

export let mapDashboardInstanceServersDeploymentsTemplatesUpdateBody =
  mtMap.object<DashboardInstanceServersDeploymentsTemplatesUpdateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    oauth: mtMap.objectField(
      'oauth',
