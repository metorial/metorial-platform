...
export type DashboardInstanceCallbacksDestinationsGetOutput = {
...
export let mapDashboardInstanceCallbacksDestinationsGetOutput =
  mtMap.object<DashboardInstanceCallbacksDestinationsGetOutput>({
