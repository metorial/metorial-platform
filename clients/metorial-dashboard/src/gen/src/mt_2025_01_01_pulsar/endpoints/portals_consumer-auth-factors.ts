 ...
 */
export class MetorialPortalsConsumerAuthFactorsEndpoint {
  ...
  list(
    ...
    let path = `portals/${portalId}/auth-factors`;
  ...
  get(
    ...
    let path = `portals/${portalId}/auth-factors/${consumerAuthFactorId}`;
