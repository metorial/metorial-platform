 ...
 */
export class MetorialDashboardInstanceFilesEndpoint extends BaseMetorialEndpoint<any> {
  ...
  list(
    ...
    let path = `dashboard/instances/${instanceId}/files`;
    return this._get({
      path,
  ...
  get(
    ...
    let path = `dashboard/instances/${instanceId}/files/${fileId}`;
    return this._get({
      path
