 ...
 */
export class MetorialDashboardInstanceProviderOauthTakeoutsEndpoint {
  ...
  list(
    ...
    let path = `dashboard/instances/${instanceId}/provider-oauth/takeouts`;
  ...
  get(
    ...
    let path = `dashboard/instances/${instanceId}/provider-oauth/takeouts/${takeoutId}`;
