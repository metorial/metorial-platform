 ...
 */
export class MetorialDashboardInstanceSsoTenantsUsersEndpoint {
  ...
  list(
    ...
    let path = `dashboard/instances/${instanceId}/sso-users`;
  ...
  get(
    ...
    let path = `dashboard/instances/${instanceId}/sso-users/${ssoUserId}`;
