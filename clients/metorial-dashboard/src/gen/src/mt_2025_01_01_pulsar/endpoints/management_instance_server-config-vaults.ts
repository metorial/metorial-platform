 ...
 */
export class MetorialManagementInstanceServerConfigVaultsEndpoint {
  ...
  list(
    ...
    let path = `instances/${instanceId}/server-config-vault`;
  ...
  get(
    ...
    let path = `instances/${instanceId}/server-config-vault/${serverConfigVaultId}`;
