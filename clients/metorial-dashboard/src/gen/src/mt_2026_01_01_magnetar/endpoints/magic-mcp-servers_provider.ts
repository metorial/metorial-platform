 ...
 */
export class MetorialMagicMcpServersProviderEndpoint {
  ...
  list(
    ...
    let path = `magic-mcp-servers/${magicMcpServerId}/provider`;
  ...
  get(
    ...
    let path = `magic-mcp-servers/${magicMcpServerId}/provider/${magicMcpServerProviderId}`;
