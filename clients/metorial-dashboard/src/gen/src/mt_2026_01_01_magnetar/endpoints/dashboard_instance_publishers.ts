 ...
 */
export class MetorialDashboardInstancePublishersEndpoint {
  ...
  list(
    ...
    let path = `dashboard/instances/${instanceId}/publishers`;
  ...
  get(
    ...
    let path = `dashboard/instances/${instanceId}/publishers/${publisherId}`;
