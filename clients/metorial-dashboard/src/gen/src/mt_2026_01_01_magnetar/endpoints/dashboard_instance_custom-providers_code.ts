 ...
 */
export class MetorialDashboardInstanceCustomProvidersCodeEndpoint {
  ...
  getCodeEditorToken(
    ...
    let path = `dashboard/instances/${instanceId}/custom-providers/${customProviderId}/code-editor-token`;
