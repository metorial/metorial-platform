 ...
 */
export class MetorialManagementInstanceProviderDeploymentsConfigVaultsEndpoint {
  ...
  list(
    ...
    let path = `instances/${instanceId}/provider-deployments/${providerDeploymentId}/config-vaults`;

    let request = {
      path,

      query: query
        ? mapDashboardInstanceProviderDeploymentsConfigVaultsListQuery.transformTo(
            query
          )
        : undefined,
  ...
  get(
    ...
    let path = `instances/${instanceId}/provider-deployments/${providerDeploymentId}/config-vaults/${providerConfigVaultId}`;
  ...
  create(
    ...
    let request = {
      path,
      body: mapDashboardInstanceProviderDeploymentsConfigVaultsCreateBody.transformTo(
        body
      ),
  ...
  update(
    ...
    let request = {
      path,
      body: mapDashboardInstanceProviderDeploymentsConfigVaultsUpdateBody.transformTo(
        body
      ),
