 ...
 */
export class MetorialDashboardInstanceSessionTemplatesProvidersEndpoint {
  ...
  list(
    ...
    let path = `dashboard/instances/${instanceId}/session-templates/${sessionTemplateId}/providers`;

    let request = {
      path,

      query: query
        ? mapDashboardInstanceSessionTemplatesProvidersListQuery.transformTo(
            query
          )
        : undefined,
  ...
  get(
    ...
    let path = `dashboard/instances/${instanceId}/session-templates/${sessionTemplateId}/providers/${sessionTemplateProviderId}`;
  ...
  create(
    ...
    let request = {
      path,
      body: mapDashboardInstanceSessionTemplatesProvidersCreateBody.transformTo(
        body
      ),
  ...
  update(
    ...
    let request = {
      path,
      body: mapDashboardInstanceSessionTemplatesProvidersUpdateBody.transformTo(
        body
      ),
