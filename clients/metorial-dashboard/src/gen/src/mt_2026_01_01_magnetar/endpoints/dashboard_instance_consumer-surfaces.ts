 ...
 */
export class MetorialDashboardInstanceConsumerSurfacesEndpoint {
  ...
  list(
    ...
    let path = `dashboard/instances/${instanceId}/consumer-surfaces`;
  ...
  get(
    ...
    let path = `dashboard/instances/${instanceId}/consumer-surfaces/${consumerSurfaceId}`;
