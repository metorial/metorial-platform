 ...
 */
export class MetorialManagementInstanceConsumersEndpoint {
  ...
  list(
    ...
    let path = `instances/${instanceId}/consumers`;
  ...
  get(
    ...
    let path = `instances/${instanceId}/consumers/${consumerId}`;
  ...
  getMemberConsumer(
    ...
    let path = `instances/${instanceId}/get-member-consumer`;
