 ...
 */
export class MetorialSessionTemplatesEndpoint {
  ...
  get(
    ...
    let path = `session-templates/${sessionTemplateId}`;
  ...
  listTools(
    ...
    let path = `session-templates/${sessionTemplateId}/tools`;
