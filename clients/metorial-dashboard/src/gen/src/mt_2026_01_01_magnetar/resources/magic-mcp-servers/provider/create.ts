...
export type MagicMcpServersProviderCreateOutput = {
...
export let mapMagicMcpServersProviderCreateOutput =
  mtMap.object<MagicMcpServersProviderCreateOutput>({
...
export type MagicMcpServersProviderCreateBody = {
...
export let mapMagicMcpServersProviderCreateBody =
  mtMap.object<MagicMcpServersProviderCreateBody>({
