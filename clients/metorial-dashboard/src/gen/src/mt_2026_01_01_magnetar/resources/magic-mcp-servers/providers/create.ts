...
export type MagicMcpServersProvidersCreateOutput = {
...
export let mapMagicMcpServersProvidersCreateOutput =
  mtMap.object<MagicMcpServersProvidersCreateOutput>({
...
export type MagicMcpServersProvidersCreateBody = {
...
export let mapMagicMcpServersProvidersCreateBody =
  mtMap.object<MagicMcpServersProvidersCreateBody>({
