...
export type MagicMcpServersProvidersUpdateOutput = {
...
export let mapMagicMcpServersProvidersUpdateOutput =
  mtMap.object<MagicMcpServersProvidersUpdateOutput>({
...
export type MagicMcpServersProvidersUpdateBody = {
  toolFilters?:
    | (
        | { type: 'tool_keys'; keys: string[] }
        | { type: 'tool_regex'; pattern: string }
...
export let mapMagicMcpServersProvidersUpdateBody =
  mtMap.object<MagicMcpServersProvidersUpdateBody>({
