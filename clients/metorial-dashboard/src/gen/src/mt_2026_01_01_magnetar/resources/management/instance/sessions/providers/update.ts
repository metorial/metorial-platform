...
export type ManagementInstanceSessionsProvidersUpdateOutput = {
...
export let mapManagementInstanceSessionsProvidersUpdateOutput =
  mtMap.object<ManagementInstanceSessionsProvidersUpdateOutput>({
...
export type ManagementInstanceSessionsProvidersUpdateBody = {
  toolFilters?:
    | (
        | { type: 'tool_keys'; keys: string[] }
        | { type: 'tool_regex'; pattern: string }
...
export let mapManagementInstanceSessionsProvidersUpdateBody =
  mtMap.object<ManagementInstanceSessionsProvidersUpdateBody>({
