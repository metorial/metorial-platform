...
export type ManagementInstanceSessionsProvidersListOutput = {
  items: {
...
export let mapManagementInstanceSessionsProvidersListOutput =
  mtMap.object<ManagementInstanceSessionsProvidersListOutput>({
...
export type ManagementInstanceSessionsProvidersListQuery = {
...
export let mapManagementInstanceSessionsProvidersListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
