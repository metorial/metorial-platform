...
export type ManagementInstanceConsumersProfilesGetOutput = {
...
export let mapManagementInstanceConsumersProfilesGetOutput =
  mtMap.object<ManagementInstanceConsumersProfilesGetOutput>({
