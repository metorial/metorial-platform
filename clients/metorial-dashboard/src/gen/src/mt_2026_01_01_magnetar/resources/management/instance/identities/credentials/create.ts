...
export type ManagementInstanceIdentitiesCredentialsCreateOutput = {
...
export let mapManagementInstanceIdentitiesCredentialsCreateOutput =
  mtMap.object<ManagementInstanceIdentitiesCredentialsCreateOutput>({
...
export type ManagementInstanceIdentitiesCredentialsCreateBody = {
  identityId: string;
...
export let mapManagementInstanceIdentitiesCredentialsCreateBody =
  mtMap.object<ManagementInstanceIdentitiesCredentialsCreateBody>({
    identityId: mtMap.objectField('identity_id', mtMap.passthrough()),
    deploymentId: mtMap.objectField('deployment_id', mtMap.passthrough()),
    configId: mtMap.objectField('config_id', mtMap.passthrough()),
    authConfigId: mtMap.objectField('auth_config_id', mtMap.passthrough()),
