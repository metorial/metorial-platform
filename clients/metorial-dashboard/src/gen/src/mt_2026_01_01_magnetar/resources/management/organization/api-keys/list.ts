...
export type ManagementOrganizationApiKeysListOutput = {
  items: {
...
export let mapManagementOrganizationApiKeysListOutput =
  mtMap.object<ManagementOrganizationApiKeysListOutput>({
...
export type ManagementOrganizationApiKeysListQuery = {
...
export let mapManagementOrganizationApiKeysListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
