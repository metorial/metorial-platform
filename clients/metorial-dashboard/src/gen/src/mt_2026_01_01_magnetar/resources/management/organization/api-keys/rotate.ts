...
export type ManagementOrganizationApiKeysRotateOutput = {
...
export let mapManagementOrganizationApiKeysRotateOutput =
  mtMap.object<ManagementOrganizationApiKeysRotateOutput>({
...
export type ManagementOrganizationApiKeysRotateBody = {
  currentExpiresAt?: Date | undefined;
};

export let mapManagementOrganizationApiKeysRotateBody =
  mtMap.object<ManagementOrganizationApiKeysRotateBody>({
