...
export type ManagementInstanceMagicMcpServersProviderUpdateOutput = {
...
export let mapManagementInstanceMagicMcpServersProviderUpdateOutput =
  mtMap.object<ManagementInstanceMagicMcpServersProviderUpdateOutput>({
...
export type ManagementInstanceMagicMcpServersProviderUpdateBody = {
  toolFilters?:
    | (
        | { type: 'tool_keys'; keys: string[] }
        | { type: 'tool_regex'; pattern: string }
...
export let mapManagementInstanceMagicMcpServersProviderUpdateBody =
  mtMap.object<ManagementInstanceMagicMcpServersProviderUpdateBody>({
