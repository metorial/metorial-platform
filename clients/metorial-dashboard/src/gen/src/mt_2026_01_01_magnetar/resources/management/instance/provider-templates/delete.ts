...
export type ManagementInstanceProviderTemplatesDeleteOutput = {
...
export let mapManagementInstanceProviderTemplatesDeleteOutput =
  mtMap.object<ManagementInstanceProviderTemplatesDeleteOutput>({
