...
export type ManagementInstanceIdentitiesCredentialsDeleteOutput = {
...
export let mapManagementInstanceIdentitiesCredentialsDeleteOutput =
  mtMap.object<ManagementInstanceIdentitiesCredentialsDeleteOutput>({
