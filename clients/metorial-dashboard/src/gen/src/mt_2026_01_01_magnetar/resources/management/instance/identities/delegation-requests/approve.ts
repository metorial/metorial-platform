...
export type ManagementInstanceIdentitiesDelegationRequestsApproveOutput = {
...
export let mapManagementInstanceIdentitiesDelegationRequestsApproveOutput =
  mtMap.object<ManagementInstanceIdentitiesDelegationRequestsApproveOutput>({
...
export type ManagementInstanceIdentitiesDelegationRequestsApproveQuery = {
  allowDeleted?: boolean | undefined;
};

export let mapManagementInstanceIdentitiesDelegationRequestsApproveQuery =
  mtMap.object<ManagementInstanceIdentitiesDelegationRequestsApproveQuery>({
