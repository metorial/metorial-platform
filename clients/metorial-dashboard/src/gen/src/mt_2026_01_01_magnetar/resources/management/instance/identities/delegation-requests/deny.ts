...
export type ManagementInstanceIdentitiesDelegationRequestsDenyOutput = {
...
export let mapManagementInstanceIdentitiesDelegationRequestsDenyOutput =
  mtMap.object<ManagementInstanceIdentitiesDelegationRequestsDenyOutput>({
...
export type ManagementInstanceIdentitiesDelegationRequestsDenyQuery = {
  allowDeleted?: boolean | undefined;
};

export let mapManagementInstanceIdentitiesDelegationRequestsDenyQuery =
  mtMap.object<ManagementInstanceIdentitiesDelegationRequestsDenyQuery>({
