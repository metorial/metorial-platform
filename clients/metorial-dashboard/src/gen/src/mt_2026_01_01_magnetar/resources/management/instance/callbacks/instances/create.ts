...
export type ManagementInstanceCallbacksInstancesCreateOutput = {
...
export let mapManagementInstanceCallbacksInstancesCreateOutput =
  mtMap.object<ManagementInstanceCallbacksInstancesCreateOutput>({
...
export type ManagementInstanceCallbacksInstancesCreateBody = {
  providerConfigId: string;
  providerAuthConfigId?: string | undefined;
};

export let mapManagementInstanceCallbacksInstancesCreateBody =
  mtMap.object<ManagementInstanceCallbacksInstancesCreateBody>({
