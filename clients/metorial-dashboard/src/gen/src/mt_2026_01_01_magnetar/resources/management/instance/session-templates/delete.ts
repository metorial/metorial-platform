...
export type ManagementInstanceSessionTemplatesDeleteOutput = {
...
export let mapManagementInstanceSessionTemplatesDeleteOutput =
  mtMap.object<ManagementInstanceSessionTemplatesDeleteOutput>({
