...
export type ManagementInstanceIdentitiesDelegationsGetOutput = {
...
export let mapManagementInstanceIdentitiesDelegationsGetOutput =
  mtMap.object<ManagementInstanceIdentitiesDelegationsGetOutput>({
