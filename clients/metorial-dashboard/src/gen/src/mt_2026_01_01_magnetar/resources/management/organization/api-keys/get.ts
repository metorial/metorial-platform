...
export type ManagementOrganizationApiKeysGetOutput = {
...
export let mapManagementOrganizationApiKeysGetOutput =
  mtMap.object<ManagementOrganizationApiKeysGetOutput>({
