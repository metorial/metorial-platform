...
export type ProviderDeploymentsSetupSessionsGetOutput = {
...
export let mapProviderDeploymentsSetupSessionsGetOutput =
  mtMap.object<ProviderDeploymentsSetupSessionsGetOutput>({
