...
export type ConsumerConsumerInternalOauthAuthorizationsGetOutput = {
...
export let mapConsumerConsumerInternalOauthAuthorizationsGetOutput =
  mtMap.object<ConsumerConsumerInternalOauthAuthorizationsGetOutput>({
