...
export type ConsumerConsumerInternalOauthAuthorizationsRejectOutput = {
...
export let mapConsumerConsumerInternalOauthAuthorizationsRejectOutput =
  mtMap.object<ConsumerConsumerInternalOauthAuthorizationsRejectOutput>({
    ...
    magicMcpEndpointId: mtMap.objectField('magic_mcp_endpoint_id', mtMap.passthrough()),
