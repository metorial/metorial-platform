...
export type MagicMcpEndpointsRemoveServersOutput = {
...
export let mapMagicMcpEndpointsRemoveServersOutput =
  mtMap.object<MagicMcpEndpointsRemoveServersOutput>({
...
export type MagicMcpEndpointsRemoveServersBody = {
  magicMcpServerIds: string[];
};

export let mapMagicMcpEndpointsRemoveServersBody =
  mtMap.object<MagicMcpEndpointsRemoveServersBody>({
