...
export type IdentitiesDelegationRequestsGetOutput = {
...
export let mapIdentitiesDelegationRequestsGetOutput =
  mtMap.object<IdentitiesDelegationRequestsGetOutput>({
...
export type IdentitiesDelegationRequestsGetQuery = {
  allowDeleted?: boolean | undefined;
};

export let mapIdentitiesDelegationRequestsGetQuery =
  mtMap.object<IdentitiesDelegationRequestsGetQuery>({
