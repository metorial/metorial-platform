...
export type IdentitiesDelegationsCreateOutput = {
...
export let mapIdentitiesDelegationsCreateOutput =
  mtMap.object<IdentitiesDelegationsCreateOutput>({
...
export type IdentitiesDelegationsCreateBody = {
  identityId: string;
...
export let mapIdentitiesDelegationsCreateBody =
  mtMap.object<IdentitiesDelegationsCreateBody>({
    identityId: mtMap.objectField('identity_id', mtMap.passthrough()),
