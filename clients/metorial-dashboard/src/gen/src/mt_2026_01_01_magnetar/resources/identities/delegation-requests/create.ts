...
export type IdentitiesDelegationRequestsCreateOutput = {
...
export let mapIdentitiesDelegationRequestsCreateOutput =
  mtMap.object<IdentitiesDelegationRequestsCreateOutput>({
...
export type IdentitiesDelegationRequestsCreateBody = {
  identityId: string;
...
export let mapIdentitiesDelegationRequestsCreateBody =
  mtMap.object<IdentitiesDelegationRequestsCreateBody>({
    identityId: mtMap.objectField('identity_id', mtMap.passthrough()),
