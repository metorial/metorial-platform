...
export type ProvidersSpecificationsListOutput = {
  items: {
...
export let mapProvidersSpecificationsListOutput =
  mtMap.object<ProvidersSpecificationsListOutput>({
...
export type ProvidersSpecificationsListQuery = {
...
export let mapProvidersSpecificationsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
