...
export type ProvidersUpdateOutput = {
  object: 'provider';
  id: string;
  name: string;
...
export let mapProvidersUpdateOutput = mtMap.object<ProvidersUpdateOutput>({
...
export type ProvidersUpdateBody = {
...
export let mapProvidersUpdateBody = mtMap.object<ProvidersUpdateBody>({
  name: mtMap.objectField('name', mtMap.passthrough()),
  description: mtMap.objectField('description', mtMap.passthrough()),
  slug: mtMap.objectField('slug', mtMap.passthrough()),
