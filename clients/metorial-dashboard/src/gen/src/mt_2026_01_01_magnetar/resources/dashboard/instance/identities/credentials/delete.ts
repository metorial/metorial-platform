...
export type DashboardInstanceIdentitiesCredentialsDeleteOutput = {
...
export let mapDashboardInstanceIdentitiesCredentialsDeleteOutput =
  mtMap.object<DashboardInstanceIdentitiesCredentialsDeleteOutput>({
