...
export type DashboardInstanceIdentitiesDeleteOutput = {
  object: 'identity';
  id: string;
...
export let mapDashboardInstanceIdentitiesDeleteOutput =
  mtMap.object<DashboardInstanceIdentitiesDeleteOutput>({
