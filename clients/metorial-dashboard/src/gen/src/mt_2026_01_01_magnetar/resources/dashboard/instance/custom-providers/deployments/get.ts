...
export type DashboardInstanceCustomProvidersDeploymentsGetOutput = {
...
export let mapDashboardInstanceCustomProvidersDeploymentsGetOutput =
  mtMap.object<DashboardInstanceCustomProvidersDeploymentsGetOutput>({
