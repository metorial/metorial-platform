...
export type DashboardOrganizationsApiKeysRevealOutput = {
...
export let mapDashboardOrganizationsApiKeysRevealOutput =
  mtMap.object<DashboardOrganizationsApiKeysRevealOutput>({
