...
export type DashboardInstanceProviderDeploymentsOauthSetupsUpdateOutput = {
...
export let mapDashboardInstanceProviderDeploymentsOauthSetupsUpdateOutput =
  mtMap.object<DashboardInstanceProviderDeploymentsOauthSetupsUpdateOutput>({
...
export type DashboardInstanceProviderDeploymentsOauthSetupsUpdateBody = {
  name?: string | undefined;
  description?: string | undefined;
  metadata?: Record<string, any> | undefined;
};

export let mapDashboardInstanceProviderDeploymentsOauthSetupsUpdateBody =
  mtMap.object<DashboardInstanceProviderDeploymentsOauthSetupsUpdateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    metadata: mtMap.objectField('metadata', mtMap.passthrough())
  });
