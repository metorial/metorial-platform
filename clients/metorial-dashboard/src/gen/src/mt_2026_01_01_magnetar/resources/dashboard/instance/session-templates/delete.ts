...
export type DashboardInstanceSessionTemplatesDeleteOutput = {
...
export let mapDashboardInstanceSessionTemplatesDeleteOutput =
  mtMap.object<DashboardInstanceSessionTemplatesDeleteOutput>({
