...
export type DashboardInstanceIdentitiesDelegationsCreateOutput = {
...
export let mapDashboardInstanceIdentitiesDelegationsCreateOutput =
  mtMap.object<DashboardInstanceIdentitiesDelegationsCreateOutput>({
...
export type DashboardInstanceIdentitiesDelegationsCreateBody = {
  identityId: string;
...
export let mapDashboardInstanceIdentitiesDelegationsCreateBody =
  mtMap.object<DashboardInstanceIdentitiesDelegationsCreateBody>({
    identityId: mtMap.objectField('identity_id', mtMap.passthrough()),
