...
export type DashboardInstanceProviderTemplatesGetOutput = {
...
export let mapDashboardInstanceProviderTemplatesGetOutput =
  mtMap.object<DashboardInstanceProviderTemplatesGetOutput>({
