...
export type DashboardInstanceIdentitiesCredentialsListOutput = {
  items: {
...
export let mapDashboardInstanceIdentitiesCredentialsListOutput =
  mtMap.object<DashboardInstanceIdentitiesCredentialsListOutput>({
...
export type DashboardInstanceIdentitiesCredentialsListQuery = {
...
export let mapDashboardInstanceIdentitiesCredentialsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
