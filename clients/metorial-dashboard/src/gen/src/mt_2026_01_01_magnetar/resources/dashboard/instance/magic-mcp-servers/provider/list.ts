...
export type DashboardInstanceMagicMcpServersProviderListOutput = {
  items: {
...
export let mapDashboardInstanceMagicMcpServersProviderListOutput =
  mtMap.object<DashboardInstanceMagicMcpServersProviderListOutput>({
...
export type DashboardInstanceMagicMcpServersProviderListQuery = {
...
export let mapDashboardInstanceMagicMcpServersProviderListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
