...
export type CustomProvidersVersionsListOutput = {
  items: {
...
export let mapCustomProvidersVersionsListOutput =
  mtMap.object<CustomProvidersVersionsListOutput>({
...
export type CustomProvidersVersionsListQuery = {
...
export let mapCustomProvidersVersionsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
