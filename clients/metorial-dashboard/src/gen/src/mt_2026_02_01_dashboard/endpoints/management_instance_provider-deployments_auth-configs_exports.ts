 ...
 */
export class MetorialManagementInstanceProviderDeploymentsAuthConfigsExportsEndpoint {
  ...
  list(
    ...
    let path = `instances/${instanceId}/provider-deployments/${providerDeploymentId}/auth-configs/${providerAuthConfigId}/exports`;
  ...
  get(
    ...
    let path = `instances/${instanceId}/provider-deployments/${providerDeploymentId}/auth-configs/${providerAuthConfigId}/exports/${providerAuthExportId}`;
