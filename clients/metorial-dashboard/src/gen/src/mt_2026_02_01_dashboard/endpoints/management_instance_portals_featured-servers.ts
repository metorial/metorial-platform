 ...
 */
export class MetorialManagementInstancePortalsFeaturedServersEndpoint {
  ...
  list(
    ...
    let path = `instances/${instanceId}/portals/${portalId}/featured-servers`;
  ...
  get(
    ...
    let path = `instances/${instanceId}/portals/${portalId}/featured-servers/${serverListingId}`;
  ...
  addListing(
    ...
    let path = `instances/${instanceId}/portals/${portalId}/featured-servers/add-listing`;
  ...
  removeListing(
    ...
    let path = `instances/${instanceId}/portals/${portalId}/featured-servers/remove-listing`;
