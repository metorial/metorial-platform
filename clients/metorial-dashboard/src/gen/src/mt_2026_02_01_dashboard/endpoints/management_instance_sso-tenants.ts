 ...
 */
export class MetorialManagementInstanceSsoTenantsEndpoint {
  ...
  list(
    ...
    let path = `instances/${instanceId}/sso-tenants`;
  ...
  get(
    ...
    let path = `instances/${instanceId}/sso-tenants/${ssoTenantId}`;
  ...
  setup(
    ...
    let path = `instances/${instanceId}/sso-tenants/${ssoTenantId}/setup`;
