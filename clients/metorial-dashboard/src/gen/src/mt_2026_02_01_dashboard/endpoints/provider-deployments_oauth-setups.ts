 ...
 */
export class MetorialProviderDeploymentsOauthSetupsEndpoint {
  ...
  list(
    ...
    let path = `provider-deployments/${providerDeploymentId}/oauth-setups`;
  ...
  get(
    ...
    let path = `provider-deployments/${providerDeploymentId}/oauth-setups/${providerOAuthSetupId}`;
