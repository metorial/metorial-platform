 ...
 */
export class MetorialManagementInstanceProviderDeploymentsOauthSetupsEndpoint {
  ...
  list(
    ...
    let path = `instances/${instanceId}/provider-deployments/${providerDeploymentId}/oauth-setups`;
  ...
  get(
    ...
    let path = `instances/${instanceId}/provider-deployments/${providerDeploymentId}/oauth-setups/${providerOAuthSetupId}`;
