...
export type CallbacksDestinationsUpdateOutput = {
...
export let mapCallbacksDestinationsUpdateOutput =
  mtMap.object<CallbacksDestinationsUpdateOutput>({
...
export type CallbacksDestinationsUpdateBody = {
  name?: string | undefined;
  description?: string | null | undefined;
};

export let mapCallbacksDestinationsUpdateBody =
  mtMap.object<CallbacksDestinationsUpdateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough())
  });
