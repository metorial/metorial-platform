...
export type ProviderDeploymentsOauthSetupsListOutput = {
  items: {
...
export let mapProviderDeploymentsOauthSetupsListOutput =
  mtMap.object<ProviderDeploymentsOauthSetupsListOutput>({
...
export type ProviderDeploymentsOauthSetupsListQuery = {
...
export let mapProviderDeploymentsOauthSetupsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
