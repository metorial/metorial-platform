...
export type ProviderDeploymentsOauthSetupsCreateOutput = {
...
export let mapProviderDeploymentsOauthSetupsCreateOutput =
  mtMap.object<ProviderDeploymentsOauthSetupsCreateOutput>({
...
export type ProviderDeploymentsOauthSetupsCreateBody = {
  name: string;
...
export let mapProviderDeploymentsOauthSetupsCreateBody =
  mtMap.object<ProviderDeploymentsOauthSetupsCreateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    metadata: mtMap.objectField('metadata', mtMap.passthrough()),
    redirectUrl: mtMap.objectField('redirect_url', mtMap.passthrough()),
