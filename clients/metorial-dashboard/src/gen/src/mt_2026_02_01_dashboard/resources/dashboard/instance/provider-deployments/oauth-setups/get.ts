...
export type DashboardInstanceProviderDeploymentsOauthSetupsGetOutput = {
...
export let mapDashboardInstanceProviderDeploymentsOauthSetupsGetOutput =
  mtMap.object<DashboardInstanceProviderDeploymentsOauthSetupsGetOutput>({
