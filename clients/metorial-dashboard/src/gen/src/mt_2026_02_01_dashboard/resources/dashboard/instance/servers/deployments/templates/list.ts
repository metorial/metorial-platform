...
export type DashboardInstanceServersDeploymentsTemplatesListOutput = {
  items: {
...
export let mapDashboardInstanceServersDeploymentsTemplatesListOutput =
  mtMap.object<DashboardInstanceServersDeploymentsTemplatesListOutput>({
...
export type DashboardInstanceServersDeploymentsTemplatesListQuery = {
...
export let mapDashboardInstanceServersDeploymentsTemplatesListQuery =
  mtMap.union([
    mtMap.unionOption(
      'object',
      mtMap.object({
