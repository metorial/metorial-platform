...
export type DashboardInstanceProviderDeploymentsOauthSetupsCreateOutput = {
...
export let mapDashboardInstanceProviderDeploymentsOauthSetupsCreateOutput =
  mtMap.object<DashboardInstanceProviderDeploymentsOauthSetupsCreateOutput>({
...
export type DashboardInstanceProviderDeploymentsOauthSetupsCreateBody = {
  name: string;
...
export let mapDashboardInstanceProviderDeploymentsOauthSetupsCreateBody =
  mtMap.object<DashboardInstanceProviderDeploymentsOauthSetupsCreateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    metadata: mtMap.objectField('metadata', mtMap.passthrough()),
    redirectUrl: mtMap.objectField('redirect_url', mtMap.passthrough()),
