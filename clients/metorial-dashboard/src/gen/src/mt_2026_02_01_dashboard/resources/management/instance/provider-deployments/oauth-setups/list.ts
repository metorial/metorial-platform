...
export type ManagementInstanceProviderDeploymentsOauthSetupsListOutput = {
  items: {
...
export let mapManagementInstanceProviderDeploymentsOauthSetupsListOutput =
  mtMap.object<ManagementInstanceProviderDeploymentsOauthSetupsListOutput>({
...
export type ManagementInstanceProviderDeploymentsOauthSetupsListQuery = {
...
export let mapManagementInstanceProviderDeploymentsOauthSetupsListQuery =
  mtMap.union([
    mtMap.unionOption(
      'object',
      mtMap.object({
