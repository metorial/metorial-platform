...
export type ManagementInstanceServersDeploymentsTemplatesListOutput = {
  items: {
...
export let mapManagementInstanceServersDeploymentsTemplatesListOutput =
  mtMap.object<ManagementInstanceServersDeploymentsTemplatesListOutput>({
...
export type ManagementInstanceServersDeploymentsTemplatesListQuery = {
