...
export type ManagementInstanceSessionsProviderRunsGetOutput = {
...
export let mapManagementInstanceSessionsProviderRunsGetOutput =
  mtMap.object<ManagementInstanceSessionsProviderRunsGetOutput>({
