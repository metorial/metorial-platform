...
export type ProviderDeploymentsOauthSetupsGetOutput = {
...
export let mapProviderDeploymentsOauthSetupsGetOutput =
  mtMap.object<ProviderDeploymentsOauthSetupsGetOutput>({
