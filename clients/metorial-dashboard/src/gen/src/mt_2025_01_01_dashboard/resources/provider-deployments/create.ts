...
export type ProviderDeploymentsCreateOutput = {
...
export let mapProviderDeploymentsCreateOutput = mtMap.object<ProviderDeploymentsCreateOutput>({
...
export let mapProviderDeploymentsCreateBody = mtMap.object<ProviderDeploymentsCreateBody>({
  name: mtMap.objectField('name', mtMap.passthrough()),
  description: mtMap.objectField('description', mtMap.passthrough()),
  metadata: mtMap.objectField('metadata', mtMap.passthrough()),
  providerId: mtMap.objectField('provider_id', mtMap.passthrough()),
