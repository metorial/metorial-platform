...
export type ProviderDeploymentsAuthConfigsExportsListOutput = {
  items: {
...
export let mapProviderDeploymentsAuthConfigsExportsListOutput =
  mtMap.object<ProviderDeploymentsAuthConfigsExportsListOutput>({
...
export type ProviderDeploymentsAuthConfigsExportsListQuery = {
...
export let mapProviderDeploymentsAuthConfigsExportsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
