...
export type MagicMcpServersProviderListOutput = {
  items: {
...
export let mapMagicMcpServersProviderListOutput =
  mtMap.object<MagicMcpServersProviderListOutput>({
...
export type MagicMcpServersProviderListQuery = {
...
export let mapMagicMcpServersProviderListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
