...
export type ManagementInstanceSkillsAgentsListOutput = {
  items: {
    object: 'skill.agent';
    id: string;
    skillId: string;
...
export let mapManagementInstanceSkillsAgentsListOutput =
  mtMap.object<ManagementInstanceSkillsAgentsListOutput>({
...
export type ManagementInstanceSkillsAgentsListQuery = {
...
export let mapManagementInstanceSkillsAgentsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
