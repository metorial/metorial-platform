...
export type ManagementInstanceFirewallsListOutput = {
  items: {
...
export let mapManagementInstanceFirewallsListOutput =
  mtMap.object<ManagementInstanceFirewallsListOutput>({
...
export type ManagementInstanceFirewallsListQuery = {
...
export let mapManagementInstanceFirewallsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
