...
export type ManagementInstanceWebhookRegistrationsDeleteOutput = {
...
export let mapManagementInstanceWebhookRegistrationsDeleteOutput =
  mtMap.object<ManagementInstanceWebhookRegistrationsDeleteOutput>({
