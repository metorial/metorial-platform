...
export type ManagementInstanceIntegrationsSetupSessionsListOutput = {
  items: {
...
export let mapManagementInstanceIntegrationsSetupSessionsListOutput =
  mtMap.object<ManagementInstanceIntegrationsSetupSessionsListOutput>({
...
export type ManagementInstanceIntegrationsSetupSessionsListQuery = {
...
export let mapManagementInstanceIntegrationsSetupSessionsListQuery =
  mtMap.union([
    mtMap.unionOption(
      'object',
      mtMap.object({
