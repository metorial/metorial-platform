...
export type ManagementInstanceProvidersAuthMethodsGetOutput = {
...
export let mapManagementInstanceProvidersAuthMethodsGetOutput =
  mtMap.object<ManagementInstanceProvidersAuthMethodsGetOutput>({
    ...
    adapters: mtMap.objectField('adapters', mtMap.array(mtMap.passthrough())),
