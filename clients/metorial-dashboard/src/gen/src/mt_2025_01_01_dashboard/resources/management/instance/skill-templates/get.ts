...
export type ManagementInstanceSkillTemplatesGetOutput = {
...
export let mapManagementInstanceSkillTemplatesGetOutput =
  mtMap.object<ManagementInstanceSkillTemplatesGetOutput>({
