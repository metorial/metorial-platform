...
export type ManagementInstanceIntegrationsProvidersCreateOutput = {
...
export let mapManagementInstanceIntegrationsProvidersCreateOutput =
  mtMap.object<ManagementInstanceIntegrationsProvidersCreateOutput>({
    ...
    callbacksEnabled: mtMap.objectField(
      'callbacks_enabled',
      mtMap.passthrough()
    ),
...
export type ManagementInstanceIntegrationsProvidersCreateBody = {
  integrationId: string;
  providerId: string;
  ...
  toolFilters?:
    ...
    | null
    | undefined;
  callbacksEnabled?: boolean | undefined;
};

export let mapManagementInstanceIntegrationsProvidersCreateBody =
  mtMap.object<ManagementInstanceIntegrationsProvidersCreateBody>({
    integrationId: mtMap.objectField('integration_id', mtMap.passthrough()),
    providerId: mtMap.objectField('provider_id', mtMap.passthrough()),
