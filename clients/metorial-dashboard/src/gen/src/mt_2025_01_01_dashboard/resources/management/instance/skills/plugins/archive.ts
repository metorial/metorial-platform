...
export type ManagementInstanceSkillsPluginsArchiveOutput = {
  object: 'skill.plugin';
  id: string;
...
export let mapManagementInstanceSkillsPluginsArchiveOutput =
  mtMap.object<ManagementInstanceSkillsPluginsArchiveOutput>({
