...
export type ManagementInstanceCallbackEventsGetOutput = {
...
export let mapManagementInstanceCallbackEventsGetOutput =
  mtMap.object<ManagementInstanceCallbackEventsGetOutput>({
