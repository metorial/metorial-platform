...
export type ManagementInstanceChatInstancesDeleteOutput = {
...
export let mapManagementInstanceChatInstancesDeleteOutput =
  mtMap.object<ManagementInstanceChatInstancesDeleteOutput>({
