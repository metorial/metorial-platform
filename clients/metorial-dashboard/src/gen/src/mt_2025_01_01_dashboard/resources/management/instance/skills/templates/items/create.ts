...
export type ManagementInstanceSkillsTemplatesItemsCreateOutput = {
...
export let mapManagementInstanceSkillsTemplatesItemsCreateOutput =
  mtMap.object<ManagementInstanceSkillsTemplatesItemsCreateOutput>({
...
export type ManagementInstanceSkillsTemplatesItemsCreateBody =
  | { type: 'provider'; providerId: string }
  | { type: 'integration'; integrationId: string };

export let mapManagementInstanceSkillsTemplatesItemsCreateBody = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
      type: mtMap.objectField('type', mtMap.passthrough()),
