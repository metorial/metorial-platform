...
export type ManagementOrganizationAuditLogStreamsGetOutput = {
...
export let mapManagementOrganizationAuditLogStreamsGetOutput =
  mtMap.object<ManagementOrganizationAuditLogStreamsGetOutput>({
