...
export type ManagementOrganizationConversationsCreateOutput = {
...
export let mapManagementOrganizationConversationsCreateOutput =
  mtMap.object<ManagementOrganizationConversationsCreateOutput>({
...
export type ManagementOrganizationConversationsCreateBody = {
  assistantId: string;
  title?: string | undefined;
};

export let mapManagementOrganizationConversationsCreateBody =
  mtMap.object<ManagementOrganizationConversationsCreateBody>({
    assistantId: mtMap.objectField('assistant_id', mtMap.passthrough()),
    title: mtMap.objectField('title', mtMap.passthrough())
  });
