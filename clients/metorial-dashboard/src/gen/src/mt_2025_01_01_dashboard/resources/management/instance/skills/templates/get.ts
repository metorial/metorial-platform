...
export type ManagementInstanceSkillsTemplatesGetOutput = {
...
export let mapManagementInstanceSkillsTemplatesGetOutput =
  mtMap.object<ManagementInstanceSkillsTemplatesGetOutput>({
