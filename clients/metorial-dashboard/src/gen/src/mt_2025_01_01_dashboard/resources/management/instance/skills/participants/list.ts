...
export type ManagementInstanceSkillsParticipantsListOutput = {
  items: {
...
export let mapManagementInstanceSkillsParticipantsListOutput =
  mtMap.object<ManagementInstanceSkillsParticipantsListOutput>({
...
export type ManagementInstanceSkillsParticipantsListQuery = {
...
export let mapManagementInstanceSkillsParticipantsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
