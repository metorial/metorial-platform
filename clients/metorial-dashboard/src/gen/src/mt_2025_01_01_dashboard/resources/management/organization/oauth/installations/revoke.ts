...
export type ManagementOrganizationOauthInstallationsRevokeOutput = {
...
export let mapManagementOrganizationOauthInstallationsRevokeOutput =
  mtMap.object<ManagementOrganizationOauthInstallationsRevokeOutput>({
