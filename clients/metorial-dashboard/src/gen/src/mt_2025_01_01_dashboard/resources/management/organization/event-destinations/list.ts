...
export type ManagementOrganizationEventDestinationsListOutput = {
  items: {
...
export let mapManagementOrganizationEventDestinationsListOutput =
  mtMap.object<ManagementOrganizationEventDestinationsListOutput>({
...
export type ManagementOrganizationEventDestinationsListQuery = {
...
export let mapManagementOrganizationEventDestinationsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
