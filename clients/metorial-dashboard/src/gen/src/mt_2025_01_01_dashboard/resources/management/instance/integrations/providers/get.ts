...
export type ManagementInstanceIntegrationsProvidersGetOutput = {
...
export let mapManagementInstanceIntegrationsProvidersGetOutput =
  mtMap.object<ManagementInstanceIntegrationsProvidersGetOutput>({
