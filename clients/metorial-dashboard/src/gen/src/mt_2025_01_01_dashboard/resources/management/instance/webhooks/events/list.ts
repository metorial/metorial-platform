...
export type ManagementInstanceWebhooksEventsListOutput = {
  items: {
...
export let mapManagementInstanceWebhooksEventsListOutput =
  mtMap.object<ManagementInstanceWebhooksEventsListOutput>({
          ...
          deliveries: mtMap.objectField(
            ...
            mtMap.array(
              mtMap.object({
                ...
                attemptCount: mtMap.objectField(
                  'attempt_count',
                  mtMap.passthrough()
                ),
                ...
                lastAttemptAt: mtMap.objectField(
                  'last_attempt_at',
                  mtMap.date()
                ),
                nextAttemptAt: mtMap.objectField(
                  'next_attempt_at',
                  mtMap.date()
                ),
                createdAt: mtMap.objectField('created_at', mtMap.date()),
...
export type ManagementInstanceWebhooksEventsListQuery = {
...
export let mapManagementInstanceWebhooksEventsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
      ...
      destinationId: mtMap.objectField('destination_id', mtMap.passthrough()),
