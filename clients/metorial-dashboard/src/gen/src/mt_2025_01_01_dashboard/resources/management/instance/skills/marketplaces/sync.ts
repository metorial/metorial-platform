...
export type ManagementInstanceSkillsMarketplacesSyncOutput = {
...
export let mapManagementInstanceSkillsMarketplacesSyncOutput =
  mtMap.object<ManagementInstanceSkillsMarketplacesSyncOutput>({
...
export type ManagementInstanceSkillsMarketplacesSyncBody = {};

export let mapManagementInstanceSkillsMarketplacesSyncBody =
  mtMap.object<ManagementInstanceSkillsMarketplacesSyncBody>({});
