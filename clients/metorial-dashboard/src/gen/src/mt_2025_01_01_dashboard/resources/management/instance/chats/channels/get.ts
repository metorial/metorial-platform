...
export type ManagementInstanceChatsChannelsGetOutput = {
  object: 'chat.channel';
  id: string;
  chatId: string;
...
export let mapManagementInstanceChatsChannelsGetOutput =
  mtMap.object<ManagementInstanceChatsChannelsGetOutput>({
