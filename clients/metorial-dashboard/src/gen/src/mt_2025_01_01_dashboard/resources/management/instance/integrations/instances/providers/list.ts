...
export type ManagementInstanceIntegrationsInstancesProvidersListOutput = {
  items: {
...
export let mapManagementInstanceIntegrationsInstancesProvidersListOutput =
  mtMap.object<ManagementInstanceIntegrationsInstancesProvidersListOutput>({
...
export type ManagementInstanceIntegrationsInstancesProvidersListQuery = {
...
export let mapManagementInstanceIntegrationsInstancesProvidersListQuery =
  mtMap.union([
    mtMap.unionOption(
      'object',
      mtMap.object({
