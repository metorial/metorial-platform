...
export type ManagementInstanceProtoGuardConfigGetOutput = {
...
export let mapManagementInstanceProtoGuardConfigGetOutput =
  mtMap.object<ManagementInstanceProtoGuardConfigGetOutput>({
