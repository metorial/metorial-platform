...
export type ManagementInstanceSkillsItemsDeleteOutput = {
  object: 'skill.item';
  id: string;
...
export let mapManagementInstanceSkillsItemsDeleteOutput =
  mtMap.object<ManagementInstanceSkillsItemsDeleteOutput>({
