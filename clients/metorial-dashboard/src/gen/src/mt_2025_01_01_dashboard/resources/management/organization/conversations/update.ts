...
export type ManagementOrganizationConversationsUpdateOutput = {
...
export let mapManagementOrganizationConversationsUpdateOutput =
  mtMap.object<ManagementOrganizationConversationsUpdateOutput>({
...
export type ManagementOrganizationConversationsUpdateBody = {
  title?: string | undefined;
};

export let mapManagementOrganizationConversationsUpdateBody =
  mtMap.object<ManagementOrganizationConversationsUpdateBody>({
    title: mtMap.objectField('title', mtMap.passthrough())
  });
