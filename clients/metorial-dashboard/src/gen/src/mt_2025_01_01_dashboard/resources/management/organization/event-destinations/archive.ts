...
export type ManagementOrganizationEventDestinationsArchiveOutput = {
...
export let mapManagementOrganizationEventDestinationsArchiveOutput =
  mtMap.object<ManagementOrganizationEventDestinationsArchiveOutput>({
