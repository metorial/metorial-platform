...
export type ManagementInstanceChatConnectionsListOutput = {
  items: {
...
export let mapManagementInstanceChatConnectionsListOutput =
  mtMap.object<ManagementInstanceChatConnectionsListOutput>({
...
export type ManagementInstanceChatConnectionsListQuery = {
...
export let mapManagementInstanceChatConnectionsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
