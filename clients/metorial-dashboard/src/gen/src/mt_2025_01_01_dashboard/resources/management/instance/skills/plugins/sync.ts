...
export type ManagementInstanceSkillsPluginsSyncOutput = {
  object: 'skill.plugin';
  id: string;
...
export let mapManagementInstanceSkillsPluginsSyncOutput =
  mtMap.object<ManagementInstanceSkillsPluginsSyncOutput>({
...
export type ManagementInstanceSkillsPluginsSyncBody = {};

export let mapManagementInstanceSkillsPluginsSyncBody =
  mtMap.object<ManagementInstanceSkillsPluginsSyncBody>({});
