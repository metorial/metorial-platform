...
export type ManagementInstanceIntegrationsInstanceGroupsProvidersSetOutput = {
...
export let mapManagementInstanceIntegrationsInstanceGroupsProvidersSetOutput =
  mtMap.object<ManagementInstanceIntegrationsInstanceGroupsProvidersSetOutput>({
...
export type ManagementInstanceIntegrationsInstanceGroupsProvidersSetBody = {
  toolFilters?:
    | (
        | { type: 'tool_keys'; keys: string[] }
        | { type: 'tool_regex'; pattern: string }
...
export let mapManagementInstanceIntegrationsInstanceGroupsProvidersSetBody =
  mtMap.object<ManagementInstanceIntegrationsInstanceGroupsProvidersSetBody>({
