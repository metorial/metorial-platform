...
export type ManagementInstanceSkillsTemplatesDeleteOutput = {
...
export let mapManagementInstanceSkillsTemplatesDeleteOutput =
  mtMap.object<ManagementInstanceSkillsTemplatesDeleteOutput>({
