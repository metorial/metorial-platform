...
export type ManagementInstanceSkillsImportsGetOutput = {
  object: 'skill.import';
  id: string;
...
export let mapManagementInstanceSkillsImportsGetOutput =
  mtMap.object<ManagementInstanceSkillsImportsGetOutput>({
