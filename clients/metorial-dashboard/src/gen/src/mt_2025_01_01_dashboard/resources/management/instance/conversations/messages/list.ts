...
export type ManagementInstanceConversationsMessagesListOutput = {
  items: {
...
export let mapManagementInstanceConversationsMessagesListOutput =
  mtMap.object<ManagementInstanceConversationsMessagesListOutput>({
...
export type ManagementInstanceConversationsMessagesListQuery = {
...
export let mapManagementInstanceConversationsMessagesListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
