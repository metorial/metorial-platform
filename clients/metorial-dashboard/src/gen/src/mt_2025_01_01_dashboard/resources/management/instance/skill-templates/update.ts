...
export type ManagementInstanceSkillTemplatesUpdateOutput = {
...
export let mapManagementInstanceSkillTemplatesUpdateOutput =
  mtMap.object<ManagementInstanceSkillTemplatesUpdateOutput>({
...
export type ManagementInstanceSkillTemplatesUpdateBody = {
  name?: string | undefined;
  description?: string | null | undefined;
  metadata?: Record<string, any> | null | undefined;
};

export let mapManagementInstanceSkillTemplatesUpdateBody =
  mtMap.object<ManagementInstanceSkillTemplatesUpdateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    metadata: mtMap.objectField('metadata', mtMap.passthrough())
  });
