...
export type ManagementInstanceChatsMessagesListOutput = {
  items: {
    object: 'chat.message';
    id: string;
    chatId: string;
...
export let mapManagementInstanceChatsMessagesListOutput =
  mtMap.object<ManagementInstanceChatsMessagesListOutput>({
                ...
                authors: mtMap.objectField(
                  ...
                  mtMap.array(
                    mtMap.object({
                      ...
                      userName: mtMap.objectField(
                        'userName',
                        mtMap.passthrough()
                      ),
                      fullName: mtMap.objectField(
                        'fullName',
                        mtMap.passthrough()
                      ),
                      type: mtMap.objectField('type', mtMap.passthrough()),
...
export type ManagementInstanceChatsMessagesListQuery = {
...
export let mapManagementInstanceChatsMessagesListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
