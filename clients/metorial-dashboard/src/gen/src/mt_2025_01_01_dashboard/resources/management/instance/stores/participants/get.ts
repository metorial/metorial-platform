...
export type ManagementInstanceStoresParticipantsGetOutput = {
...
export let mapManagementInstanceStoresParticipantsGetOutput =
  mtMap.object<ManagementInstanceStoresParticipantsGetOutput>({
