...
export type ManagementInstanceSkillGroupsItemsListOutput = {
  items: {
...
export let mapManagementInstanceSkillGroupsItemsListOutput =
  mtMap.object<ManagementInstanceSkillGroupsItemsListOutput>({
...
export type ManagementInstanceSkillGroupsItemsListQuery = {
...
export let mapManagementInstanceSkillGroupsItemsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
