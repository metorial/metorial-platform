...
export type ManagementInstanceSkillsCreateOutput = {
  object: 'skill';
  id: string;
...
export let mapManagementInstanceSkillsCreateOutput =
  mtMap.object<ManagementInstanceSkillsCreateOutput>({
...
export type ManagementInstanceSkillsCreateBody = {
  name: string;
