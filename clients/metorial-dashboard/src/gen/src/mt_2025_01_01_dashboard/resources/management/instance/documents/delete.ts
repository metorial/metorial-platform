...
export type ManagementInstanceDocumentsDeleteOutput = {
  object: 'document';
  id: string;
...
export let mapManagementInstanceDocumentsDeleteOutput =
  mtMap.object<ManagementInstanceDocumentsDeleteOutput>({
