...
export type ManagementInstanceCustomProvidersCreateOutput = {
...
export let mapManagementInstanceCustomProvidersCreateOutput =
  mtMap.object<ManagementInstanceCustomProvidersCreateOutput>({
...
export type ManagementInstanceCustomProvidersCreateBody = {
  name: string;
...
export let mapManagementInstanceCustomProvidersCreateBody =
  mtMap.object<ManagementInstanceCustomProvidersCreateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    metadata: mtMap.objectField('metadata', mtMap.passthrough()),
