...
export type ManagementInstanceSkillsPluginsSkillsRemoveOutput = {
...
export let mapManagementInstanceSkillsPluginsSkillsRemoveOutput =
  mtMap.object<ManagementInstanceSkillsPluginsSkillsRemoveOutput>({
