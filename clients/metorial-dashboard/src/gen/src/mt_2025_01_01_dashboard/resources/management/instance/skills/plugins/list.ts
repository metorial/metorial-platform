...
export type ManagementInstanceSkillsPluginsListOutput = {
  items: {
    object: 'skill.plugin';
    id: string;
...
export let mapManagementInstanceSkillsPluginsListOutput =
  mtMap.object<ManagementInstanceSkillsPluginsListOutput>({
...
export type ManagementInstanceSkillsPluginsListQuery = {
...
export let mapManagementInstanceSkillsPluginsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
