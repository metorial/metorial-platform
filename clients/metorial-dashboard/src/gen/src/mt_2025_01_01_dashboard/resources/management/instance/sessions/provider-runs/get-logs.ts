...
export type ManagementInstanceSessionsProviderRunsGetLogsOutput = {
  object: 'session.provider_run.logs';
  logs: { type: string; line: string; timestamp: Date | null }[];
};

export let mapManagementInstanceSessionsProviderRunsGetLogsOutput =
  mtMap.object<ManagementInstanceSessionsProviderRunsGetLogsOutput>({
