...
export type ManagementInstanceSkillsMergeRequestsItemsBulkResolveOutput = {
  items: {
...
export let mapManagementInstanceSkillsMergeRequestsItemsBulkResolveOutput =
  mtMap.object<ManagementInstanceSkillsMergeRequestsItemsBulkResolveOutput>({
...
export type ManagementInstanceSkillsMergeRequestsItemsBulkResolveBody = {
  items: {
    itemId: string;
    resolutionType:
      | 'accept_source'
...
export let mapManagementInstanceSkillsMergeRequestsItemsBulkResolveBody =
  mtMap.object<ManagementInstanceSkillsMergeRequestsItemsBulkResolveBody>({
    items: mtMap.objectField(
      'items',
      mtMap.array(
        mtMap.object({
