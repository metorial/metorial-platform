...
export type ManagementInstanceProtoGuardAlertsGetOutput = {
...
export let mapManagementInstanceProtoGuardAlertsGetOutput =
  mtMap.object<ManagementInstanceProtoGuardAlertsGetOutput>({
