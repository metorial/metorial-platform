...
export type ManagementInstanceIntegrationsInstancesUpdateOutput = {
...
export let mapManagementInstanceIntegrationsInstancesUpdateOutput =
  mtMap.object<ManagementInstanceIntegrationsInstancesUpdateOutput>({
...
export type ManagementInstanceIntegrationsInstancesUpdateBody = {
...
export let mapManagementInstanceIntegrationsInstancesUpdateBody =
  mtMap.object<ManagementInstanceIntegrationsInstancesUpdateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    metadata: mtMap.objectField('metadata', mtMap.passthrough()),
    identityActorId: mtMap.objectField(
