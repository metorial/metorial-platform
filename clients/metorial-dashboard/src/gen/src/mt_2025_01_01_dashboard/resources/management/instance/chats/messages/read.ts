...
export type ManagementInstanceChatsMessagesReadOutput = {
  object: 'chat.message';
  id: string;
  chatId: string;
  channelId: string;
...
export let mapManagementInstanceChatsMessagesReadOutput =
  mtMap.object<ManagementInstanceChatsMessagesReadOutput>({
...
export type ManagementInstanceChatsMessagesReadBody = {
  channelId: string;
  threadId?: string | undefined;
};

export let mapManagementInstanceChatsMessagesReadBody =
  mtMap.object<ManagementInstanceChatsMessagesReadBody>({
    channelId: mtMap.objectField('channel_id', mtMap.passthrough()),
    threadId: mtMap.objectField('thread_id', mtMap.passthrough())
  });
