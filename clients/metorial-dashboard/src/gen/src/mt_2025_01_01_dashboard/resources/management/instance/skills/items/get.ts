...
export type ManagementInstanceSkillsItemsGetOutput = {
  object: 'skill.item';
  id: string;
...
export let mapManagementInstanceSkillsItemsGetOutput =
  mtMap.object<ManagementInstanceSkillsItemsGetOutput>({
