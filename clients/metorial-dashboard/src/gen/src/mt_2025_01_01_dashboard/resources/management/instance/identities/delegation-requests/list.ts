...
export type ManagementInstanceIdentitiesDelegationRequestsListOutput = {
  items: {
...
export let mapManagementInstanceIdentitiesDelegationRequestsListOutput =
  mtMap.object<ManagementInstanceIdentitiesDelegationRequestsListOutput>({
...
export type ManagementInstanceIdentitiesDelegationRequestsListQuery = {
...
export let mapManagementInstanceIdentitiesDelegationRequestsListQuery =
  mtMap.union([
    mtMap.unionOption(
      'object',
      mtMap.object({
