...
export type ManagementInstanceCallbacksDestinationsDeleteOutput = {
...
export let mapManagementInstanceCallbacksDestinationsDeleteOutput =
  mtMap.object<ManagementInstanceCallbacksDestinationsDeleteOutput>({
