...
export type ManagementInstanceNetworkPoliciesListOutput = {
  items: {
...
export let mapManagementInstanceNetworkPoliciesListOutput =
  mtMap.object<ManagementInstanceNetworkPoliciesListOutput>({
...
export type ManagementInstanceNetworkPoliciesListQuery = {
...
export let mapManagementInstanceNetworkPoliciesListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
