...
export type ManagementInstanceChatsChannelsMembersGetOutput = {
  object: 'chat.author';
  id: string;
  chatId: string;
...
export let mapManagementInstanceChatsChannelsMembersGetOutput =
  mtMap.object<ManagementInstanceChatsChannelsMembersGetOutput>({
