...
export type ManagementInstancePortalsFeaturedServersListOutput = {
  items: ({
...
export let mapManagementInstancePortalsFeaturedServersListOutput =
  mtMap.object<ManagementInstancePortalsFeaturedServersListOutput>({
...
export type ManagementInstancePortalsFeaturedServersListQuery = {
...
export let mapManagementInstancePortalsFeaturedServersListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
