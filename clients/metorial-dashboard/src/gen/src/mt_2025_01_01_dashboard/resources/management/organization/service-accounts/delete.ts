...
export type ManagementOrganizationServiceAccountsDeleteOutput = {
...
export let mapManagementOrganizationServiceAccountsDeleteOutput =
  mtMap.object<ManagementOrganizationServiceAccountsDeleteOutput>({
