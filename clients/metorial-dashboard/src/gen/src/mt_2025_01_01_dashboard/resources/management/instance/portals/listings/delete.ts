...
export type ManagementInstancePortalsListingsDeleteOutput = {
...
export let mapManagementInstancePortalsListingsDeleteOutput =
  mtMap.object<ManagementInstancePortalsListingsDeleteOutput>({
