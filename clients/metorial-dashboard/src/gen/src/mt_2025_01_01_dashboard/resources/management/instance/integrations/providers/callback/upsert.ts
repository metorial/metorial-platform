...
export type ManagementInstanceIntegrationsProvidersCallbackUpsertOutput = {
  object: 'callback';
  id: string;
...
export let mapManagementInstanceIntegrationsProvidersCallbackUpsertOutput =
  mtMap.object<ManagementInstanceIntegrationsProvidersCallbackUpsertOutput>({
...
export type ManagementInstanceIntegrationsProvidersCallbackUpsertBody = {
  name?: string | undefined;
  description?: string | undefined;
  metadata?: Record<string, any> | undefined;
  pollIntervalSecondsOverride?: number | null | undefined;
  triggers: { triggerId: string; eventTypes?: string[] | undefined }[];
  destinationIds?: string[] | undefined;
  configValues?: Record<string, string> | undefined;
};

export let mapManagementInstanceIntegrationsProvidersCallbackUpsertBody =
  mtMap.object<ManagementInstanceIntegrationsProvidersCallbackUpsertBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    metadata: mtMap.objectField('metadata', mtMap.passthrough()),
    pollIntervalSecondsOverride: mtMap.objectField(
    ...
    configValues: mtMap.objectField('config_values', mtMap.passthrough())
  });
