...
export type ManagementInstanceSkillGroupsListOutput = {
  items: {
    object: 'skill.group';
    id: string;
...
export let mapManagementInstanceSkillGroupsListOutput =
  mtMap.object<ManagementInstanceSkillGroupsListOutput>({
...
export type ManagementInstanceSkillGroupsListQuery = {
...
export let mapManagementInstanceSkillGroupsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
