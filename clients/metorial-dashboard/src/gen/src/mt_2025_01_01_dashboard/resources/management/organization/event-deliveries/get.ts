...
export type ManagementOrganizationEventDeliveriesGetOutput = {
...
export let mapManagementOrganizationEventDeliveriesGetOutput =
  mtMap.object<ManagementOrganizationEventDeliveriesGetOutput>({
