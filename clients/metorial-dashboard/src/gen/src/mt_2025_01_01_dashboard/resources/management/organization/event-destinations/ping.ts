...
export type ManagementOrganizationEventDestinationsPingOutput = {
...
export let mapManagementOrganizationEventDestinationsPingOutput =
  mtMap.object<ManagementOrganizationEventDestinationsPingOutput>({
