...
export type ManagementInstanceChatsMessagesCreateOutput = {
  object: 'chat.message';
  id: string;
  chatId: string;
  channelId: string;
...
export let mapManagementInstanceChatsMessagesCreateOutput =
  mtMap.object<ManagementInstanceChatsMessagesCreateOutput>({
...
export type ManagementInstanceChatsMessagesCreateBody = {
  channelId: string;
...
export let mapManagementInstanceChatsMessagesCreateBody =
  mtMap.object<ManagementInstanceChatsMessagesCreateBody>({
    channelId: mtMap.objectField('channel_id', mtMap.passthrough()),
    threadId: mtMap.objectField('thread_id', mtMap.passthrough()),
