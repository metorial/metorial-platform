...
export type ManagementInstanceSkillsGroupsItemsGetOutput = {
...
export let mapManagementInstanceSkillsGroupsItemsGetOutput =
  mtMap.object<ManagementInstanceSkillsGroupsItemsGetOutput>({
