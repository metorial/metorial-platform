...
export type ManagementInstanceProvidersTriggersListOutput = {
  items: {
...
export let mapManagementInstanceProvidersTriggersListOutput =
  mtMap.object<ManagementInstanceProvidersTriggersListOutput>({
                                  ...
                                  mtMap.union([
                                    mtMap.unionOption(
                                      ...
                                      mtMap.object({
                                        ...
                                        callbackSecretKey: mtMap.objectField(
                                          'callbackSecretKey',
                                          mtMap.passthrough()
                                        ),
                                  ...
                                  mtMap.object({
                                    ...
                                    when: mtMap.objectField(
                                      ...
                                      mtMap.object({
                                        ...
                                        registrationStatuses: mtMap.objectField(
                                          'registrationStatuses',
                                          mtMap.array(mtMap.passthrough())
                                        ),
                                        matcher: mtMap.objectField(
                                          ...
                                          mtMap.object({
                                            ...
                                            hasQueryParam: mtMap.objectField(
                                              'hasQueryParam',
                                              mtMap.passthrough()
                                            ),
                                            lacksQueryParam: mtMap.objectField(
                                              'lacksQueryParam',
                                              mtMap.passthrough()
                                            ),
                                            ...
                                            jsonBodyField: mtMap.objectField(
                                              'jsonBodyField',
                                              mtMap.object({
                                            ...
                                            formBodyField: mtMap.objectField(
                                              'formBodyField',
                                              mtMap.object({
                                                path: mtMap.objectField(
                                                  'path',
...
export type ManagementInstanceProvidersTriggersListQuery = {
...
export let mapManagementInstanceProvidersTriggersListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
