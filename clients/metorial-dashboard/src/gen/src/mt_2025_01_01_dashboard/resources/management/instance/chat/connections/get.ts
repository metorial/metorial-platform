...
export type ManagementInstanceChatConnectionsGetOutput = {
...
export let mapManagementInstanceChatConnectionsGetOutput =
  mtMap.object<ManagementInstanceChatConnectionsGetOutput>({
