...
export type ManagementOrganizationOauthAppsGetOutput = {
...
export let mapManagementOrganizationOauthAppsGetOutput =
  mtMap.object<ManagementOrganizationOauthAppsGetOutput>({
