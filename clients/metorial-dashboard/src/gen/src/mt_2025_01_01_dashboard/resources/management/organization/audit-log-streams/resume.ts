...
export type ManagementOrganizationAuditLogStreamsResumeOutput = {
...
export let mapManagementOrganizationAuditLogStreamsResumeOutput =
  mtMap.object<ManagementOrganizationAuditLogStreamsResumeOutput>({
