...
export type ManagementInstanceDocumentsParticipantsGetOutput = {
...
export let mapManagementInstanceDocumentsParticipantsGetOutput =
  mtMap.object<ManagementInstanceDocumentsParticipantsGetOutput>({
