...
export type ManagementInstanceSessionTemplatesProvidersCreateOutput = {
...
export let mapManagementInstanceSessionTemplatesProvidersCreateOutput =
  mtMap.object<ManagementInstanceSessionTemplatesProvidersCreateOutput>({
...
export type ManagementInstanceSessionTemplatesProvidersCreateBody = {
...
export let mapManagementInstanceSessionTemplatesProvidersCreateBody =
  mtMap.object<ManagementInstanceSessionTemplatesProvidersCreateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    metadata: mtMap.objectField('metadata', mtMap.passthrough()),
