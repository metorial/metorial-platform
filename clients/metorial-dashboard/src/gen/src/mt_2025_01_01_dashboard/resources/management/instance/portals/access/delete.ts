...
export type ManagementInstancePortalsAccessDeleteOutput = {
...
export let mapManagementInstancePortalsAccessDeleteOutput =
  mtMap.object<ManagementInstancePortalsAccessDeleteOutput>({
