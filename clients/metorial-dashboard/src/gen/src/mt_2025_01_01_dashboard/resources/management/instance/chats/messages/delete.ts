...
export type ManagementInstanceChatsMessagesDeleteOutput = {
  object: 'chat.message';
  id: string;
  chatId: string;
  channelId: string;
...
export let mapManagementInstanceChatsMessagesDeleteOutput =
  mtMap.object<ManagementInstanceChatsMessagesDeleteOutput>({
...
export type ManagementInstanceChatsMessagesDeleteQuery = { channelId: string };

export let mapManagementInstanceChatsMessagesDeleteQuery =
  mtMap.object<ManagementInstanceChatsMessagesDeleteQuery>({
    channelId: mtMap.objectField('channel_id', mtMap.passthrough())
  });
