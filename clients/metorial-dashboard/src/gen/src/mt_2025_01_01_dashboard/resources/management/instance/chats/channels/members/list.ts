...
export type ManagementInstanceChatsChannelsMembersListOutput = {
  items: {
    object: 'chat.author';
    id: string;
    chatId: string;
...
export let mapManagementInstanceChatsChannelsMembersListOutput =
  mtMap.object<ManagementInstanceChatsChannelsMembersListOutput>({
...
export type ManagementInstanceChatsChannelsMembersListQuery = {
...
export let mapManagementInstanceChatsChannelsMembersListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
