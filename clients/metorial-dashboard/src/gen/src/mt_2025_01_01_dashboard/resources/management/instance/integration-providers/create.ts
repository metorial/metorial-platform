...
export type ManagementInstanceIntegrationProvidersCreateOutput = {
...
export let mapManagementInstanceIntegrationProvidersCreateBody =
  mtMap.object<ManagementInstanceIntegrationProvidersCreateBody>({
    integrationId: mtMap.objectField('integration_id', mtMap.passthrough()),
    providerId: mtMap.objectField('provider_id', mtMap.passthrough()),
