...
export type ManagementInstanceChatsListOutput = {
  items: {
    object: 'chat';
    id: string;
...
export let mapManagementInstanceChatsListOutput =
  mtMap.object<ManagementInstanceChatsListOutput>({
...
export type ManagementInstanceChatsListQuery = {
  ...
  chatInstanceProviderId?: string | string[] | undefined;
  createdAt?: { gt?: Date | undefined; lt?: Date | undefined } | undefined;
  updatedAt?: { gt?: Date | undefined; lt?: Date | undefined } | undefined;
};

export let mapManagementInstanceChatsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
