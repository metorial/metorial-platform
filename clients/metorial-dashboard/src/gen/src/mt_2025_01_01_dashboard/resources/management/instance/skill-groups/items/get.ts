...
export type ManagementInstanceSkillGroupsItemsGetOutput = {
...
export let mapManagementInstanceSkillGroupsItemsGetOutput =
  mtMap.object<ManagementInstanceSkillGroupsItemsGetOutput>({
