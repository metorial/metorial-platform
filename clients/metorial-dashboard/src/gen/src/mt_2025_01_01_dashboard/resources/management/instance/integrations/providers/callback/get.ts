...
export type ManagementInstanceIntegrationsProvidersCallbackGetOutput = {
  object: 'callback';
  id: string;
...
export let mapManagementInstanceIntegrationsProvidersCallbackGetOutput =
  mtMap.object<ManagementInstanceIntegrationsProvidersCallbackGetOutput>({
