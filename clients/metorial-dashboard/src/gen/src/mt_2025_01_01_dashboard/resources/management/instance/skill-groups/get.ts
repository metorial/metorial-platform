...
export type ManagementInstanceSkillGroupsGetOutput = {
  object: 'skill.group';
  id: string;
...
export let mapManagementInstanceSkillGroupsGetOutput =
  mtMap.object<ManagementInstanceSkillGroupsGetOutput>({
