...
export type ManagementInstancePortalsConsumerAccessListingsCreateOutput = {
...
export let mapManagementInstancePortalsConsumerAccessListingsCreateOutput =
  mtMap.object<ManagementInstancePortalsConsumerAccessListingsCreateOutput>({
...
export type ManagementInstancePortalsConsumerAccessListingsCreateBody = {
...
export let mapManagementInstancePortalsConsumerAccessListingsCreateBody =
  mtMap.object<ManagementInstancePortalsConsumerAccessListingsCreateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    readme: mtMap.objectField('readme', mtMap.passthrough()),
    access: mtMap.objectField(
