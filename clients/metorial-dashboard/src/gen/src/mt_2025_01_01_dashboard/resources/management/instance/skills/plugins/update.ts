...
export type ManagementInstanceSkillsPluginsUpdateOutput = {
  object: 'skill.plugin';
  id: string;
...
export let mapManagementInstanceSkillsPluginsUpdateOutput =
  mtMap.object<ManagementInstanceSkillsPluginsUpdateOutput>({
...
export type ManagementInstanceSkillsPluginsUpdateBody = {
...
export let mapManagementInstanceSkillsPluginsUpdateBody =
  mtMap.object<ManagementInstanceSkillsPluginsUpdateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    longDescription: mtMap.objectField('long_description', mtMap.passthrough()),
    category: mtMap.objectField('category', mtMap.passthrough()),
