...
export type ManagementInstanceSkillsPublishConsumerSkillOutput = {
  object: 'skill';
  id: string;
...
export let mapManagementInstanceSkillsPublishConsumerSkillOutput =
  mtMap.object<ManagementInstanceSkillsPublishConsumerSkillOutput>({
