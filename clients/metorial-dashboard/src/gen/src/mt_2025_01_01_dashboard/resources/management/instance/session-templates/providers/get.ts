...
export type ManagementInstanceSessionTemplatesProvidersGetOutput = {
...
export let mapManagementInstanceSessionTemplatesProvidersGetOutput =
  mtMap.object<ManagementInstanceSessionTemplatesProvidersGetOutput>({
