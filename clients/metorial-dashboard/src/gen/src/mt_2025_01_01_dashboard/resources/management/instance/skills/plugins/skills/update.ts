...
export type ManagementInstanceSkillsPluginsSkillsUpdateOutput = {
...
export let mapManagementInstanceSkillsPluginsSkillsUpdateOutput =
  mtMap.object<ManagementInstanceSkillsPluginsSkillsUpdateOutput>({
...
export type ManagementInstanceSkillsPluginsSkillsUpdateBody = {
...
export let mapManagementInstanceSkillsPluginsSkillsUpdateBody =
  mtMap.object<ManagementInstanceSkillsPluginsSkillsUpdateBody>({
    clientName: mtMap.objectField('client_name', mtMap.passthrough()),
    clientDescription: mtMap.objectField(
      'client_description',
      mtMap.passthrough()
