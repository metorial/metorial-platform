...
export type ManagementInstanceSkillsMarketplacesCreateOutput = {
...
export let mapManagementInstanceSkillsMarketplacesCreateOutput =
  mtMap.object<ManagementInstanceSkillsMarketplacesCreateOutput>({
...
export type ManagementInstanceSkillsMarketplacesCreateBody = {
  name: string;
...
export let mapManagementInstanceSkillsMarketplacesCreateBody =
  mtMap.object<ManagementInstanceSkillsMarketplacesCreateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
