...
export type ManagementInstanceSkillsPluginsRepositoriesDeleteOutput = {
...
export let mapManagementInstanceSkillsPluginsRepositoriesDeleteOutput =
  mtMap.object<ManagementInstanceSkillsPluginsRepositoriesDeleteOutput>({
