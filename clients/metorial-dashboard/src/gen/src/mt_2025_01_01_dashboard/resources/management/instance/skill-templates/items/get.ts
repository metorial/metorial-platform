...
export type ManagementInstanceSkillTemplatesItemsGetOutput = {
...
export let mapManagementInstanceSkillTemplatesItemsGetOutput =
  mtMap.object<ManagementInstanceSkillTemplatesItemsGetOutput>({
