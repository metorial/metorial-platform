...
export type ManagementInstanceProviderDeploymentsAuthConfigsCreateOutput = {
...
export let mapManagementInstanceProviderDeploymentsAuthConfigsCreateOutput =
  mtMap.object<ManagementInstanceProviderDeploymentsAuthConfigsCreateOutput>({
...
export let mapManagementInstanceProviderDeploymentsAuthConfigsCreateBody =
  mtMap.object<ManagementInstanceProviderDeploymentsAuthConfigsCreateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    metadata: mtMap.objectField('metadata', mtMap.passthrough()),
