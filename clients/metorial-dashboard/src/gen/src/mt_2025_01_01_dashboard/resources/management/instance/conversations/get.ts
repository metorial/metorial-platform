...
export type ManagementInstanceConversationsGetOutput = {
...
export let mapManagementInstanceConversationsGetOutput =
  mtMap.object<ManagementInstanceConversationsGetOutput>({
