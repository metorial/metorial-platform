...
export type ManagementInstanceProviderAuthConfigEventsGetOutput = {
...
export let mapManagementInstanceProviderAuthConfigEventsGetOutput =
  mtMap.object<ManagementInstanceProviderAuthConfigEventsGetOutput>({
