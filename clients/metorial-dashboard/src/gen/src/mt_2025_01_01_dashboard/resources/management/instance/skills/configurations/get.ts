...
export type ManagementInstanceSkillsConfigurationsGetOutput = {
...
export let mapManagementInstanceSkillsConfigurationsGetOutput =
  mtMap.object<ManagementInstanceSkillsConfigurationsGetOutput>({
