...
export type ManagementOrganizationConversationsMessagesListOutput = {
  items: {
...
export let mapManagementOrganizationConversationsMessagesListOutput =
  mtMap.object<ManagementOrganizationConversationsMessagesListOutput>({
...
export type ManagementOrganizationConversationsMessagesListQuery = {
...
export let mapManagementOrganizationConversationsMessagesListQuery =
  mtMap.union([
    mtMap.unionOption(
      'object',
      mtMap.object({
