...
export type ManagementInstanceSkillGroupsDeleteOutput = {
  object: 'skill.group';
  id: string;
...
export let mapManagementInstanceSkillGroupsDeleteOutput =
  mtMap.object<ManagementInstanceSkillGroupsDeleteOutput>({
