...
export type ManagementInstanceNetworkPoliciesGetOutput = {
...
export let mapManagementInstanceNetworkPoliciesGetOutput =
  mtMap.object<ManagementInstanceNetworkPoliciesGetOutput>({
