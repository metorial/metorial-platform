...
export type ManagementInstanceSkillsForkSyncsGetOutput = {
...
export let mapManagementInstanceSkillsForkSyncsGetOutput =
  mtMap.object<ManagementInstanceSkillsForkSyncsGetOutput>({
