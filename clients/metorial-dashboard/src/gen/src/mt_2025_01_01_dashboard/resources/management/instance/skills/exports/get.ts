...
export type ManagementInstanceSkillsExportsGetOutput = {
  object: 'skill.export';
  id: string;
...
export let mapManagementInstanceSkillsExportsGetOutput =
  mtMap.object<ManagementInstanceSkillsExportsGetOutput>({
