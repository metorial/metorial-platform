...
export type ManagementOrganizationEventDestinationsRotateWebhookSecretOutput = {
...
export let mapManagementOrganizationEventDestinationsRotateWebhookSecretOutput =
  mtMap.object<ManagementOrganizationEventDestinationsRotateWebhookSecretOutput>(
    {
