...
export type ManagementInstanceSkillsParticipantsGetOutput = {
...
export let mapManagementInstanceSkillsParticipantsGetOutput =
  mtMap.object<ManagementInstanceSkillsParticipantsGetOutput>({
