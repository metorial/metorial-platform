...
export type ManagementInstanceIntegrationInstanceGroupsUpdateOutput = {
...
export let mapManagementInstanceIntegrationInstanceGroupsUpdateBody =
  mtMap.object<ManagementInstanceIntegrationInstanceGroupsUpdateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    metadata: mtMap.objectField('metadata', mtMap.passthrough()),
    providers: mtMap.objectField(
