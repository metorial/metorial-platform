...
export type ManagementInstanceIntegrationsInstanceGroupsCreateOutput = {
...
export let mapManagementInstanceIntegrationsInstanceGroupsCreateOutput =
  mtMap.object<ManagementInstanceIntegrationsInstanceGroupsCreateOutput>({
...
export type ManagementInstanceIntegrationsInstanceGroupsCreateBody = {
  name: string;
...
export let mapManagementInstanceIntegrationsInstanceGroupsCreateBody =
  mtMap.object<ManagementInstanceIntegrationsInstanceGroupsCreateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    metadata: mtMap.objectField('metadata', mtMap.passthrough()),
    providers: mtMap.objectField(
