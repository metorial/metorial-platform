...
export type ManagementInstanceSkillsPluginsSkillsAddOutput = {
...
export let mapManagementInstanceSkillsPluginsSkillsAddOutput =
  mtMap.object<ManagementInstanceSkillsPluginsSkillsAddOutput>({
...
export type ManagementInstanceSkillsPluginsSkillsAddBody = {
  skillId: string;
...
export let mapManagementInstanceSkillsPluginsSkillsAddBody =
  mtMap.object<ManagementInstanceSkillsPluginsSkillsAddBody>({
    skillId: mtMap.objectField('skill_id', mtMap.passthrough()),
    identifier: mtMap.objectField('identifier', mtMap.passthrough()),
    clientName: mtMap.objectField('client_name', mtMap.passthrough()),
    clientDescription: mtMap.objectField(
