...
export type ManagementInstanceDocumentsCreateOutput = {
  object: 'document';
  id: string;
...
export let mapManagementInstanceDocumentsCreateOutput =
  mtMap.object<ManagementInstanceDocumentsCreateOutput>({
...
export type ManagementInstanceDocumentsCreateBody = {
  title: string;
  content: string;
};

export let mapManagementInstanceDocumentsCreateBody =
  mtMap.object<ManagementInstanceDocumentsCreateBody>({
    title: mtMap.objectField('title', mtMap.passthrough()),
    content: mtMap.objectField('content', mtMap.passthrough())
  });
