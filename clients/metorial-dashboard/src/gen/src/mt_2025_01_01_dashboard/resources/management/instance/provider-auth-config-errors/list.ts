...
export type ManagementInstanceProviderAuthConfigErrorsListOutput = {
  items: {
...
export let mapManagementInstanceProviderAuthConfigErrorsListOutput =
  mtMap.object<ManagementInstanceProviderAuthConfigErrorsListOutput>({
...
export type ManagementInstanceProviderAuthConfigErrorsListQuery = {
...
export let mapManagementInstanceProviderAuthConfigErrorsListQuery = mtMap.union(
  [
    mtMap.unionOption(
      'object',
      mtMap.object({
