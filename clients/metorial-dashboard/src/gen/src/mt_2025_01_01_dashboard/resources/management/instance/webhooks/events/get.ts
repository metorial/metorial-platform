...
export type ManagementInstanceWebhooksEventsGetOutput = {
...
export let mapManagementInstanceWebhooksEventsGetOutput =
  mtMap.object<ManagementInstanceWebhooksEventsGetOutput>({
