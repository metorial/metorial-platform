...
export type ManagementInstanceSkillTemplatesListOutput = {
  items: {
...
export let mapManagementInstanceSkillTemplatesListOutput =
  mtMap.object<ManagementInstanceSkillTemplatesListOutput>({
...
export type ManagementInstanceSkillTemplatesListQuery = {
...
export let mapManagementInstanceSkillTemplatesListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
