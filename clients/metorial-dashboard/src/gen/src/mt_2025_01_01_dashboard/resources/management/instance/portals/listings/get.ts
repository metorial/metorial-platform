...
export type ManagementInstancePortalsListingsGetOutput = {
...
export let mapManagementInstancePortalsListingsGetOutput =
  mtMap.object<ManagementInstancePortalsListingsGetOutput>({
