...
export type ManagementInstanceEnclavesListOutput = {
  items: {
    object: 'enclave';
    id: string;
    slug: string;
...
export let mapManagementInstanceEnclavesListOutput =
  mtMap.object<ManagementInstanceEnclavesListOutput>({
...
export type ManagementInstanceEnclavesListQuery = {
...
export let mapManagementInstanceEnclavesListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
