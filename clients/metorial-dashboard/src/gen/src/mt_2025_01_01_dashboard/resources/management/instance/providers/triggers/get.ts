...
export type ManagementInstanceProvidersTriggersGetOutput = {
...
export let mapManagementInstanceProvidersTriggersGetOutput =
  mtMap.object<ManagementInstanceProvidersTriggersGetOutput>({
                                        ...
                                        mtMap.union([
                                          mtMap.unionOption(
                                            ...
                                            mtMap.object({
                                              ...
                                              maxAgeSeconds: mtMap.objectField(
                                                'maxAgeSeconds',
                                                mtMap.passthrough()
                                              ),
