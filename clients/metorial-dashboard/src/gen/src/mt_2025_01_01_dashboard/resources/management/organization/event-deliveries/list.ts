...
export type ManagementOrganizationEventDeliveriesListOutput = {
  items: {
...
export let mapManagementOrganizationEventDeliveriesListOutput =
  mtMap.object<ManagementOrganizationEventDeliveriesListOutput>({
...
export type ManagementOrganizationEventDeliveriesListQuery = {
...
export let mapManagementOrganizationEventDeliveriesListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
