...
export let mapManagementInstanceIntegrationsProvidersUpdateOutput =
  mtMap.object<ManagementInstanceIntegrationsProvidersUpdateOutput>({
...
export type ManagementInstanceIntegrationsProvidersUpdateBody = {
...
export let mapManagementInstanceIntegrationsProvidersUpdateBody =
  mtMap.object<ManagementInstanceIntegrationsProvidersUpdateBody>({
