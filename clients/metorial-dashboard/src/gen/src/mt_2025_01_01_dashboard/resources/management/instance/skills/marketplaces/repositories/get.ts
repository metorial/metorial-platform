...
export type ManagementInstanceSkillsMarketplacesRepositoriesGetOutput = {
...
export let mapManagementInstanceSkillsMarketplacesRepositoriesGetOutput =
  mtMap.object<ManagementInstanceSkillsMarketplacesRepositoriesGetOutput>({
