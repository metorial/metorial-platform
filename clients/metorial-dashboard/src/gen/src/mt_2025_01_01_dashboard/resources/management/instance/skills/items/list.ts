...
export type ManagementInstanceSkillsItemsListOutput = {
  items: {
    object: 'skill.item';
    id: string;
...
export let mapManagementInstanceSkillsItemsListOutput =
  mtMap.object<ManagementInstanceSkillsItemsListOutput>({
...
export type ManagementInstanceSkillsItemsListQuery = {
...
export let mapManagementInstanceSkillsItemsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
