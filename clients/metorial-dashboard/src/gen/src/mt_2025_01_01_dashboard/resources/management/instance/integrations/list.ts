...
export let mapManagementInstanceIntegrationsListOutput =
  mtMap.object<ManagementInstanceIntegrationsListOutput>({
...
export type ManagementInstanceIntegrationsListQuery = {
...
export let mapManagementInstanceIntegrationsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
