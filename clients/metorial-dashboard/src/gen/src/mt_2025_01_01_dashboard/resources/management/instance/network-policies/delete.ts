...
export type ManagementInstanceNetworkPoliciesDeleteOutput = {
...
export let mapManagementInstanceNetworkPoliciesDeleteOutput =
  mtMap.object<ManagementInstanceNetworkPoliciesDeleteOutput>({
