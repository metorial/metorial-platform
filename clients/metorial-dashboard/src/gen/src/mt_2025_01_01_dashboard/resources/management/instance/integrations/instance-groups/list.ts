...
export type ManagementInstanceIntegrationsInstanceGroupsListOutput = {
  items: {
...
export let mapManagementInstanceIntegrationsInstanceGroupsListOutput =
  mtMap.object<ManagementInstanceIntegrationsInstanceGroupsListOutput>({
...
export type ManagementInstanceIntegrationsInstanceGroupsListQuery = {
...
export let mapManagementInstanceIntegrationsInstanceGroupsListQuery =
  mtMap.union([
    mtMap.unionOption(
      'object',
      mtMap.object({
