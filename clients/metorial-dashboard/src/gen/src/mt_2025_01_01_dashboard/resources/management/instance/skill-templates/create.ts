...
export type ManagementInstanceSkillTemplatesCreateOutput = {
...
export let mapManagementInstanceSkillTemplatesCreateOutput =
  mtMap.object<ManagementInstanceSkillTemplatesCreateOutput>({
...
export type ManagementInstanceSkillTemplatesCreateBody = {
  name: string;
  description?: string | undefined;
  metadata?: Record<string, any> | undefined;
};

export let mapManagementInstanceSkillTemplatesCreateBody =
  mtMap.object<ManagementInstanceSkillTemplatesCreateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    metadata: mtMap.objectField('metadata', mtMap.passthrough())
  });
