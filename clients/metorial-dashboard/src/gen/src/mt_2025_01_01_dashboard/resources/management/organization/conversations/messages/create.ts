...
export type ManagementOrganizationConversationsMessagesCreateOutput = {
...
export let mapManagementOrganizationConversationsMessagesCreateOutput =
  mtMap.object<ManagementOrganizationConversationsMessagesCreateOutput>({
...
export type ManagementOrganizationConversationsMessagesCreateBody = {
  message: {
    parts: (
...
export let mapManagementOrganizationConversationsMessagesCreateBody =
  mtMap.object<ManagementOrganizationConversationsMessagesCreateBody>({
