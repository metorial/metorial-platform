...
export type ManagementInstanceDocumentsUpdateOutput = {
  object: 'document';
  id: string;
...
export let mapManagementInstanceDocumentsUpdateOutput =
  mtMap.object<ManagementInstanceDocumentsUpdateOutput>({
...
export type ManagementInstanceDocumentsUpdateBody = {
  title?: string | undefined;
  content?: string | undefined;
};

export let mapManagementInstanceDocumentsUpdateBody =
  mtMap.object<ManagementInstanceDocumentsUpdateBody>({
    title: mtMap.objectField('title', mtMap.passthrough()),
    content: mtMap.objectField('content', mtMap.passthrough())
  });
