...
export type ManagementInstanceSkillsImportsListOutput = {
  items: {
    object: 'skill.import';
    id: string;
...
export let mapManagementInstanceSkillsImportsListOutput =
  mtMap.object<ManagementInstanceSkillsImportsListOutput>({
...
export type ManagementInstanceSkillsImportsListQuery = {
...
export let mapManagementInstanceSkillsImportsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
