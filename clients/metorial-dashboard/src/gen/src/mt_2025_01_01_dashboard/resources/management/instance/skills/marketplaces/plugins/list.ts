...
export type ManagementInstanceSkillsMarketplacesPluginsListOutput = {
  items: {
...
export let mapManagementInstanceSkillsMarketplacesPluginsListOutput =
  mtMap.object<ManagementInstanceSkillsMarketplacesPluginsListOutput>({
...
export type ManagementInstanceSkillsMarketplacesPluginsListQuery = {
...
export let mapManagementInstanceSkillsMarketplacesPluginsListQuery =
  mtMap.union([
    mtMap.unionOption(
      'object',
      mtMap.object({
