...
export type ManagementInstanceChatsMessagesGetOutput = {
  object: 'chat.message';
  id: string;
  chatId: string;
  channelId: string;
...
export let mapManagementInstanceChatsMessagesGetOutput =
  mtMap.object<ManagementInstanceChatsMessagesGetOutput>({
...
export type ManagementInstanceChatsMessagesGetQuery = { channelId: string };

export let mapManagementInstanceChatsMessagesGetQuery =
  mtMap.object<ManagementInstanceChatsMessagesGetQuery>({
    channelId: mtMap.objectField('channel_id', mtMap.passthrough())
  });
