...
export type ManagementInstanceIdentitiesUpdateOutput = {
  object: 'identity';
  id: string;
...
export let mapManagementInstanceIdentitiesUpdateOutput =
  mtMap.object<ManagementInstanceIdentitiesUpdateOutput>({
...
export type ManagementInstanceIdentitiesUpdateBody = {
  name?: string | undefined;
  description?: string | undefined;
  metadata?: Record<string, any> | undefined;
};

export let mapManagementInstanceIdentitiesUpdateBody =
  mtMap.object<ManagementInstanceIdentitiesUpdateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    metadata: mtMap.objectField('metadata', mtMap.passthrough())
  });
