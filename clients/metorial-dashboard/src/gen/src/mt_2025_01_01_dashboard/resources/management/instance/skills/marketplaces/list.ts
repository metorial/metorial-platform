...
export type ManagementInstanceSkillsMarketplacesListOutput = {
  items: ({
...
export let mapManagementInstanceSkillsMarketplacesListOutput =
  mtMap.object<ManagementInstanceSkillsMarketplacesListOutput>({
...
export type ManagementInstanceSkillsMarketplacesListQuery = {
...
export let mapManagementInstanceSkillsMarketplacesListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
