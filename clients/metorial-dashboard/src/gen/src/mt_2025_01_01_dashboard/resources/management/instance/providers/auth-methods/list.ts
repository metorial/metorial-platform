...
export type ManagementInstanceProvidersAuthMethodsListOutput = {
  items: {
...
export let mapManagementInstanceProvidersAuthMethodsListOutput =
  mtMap.object<ManagementInstanceProvidersAuthMethodsListOutput>({
...
export type ManagementInstanceProvidersAuthMethodsListQuery = {
...
export let mapManagementInstanceProvidersAuthMethodsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
