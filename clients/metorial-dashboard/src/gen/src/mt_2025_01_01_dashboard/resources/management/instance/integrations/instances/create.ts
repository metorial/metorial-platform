...
export type ManagementInstanceIntegrationsInstancesCreateOutput = {
  ...
  implementation: { type: 'magic_mcp_server'; magicMcpServerId: string } | null;
  providers: {
...
export let mapManagementInstanceIntegrationsInstancesCreateOutput =
  mtMap.object<ManagementInstanceIntegrationsInstancesCreateOutput>({
...
export type ManagementInstanceIntegrationsInstancesCreateBody = {
  integrationId: string;
  name: string;
...
export let mapManagementInstanceIntegrationsInstancesCreateBody =
  mtMap.object<ManagementInstanceIntegrationsInstancesCreateBody>({
    integrationId: mtMap.objectField('integration_id', mtMap.passthrough()),
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    metadata: mtMap.objectField('metadata', mtMap.passthrough()),
