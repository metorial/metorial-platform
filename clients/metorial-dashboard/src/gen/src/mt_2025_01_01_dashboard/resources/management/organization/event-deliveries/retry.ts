...
export type ManagementOrganizationEventDeliveriesRetryOutput = {
...
export let mapManagementOrganizationEventDeliveriesRetryOutput =
  mtMap.object<ManagementOrganizationEventDeliveriesRetryOutput>({
