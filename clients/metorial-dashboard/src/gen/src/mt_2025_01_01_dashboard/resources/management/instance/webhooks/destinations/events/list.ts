...
export type ManagementInstanceWebhooksDestinationsEventsListOutput = {
  items: {
...
export let mapManagementInstanceWebhooksDestinationsEventsListOutput =
  mtMap.object<ManagementInstanceWebhooksDestinationsEventsListOutput>({
...
export type ManagementInstanceWebhooksDestinationsEventsListQuery = {
...
export let mapManagementInstanceWebhooksDestinationsEventsListQuery =
  mtMap.union([
    mtMap.unionOption(
      'object',
      mtMap.object({
