...
export type ManagementInstanceIntegrationInstanceProvidersSetOutput = {
...
export let mapManagementInstanceIntegrationInstanceProvidersSetBody =
  mtMap.object<ManagementInstanceIntegrationInstanceProvidersSetBody>({
