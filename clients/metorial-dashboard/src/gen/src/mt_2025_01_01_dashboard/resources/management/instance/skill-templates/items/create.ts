...
export type ManagementInstanceSkillTemplatesItemsCreateOutput = {
...
export let mapManagementInstanceSkillTemplatesItemsCreateOutput =
  mtMap.object<ManagementInstanceSkillTemplatesItemsCreateOutput>({
...
export type ManagementInstanceSkillTemplatesItemsCreateBody =
  | { type: 'provider'; providerId: string }
  | { type: 'integration'; integrationId: string };

export let mapManagementInstanceSkillTemplatesItemsCreateBody = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
      type: mtMap.objectField('type', mtMap.passthrough()),
