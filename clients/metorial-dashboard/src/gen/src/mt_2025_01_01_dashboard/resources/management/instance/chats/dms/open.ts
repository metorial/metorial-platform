...
export type ManagementInstanceChatsDmsOpenOutput = {
  object: 'chat.channel';
  id: string;
  chatId: string;
...
export let mapManagementInstanceChatsDmsOpenOutput =
  mtMap.object<ManagementInstanceChatsDmsOpenOutput>({
...
export type ManagementInstanceChatsDmsOpenBody =
  | {
      type: 'single';
      user:
...
export let mapManagementInstanceChatsDmsOpenBody = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
      type: mtMap.objectField('type', mtMap.passthrough()),
      ...
      users: mtMap.objectField(
        ...
        mtMap.union([
          mtMap.unionOption(
            ...
            mtMap.object({
              type: mtMap.objectField('type', mtMap.passthrough()),
              emails: mtMap.objectField(
                'emails',
                mtMap.array(mtMap.passthrough())
              ),
              phoneNumbers: mtMap.objectField(
                'phone_numbers',
                mtMap.array(mtMap.passthrough())
              ),
              userIds: mtMap.objectField(
                'user_ids',
                mtMap.array(mtMap.passthrough())
              )
            })
