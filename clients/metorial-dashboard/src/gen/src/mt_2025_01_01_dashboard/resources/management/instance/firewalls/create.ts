...
export type ManagementInstanceFirewallsCreateOutput = {
...
export let mapManagementInstanceFirewallsCreateOutput =
  mtMap.object<ManagementInstanceFirewallsCreateOutput>({
...
export type ManagementInstanceFirewallsCreateBody = {
  name: string;
...
export let mapManagementInstanceFirewallsCreateBody =
  mtMap.object<ManagementInstanceFirewallsCreateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    slug: mtMap.objectField('slug', mtMap.passthrough()),
    networkId: mtMap.objectField('network_id', mtMap.passthrough()),
    bindings: mtMap.objectField(
      'bindings',
      mtMap.array(
        mtMap.object({
