...
export type ManagementInstanceSkillsDuplicateOutput = {
  object: 'skill';
  id: string;
...
export let mapManagementInstanceSkillsDuplicateOutput =
  mtMap.object<ManagementInstanceSkillsDuplicateOutput>({
...
export type ManagementInstanceSkillsDuplicateBody = {
  name: string;
...
export let mapManagementInstanceSkillsDuplicateBody =
  mtMap.object<ManagementInstanceSkillsDuplicateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    clientName: mtMap.objectField('client_name', mtMap.passthrough()),
    clientDescription: mtMap.objectField(
