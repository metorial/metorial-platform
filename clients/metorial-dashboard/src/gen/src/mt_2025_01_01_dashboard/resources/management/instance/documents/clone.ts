...
export type ManagementInstanceDocumentsCloneOutput = {
  object: 'document';
  id: string;
...
export let mapManagementInstanceDocumentsCloneOutput =
  mtMap.object<ManagementInstanceDocumentsCloneOutput>({
...
export type ManagementInstanceDocumentsCloneBody = {
  targetDocumentId?: string | undefined;
  title?: string | undefined;
};

export let mapManagementInstanceDocumentsCloneBody =
  mtMap.object<ManagementInstanceDocumentsCloneBody>({
