...
export type ManagementOrganizationSandboxesUpdateOutput = {
...
export let mapManagementOrganizationSandboxesUpdateOutput =
  mtMap.object<ManagementOrganizationSandboxesUpdateOutput>({
...
export type ManagementOrganizationSandboxesUpdateBody = {
  name?: string | undefined;
};

export let mapManagementOrganizationSandboxesUpdateBody =
  mtMap.object<ManagementOrganizationSandboxesUpdateBody>({
    name: mtMap.objectField('name', mtMap.passthrough())
  });
