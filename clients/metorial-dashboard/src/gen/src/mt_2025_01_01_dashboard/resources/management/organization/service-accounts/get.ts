...
export type ManagementOrganizationServiceAccountsGetOutput = {
...
export let mapManagementOrganizationServiceAccountsGetOutput =
  mtMap.object<ManagementOrganizationServiceAccountsGetOutput>({
