...
export type ManagementInstanceIntegrationsSetupSessionsCreateOutput = {
...
export let mapManagementInstanceIntegrationsSetupSessionsCreateOutput =
  mtMap.object<ManagementInstanceIntegrationsSetupSessionsCreateOutput>({
...
export type ManagementInstanceIntegrationsSetupSessionsCreateBody = {
  integrationId: string;
  name: string;
...
export let mapManagementInstanceIntegrationsSetupSessionsCreateBody =
  mtMap.object<ManagementInstanceIntegrationsSetupSessionsCreateBody>({
    integrationId: mtMap.objectField('integration_id', mtMap.passthrough()),
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    metadata: mtMap.objectField('metadata', mtMap.passthrough()),
