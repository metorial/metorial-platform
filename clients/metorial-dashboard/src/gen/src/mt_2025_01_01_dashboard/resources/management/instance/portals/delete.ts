...
export type ManagementInstancePortalsDeleteOutput = {
  object: 'portal';
  id: string;
...
export let mapManagementInstancePortalsDeleteOutput =
  mtMap.object<ManagementInstancePortalsDeleteOutput>({
