...
export type ManagementInstanceIntegrationProvidersUpdateOutput = {
...
export let mapManagementInstanceIntegrationProvidersUpdateBody =
  mtMap.object<ManagementInstanceIntegrationProvidersUpdateBody>({
