...
export let mapManagementInstanceIntegrationProvidersListOutput =
  mtMap.object<ManagementInstanceIntegrationProvidersListOutput>({
...
export type ManagementInstanceIntegrationProvidersListQuery = {
...
export let mapManagementInstanceIntegrationProvidersListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
