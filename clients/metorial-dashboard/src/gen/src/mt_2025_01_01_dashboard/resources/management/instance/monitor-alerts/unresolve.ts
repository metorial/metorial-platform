...
export type ManagementInstanceMonitorAlertsUnresolveOutput = {
...
export let mapManagementInstanceMonitorAlertsUnresolveOutput =
  mtMap.object<ManagementInstanceMonitorAlertsUnresolveOutput>({
