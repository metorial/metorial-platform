...
export let mapManagementInstanceIntegrationInstancesListOutput =
  mtMap.object<ManagementInstanceIntegrationInstancesListOutput>({
...
export type ManagementInstanceIntegrationInstancesListQuery = {
...
export let mapManagementInstanceIntegrationInstancesListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
