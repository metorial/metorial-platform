...
export type ManagementInstanceSessionsProviderRunsListOutput = {
  items: {
...
export let mapManagementInstanceSessionsProviderRunsListOutput =
  mtMap.object<ManagementInstanceSessionsProviderRunsListOutput>({
...
export type ManagementInstanceSessionsProviderRunsListQuery = {
...
export let mapManagementInstanceSessionsProviderRunsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
