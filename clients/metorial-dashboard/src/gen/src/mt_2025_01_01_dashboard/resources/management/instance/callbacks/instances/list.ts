...
export type ManagementInstanceCallbacksInstancesListOutput = {
  items: {
...
export let mapManagementInstanceCallbacksInstancesListOutput =
  mtMap.object<ManagementInstanceCallbacksInstancesListOutput>({
...
export type ManagementInstanceCallbacksInstancesListQuery = {
...
export let mapManagementInstanceCallbacksInstancesListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
