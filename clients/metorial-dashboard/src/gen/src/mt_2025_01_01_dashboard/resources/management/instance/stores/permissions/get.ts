...
export type ManagementInstanceStoresPermissionsGetOutput = {
...
export let mapManagementInstanceStoresPermissionsGetOutput =
  mtMap.object<ManagementInstanceStoresPermissionsGetOutput>({
