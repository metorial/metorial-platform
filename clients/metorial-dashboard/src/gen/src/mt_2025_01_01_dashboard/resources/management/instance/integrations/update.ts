...
export type ManagementInstanceIntegrationsUpdateOutput = {
  object: 'integration';
  id: string;
...
export let mapManagementInstanceIntegrationsUpdateBody =
  mtMap.object<ManagementInstanceIntegrationsUpdateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    metadata: mtMap.objectField('metadata', mtMap.passthrough()),
    useIntegrationNameInToolNames: mtMap.objectField(
