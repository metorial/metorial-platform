...
export type ManagementInstanceFirewallBindingsListOutput = {
  items: {
...
export let mapManagementInstanceFirewallBindingsListOutput =
  mtMap.object<ManagementInstanceFirewallBindingsListOutput>({
...
export type ManagementInstanceFirewallBindingsListQuery = {
  ...
  targetType?:
    ...
    | 'provider'
    | 'network'
    | ('enclave' | 'provider' | 'network')[]
    | undefined;
  createdAt?: { gt?: Date | undefined; lt?: Date | undefined } | undefined;
};

export let mapManagementInstanceFirewallBindingsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
