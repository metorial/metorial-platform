...
export type ManagementInstanceSessionTemplatesListToolsOutput = {
...
export let mapManagementInstanceSessionTemplatesListToolsOutput =
  mtMap.object<ManagementInstanceSessionTemplatesListToolsOutput>({
