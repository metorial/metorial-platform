...
export type ManagementInstancePortalsConsumerAccessListingsListOutput = {
  items: {
...
export let mapManagementInstancePortalsConsumerAccessListingsListOutput =
  mtMap.object<ManagementInstancePortalsConsumerAccessListingsListOutput>({
...
export type ManagementInstancePortalsConsumerAccessListingsListQuery = {
...
export let mapManagementInstancePortalsConsumerAccessListingsListQuery =
  mtMap.union([
    mtMap.unionOption(
      'object',
      mtMap.object({
