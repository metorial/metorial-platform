...
export type ManagementInstancePortalsListingsListOutput = {
  items: {
...
export let mapManagementInstancePortalsListingsListOutput =
  mtMap.object<ManagementInstancePortalsListingsListOutput>({
...
export type ManagementInstancePortalsListingsListQuery = {
...
export let mapManagementInstancePortalsListingsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
