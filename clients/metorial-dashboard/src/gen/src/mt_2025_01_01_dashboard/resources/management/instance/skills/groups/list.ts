...
export type ManagementInstanceSkillsGroupsListOutput = {
  items: {
    object: 'skill.group';
    id: string;
...
export let mapManagementInstanceSkillsGroupsListOutput =
  mtMap.object<ManagementInstanceSkillsGroupsListOutput>({
...
export type ManagementInstanceSkillsGroupsListQuery = {
...
export let mapManagementInstanceSkillsGroupsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
