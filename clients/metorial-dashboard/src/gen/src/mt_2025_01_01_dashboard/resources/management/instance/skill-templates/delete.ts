...
export type ManagementInstanceSkillTemplatesDeleteOutput = {
...
export let mapManagementInstanceSkillTemplatesDeleteOutput =
  mtMap.object<ManagementInstanceSkillTemplatesDeleteOutput>({
