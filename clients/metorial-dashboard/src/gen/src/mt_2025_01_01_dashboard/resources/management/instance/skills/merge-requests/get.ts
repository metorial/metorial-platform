...
export type ManagementInstanceSkillsMergeRequestsGetOutput = {
...
export let mapManagementInstanceSkillsMergeRequestsGetOutput =
  mtMap.object<ManagementInstanceSkillsMergeRequestsGetOutput>({
