...
export type ManagementInstanceStoresItemsGetOutput = {
  object: 'store.item';
  id: string;
...
export let mapManagementInstanceStoresItemsGetOutput =
  mtMap.object<ManagementInstanceStoresItemsGetOutput>({
