...
export type ManagementInstanceSkillsAgentsGetOutput = {
  object: 'skill.agent';
  id: string;
  skillId: string;
  name: string;
...
export let mapManagementInstanceSkillsAgentsGetOutput =
  mtMap.object<ManagementInstanceSkillsAgentsGetOutput>({
