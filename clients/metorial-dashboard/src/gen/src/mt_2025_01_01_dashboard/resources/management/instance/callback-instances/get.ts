...
export type ManagementInstanceCallbackInstancesGetOutput = {
...
export let mapManagementInstanceCallbackInstancesGetOutput =
  mtMap.object<ManagementInstanceCallbackInstancesGetOutput>({
