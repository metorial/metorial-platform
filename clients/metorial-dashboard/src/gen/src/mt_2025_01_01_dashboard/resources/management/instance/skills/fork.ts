...
export type ManagementInstanceSkillsForkOutput = {
  object: 'skill';
  id: string;
...
export let mapManagementInstanceSkillsForkOutput =
  mtMap.object<ManagementInstanceSkillsForkOutput>({
...
export type ManagementInstanceSkillsForkBody = {
  name: string;
...
export let mapManagementInstanceSkillsForkBody =
  mtMap.object<ManagementInstanceSkillsForkBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    clientName: mtMap.objectField('client_name', mtMap.passthrough()),
    clientDescription: mtMap.objectField(
