...
export type ManagementInstanceIntegrationInstanceGroupsCreateOutput = {
...
export let mapManagementInstanceIntegrationInstanceGroupsCreateBody =
  mtMap.object<ManagementInstanceIntegrationInstanceGroupsCreateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    metadata: mtMap.objectField('metadata', mtMap.passthrough()),
    providers: mtMap.objectField(
