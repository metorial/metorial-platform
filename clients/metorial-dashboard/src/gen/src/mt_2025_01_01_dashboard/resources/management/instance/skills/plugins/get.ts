...
export type ManagementInstanceSkillsPluginsGetOutput = {
  object: 'skill.plugin';
  id: string;
...
export let mapManagementInstanceSkillsPluginsGetOutput =
  mtMap.object<ManagementInstanceSkillsPluginsGetOutput>({
