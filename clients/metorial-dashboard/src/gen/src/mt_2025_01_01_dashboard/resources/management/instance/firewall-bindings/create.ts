...
export type ManagementInstanceFirewallBindingsCreateOutput = {
...
export let mapManagementInstanceFirewallBindingsCreateOutput =
  mtMap.object<ManagementInstanceFirewallBindingsCreateOutput>({
...
export type ManagementInstanceFirewallBindingsCreateBody = {
  firewallId: string;
} & {
  targetType: 'enclave' | 'provider' | 'network';
...
export let mapManagementInstanceFirewallBindingsCreateBody = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
