...
export type ManagementInstanceSkillsMarketplacesUpdateOutput = {
...
export let mapManagementInstanceSkillsMarketplacesUpdateOutput =
  mtMap.object<ManagementInstanceSkillsMarketplacesUpdateOutput>({
...
export type ManagementInstanceSkillsMarketplacesUpdateBody = {
...
export let mapManagementInstanceSkillsMarketplacesUpdateBody =
  mtMap.object<ManagementInstanceSkillsMarketplacesUpdateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
