...
export type ManagementInstanceFirewallsNetworkPoliciesDetachOutput = {
...
export let mapManagementInstanceFirewallsNetworkPoliciesDetachOutput =
  mtMap.object<ManagementInstanceFirewallsNetworkPoliciesDetachOutput>({
