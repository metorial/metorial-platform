...
export let mapManagementInstanceIntegrationInstanceProvidersListOutput =
  mtMap.object<ManagementInstanceIntegrationInstanceProvidersListOutput>({
...
export type ManagementInstanceIntegrationInstanceProvidersListQuery = {
...
export let mapManagementInstanceIntegrationInstanceProvidersListQuery =
  mtMap.union([
    mtMap.unionOption(
      'object',
      mtMap.object({
