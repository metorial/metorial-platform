...
export type ManagementInstanceConversationsUpdateOutput = {
...
export let mapManagementInstanceConversationsUpdateOutput =
  mtMap.object<ManagementInstanceConversationsUpdateOutput>({
...
export type ManagementInstanceConversationsUpdateBody = {
  title?: string | undefined;
};

export let mapManagementInstanceConversationsUpdateBody =
  mtMap.object<ManagementInstanceConversationsUpdateBody>({
    title: mtMap.objectField('title', mtMap.passthrough())
  });
