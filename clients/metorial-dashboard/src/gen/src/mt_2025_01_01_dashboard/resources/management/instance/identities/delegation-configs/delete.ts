...
export type ManagementInstanceIdentitiesDelegationConfigsDeleteOutput = {
...
export let mapManagementInstanceIdentitiesDelegationConfigsDeleteOutput =
  mtMap.object<ManagementInstanceIdentitiesDelegationConfigsDeleteOutput>({
