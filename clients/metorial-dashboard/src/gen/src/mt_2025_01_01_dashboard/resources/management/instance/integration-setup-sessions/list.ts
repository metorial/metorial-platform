...
export let mapManagementInstanceIntegrationSetupSessionsListOutput =
  mtMap.object<ManagementInstanceIntegrationSetupSessionsListOutput>({
...
export type ManagementInstanceIntegrationSetupSessionsListQuery = {
...
export let mapManagementInstanceIntegrationSetupSessionsListQuery = mtMap.union(
  [
    mtMap.unionOption(
      'object',
      mtMap.object({
