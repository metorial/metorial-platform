...
export type ManagementInstanceMonitorAlertsGetOutput = {
...
export let mapManagementInstanceMonitorAlertsGetOutput =
  mtMap.object<ManagementInstanceMonitorAlertsGetOutput>({
