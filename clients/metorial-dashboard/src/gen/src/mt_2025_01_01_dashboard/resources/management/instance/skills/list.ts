...
export type ManagementInstanceSkillsListOutput = {
  items: {
    object: 'skill';
    id: string;
...
export let mapManagementInstanceSkillsListOutput =
  mtMap.object<ManagementInstanceSkillsListOutput>({
...
export type ManagementInstanceSkillsListQuery = {
...
export let mapManagementInstanceSkillsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
