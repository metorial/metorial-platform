...
export type ManagementInstanceSkillsPluginsRepositoriesGetOutput = {
...
export let mapManagementInstanceSkillsPluginsRepositoriesGetOutput =
  mtMap.object<ManagementInstanceSkillsPluginsRepositoriesGetOutput>({
