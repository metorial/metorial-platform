...
export type ManagementInstanceChatsMessagesUpdateOutput = {
  object: 'chat.message';
  id: string;
  chatId: string;
  channelId: string;
...
export let mapManagementInstanceChatsMessagesUpdateOutput =
  mtMap.object<ManagementInstanceChatsMessagesUpdateOutput>({
...
export type ManagementInstanceChatsMessagesUpdateBody = {
  channelId: string;
  parts: (
...
export let mapManagementInstanceChatsMessagesUpdateBody =
  mtMap.object<ManagementInstanceChatsMessagesUpdateBody>({
    channelId: mtMap.objectField('channel_id', mtMap.passthrough()),
