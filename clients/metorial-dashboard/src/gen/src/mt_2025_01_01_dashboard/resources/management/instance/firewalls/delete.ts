...
export type ManagementInstanceFirewallsDeleteOutput = {
...
export let mapManagementInstanceFirewallsDeleteOutput =
  mtMap.object<ManagementInstanceFirewallsDeleteOutput>({
