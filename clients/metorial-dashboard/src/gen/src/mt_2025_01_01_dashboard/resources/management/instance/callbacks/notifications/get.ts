...
export type ManagementInstanceCallbacksNotificationsGetOutput = {
...
export let mapManagementInstanceCallbacksNotificationsGetOutput =
  mtMap.object<ManagementInstanceCallbacksNotificationsGetOutput>({
