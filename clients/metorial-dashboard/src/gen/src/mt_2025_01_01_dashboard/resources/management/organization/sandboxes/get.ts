...
export type ManagementOrganizationSandboxesGetOutput = {
...
export let mapManagementOrganizationSandboxesGetOutput =
  mtMap.object<ManagementOrganizationSandboxesGetOutput>({
