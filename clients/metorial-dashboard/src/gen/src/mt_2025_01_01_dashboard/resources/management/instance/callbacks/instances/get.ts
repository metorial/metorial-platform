...
export type ManagementInstanceCallbacksInstancesGetOutput = {
...
export let mapManagementInstanceCallbacksInstancesGetOutput =
  mtMap.object<ManagementInstanceCallbacksInstancesGetOutput>({
