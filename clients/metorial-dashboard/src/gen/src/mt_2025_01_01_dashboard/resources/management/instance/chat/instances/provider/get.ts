...
export type ManagementInstanceChatInstancesProviderGetOutput = {
...
export let mapManagementInstanceChatInstancesProviderGetOutput =
  mtMap.object<ManagementInstanceChatInstancesProviderGetOutput>({
