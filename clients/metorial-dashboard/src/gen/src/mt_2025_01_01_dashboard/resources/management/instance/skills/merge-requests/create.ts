...
export type ManagementInstanceSkillsMergeRequestsCreateOutput = {
...
export let mapManagementInstanceSkillsMergeRequestsCreateOutput =
  mtMap.object<ManagementInstanceSkillsMergeRequestsCreateOutput>({
...
export type ManagementInstanceSkillsMergeRequestsCreateBody = {
  sourceSkillId: string;
...
export let mapManagementInstanceSkillsMergeRequestsCreateBody =
  mtMap.object<ManagementInstanceSkillsMergeRequestsCreateBody>({
    sourceSkillId: mtMap.objectField('source_skill_id', mtMap.passthrough()),
    targetSkillId: mtMap.objectField('target_skill_id', mtMap.passthrough()),
    title: mtMap.objectField('title', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough())
