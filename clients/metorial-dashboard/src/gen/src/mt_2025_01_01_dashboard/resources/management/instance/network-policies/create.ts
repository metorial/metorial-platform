...
export type ManagementInstanceNetworkPoliciesCreateOutput = {
...
export let mapManagementInstanceNetworkPoliciesCreateOutput =
  mtMap.object<ManagementInstanceNetworkPoliciesCreateOutput>({
...
export type ManagementInstanceNetworkPoliciesCreateBody = {
  name: string;
...
export let mapManagementInstanceNetworkPoliciesCreateBody =
  mtMap.object<ManagementInstanceNetworkPoliciesCreateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    rules: mtMap.objectField(
      'rules',
