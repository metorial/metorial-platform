...
export type ManagementOrganizationEventDestinationsGetOutput = {
...
export let mapManagementOrganizationEventDestinationsGetOutput =
  mtMap.object<ManagementOrganizationEventDestinationsGetOutput>({
