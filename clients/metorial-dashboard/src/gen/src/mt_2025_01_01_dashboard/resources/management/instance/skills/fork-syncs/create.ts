...
export type ManagementInstanceSkillsForkSyncsCreateOutput = {
...
export let mapManagementInstanceSkillsForkSyncsCreateOutput =
  mtMap.object<ManagementInstanceSkillsForkSyncsCreateOutput>({
...
export type ManagementInstanceSkillsForkSyncsCreateBody = { skillId: string };

export let mapManagementInstanceSkillsForkSyncsCreateBody =
  mtMap.object<ManagementInstanceSkillsForkSyncsCreateBody>({
