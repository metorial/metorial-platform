...
export type ManagementInstanceIntegrationsInstanceGroupsCreateSessionTemplateOutput =
  {
...
export let mapManagementInstanceIntegrationsInstanceGroupsCreateSessionTemplateOutput =
  mtMap.object<ManagementInstanceIntegrationsInstanceGroupsCreateSessionTemplateOutput>(
    {
...
export type ManagementInstanceIntegrationsInstanceGroupsCreateSessionTemplateBody =
  {
...
export let mapManagementInstanceIntegrationsInstanceGroupsCreateSessionTemplateBody =
  mtMap.object<ManagementInstanceIntegrationsInstanceGroupsCreateSessionTemplateBody>(
    {
      name: mtMap.objectField('name', mtMap.passthrough()),
      description: mtMap.objectField('description', mtMap.passthrough()),
      metadata: mtMap.objectField('metadata', mtMap.passthrough())
