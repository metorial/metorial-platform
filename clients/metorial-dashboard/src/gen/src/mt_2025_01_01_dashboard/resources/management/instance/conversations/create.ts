...
export type ManagementInstanceConversationsCreateOutput = {
...
export let mapManagementInstanceConversationsCreateOutput =
  mtMap.object<ManagementInstanceConversationsCreateOutput>({
