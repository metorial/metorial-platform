...
export type ManagementInstanceNetworksListOutput = {
  items: {
    object: 'network';
    id: string;
    name: string;
...
export let mapManagementInstanceNetworksListOutput =
  mtMap.object<ManagementInstanceNetworksListOutput>({
...
export type ManagementInstanceNetworksListQuery = {
...
export let mapManagementInstanceNetworksListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
