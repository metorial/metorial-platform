...
export type ManagementInstanceMagicMcpServersSessionCreateOutput = {
  object: 'session';
  id: string;
...
export let mapManagementInstanceMagicMcpServersSessionCreateOutput =
  mtMap.object<ManagementInstanceMagicMcpServersSessionCreateOutput>({
