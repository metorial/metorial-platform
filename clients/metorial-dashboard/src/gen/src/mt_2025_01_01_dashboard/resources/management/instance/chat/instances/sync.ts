...
export type ManagementInstanceChatInstancesSyncOutput = {
...
export let mapManagementInstanceChatInstancesSyncOutput =
  mtMap.object<ManagementInstanceChatInstancesSyncOutput>({
