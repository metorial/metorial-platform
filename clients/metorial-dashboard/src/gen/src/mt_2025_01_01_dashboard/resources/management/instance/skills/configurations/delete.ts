...
export type ManagementInstanceSkillsConfigurationsDeleteOutput = {
...
export let mapManagementInstanceSkillsConfigurationsDeleteOutput =
  mtMap.object<ManagementInstanceSkillsConfigurationsDeleteOutput>({
