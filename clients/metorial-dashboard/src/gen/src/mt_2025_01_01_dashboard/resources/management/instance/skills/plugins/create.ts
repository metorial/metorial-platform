...
export type ManagementInstanceSkillsPluginsCreateOutput = {
  object: 'skill.plugin';
  id: string;
...
export let mapManagementInstanceSkillsPluginsCreateOutput =
  mtMap.object<ManagementInstanceSkillsPluginsCreateOutput>({
...
export type ManagementInstanceSkillsPluginsCreateBody = {
  name: string;
...
export let mapManagementInstanceSkillsPluginsCreateBody =
  mtMap.object<ManagementInstanceSkillsPluginsCreateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    longDescription: mtMap.objectField('long_description', mtMap.passthrough()),
    category: mtMap.objectField('category', mtMap.passthrough()),
