...
export type ManagementInstanceSkillsUpdateOutput = {
  object: 'skill';
  id: string;
...
export let mapManagementInstanceSkillsUpdateOutput =
  mtMap.object<ManagementInstanceSkillsUpdateOutput>({
...
export type ManagementInstanceSkillsUpdateBody = {
...
export let mapManagementInstanceSkillsUpdateBody =
  mtMap.object<ManagementInstanceSkillsUpdateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    clientName: mtMap.objectField('client_name', mtMap.passthrough()),
    clientDescription: mtMap.objectField(
