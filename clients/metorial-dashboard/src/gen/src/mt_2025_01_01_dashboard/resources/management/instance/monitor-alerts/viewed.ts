...
export type ManagementInstanceMonitorAlertsViewedOutput = {
...
export let mapManagementInstanceMonitorAlertsViewedOutput =
  mtMap.object<ManagementInstanceMonitorAlertsViewedOutput>({
