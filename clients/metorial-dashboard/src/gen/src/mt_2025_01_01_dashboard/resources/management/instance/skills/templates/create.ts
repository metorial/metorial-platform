...
export type ManagementInstanceSkillsTemplatesCreateOutput = {
...
export let mapManagementInstanceSkillsTemplatesCreateOutput =
  mtMap.object<ManagementInstanceSkillsTemplatesCreateOutput>({
...
export type ManagementInstanceSkillsTemplatesCreateBody = {
  name: string;
...
export let mapManagementInstanceSkillsTemplatesCreateBody =
  mtMap.object<ManagementInstanceSkillsTemplatesCreateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    metadata: mtMap.objectField('metadata', mtMap.passthrough()),
