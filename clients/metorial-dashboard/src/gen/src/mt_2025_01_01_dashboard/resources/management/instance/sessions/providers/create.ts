...
export type ManagementInstanceSessionsProvidersCreateOutput = {
...
export let mapManagementInstanceSessionsProvidersCreateOutput =
  mtMap.object<ManagementInstanceSessionsProvidersCreateOutput>({
...
export type ManagementInstanceSessionsProvidersCreateBody = {
...
export let mapManagementInstanceSessionsProvidersCreateBody =
  mtMap.object<ManagementInstanceSessionsProvidersCreateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    metadata: mtMap.objectField('metadata', mtMap.passthrough()),
