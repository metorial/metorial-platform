...
export type ManagementInstanceDocumentsParticipantsListOutput = {
  items: {
...
export let mapManagementInstanceDocumentsParticipantsListOutput =
  mtMap.object<ManagementInstanceDocumentsParticipantsListOutput>({
...
export type ManagementInstanceDocumentsParticipantsListQuery = {
...
export let mapManagementInstanceDocumentsParticipantsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
