...
export type ManagementOrganizationEventDestinationsUpdateOutput = {
...
export let mapManagementOrganizationEventDestinationsUpdateOutput =
  mtMap.object<ManagementOrganizationEventDestinationsUpdateOutput>({
...
export type ManagementOrganizationEventDestinationsUpdateBody = {
  name?: string | undefined;
  description?: string | null | undefined;
  webhook?: { url?: string | undefined } | undefined;
};

export let mapManagementOrganizationEventDestinationsUpdateBody =
  mtMap.object<ManagementOrganizationEventDestinationsUpdateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    webhook: mtMap.objectField(
      'webhook',
