...
export type ManagementInstanceSkillsTemplatesUpdateOutput = {
...
export let mapManagementInstanceSkillsTemplatesUpdateOutput =
  mtMap.object<ManagementInstanceSkillsTemplatesUpdateOutput>({
...
export type ManagementInstanceSkillsTemplatesUpdateBody = {
  name?: string | undefined;
  description?: string | null | undefined;
  metadata?: Record<string, any> | null | undefined;
};

export let mapManagementInstanceSkillsTemplatesUpdateBody =
  mtMap.object<ManagementInstanceSkillsTemplatesUpdateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    metadata: mtMap.objectField('metadata', mtMap.passthrough())
  });
