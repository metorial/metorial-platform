...
export type ManagementInstanceIntegrationsProvidersDeleteOutput = {
...
export let mapManagementInstanceIntegrationsProvidersDeleteOutput =
  mtMap.object<ManagementInstanceIntegrationsProvidersDeleteOutput>({
