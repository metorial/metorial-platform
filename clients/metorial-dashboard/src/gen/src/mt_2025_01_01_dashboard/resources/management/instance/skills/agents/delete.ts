...
export type ManagementInstanceSkillsAgentsDeleteOutput = {
  object: 'skill.agent';
  id: string;
  skillId: string;
  name: string;
...
export let mapManagementInstanceSkillsAgentsDeleteOutput =
  mtMap.object<ManagementInstanceSkillsAgentsDeleteOutput>({
