...
export type ManagementInstanceSkillTemplatesItemsListOutput = {
  items: {
...
export let mapManagementInstanceSkillTemplatesItemsListOutput =
  mtMap.object<ManagementInstanceSkillTemplatesItemsListOutput>({
...
export type ManagementInstanceSkillTemplatesItemsListQuery = {
...
export let mapManagementInstanceSkillTemplatesItemsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
