...
export type ManagementOrganizationMembersPoliciesDeleteOutput = {
...
export let mapManagementOrganizationMembersPoliciesDeleteOutput =
  mtMap.object<ManagementOrganizationMembersPoliciesDeleteOutput>({
