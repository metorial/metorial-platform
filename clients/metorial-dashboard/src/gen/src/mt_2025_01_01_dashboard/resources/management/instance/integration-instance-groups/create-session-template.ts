...
export type ManagementInstanceIntegrationInstanceGroupsCreateSessionTemplateOutput =
  {
...
export let mapManagementInstanceIntegrationInstanceGroupsCreateSessionTemplateOutput =
  mtMap.object<ManagementInstanceIntegrationInstanceGroupsCreateSessionTemplateOutput>(
    {
...
export type ManagementInstanceIntegrationInstanceGroupsCreateSessionTemplateBody =
  {
...
export let mapManagementInstanceIntegrationInstanceGroupsCreateSessionTemplateBody =
  mtMap.object<ManagementInstanceIntegrationInstanceGroupsCreateSessionTemplateBody>(
    {
      name: mtMap.objectField('name', mtMap.passthrough()),
      description: mtMap.objectField('description', mtMap.passthrough()),
      metadata: mtMap.objectField('metadata', mtMap.passthrough())
