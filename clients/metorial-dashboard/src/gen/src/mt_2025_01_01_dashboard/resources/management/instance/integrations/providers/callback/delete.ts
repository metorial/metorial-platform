...
export type ManagementInstanceIntegrationsProvidersCallbackDeleteOutput = {
  object: 'callback';
  id: string;
...
export let mapManagementInstanceIntegrationsProvidersCallbackDeleteOutput =
  mtMap.object<ManagementInstanceIntegrationsProvidersCallbackDeleteOutput>({
