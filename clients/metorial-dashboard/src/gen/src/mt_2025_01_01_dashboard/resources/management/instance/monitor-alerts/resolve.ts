...
export type ManagementInstanceMonitorAlertsResolveOutput = {
...
export let mapManagementInstanceMonitorAlertsResolveOutput =
  mtMap.object<ManagementInstanceMonitorAlertsResolveOutput>({
