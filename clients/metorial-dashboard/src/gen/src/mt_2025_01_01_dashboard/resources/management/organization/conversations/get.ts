...
export type ManagementOrganizationConversationsGetOutput = {
...
export let mapManagementOrganizationConversationsGetOutput =
  mtMap.object<ManagementOrganizationConversationsGetOutput>({
