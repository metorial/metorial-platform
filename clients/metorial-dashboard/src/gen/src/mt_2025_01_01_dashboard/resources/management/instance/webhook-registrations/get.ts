...
export type ManagementInstanceWebhookRegistrationsGetOutput = {
...
export let mapManagementInstanceWebhookRegistrationsGetOutput =
  mtMap.object<ManagementInstanceWebhookRegistrationsGetOutput>({
