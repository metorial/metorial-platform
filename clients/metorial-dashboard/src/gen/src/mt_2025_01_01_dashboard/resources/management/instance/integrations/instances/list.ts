...
export type ManagementInstanceIntegrationsInstancesListOutput = {
  items: {
...
export let mapManagementInstanceIntegrationsInstancesListOutput =
  mtMap.object<ManagementInstanceIntegrationsInstancesListOutput>({
...
export type ManagementInstanceIntegrationsInstancesListQuery = {
...
export let mapManagementInstanceIntegrationsInstancesListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
