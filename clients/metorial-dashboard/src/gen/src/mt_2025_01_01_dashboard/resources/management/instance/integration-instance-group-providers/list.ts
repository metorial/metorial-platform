...
export let mapManagementInstanceIntegrationInstanceGroupProvidersListOutput =
  mtMap.object<ManagementInstanceIntegrationInstanceGroupProvidersListOutput>({
...
export type ManagementInstanceIntegrationInstanceGroupProvidersListQuery = {
...
export let mapManagementInstanceIntegrationInstanceGroupProvidersListQuery =
  mtMap.union([
    mtMap.unionOption(
      'object',
      mtMap.object({
