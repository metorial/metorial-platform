...
export type ManagementInstancePortalsAccessGetOutput = {
...
export let mapManagementInstancePortalsAccessGetOutput =
  mtMap.object<ManagementInstancePortalsAccessGetOutput>({
