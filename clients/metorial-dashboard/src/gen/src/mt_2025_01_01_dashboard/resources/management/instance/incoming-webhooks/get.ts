...
export type ManagementInstanceIncomingWebhooksGetOutput = {
...
export let mapManagementInstanceIncomingWebhooksGetOutput =
  mtMap.object<ManagementInstanceIncomingWebhooksGetOutput>({
