...
export type ManagementInstanceCallbacksInstancesSendTestEventOutput = {
...
export let mapManagementInstanceCallbacksInstancesSendTestEventOutput =
  mtMap.object<ManagementInstanceCallbacksInstancesSendTestEventOutput>({
...
export type ManagementInstanceCallbacksInstancesSendTestEventBody = {
  eventType: string;
  payload: Record<string, any>;
};

export let mapManagementInstanceCallbacksInstancesSendTestEventBody =
  mtMap.object<ManagementInstanceCallbacksInstancesSendTestEventBody>({
