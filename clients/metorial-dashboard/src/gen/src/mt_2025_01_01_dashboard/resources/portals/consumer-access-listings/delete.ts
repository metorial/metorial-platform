...
export type PortalsConsumerAccessListingsDeleteOutput = {
...
export let mapPortalsConsumerAccessListingsDeleteOutput =
  mtMap.object<PortalsConsumerAccessListingsDeleteOutput>({
