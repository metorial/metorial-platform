...
export type PortalsConsumerAccessListingsGetOutput = {
...
export let mapPortalsConsumerAccessListingsGetOutput =
  mtMap.object<PortalsConsumerAccessListingsGetOutput>({
