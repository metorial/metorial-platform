...
export type PortalsConsumerInvitesListOutput = {
  items: {
...
export let mapPortalsConsumerInvitesListOutput =
  mtMap.object<PortalsConsumerInvitesListOutput>({
...
export type PortalsConsumerInvitesListQuery = {
...
export let mapPortalsConsumerInvitesListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
