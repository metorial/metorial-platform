...
export type PortalsAccessRequestsListOutput = {
  items: {
...
export let mapPortalsAccessRequestsListOutput =
  mtMap.object<PortalsAccessRequestsListOutput>({
...
export type PortalsAccessRequestsListQuery = {
