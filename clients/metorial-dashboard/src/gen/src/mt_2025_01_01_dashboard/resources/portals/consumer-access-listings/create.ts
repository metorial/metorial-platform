...
export type PortalsConsumerAccessListingsCreateOutput = {
...
export let mapPortalsConsumerAccessListingsCreateOutput =
  mtMap.object<PortalsConsumerAccessListingsCreateOutput>({
...
export type PortalsConsumerAccessListingsCreateBody = {
...
export let mapPortalsConsumerAccessListingsCreateBody =
  mtMap.object<PortalsConsumerAccessListingsCreateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    readme: mtMap.objectField('readme', mtMap.passthrough()),
    access: mtMap.objectField(
