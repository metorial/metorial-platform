...
export type PortalsListingsCreateOutput = {
...
export let mapPortalsListingsCreateOutput =
  mtMap.object<PortalsListingsCreateOutput>({
...
export type PortalsListingsCreateBody = {
...
export let mapPortalsListingsCreateBody =
  mtMap.object<PortalsListingsCreateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    readme: mtMap.objectField('readme', mtMap.passthrough()),
    access: mtMap.objectField(
