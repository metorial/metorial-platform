...
export type PortalsListingsListOutput = {
  items: {
...
export let mapPortalsListingsListOutput =
  mtMap.object<PortalsListingsListOutput>({
...
export type PortalsListingsListQuery = {
...
export let mapPortalsListingsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
