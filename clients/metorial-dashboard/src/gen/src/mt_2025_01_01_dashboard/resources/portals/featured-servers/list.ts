...
export type PortalsFeaturedServersListOutput = {
  items: ({
...
export let mapPortalsFeaturedServersListOutput =
  mtMap.object<PortalsFeaturedServersListOutput>({
...
export type PortalsFeaturedServersListQuery = {
...
export let mapPortalsFeaturedServersListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
