...
export type PortalsAccessListOutput = {
  items: {
...
export let mapPortalsAccessListOutput = mtMap.object<PortalsAccessListOutput>({
...
export type PortalsAccessListQuery = {
...
export let mapPortalsAccessListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
