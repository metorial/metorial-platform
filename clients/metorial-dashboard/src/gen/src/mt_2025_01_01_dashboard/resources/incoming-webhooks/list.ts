...
export type IncomingWebhooksListOutput = {
  items: {
...
export let mapIncomingWebhooksListOutput =
  mtMap.object<IncomingWebhooksListOutput>({
...
export type IncomingWebhooksListQuery = {
...
export let mapIncomingWebhooksListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
