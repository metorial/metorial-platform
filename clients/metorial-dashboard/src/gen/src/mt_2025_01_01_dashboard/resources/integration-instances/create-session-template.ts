...
export type IntegrationInstancesCreateSessionTemplateOutput = {
...
export let mapIntegrationInstancesCreateSessionTemplateOutput =
  mtMap.object<IntegrationInstancesCreateSessionTemplateOutput>({
...
export type IntegrationInstancesCreateSessionTemplateBody = {
  name?: string | undefined;
  description?: string | undefined;
  metadata?: Record<string, any> | undefined;
};

export let mapIntegrationInstancesCreateSessionTemplateBody =
  mtMap.object<IntegrationInstancesCreateSessionTemplateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    metadata: mtMap.objectField('metadata', mtMap.passthrough())
  });
