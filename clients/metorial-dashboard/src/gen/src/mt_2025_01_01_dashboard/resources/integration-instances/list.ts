...
export let mapIntegrationInstancesListOutput =
  mtMap.object<IntegrationInstancesListOutput>({
...
export type IntegrationInstancesListQuery = {
...
export let mapIntegrationInstancesListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
