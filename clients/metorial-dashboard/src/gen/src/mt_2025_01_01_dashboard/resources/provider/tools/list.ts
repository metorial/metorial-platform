...
export type ProviderToolsListOutput = {
  items: {
...
export let mapProviderToolsListOutput = mtMap.object<ProviderToolsListOutput>({
...
export type ProviderToolsListQuery = {
...
export let mapProviderToolsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
