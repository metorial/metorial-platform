...
export type ProviderAuthConfigEventsListOutput = {
  items: {
...
export let mapProviderAuthConfigEventsListOutput =
  mtMap.object<ProviderAuthConfigEventsListOutput>({
...
export type ProviderAuthConfigEventsListQuery = {
...
export let mapProviderAuthConfigEventsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
