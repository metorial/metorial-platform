...
export type ProviderInvocationsListOutput = {
...
export let mapProviderInvocationsListOutput =
  mtMap.object<ProviderInvocationsListOutput>({
...
export type ProviderInvocationsListQuery = {
...
export let mapProviderInvocationsListQuery =
  mtMap.object<ProviderInvocationsListQuery>({
