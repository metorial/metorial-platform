...
export type IdentitiesDelegationsListOutput = {
  items: {
...
export let mapIdentitiesDelegationsListOutput =
  mtMap.object<IdentitiesDelegationsListOutput>({
...
export type IdentitiesDelegationsListQuery = {
...
export let mapIdentitiesDelegationsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
