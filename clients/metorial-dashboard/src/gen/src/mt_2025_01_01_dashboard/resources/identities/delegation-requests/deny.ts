...
export type IdentitiesDelegationRequestsDenyOutput = {
...
export let mapIdentitiesDelegationRequestsDenyOutput =
  mtMap.object<IdentitiesDelegationRequestsDenyOutput>({
...
export type IdentitiesDelegationRequestsDenyQuery = {
  allowDeleted?: boolean | undefined;
};

export let mapIdentitiesDelegationRequestsDenyQuery =
  mtMap.object<IdentitiesDelegationRequestsDenyQuery>({
