...
export type ChatsMessagesUpdateOutput = {
  object: 'chat.message';
  id: string;
  chatId: string;
  channelId: string;
...
export let mapChatsMessagesUpdateOutput =
  mtMap.object<ChatsMessagesUpdateOutput>({
...
export type ChatsMessagesUpdateBody = {
  channelId: string;
  parts: (
...
export let mapChatsMessagesUpdateBody = mtMap.object<ChatsMessagesUpdateBody>({
  channelId: mtMap.objectField('channel_id', mtMap.passthrough()),
      ...
      mtMap.union([
        mtMap.unionOption(
          ...
          mtMap.object({
            ...
            align: mtMap.objectField('align', mtMap.array(mtMap.passthrough())),
