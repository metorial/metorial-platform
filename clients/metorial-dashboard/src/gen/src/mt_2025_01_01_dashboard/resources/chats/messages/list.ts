...
export type ChatsMessagesListOutput = {
  items: {
    object: 'chat.message';
    id: string;
    chatId: string;
...
export let mapChatsMessagesListOutput = mtMap.object<ChatsMessagesListOutput>({
...
export type ChatsMessagesListQuery = {
...
export let mapChatsMessagesListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
