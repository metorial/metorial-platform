...
export type ChatsThreadsListOutput = {
  items: {
    object: 'chat.thread';
    id: string;
    chatId: string;
...
export let mapChatsThreadsListOutput = mtMap.object<ChatsThreadsListOutput>({
...
export type ChatsThreadsListQuery = {
...
export let mapChatsThreadsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
