...
export type ChatsMessagesGetOutput = {
  object: 'chat.message';
  id: string;
  chatId: string;
  channelId: string;
...
export let mapChatsMessagesGetOutput = mtMap.object<ChatsMessagesGetOutput>({
...
export type ChatsMessagesGetQuery = { channelId: string };

export let mapChatsMessagesGetQuery = mtMap.object<ChatsMessagesGetQuery>({
  channelId: mtMap.objectField('channel_id', mtMap.passthrough())
});
