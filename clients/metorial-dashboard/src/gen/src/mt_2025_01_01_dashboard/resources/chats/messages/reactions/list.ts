...
export type ChatsMessagesReactionsListOutput = {
...
export let mapChatsMessagesReactionsListOutput =
  mtMap.object<ChatsMessagesReactionsListOutput>({
...
export type ChatsMessagesReactionsListQuery = { channelId: string };

export let mapChatsMessagesReactionsListQuery =
  mtMap.object<ChatsMessagesReactionsListQuery>({
