...
export type ChatsMessagesDeleteOutput = {
  object: 'chat.message';
  id: string;
  chatId: string;
  channelId: string;
...
export let mapChatsMessagesDeleteOutput =
  mtMap.object<ChatsMessagesDeleteOutput>({
...
export type ChatsMessagesDeleteQuery = { channelId: string };

export let mapChatsMessagesDeleteQuery = mtMap.object<ChatsMessagesDeleteQuery>(
  { channelId: mtMap.objectField('channel_id', mtMap.passthrough()) }
);
