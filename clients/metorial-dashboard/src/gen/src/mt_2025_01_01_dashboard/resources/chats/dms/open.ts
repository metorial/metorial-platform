...
export type ChatsDmsOpenOutput = {
  object: 'chat.channel';
  id: string;
  chatId: string;
...
export let mapChatsDmsOpenOutput = mtMap.object<ChatsDmsOpenOutput>({
...
export let mapChatsDmsOpenBody = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
      type: mtMap.objectField('type', mtMap.passthrough()),
