...
export type ChatsMessagesReadOutput = {
  object: 'chat.message';
  id: string;
  chatId: string;
  channelId: string;
...
export let mapChatsMessagesReadOutput = mtMap.object<ChatsMessagesReadOutput>({
...
export type ChatsMessagesReadBody = {
  channelId: string;
  threadId?: string | undefined;
};

export let mapChatsMessagesReadBody = mtMap.object<ChatsMessagesReadBody>({
  channelId: mtMap.objectField('channel_id', mtMap.passthrough()),
  threadId: mtMap.objectField('thread_id', mtMap.passthrough())
});
