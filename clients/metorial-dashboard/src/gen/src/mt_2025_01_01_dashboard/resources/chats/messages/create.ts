...
export type ChatsMessagesCreateOutput = {
  object: 'chat.message';
  id: string;
  chatId: string;
  channelId: string;
...
export let mapChatsMessagesCreateOutput =
  mtMap.object<ChatsMessagesCreateOutput>({
...
export type ChatsMessagesCreateBody = {
  channelId: string;
...
export let mapChatsMessagesCreateBody = mtMap.object<ChatsMessagesCreateBody>({
  channelId: mtMap.objectField('channel_id', mtMap.passthrough()),
  threadId: mtMap.objectField('thread_id', mtMap.passthrough()),
