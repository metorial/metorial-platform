...
export type ChatsChannelsListOutput = {
  items: {
    object: 'chat.channel';
    id: string;
    chatId: string;
...
export let mapChatsChannelsListOutput = mtMap.object<ChatsChannelsListOutput>({
...
export type ChatsChannelsListQuery = {
...
export let mapChatsChannelsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
