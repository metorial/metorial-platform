...
export type IntegrationsInstanceGroupsCreateOutput = {
...
export let mapIntegrationsInstanceGroupsCreateOutput =
  mtMap.object<IntegrationsInstanceGroupsCreateOutput>({
...
export type IntegrationsInstanceGroupsCreateBody = {
  name: string;
...
export let mapIntegrationsInstanceGroupsCreateBody =
  mtMap.object<IntegrationsInstanceGroupsCreateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    metadata: mtMap.objectField('metadata', mtMap.passthrough()),
    providers: mtMap.objectField(
