...
export type IntegrationsInstancesListOutput = {
  items: {
...
export let mapIntegrationsInstancesListOutput =
  mtMap.object<IntegrationsInstancesListOutput>({
...
export type IntegrationsInstancesListQuery = {
...
export let mapIntegrationsInstancesListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
