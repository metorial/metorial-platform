...
export type IntegrationsProvidersListOutput = {
  items: {
...
export let mapIntegrationsProvidersListOutput =
  mtMap.object<IntegrationsProvidersListOutput>({
...
export type IntegrationsProvidersListQuery = {
...
export let mapIntegrationsProvidersListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
