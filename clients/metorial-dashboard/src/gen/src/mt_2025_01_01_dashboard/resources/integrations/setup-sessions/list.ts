...
export type IntegrationsSetupSessionsListOutput = {
  items: {
...
export let mapIntegrationsSetupSessionsListOutput =
  mtMap.object<IntegrationsSetupSessionsListOutput>({
...
export type IntegrationsSetupSessionsListQuery = {
...
export let mapIntegrationsSetupSessionsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
