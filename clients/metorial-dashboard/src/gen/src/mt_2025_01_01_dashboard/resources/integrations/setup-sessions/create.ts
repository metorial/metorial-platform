...
export type IntegrationsSetupSessionsCreateOutput = {
...
export let mapIntegrationsSetupSessionsCreateOutput =
  mtMap.object<IntegrationsSetupSessionsCreateOutput>({
...
export type IntegrationsSetupSessionsCreateBody = {
  integrationId: string;
  name: string;
...
export let mapIntegrationsSetupSessionsCreateBody =
  mtMap.object<IntegrationsSetupSessionsCreateBody>({
    integrationId: mtMap.objectField('integration_id', mtMap.passthrough()),
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    metadata: mtMap.objectField('metadata', mtMap.passthrough()),
