...
export type IntegrationsInstanceGroupsProvidersGetOutput = {
...
export let mapIntegrationsInstanceGroupsProvidersGetOutput =
  mtMap.object<IntegrationsInstanceGroupsProvidersGetOutput>({
