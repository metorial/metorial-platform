...
export type IntegrationsInstancesCreateSessionOutput = {
  object: 'session';
  id: string;
...
export let mapIntegrationsInstancesCreateSessionOutput =
  mtMap.object<IntegrationsInstancesCreateSessionOutput>({
...
export type IntegrationsInstancesCreateSessionBody = {
  name?: string | undefined;
  description?: string | undefined;
  metadata?: Record<string, any> | undefined;
};

export let mapIntegrationsInstancesCreateSessionBody =
  mtMap.object<IntegrationsInstancesCreateSessionBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    metadata: mtMap.objectField('metadata', mtMap.passthrough())
  });
