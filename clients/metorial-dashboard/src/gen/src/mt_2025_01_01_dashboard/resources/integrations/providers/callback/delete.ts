...
export type IntegrationsProvidersCallbackDeleteOutput = {
  object: 'callback';
  id: string;
...
export let mapIntegrationsProvidersCallbackDeleteOutput =
  mtMap.object<IntegrationsProvidersCallbackDeleteOutput>({
