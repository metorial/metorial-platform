...
export type IntegrationsInstancesUpdateOutput = {
...
export let mapIntegrationsInstancesUpdateOutput =
  mtMap.object<IntegrationsInstancesUpdateOutput>({
...
export type IntegrationsInstancesUpdateBody = {
...
export let mapIntegrationsInstancesUpdateBody =
  mtMap.object<IntegrationsInstancesUpdateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    metadata: mtMap.objectField('metadata', mtMap.passthrough()),
    identityActorId: mtMap.objectField(
