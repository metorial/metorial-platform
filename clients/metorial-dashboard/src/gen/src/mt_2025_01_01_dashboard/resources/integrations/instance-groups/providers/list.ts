...
export type IntegrationsInstanceGroupsProvidersListOutput = {
  items: {
...
export let mapIntegrationsInstanceGroupsProvidersListOutput =
  mtMap.object<IntegrationsInstanceGroupsProvidersListOutput>({
...
export type IntegrationsInstanceGroupsProvidersListQuery = {
...
export let mapIntegrationsInstanceGroupsProvidersListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
