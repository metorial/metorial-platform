...
export type IntegrationsInstanceGroupsCreateSessionTemplateOutput = {
...
export let mapIntegrationsInstanceGroupsCreateSessionTemplateOutput =
  mtMap.object<IntegrationsInstanceGroupsCreateSessionTemplateOutput>({
...
export type IntegrationsInstanceGroupsCreateSessionTemplateBody = {
  name?: string | undefined;
  description?: string | undefined;
  metadata?: Record<string, any> | undefined;
};

export let mapIntegrationsInstanceGroupsCreateSessionTemplateBody =
  mtMap.object<IntegrationsInstanceGroupsCreateSessionTemplateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    metadata: mtMap.objectField('metadata', mtMap.passthrough())
  });
