...
export type IntegrationsProvidersCallbackGetOutput = {
  object: 'callback';
  id: string;
...
export let mapIntegrationsProvidersCallbackGetOutput =
  mtMap.object<IntegrationsProvidersCallbackGetOutput>({
