...
export type IntegrationsInstancesProvidersGetOutput = {
...
export let mapIntegrationsInstancesProvidersGetOutput =
  mtMap.object<IntegrationsInstancesProvidersGetOutput>({
