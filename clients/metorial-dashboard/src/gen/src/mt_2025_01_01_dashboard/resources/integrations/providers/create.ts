...
export type IntegrationsProvidersCreateOutput = {
...
export let mapIntegrationsProvidersCreateOutput =
  mtMap.object<IntegrationsProvidersCreateOutput>({
...
export type IntegrationsProvidersCreateBody = {
  integrationId: string;
  providerId: string;
...
export let mapIntegrationsProvidersCreateBody =
  mtMap.object<IntegrationsProvidersCreateBody>({
    integrationId: mtMap.objectField('integration_id', mtMap.passthrough()),
    providerId: mtMap.objectField('provider_id', mtMap.passthrough()),
