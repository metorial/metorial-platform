...
export type IntegrationsInstancesCreateOutput = {
...
export let mapIntegrationsInstancesCreateOutput =
  mtMap.object<IntegrationsInstancesCreateOutput>({
...
export type IntegrationsInstancesCreateBody = {
  integrationId: string;
  name: string;
...
export let mapIntegrationsInstancesCreateBody =
  mtMap.object<IntegrationsInstancesCreateBody>({
    integrationId: mtMap.objectField('integration_id', mtMap.passthrough()),
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    metadata: mtMap.objectField('metadata', mtMap.passthrough()),
