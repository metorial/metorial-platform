...
export type IntegrationsInstanceGroupsDeleteOutput = {
...
export let mapIntegrationsInstanceGroupsDeleteOutput =
  mtMap.object<IntegrationsInstanceGroupsDeleteOutput>({
