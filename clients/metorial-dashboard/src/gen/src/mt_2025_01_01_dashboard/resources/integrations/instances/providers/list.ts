...
export type IntegrationsInstancesProvidersListOutput = {
  items: {
...
export let mapIntegrationsInstancesProvidersListOutput =
  mtMap.object<IntegrationsInstancesProvidersListOutput>({
...
export type IntegrationsInstancesProvidersListQuery = {
...
export let mapIntegrationsInstancesProvidersListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
