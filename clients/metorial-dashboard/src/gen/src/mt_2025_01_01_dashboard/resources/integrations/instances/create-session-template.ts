...
export type IntegrationsInstancesCreateSessionTemplateOutput = {
...
export let mapIntegrationsInstancesCreateSessionTemplateOutput =
  mtMap.object<IntegrationsInstancesCreateSessionTemplateOutput>({
...
export type IntegrationsInstancesCreateSessionTemplateBody = {
  name?: string | undefined;
  description?: string | undefined;
  metadata?: Record<string, any> | undefined;
};

export let mapIntegrationsInstancesCreateSessionTemplateBody =
  mtMap.object<IntegrationsInstancesCreateSessionTemplateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    metadata: mtMap.objectField('metadata', mtMap.passthrough())
  });
