...
export type CustomProvidersDeploymentsListOutput = {
  items: {
...
export let mapCustomProvidersDeploymentsListOutput =
  mtMap.object<CustomProvidersDeploymentsListOutput>({
...
export type CustomProvidersDeploymentsListQuery = {
...
export let mapCustomProvidersDeploymentsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
