...
export type CustomProvidersCommitsListOutput = {
  items: {
...
export let mapCustomProvidersCommitsListOutput =
  mtMap.object<CustomProvidersCommitsListOutput>({
...
export type CustomProvidersCommitsListQuery = {
...
export let mapCustomProvidersCommitsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
