...
export type SkillTemplatesUpdateOutput = {
...
export let mapSkillTemplatesUpdateOutput =
  mtMap.object<SkillTemplatesUpdateOutput>({
...
export type SkillTemplatesUpdateBody = {
  name?: string | undefined;
  description?: string | null | undefined;
  metadata?: Record<string, any> | null | undefined;
};

export let mapSkillTemplatesUpdateBody = mtMap.object<SkillTemplatesUpdateBody>(
  {
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    metadata: mtMap.objectField('metadata', mtMap.passthrough())
