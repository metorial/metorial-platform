...
export type SkillTemplatesCreateOutput = {
...
export let mapSkillTemplatesCreateOutput =
  mtMap.object<SkillTemplatesCreateOutput>({
...
export type SkillTemplatesCreateBody = {
  name: string;
