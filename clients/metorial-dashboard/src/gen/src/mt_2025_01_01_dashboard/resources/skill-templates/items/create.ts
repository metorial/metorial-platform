...
export type SkillTemplatesItemsCreateOutput = {
...
export let mapSkillTemplatesItemsCreateOutput =
  mtMap.object<SkillTemplatesItemsCreateOutput>({
...
export type SkillTemplatesItemsCreateBody =
  | { type: 'provider'; providerId: string }
  | { type: 'integration'; integrationId: string };

export let mapSkillTemplatesItemsCreateBody = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
      type: mtMap.objectField('type', mtMap.passthrough()),
