...
export type SkillTemplatesItemsListOutput = {
  items: {
...
export let mapSkillTemplatesItemsListOutput =
  mtMap.object<SkillTemplatesItemsListOutput>({
...
export type SkillTemplatesItemsListQuery = {
...
export let mapSkillTemplatesItemsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
