...
export type SkillTemplatesListOutput = {
  items: {
...
export let mapSkillTemplatesListOutput = mtMap.object<SkillTemplatesListOutput>(
  {
...
export type SkillTemplatesListQuery = {
...
export let mapSkillTemplatesListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
