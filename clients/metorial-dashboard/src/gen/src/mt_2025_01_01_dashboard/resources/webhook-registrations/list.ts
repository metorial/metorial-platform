...
export type WebhookRegistrationsListOutput = {
  items: {
...
export let mapWebhookRegistrationsListOutput =
  mtMap.object<WebhookRegistrationsListOutput>({
...
export type WebhookRegistrationsListQuery = {
...
export let mapWebhookRegistrationsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
