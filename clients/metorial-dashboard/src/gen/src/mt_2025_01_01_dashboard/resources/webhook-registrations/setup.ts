...
export type WebhookRegistrationsSetupOutput = {
...
export let mapWebhookRegistrationsSetupOutput =
  mtMap.object<WebhookRegistrationsSetupOutput>({
...
export type WebhookRegistrationsSetupBody = { userConfig: Record<string, any> };

export let mapWebhookRegistrationsSetupBody =
  mtMap.object<WebhookRegistrationsSetupBody>({
