...
export type SkillGroupsCreateOutput = {
  object: 'skill.group';
  id: string;
...
export let mapSkillGroupsCreateOutput = mtMap.object<SkillGroupsCreateOutput>({
...
export type SkillGroupsCreateBody = {
  name: string;
...
export let mapSkillGroupsCreateBody = mtMap.object<SkillGroupsCreateBody>({
  name: mtMap.objectField('name', mtMap.passthrough()),
  description: mtMap.objectField('description', mtMap.passthrough()),
  metadata: mtMap.objectField('metadata', mtMap.passthrough()),
