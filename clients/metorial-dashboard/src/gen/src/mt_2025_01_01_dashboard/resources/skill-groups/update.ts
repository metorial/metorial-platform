...
export type SkillGroupsUpdateOutput = {
  object: 'skill.group';
  id: string;
...
export let mapSkillGroupsUpdateOutput = mtMap.object<SkillGroupsUpdateOutput>({
...
export type SkillGroupsUpdateBody = {
...
export let mapSkillGroupsUpdateBody = mtMap.object<SkillGroupsUpdateBody>({
  name: mtMap.objectField('name', mtMap.passthrough()),
  description: mtMap.objectField('description', mtMap.passthrough()),
  metadata: mtMap.objectField('metadata', mtMap.passthrough()),
