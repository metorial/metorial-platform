...
export type SkillGroupsItemsListOutput = {
  items: {
...
export let mapSkillGroupsItemsListOutput =
  mtMap.object<SkillGroupsItemsListOutput>({
...
export type SkillGroupsItemsListQuery = {
...
export let mapSkillGroupsItemsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
