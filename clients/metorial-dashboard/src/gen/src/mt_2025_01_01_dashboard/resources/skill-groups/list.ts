...
export type SkillGroupsListOutput = {
  items: {
    object: 'skill.group';
    id: string;
...
export let mapSkillGroupsListOutput = mtMap.object<SkillGroupsListOutput>({
...
export type SkillGroupsListQuery = {
...
export let mapSkillGroupsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
