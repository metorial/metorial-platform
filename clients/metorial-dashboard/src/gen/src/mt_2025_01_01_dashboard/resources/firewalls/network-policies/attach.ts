...
export type FirewallsNetworkPoliciesAttachOutput = {
...
export let mapFirewallsNetworkPoliciesAttachOutput =
  mtMap.object<FirewallsNetworkPoliciesAttachOutput>({
...
export type FirewallsNetworkPoliciesAttachBody = {
  networkPolicyId: string;
  position?: number | undefined;
};

export let mapFirewallsNetworkPoliciesAttachBody =
  mtMap.object<FirewallsNetworkPoliciesAttachBody>({
