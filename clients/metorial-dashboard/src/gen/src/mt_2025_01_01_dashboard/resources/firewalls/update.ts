...
export type FirewallsUpdateOutput = {
...
export let mapFirewallsUpdateOutput = mtMap.object<FirewallsUpdateOutput>({
...
export type FirewallsUpdateBody = {
...
export let mapFirewallsUpdateBody = mtMap.object<FirewallsUpdateBody>({
  name: mtMap.objectField('name', mtMap.passthrough()),
  description: mtMap.objectField('description', mtMap.passthrough()),
  slug: mtMap.objectField('slug', mtMap.passthrough()),
