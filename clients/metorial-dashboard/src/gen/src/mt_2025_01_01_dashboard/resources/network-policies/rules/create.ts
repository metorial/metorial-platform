...
export type NetworkPoliciesRulesCreateOutput = {
...
export let mapNetworkPoliciesRulesCreateOutput =
  mtMap.object<NetworkPoliciesRulesCreateOutput>({
...
export type NetworkPoliciesRulesCreateBody = {
  effect: 'allow' | 'deny';
  direction: 'ingress' | 'egress';
  cidrs: string[];
...
export let mapNetworkPoliciesRulesCreateBody =
  mtMap.object<NetworkPoliciesRulesCreateBody>({
    effect: mtMap.objectField('effect', mtMap.passthrough()),
    direction: mtMap.objectField('direction', mtMap.passthrough()),
    cidrs: mtMap.objectField('cidrs', mtMap.array(mtMap.passthrough())),
    description: mtMap.objectField('description', mtMap.passthrough()),
