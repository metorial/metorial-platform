...
export type NetworkPoliciesCreateOutput = {
...
export let mapNetworkPoliciesCreateOutput =
  mtMap.object<NetworkPoliciesCreateOutput>({
...
export type NetworkPoliciesCreateBody = {
  name: string;
...
export let mapNetworkPoliciesCreateBody =
  mtMap.object<NetworkPoliciesCreateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    rules: mtMap.objectField(
      'rules',
