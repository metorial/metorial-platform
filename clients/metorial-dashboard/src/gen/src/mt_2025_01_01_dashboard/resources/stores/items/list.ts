...
export type StoresItemsListOutput = {
  items: {
    object: 'store.item';
    id: string;
...
export let mapStoresItemsListOutput = mtMap.object<StoresItemsListOutput>({
...
export type StoresItemsListQuery = {
...
export let mapStoresItemsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
