...
export type StoresParticipantsListOutput = {
  items: {
...
export let mapStoresParticipantsListOutput =
  mtMap.object<StoresParticipantsListOutput>({
...
export type StoresParticipantsListQuery = {
...
export let mapStoresParticipantsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
