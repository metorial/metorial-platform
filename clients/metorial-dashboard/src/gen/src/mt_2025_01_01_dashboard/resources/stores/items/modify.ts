...
export type StoresItemsModifyOutput = {
...
export let mapStoresItemsModifyOutput = mtMap.object<StoresItemsModifyOutput>({
...
export type StoresItemsModifyBody = {
  operations: {
...
export let mapStoresItemsModifyBody = mtMap.object<StoresItemsModifyBody>({
