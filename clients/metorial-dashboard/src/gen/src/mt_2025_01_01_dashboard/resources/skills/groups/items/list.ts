...
export type SkillsGroupsItemsListOutput = {
  items: {
...
export let mapSkillsGroupsItemsListOutput =
  mtMap.object<SkillsGroupsItemsListOutput>({
...
export type SkillsGroupsItemsListQuery = {
...
export let mapSkillsGroupsItemsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
