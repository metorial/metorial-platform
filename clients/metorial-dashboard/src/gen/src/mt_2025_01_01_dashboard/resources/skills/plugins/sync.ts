...
export type SkillsPluginsSyncOutput = {
  object: 'skill.plugin';
  id: string;
...
export let mapSkillsPluginsSyncOutput = mtMap.object<SkillsPluginsSyncOutput>({
...
export type SkillsPluginsSyncBody = {};

export let mapSkillsPluginsSyncBody = mtMap.object<SkillsPluginsSyncBody>({});
