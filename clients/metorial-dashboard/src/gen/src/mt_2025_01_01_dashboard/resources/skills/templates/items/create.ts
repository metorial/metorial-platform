...
export type SkillsTemplatesItemsCreateOutput = {
...
export let mapSkillsTemplatesItemsCreateOutput =
  mtMap.object<SkillsTemplatesItemsCreateOutput>({
...
export type SkillsTemplatesItemsCreateBody =
  | { type: 'provider'; providerId: string }
  | { type: 'integration'; integrationId: string };

export let mapSkillsTemplatesItemsCreateBody = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
      type: mtMap.objectField('type', mtMap.passthrough()),
