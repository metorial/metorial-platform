...
export type SkillsMarketplacesListOutput = {
  items: ({
...
export let mapSkillsMarketplacesListOutput =
  mtMap.object<SkillsMarketplacesListOutput>({
...
export type SkillsMarketplacesListQuery = {
...
export let mapSkillsMarketplacesListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
