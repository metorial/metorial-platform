...
export type SkillsPluginsRepositoriesDeleteOutput = {
...
export let mapSkillsPluginsRepositoriesDeleteOutput =
  mtMap.object<SkillsPluginsRepositoriesDeleteOutput>({
