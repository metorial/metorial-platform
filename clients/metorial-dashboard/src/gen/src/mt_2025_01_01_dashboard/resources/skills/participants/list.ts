...
export type SkillsParticipantsListOutput = {
  items: {
...
export let mapSkillsParticipantsListOutput =
  mtMap.object<SkillsParticipantsListOutput>({
...
export type SkillsParticipantsListQuery = {
...
export let mapSkillsParticipantsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
