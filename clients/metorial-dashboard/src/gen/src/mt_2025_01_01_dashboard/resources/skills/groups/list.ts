...
export type SkillsGroupsListOutput = {
  items: {
    object: 'skill.group';
    id: string;
...
export let mapSkillsGroupsListOutput = mtMap.object<SkillsGroupsListOutput>({
...
export type SkillsGroupsListQuery = {
...
export let mapSkillsGroupsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
