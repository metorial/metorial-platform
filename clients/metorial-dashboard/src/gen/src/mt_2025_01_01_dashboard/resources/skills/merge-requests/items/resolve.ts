...
export type SkillsMergeRequestsItemsResolveOutput = {
...
export let mapSkillsMergeRequestsItemsResolveOutput =
  mtMap.object<SkillsMergeRequestsItemsResolveOutput>({
...
export type SkillsMergeRequestsItemsResolveBody = {
  resolutionType:
    | 'accept_source'
    | 'keep_target'
    | 'remove'
...
export let mapSkillsMergeRequestsItemsResolveBody =
  mtMap.object<SkillsMergeRequestsItemsResolveBody>({
    resolutionType: mtMap.objectField('resolution_type', mtMap.passthrough()),
