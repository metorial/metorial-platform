...
export type SkillsConfigurationsUpdateOutput = {
...
export let mapSkillsConfigurationsUpdateOutput =
  mtMap.object<SkillsConfigurationsUpdateOutput>({
...
export type SkillsConfigurationsUpdateBody = {
  allowScripts?: boolean | undefined;
  allowedFileExtensions?: string[] | null | undefined;
  allowNonStandardDirectories?: boolean | undefined;
};

export let mapSkillsConfigurationsUpdateBody =
  mtMap.object<SkillsConfigurationsUpdateBody>({
    allowScripts: mtMap.objectField('allow_scripts', mtMap.passthrough()),
    allowedFileExtensions: mtMap.objectField(
      'allowed_file_extensions',
      mtMap.array(mtMap.passthrough())
