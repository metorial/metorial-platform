...
export type SkillsMergeRequestsCommentsListOutput = {
  items: {
...
export let mapSkillsMergeRequestsCommentsListOutput =
  mtMap.object<SkillsMergeRequestsCommentsListOutput>({
...
export type SkillsMergeRequestsCommentsListQuery = {
...
export let mapSkillsMergeRequestsCommentsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
