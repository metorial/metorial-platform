...
export type SkillsMarketplacesCreateOutput = {
...
export let mapSkillsMarketplacesCreateOutput = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
...
export type SkillsMarketplacesCreateBody = {
  name: string;
...
export let mapSkillsMarketplacesCreateBody =
  mtMap.object<SkillsMarketplacesCreateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
