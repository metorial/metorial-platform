...
export type SkillsExportsListOutput = {
  items: {
    object: 'skill.export';
    id: string;
...
export let mapSkillsExportsListOutput = mtMap.object<SkillsExportsListOutput>({
...
export type SkillsExportsListQuery = {
...
export let mapSkillsExportsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
