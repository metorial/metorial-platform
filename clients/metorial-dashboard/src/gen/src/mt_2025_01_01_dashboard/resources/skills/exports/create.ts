...
export type SkillsExportsCreateOutput = {
  object: 'skill.export';
  id: string;
...
export let mapSkillsExportsCreateOutput =
  mtMap.object<SkillsExportsCreateOutput>({
...
export type SkillsExportsCreateBody = {
  target: 'skill' | 'plugin' | 'marketplace';
...
export let mapSkillsExportsCreateBody = mtMap.object<SkillsExportsCreateBody>({
  target: mtMap.objectField('target', mtMap.passthrough()),
