...
export type SkillsMarketplacesPluginsRemoveOutput = {
...
export let mapSkillsMarketplacesPluginsRemoveOutput =
  mtMap.object<SkillsMarketplacesPluginsRemoveOutput>({
