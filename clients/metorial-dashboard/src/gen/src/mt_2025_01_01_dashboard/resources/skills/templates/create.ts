...
export type SkillsTemplatesCreateOutput = {
...
export let mapSkillsTemplatesCreateOutput =
  mtMap.object<SkillsTemplatesCreateOutput>({
...
export type SkillsTemplatesCreateBody = {
  name: string;
...
export let mapSkillsTemplatesCreateBody =
  mtMap.object<SkillsTemplatesCreateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    metadata: mtMap.objectField('metadata', mtMap.passthrough()),
