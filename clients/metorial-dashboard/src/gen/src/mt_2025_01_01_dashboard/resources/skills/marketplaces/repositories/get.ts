...
export type SkillsMarketplacesRepositoriesGetOutput = {
...
export let mapSkillsMarketplacesRepositoriesGetOutput =
  mtMap.object<SkillsMarketplacesRepositoriesGetOutput>({
