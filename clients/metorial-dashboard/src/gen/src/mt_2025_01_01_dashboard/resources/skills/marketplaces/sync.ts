...
export type SkillsMarketplacesSyncOutput = {
...
export let mapSkillsMarketplacesSyncOutput = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
...
export type SkillsMarketplacesSyncBody = {};

export let mapSkillsMarketplacesSyncBody =
  mtMap.object<SkillsMarketplacesSyncBody>({});
