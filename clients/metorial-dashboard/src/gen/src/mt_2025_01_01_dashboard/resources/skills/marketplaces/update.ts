...
export type SkillsMarketplacesUpdateOutput = {
...
export let mapSkillsMarketplacesUpdateOutput = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
...
export type SkillsMarketplacesUpdateBody = {
...
export let mapSkillsMarketplacesUpdateBody =
  mtMap.object<SkillsMarketplacesUpdateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
