...
export type SkillsTemplatesItemsListOutput = {
  items: {
...
export let mapSkillsTemplatesItemsListOutput =
  mtMap.object<SkillsTemplatesItemsListOutput>({
...
export type SkillsTemplatesItemsListQuery = {
...
export let mapSkillsTemplatesItemsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
