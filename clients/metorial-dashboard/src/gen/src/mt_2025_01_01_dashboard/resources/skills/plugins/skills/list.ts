...
export type SkillsPluginsSkillsListOutput = {
  items: {
...
export let mapSkillsPluginsSkillsListOutput =
  mtMap.object<SkillsPluginsSkillsListOutput>({
...
export type SkillsPluginsSkillsListQuery = {
...
export let mapSkillsPluginsSkillsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
