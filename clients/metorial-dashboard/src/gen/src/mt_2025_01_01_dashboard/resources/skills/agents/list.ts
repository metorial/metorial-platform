...
export type SkillsAgentsListOutput = {
  items: {
    object: 'skill.agent';
    id: string;
    skillId: string;
...
export let mapSkillsAgentsListOutput = mtMap.object<SkillsAgentsListOutput>({
...
export type SkillsAgentsListQuery = {
...
export let mapSkillsAgentsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
