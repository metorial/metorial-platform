...
export type SkillsGroupsUpdateOutput = {
  object: 'skill.group';
  id: string;
...
export let mapSkillsGroupsUpdateOutput = mtMap.object<SkillsGroupsUpdateOutput>(
  {
...
export type SkillsGroupsUpdateBody = {
...
export let mapSkillsGroupsUpdateBody = mtMap.object<SkillsGroupsUpdateBody>({
  name: mtMap.objectField('name', mtMap.passthrough()),
  description: mtMap.objectField('description', mtMap.passthrough()),
  metadata: mtMap.objectField('metadata', mtMap.passthrough()),
