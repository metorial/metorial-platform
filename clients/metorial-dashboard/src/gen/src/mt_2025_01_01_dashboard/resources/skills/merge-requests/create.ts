...
export type SkillsMergeRequestsCreateOutput = {
...
export let mapSkillsMergeRequestsCreateOutput =
  mtMap.object<SkillsMergeRequestsCreateOutput>({
...
export type SkillsMergeRequestsCreateBody = {
  sourceSkillId: string;
...
export let mapSkillsMergeRequestsCreateBody =
  mtMap.object<SkillsMergeRequestsCreateBody>({
    sourceSkillId: mtMap.objectField('source_skill_id', mtMap.passthrough()),
    targetSkillId: mtMap.objectField('target_skill_id', mtMap.passthrough()),
    title: mtMap.objectField('title', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough())
