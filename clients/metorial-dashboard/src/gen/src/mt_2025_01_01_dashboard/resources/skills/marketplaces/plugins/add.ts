...
export type SkillsMarketplacesPluginsAddOutput = {
...
export let mapSkillsMarketplacesPluginsAddOutput =
  mtMap.object<SkillsMarketplacesPluginsAddOutput>({
...
export type SkillsMarketplacesPluginsAddBody = {
  skillPluginId: string;
  skillConfigurationId?: string | null | undefined;
  identifier?: string | undefined;
};

export let mapSkillsMarketplacesPluginsAddBody =
  mtMap.object<SkillsMarketplacesPluginsAddBody>({
    skillPluginId: mtMap.objectField('skill_plugin_id', mtMap.passthrough()),
    skillConfigurationId: mtMap.objectField(
      'skill_configuration_id',
      mtMap.passthrough()
