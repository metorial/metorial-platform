...
export type SkillsImportsCreateOutput = {
  object: 'skill.import';
  id: string;
...
export let mapSkillsImportsCreateOutput =
  mtMap.object<SkillsImportsCreateOutput>({
...
export type SkillsImportsCreateBody = {
  source:
...
export let mapSkillsImportsCreateBody = mtMap.object<SkillsImportsCreateBody>({
  source: mtMap.objectField(
    'source',
    mtMap.union([
      mtMap.unionOption(
        ...
        mtMap.object({
          ...
          ref: mtMap.objectField('ref', mtMap.passthrough()),
          repositoryId: mtMap.objectField('repository_id', mtMap.passthrough()),
          path: mtMap.objectField('path', mtMap.passthrough())
        })
      )
    ])
