...
export type SkillsPluginsCreateOutput = {
  object: 'skill.plugin';
  id: string;
...
export let mapSkillsPluginsCreateOutput =
  mtMap.object<SkillsPluginsCreateOutput>({
...
export type SkillsPluginsCreateBody = {
  name: string;
...
export let mapSkillsPluginsCreateBody = mtMap.object<SkillsPluginsCreateBody>({
  name: mtMap.objectField('name', mtMap.passthrough()),
  description: mtMap.objectField('description', mtMap.passthrough()),
  longDescription: mtMap.objectField('long_description', mtMap.passthrough()),
  category: mtMap.objectField('category', mtMap.passthrough()),
