...
export type SkillsTemplatesListOutput = {
  items: {
...
export let mapSkillsTemplatesListOutput =
  mtMap.object<SkillsTemplatesListOutput>({
...
export type SkillsTemplatesListQuery = {
...
export let mapSkillsTemplatesListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
