...
export type SkillsItemsCreateOutput = {
  object: 'skill.item';
  id: string;
...
export let mapSkillsItemsCreateOutput = mtMap.object<SkillsItemsCreateOutput>({
...
export type SkillsItemsCreateBody =
  | { type: 'provider'; providerId: string }
  | { type: 'integration'; integrationId: string };

export let mapSkillsItemsCreateBody = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
      type: mtMap.objectField('type', mtMap.passthrough()),
