...
export type SkillsPluginsListOutput = {
  items: {
    object: 'skill.plugin';
    id: string;
...
export let mapSkillsPluginsListOutput = mtMap.object<SkillsPluginsListOutput>({
...
export type SkillsPluginsListQuery = {
...
export let mapSkillsPluginsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
