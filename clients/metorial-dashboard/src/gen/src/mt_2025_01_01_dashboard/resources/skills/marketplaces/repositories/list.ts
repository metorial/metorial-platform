...
export type SkillsMarketplacesRepositoriesListOutput = {
  items: {
...
export let mapSkillsMarketplacesRepositoriesListOutput =
  mtMap.object<SkillsMarketplacesRepositoriesListOutput>({
...
export type SkillsMarketplacesRepositoriesListQuery = {
...
export let mapSkillsMarketplacesRepositoriesListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
