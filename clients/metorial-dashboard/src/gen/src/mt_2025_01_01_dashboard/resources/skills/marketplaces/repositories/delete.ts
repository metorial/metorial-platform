...
export type SkillsMarketplacesRepositoriesDeleteOutput = {
...
export let mapSkillsMarketplacesRepositoriesDeleteOutput =
  mtMap.object<SkillsMarketplacesRepositoriesDeleteOutput>({
