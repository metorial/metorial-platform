...
export let mapIntegrationSetupSessionsListOutput =
  mtMap.object<IntegrationSetupSessionsListOutput>({
...
export type IntegrationSetupSessionsListQuery = {
...
export let mapIntegrationSetupSessionsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
