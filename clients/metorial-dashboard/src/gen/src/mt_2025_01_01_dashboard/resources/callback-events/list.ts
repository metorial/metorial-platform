...
export type CallbackEventsListOutput = {
  items: {
...
export let mapCallbackEventsListOutput = mtMap.object<CallbackEventsListOutput>(
  {
...
export type CallbackEventsListQuery = {
...
export let mapCallbackEventsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
