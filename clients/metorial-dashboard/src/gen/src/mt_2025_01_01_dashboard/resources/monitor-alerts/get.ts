...
export type MonitorAlertsGetOutput = {
...
export let mapMonitorAlertsGetOutput = mtMap.object<MonitorAlertsGetOutput>({
  ...
  protoGuardRunId: mtMap.objectField('proto_guard_run_id', mtMap.passthrough()),
