...
export type MonitorAlertsListOutput = {
  items: {
...
export let mapMonitorAlertsListOutput = mtMap.object<MonitorAlertsListOutput>({
...
export type MonitorAlertsListQuery = {
...
export let mapMonitorAlertsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
