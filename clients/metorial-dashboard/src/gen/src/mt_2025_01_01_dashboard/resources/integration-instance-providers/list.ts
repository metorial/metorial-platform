...
export let mapIntegrationInstanceProvidersListOutput =
  mtMap.object<IntegrationInstanceProvidersListOutput>({
...
export type IntegrationInstanceProvidersListQuery = {
...
export let mapIntegrationInstanceProvidersListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
