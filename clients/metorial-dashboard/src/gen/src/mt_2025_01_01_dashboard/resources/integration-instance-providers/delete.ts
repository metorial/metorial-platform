...
export type IntegrationInstanceProvidersDeleteOutput = {
...
export let mapIntegrationInstanceProvidersDeleteOutput =
  mtMap.object<IntegrationInstanceProvidersDeleteOutput>({
