...
export type IntegrationInstanceGroupProvidersSetOutput = {
...
export let mapIntegrationInstanceGroupProvidersSetBody =
  mtMap.object<IntegrationInstanceGroupProvidersSetBody>({
