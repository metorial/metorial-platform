...
export let mapIntegrationInstanceGroupProvidersListOutput =
  mtMap.object<IntegrationInstanceGroupProvidersListOutput>({
...
export type IntegrationInstanceGroupProvidersListQuery = {
...
export let mapIntegrationInstanceGroupProvidersListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
