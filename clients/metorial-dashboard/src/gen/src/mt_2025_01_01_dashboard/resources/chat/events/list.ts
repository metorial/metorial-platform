...
export type ChatEventsListOutput = {
  items: {
    object: 'chat.event';
    id: string;
    type: string;
...
export let mapChatEventsListOutput = mtMap.object<ChatEventsListOutput>({
...
export type ChatEventsListQuery = {
...
export let mapChatEventsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
