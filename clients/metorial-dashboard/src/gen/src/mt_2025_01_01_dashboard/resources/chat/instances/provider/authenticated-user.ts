...
export type ChatInstancesProviderAuthenticatedUserOutput = {
...
export let mapChatInstancesProviderAuthenticatedUserOutput =
  mtMap.object<ChatInstancesProviderAuthenticatedUserOutput>({
