...
export type ChatConnectionsListOutput = {
  items: {
...
export let mapChatConnectionsListOutput =
  mtMap.object<ChatConnectionsListOutput>({
...
export type ChatConnectionsListQuery = {
...
export let mapChatConnectionsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
