...
export type ChatWorkspacesListOutput = {
  items: {
...
export let mapChatWorkspacesListOutput = mtMap.object<ChatWorkspacesListOutput>(
  {
...
export type ChatWorkspacesListQuery = {
...
export let mapChatWorkspacesListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
