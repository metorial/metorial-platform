...
export type DocumentsParticipantsListOutput = {
  items: {
...
export let mapDocumentsParticipantsListOutput =
  mtMap.object<DocumentsParticipantsListOutput>({
...
export type DocumentsParticipantsListQuery = {
...
export let mapDocumentsParticipantsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
