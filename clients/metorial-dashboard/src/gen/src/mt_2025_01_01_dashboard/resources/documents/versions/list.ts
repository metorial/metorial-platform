...
export type DocumentsVersionsListOutput = {
  items: {
...
export let mapDocumentsVersionsListOutput =
  mtMap.object<DocumentsVersionsListOutput>({
...
export type DocumentsVersionsListQuery = {
...
export let mapDocumentsVersionsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
