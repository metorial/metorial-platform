...
export type WebhooksDestinationsListOutput = {
  items: {
...
export let mapWebhooksDestinationsListOutput =
  mtMap.object<WebhooksDestinationsListOutput>({
...
export type WebhooksDestinationsListQuery = {
...
export let mapWebhooksDestinationsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
