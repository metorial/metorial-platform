...
export type WebhooksEventsListOutput = {
  items: {
...
export let mapWebhooksEventsListOutput = mtMap.object<WebhooksEventsListOutput>(
  {
...
export type WebhooksEventsListQuery = {
...
export let mapWebhooksEventsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
