...
export type WebhooksDestinationsEventsListOutput = {
  items: {
...
export let mapWebhooksDestinationsEventsListOutput =
  mtMap.object<WebhooksDestinationsEventsListOutput>({
...
export type WebhooksDestinationsEventsListQuery = {
...
export let mapWebhooksDestinationsEventsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
