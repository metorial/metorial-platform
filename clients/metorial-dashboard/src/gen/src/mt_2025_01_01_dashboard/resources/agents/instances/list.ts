...
export type AgentsInstancesListOutput = {
  items: {
...
export let mapAgentsInstancesListOutput =
  mtMap.object<AgentsInstancesListOutput>({
...
export type AgentsInstancesListQuery = {
...
export let mapAgentsInstancesListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
