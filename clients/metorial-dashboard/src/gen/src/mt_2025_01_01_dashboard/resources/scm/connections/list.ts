...
export type ScmConnectionsListOutput = {
  items: {
...
export let mapScmConnectionsListOutput = mtMap.object<ScmConnectionsListOutput>(
  {
...
export type ScmConnectionsListQuery = {
...
export let mapScmConnectionsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
