...
export type ProviderOauthTakeoutsListOutput = {
  items: {
...
export let mapProviderOauthTakeoutsListOutput =
  mtMap.object<ProviderOauthTakeoutsListOutput>({
...
export type ProviderOauthTakeoutsListQuery = {
...
export let mapProviderOauthTakeoutsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
