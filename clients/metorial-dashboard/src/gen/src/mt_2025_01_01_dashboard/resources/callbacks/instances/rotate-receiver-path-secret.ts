...
export type CallbacksInstancesRotateReceiverPathSecretOutput = {
...
export let mapCallbacksInstancesRotateReceiverPathSecretOutput =
  mtMap.object<CallbacksInstancesRotateReceiverPathSecretOutput>({
