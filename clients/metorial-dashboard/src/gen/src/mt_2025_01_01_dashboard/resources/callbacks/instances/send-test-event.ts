...
export type CallbacksInstancesSendTestEventOutput = {
...
export let mapCallbacksInstancesSendTestEventOutput =
  mtMap.object<CallbacksInstancesSendTestEventOutput>({
...
export type CallbacksInstancesSendTestEventBody = {
  eventType: string;
  payload: Record<string, any>;
};

export let mapCallbacksInstancesSendTestEventBody =
  mtMap.object<CallbacksInstancesSendTestEventBody>({
