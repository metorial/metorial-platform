...
export type CallbacksInstancesListOutput = {
  items: {
...
export let mapCallbacksInstancesListOutput =
  mtMap.object<CallbacksInstancesListOutput>({
...
export type CallbacksInstancesListQuery = {
