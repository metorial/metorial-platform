...
export type CallbacksInstancesCreateReceiverPathSecretOutput = {
...
export let mapCallbacksInstancesCreateReceiverPathSecretOutput =
  mtMap.object<CallbacksInstancesCreateReceiverPathSecretOutput>({
