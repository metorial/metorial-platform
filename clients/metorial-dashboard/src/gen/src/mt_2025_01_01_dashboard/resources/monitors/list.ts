...
export type MonitorsListOutput = {
  items: {
    object: 'monitor';
    id: string;
    name: string;
...
export let mapMonitorsListOutput = mtMap.object<MonitorsListOutput>({
...
export let mapMonitorsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
