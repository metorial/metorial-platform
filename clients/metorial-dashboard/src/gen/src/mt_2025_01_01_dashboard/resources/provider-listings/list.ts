...
export type ProviderListingsListOutput = {
  items: ({
...
export let mapProviderListingsListOutput =
  mtMap.object<ProviderListingsListOutput>({
...
export type ProviderListingsListQuery = {
