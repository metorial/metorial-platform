...
export type IntegrationInstanceGroupsCreateSessionTemplateOutput = {
...
export let mapIntegrationInstanceGroupsCreateSessionTemplateOutput =
  mtMap.object<IntegrationInstanceGroupsCreateSessionTemplateOutput>({
...
export type IntegrationInstanceGroupsCreateSessionTemplateBody = {
  name?: string | undefined;
  description?: string | undefined;
  metadata?: Record<string, any> | undefined;
};

export let mapIntegrationInstanceGroupsCreateSessionTemplateBody =
  mtMap.object<IntegrationInstanceGroupsCreateSessionTemplateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    metadata: mtMap.objectField('metadata', mtMap.passthrough())
  });
