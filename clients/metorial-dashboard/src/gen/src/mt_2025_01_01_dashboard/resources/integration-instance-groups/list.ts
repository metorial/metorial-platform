...
export let mapIntegrationInstanceGroupsListOutput =
  mtMap.object<IntegrationInstanceGroupsListOutput>({
...
export type IntegrationInstanceGroupsListQuery = {
...
export let mapIntegrationInstanceGroupsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
