...
export type FirewallBindingsListOutput = {
  items: {
...
export let mapFirewallBindingsListOutput =
  mtMap.object<FirewallBindingsListOutput>({
...
export type FirewallBindingsListQuery = {
...
export let mapFirewallBindingsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
