...
export type ProtoGuardAlertsListOutput = {
  items: {
...
export let mapProtoGuardAlertsListOutput =
  mtMap.object<ProtoGuardAlertsListOutput>({
...
export type ProtoGuardAlertsListQuery = {
...
export let mapProtoGuardAlertsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
