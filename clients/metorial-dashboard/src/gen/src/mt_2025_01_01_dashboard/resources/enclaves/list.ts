...
export type EnclavesListOutput = {
  items: {
    object: 'enclave';
    id: string;
    slug: string;
...
export let mapEnclavesListOutput = mtMap.object<EnclavesListOutput>({
...
export let mapEnclavesListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
