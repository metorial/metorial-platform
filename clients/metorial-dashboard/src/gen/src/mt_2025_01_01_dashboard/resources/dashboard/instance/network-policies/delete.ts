...
export type DashboardInstanceNetworkPoliciesDeleteOutput = {
...
export let mapDashboardInstanceNetworkPoliciesDeleteOutput =
  mtMap.object<DashboardInstanceNetworkPoliciesDeleteOutput>({
