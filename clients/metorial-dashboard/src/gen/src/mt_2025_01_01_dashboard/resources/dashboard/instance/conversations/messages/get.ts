...
export type DashboardInstanceConversationsMessagesGetOutput = {
...
export let mapDashboardInstanceConversationsMessagesGetOutput =
  mtMap.object<DashboardInstanceConversationsMessagesGetOutput>({
