...
export type DashboardInstanceSkillsTemplatesItemsListOutput = {
  items: {
...
export let mapDashboardInstanceSkillsTemplatesItemsListOutput =
  mtMap.object<DashboardInstanceSkillsTemplatesItemsListOutput>({
...
export type DashboardInstanceSkillsTemplatesItemsListQuery = {
...
export let mapDashboardInstanceSkillsTemplatesItemsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
