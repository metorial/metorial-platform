...
export type DashboardProjectsKeyProvidersGetOutput = {
  object: 'key_provider';
  id: string;
  name: string;
  type: 'aws_kms' | 'local';
...
export let mapDashboardProjectsKeyProvidersGetOutput =
  mtMap.object<DashboardProjectsKeyProvidersGetOutput>({
