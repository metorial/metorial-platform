...
export type DashboardInstanceConsumersListOutput = {
  items: ({
    object: 'consumer';
    id: string;
    name: string;
...
export let mapDashboardInstanceConsumersListOutput =
  mtMap.object<DashboardInstanceConsumersListOutput>({
...
export type DashboardInstanceConsumersListQuery = {
