...
export type DashboardInstanceIntegrationsInstancesUpdateOutput = {
...
export let mapDashboardInstanceIntegrationsInstancesUpdateOutput =
  mtMap.object<DashboardInstanceIntegrationsInstancesUpdateOutput>({
...
export type DashboardInstanceIntegrationsInstancesUpdateBody = {
...
export let mapDashboardInstanceIntegrationsInstancesUpdateBody =
  mtMap.object<DashboardInstanceIntegrationsInstancesUpdateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    metadata: mtMap.objectField('metadata', mtMap.passthrough()),
    identityActorId: mtMap.objectField(
