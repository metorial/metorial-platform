...
export type DashboardInstanceMagicMcpServersProviderUpdateOutput = {
...
export let mapDashboardInstanceMagicMcpServersProviderUpdateOutput =
  mtMap.object<DashboardInstanceMagicMcpServersProviderUpdateOutput>({
...
export type DashboardInstanceMagicMcpServersProviderUpdateBody = {
  toolFilters?:
    | (
        | { type: 'tool_keys'; keys: string[] }
        | { type: 'tool_regex'; pattern: string }
...
export let mapDashboardInstanceMagicMcpServersProviderUpdateBody =
  mtMap.object<DashboardInstanceMagicMcpServersProviderUpdateBody>({
