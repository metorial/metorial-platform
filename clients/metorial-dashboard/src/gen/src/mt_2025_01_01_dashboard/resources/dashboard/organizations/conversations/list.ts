...
export type DashboardOrganizationsConversationsListOutput = {
  items: {
...
export let mapDashboardOrganizationsConversationsListOutput =
  mtMap.object<DashboardOrganizationsConversationsListOutput>({
...
export type DashboardOrganizationsConversationsListQuery = {
...
export let mapDashboardOrganizationsConversationsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
