...
export type DashboardInstanceSkillGroupsDeleteOutput = {
  object: 'skill.group';
  id: string;
...
export let mapDashboardInstanceSkillGroupsDeleteOutput =
  mtMap.object<DashboardInstanceSkillGroupsDeleteOutput>({
