...
export type DashboardInstanceSessionErrorsListOutput = {
  items: {
...
export let mapDashboardInstanceSessionErrorsListOutput =
  mtMap.object<DashboardInstanceSessionErrorsListOutput>({
...
export type DashboardInstanceSessionErrorsListQuery = {
