...
export let mapDashboardInstanceIntegrationInstancesListOutput =
  mtMap.object<DashboardInstanceIntegrationInstancesListOutput>({
...
export type DashboardInstanceIntegrationInstancesListQuery = {
...
export let mapDashboardInstanceIntegrationInstancesListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
