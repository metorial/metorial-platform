...
export type DashboardInstanceNetworkPoliciesUpdateOutput = {
...
export let mapDashboardInstanceNetworkPoliciesUpdateOutput =
  mtMap.object<DashboardInstanceNetworkPoliciesUpdateOutput>({
...
export type DashboardInstanceNetworkPoliciesUpdateBody = {
...
export let mapDashboardInstanceNetworkPoliciesUpdateBody =
  mtMap.object<DashboardInstanceNetworkPoliciesUpdateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    rules: mtMap.objectField(
      'rules',
