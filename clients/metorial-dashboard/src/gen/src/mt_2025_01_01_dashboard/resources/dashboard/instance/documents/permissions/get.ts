...
export type DashboardInstanceDocumentsPermissionsGetOutput = {
...
export let mapDashboardInstanceDocumentsPermissionsGetOutput =
  mtMap.object<DashboardInstanceDocumentsPermissionsGetOutput>({
