...
export type DashboardInstanceWebhooksEventsListOutput = {
  items: {
...
export let mapDashboardInstanceWebhooksEventsListOutput =
  mtMap.object<DashboardInstanceWebhooksEventsListOutput>({
...
export type DashboardInstanceWebhooksEventsListQuery = {
...
export let mapDashboardInstanceWebhooksEventsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
