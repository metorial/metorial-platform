...
export type DashboardInstanceProviderRunsListOutput = {
  items: {
...
export let mapDashboardInstanceProviderRunsListOutput =
  mtMap.object<DashboardInstanceProviderRunsListOutput>({
...
export type DashboardInstanceProviderRunsListQuery = {
...
export let mapDashboardInstanceProviderRunsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
