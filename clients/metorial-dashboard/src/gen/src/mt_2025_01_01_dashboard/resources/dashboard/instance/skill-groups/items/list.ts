...
export type DashboardInstanceSkillGroupsItemsListOutput = {
  items: {
...
export let mapDashboardInstanceSkillGroupsItemsListOutput =
  mtMap.object<DashboardInstanceSkillGroupsItemsListOutput>({
...
export type DashboardInstanceSkillGroupsItemsListQuery = {
...
export let mapDashboardInstanceSkillGroupsItemsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
