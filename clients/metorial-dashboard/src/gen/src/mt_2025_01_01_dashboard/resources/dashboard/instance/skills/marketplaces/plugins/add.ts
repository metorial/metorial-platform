...
export type DashboardInstanceSkillsMarketplacesPluginsAddOutput = {
...
export let mapDashboardInstanceSkillsMarketplacesPluginsAddOutput =
  mtMap.object<DashboardInstanceSkillsMarketplacesPluginsAddOutput>({
...
export type DashboardInstanceSkillsMarketplacesPluginsAddBody = {
  skillPluginId: string;
  skillConfigurationId?: string | null | undefined;
  identifier?: string | undefined;
};

export let mapDashboardInstanceSkillsMarketplacesPluginsAddBody =
  mtMap.object<DashboardInstanceSkillsMarketplacesPluginsAddBody>({
    skillPluginId: mtMap.objectField('skill_plugin_id', mtMap.passthrough()),
    skillConfigurationId: mtMap.objectField(
      'skill_configuration_id',
      mtMap.passthrough()
