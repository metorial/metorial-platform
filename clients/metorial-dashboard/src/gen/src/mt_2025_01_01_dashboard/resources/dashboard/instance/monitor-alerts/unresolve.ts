...
export type DashboardInstanceMonitorAlertsUnresolveOutput = {
...
export let mapDashboardInstanceMonitorAlertsUnresolveOutput =
  mtMap.object<DashboardInstanceMonitorAlertsUnresolveOutput>({
