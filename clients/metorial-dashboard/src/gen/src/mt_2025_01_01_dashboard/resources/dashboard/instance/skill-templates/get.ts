...
export type DashboardInstanceSkillTemplatesGetOutput = {
...
export let mapDashboardInstanceSkillTemplatesGetOutput =
  mtMap.object<DashboardInstanceSkillTemplatesGetOutput>({
