...
export type DashboardInstanceIntegrationInstanceProvidersSetOutput = {
...
export let mapDashboardInstanceIntegrationInstanceProvidersSetBody =
  mtMap.object<DashboardInstanceIntegrationInstanceProvidersSetBody>({
