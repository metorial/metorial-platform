...
export type DashboardInstanceChatConnectionsGetOutput = {
...
export let mapDashboardInstanceChatConnectionsGetOutput =
  mtMap.object<DashboardInstanceChatConnectionsGetOutput>({
