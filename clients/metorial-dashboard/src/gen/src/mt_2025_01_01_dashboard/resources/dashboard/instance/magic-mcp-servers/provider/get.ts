...
export type DashboardInstanceMagicMcpServersProviderGetOutput = {
...
export let mapDashboardInstanceMagicMcpServersProviderGetOutput =
  mtMap.object<DashboardInstanceMagicMcpServersProviderGetOutput>({
