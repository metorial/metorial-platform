...
export type DashboardInstanceFirewallsListOutput = {
  items: {
...
export let mapDashboardInstanceFirewallsListOutput =
  mtMap.object<DashboardInstanceFirewallsListOutput>({
...
export type DashboardInstanceFirewallsListQuery = {
...
export let mapDashboardInstanceFirewallsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
