...
export type DashboardInstanceSkillsGroupsDeleteOutput = {
  object: 'skill.group';
  id: string;
...
export let mapDashboardInstanceSkillsGroupsDeleteOutput =
  mtMap.object<DashboardInstanceSkillsGroupsDeleteOutput>({
