...
export type DashboardInstanceIntegrationsInstanceGroupsProvidersGetOutput = {
...
export let mapDashboardInstanceIntegrationsInstanceGroupsProvidersGetOutput =
  mtMap.object<DashboardInstanceIntegrationsInstanceGroupsProvidersGetOutput>({
