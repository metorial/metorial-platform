...
export type DashboardInstanceProviderOauthTokenExportsGetOutput = {
...
export let mapDashboardInstanceProviderOauthTokenExportsGetOutput =
  mtMap.object<DashboardInstanceProviderOauthTokenExportsGetOutput>({
