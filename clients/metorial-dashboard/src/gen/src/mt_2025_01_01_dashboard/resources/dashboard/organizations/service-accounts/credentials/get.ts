...
export type DashboardOrganizationsServiceAccountsCredentialsGetOutput = {
...
export let mapDashboardOrganizationsServiceAccountsCredentialsGetOutput =
  mtMap.object<DashboardOrganizationsServiceAccountsCredentialsGetOutput>({
