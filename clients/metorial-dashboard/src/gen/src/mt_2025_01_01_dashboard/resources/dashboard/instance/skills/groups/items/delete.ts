...
export type DashboardInstanceSkillsGroupsItemsDeleteOutput = {
...
export let mapDashboardInstanceSkillsGroupsItemsDeleteOutput =
  mtMap.object<DashboardInstanceSkillsGroupsItemsDeleteOutput>({
