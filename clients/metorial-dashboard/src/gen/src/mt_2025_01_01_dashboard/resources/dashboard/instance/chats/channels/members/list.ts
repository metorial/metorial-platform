...
export type DashboardInstanceChatsChannelsMembersListOutput = {
  items: {
    object: 'chat.author';
    id: string;
    chatId: string;
...
export let mapDashboardInstanceChatsChannelsMembersListOutput =
  mtMap.object<DashboardInstanceChatsChannelsMembersListOutput>({
...
export type DashboardInstanceChatsChannelsMembersListQuery = {
...
export let mapDashboardInstanceChatsChannelsMembersListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
