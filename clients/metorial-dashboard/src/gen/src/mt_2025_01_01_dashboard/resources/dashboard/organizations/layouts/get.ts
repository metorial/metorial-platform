...
export type DashboardOrganizationsLayoutsGetOutput = {
...
export let mapDashboardOrganizationsLayoutsGetOutput =
  mtMap.object<DashboardOrganizationsLayoutsGetOutput>({
