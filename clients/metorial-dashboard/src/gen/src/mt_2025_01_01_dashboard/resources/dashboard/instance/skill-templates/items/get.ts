...
export type DashboardInstanceSkillTemplatesItemsGetOutput = {
...
export let mapDashboardInstanceSkillTemplatesItemsGetOutput =
  mtMap.object<DashboardInstanceSkillTemplatesItemsGetOutput>({
