...
export type DashboardInstanceCustomProvidersGetOutput = {
...
export let mapDashboardInstanceCustomProvidersGetOutput =
  mtMap.object<DashboardInstanceCustomProvidersGetOutput>({
