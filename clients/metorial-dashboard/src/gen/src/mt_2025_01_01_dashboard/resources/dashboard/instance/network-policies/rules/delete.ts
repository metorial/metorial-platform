...
export type DashboardInstanceNetworkPoliciesRulesDeleteOutput = {
...
export let mapDashboardInstanceNetworkPoliciesRulesDeleteOutput =
  mtMap.object<DashboardInstanceNetworkPoliciesRulesDeleteOutput>({
