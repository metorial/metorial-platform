...
export type DashboardOrganizationsOutpostsCredentialsDeleteOutput = {
...
export let mapDashboardOrganizationsOutpostsCredentialsDeleteOutput =
  mtMap.object<DashboardOrganizationsOutpostsCredentialsDeleteOutput>({
