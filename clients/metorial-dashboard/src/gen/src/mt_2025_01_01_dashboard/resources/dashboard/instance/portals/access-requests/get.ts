...
export type DashboardInstancePortalsAccessRequestsGetOutput = {
...
export let mapDashboardInstancePortalsAccessRequestsGetOutput =
  mtMap.object<DashboardInstancePortalsAccessRequestsGetOutput>({
