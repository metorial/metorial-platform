...
export type DashboardInstanceSkillsMergeRequestsItemsResolveOutput = {
...
export let mapDashboardInstanceSkillsMergeRequestsItemsResolveOutput =
  mtMap.object<DashboardInstanceSkillsMergeRequestsItemsResolveOutput>({
...
export type DashboardInstanceSkillsMergeRequestsItemsResolveBody = {
  resolutionType:
    | 'accept_source'
    | 'keep_target'
    | 'remove'
...
export let mapDashboardInstanceSkillsMergeRequestsItemsResolveBody =
  mtMap.object<DashboardInstanceSkillsMergeRequestsItemsResolveBody>({
    resolutionType: mtMap.objectField('resolution_type', mtMap.passthrough()),
