...
export type DashboardInstancePortalsConsumerInvitesGetOutput = {
...
export let mapDashboardInstancePortalsConsumerInvitesGetOutput =
  mtMap.object<DashboardInstancePortalsConsumerInvitesGetOutput>({
