...
export type DashboardInstanceChatsMessagesReadOutput = {
  object: 'chat.message';
  id: string;
  chatId: string;
  channelId: string;
...
export let mapDashboardInstanceChatsMessagesReadOutput =
  mtMap.object<DashboardInstanceChatsMessagesReadOutput>({
...
export type DashboardInstanceChatsMessagesReadBody = {
  channelId: string;
  threadId?: string | undefined;
};

export let mapDashboardInstanceChatsMessagesReadBody =
  mtMap.object<DashboardInstanceChatsMessagesReadBody>({
    channelId: mtMap.objectField('channel_id', mtMap.passthrough()),
    threadId: mtMap.objectField('thread_id', mtMap.passthrough())
  });
