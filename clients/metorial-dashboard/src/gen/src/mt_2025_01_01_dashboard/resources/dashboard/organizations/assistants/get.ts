...
export type DashboardOrganizationsAssistantsGetOutput = {
  object: 'assistant';
  id: string;
  slug: string;
  name: string;
...
export let mapDashboardOrganizationsAssistantsGetOutput =
  mtMap.object<DashboardOrganizationsAssistantsGetOutput>({
