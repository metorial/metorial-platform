...
export type DashboardInstanceMonitorAlertsResolveOutput = {
...
export let mapDashboardInstanceMonitorAlertsResolveOutput =
  mtMap.object<DashboardInstanceMonitorAlertsResolveOutput>({
