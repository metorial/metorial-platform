...
export type DashboardOrganizationsEventDestinationListenersDeleteOutput = {
...
export let mapDashboardOrganizationsEventDestinationListenersDeleteOutput =
  mtMap.object<DashboardOrganizationsEventDestinationListenersDeleteOutput>({
