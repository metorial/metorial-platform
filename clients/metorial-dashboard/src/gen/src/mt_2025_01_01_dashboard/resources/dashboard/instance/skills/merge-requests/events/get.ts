...
export type DashboardInstanceSkillsMergeRequestsEventsGetOutput = {
...
export let mapDashboardInstanceSkillsMergeRequestsEventsGetOutput =
  mtMap.object<DashboardInstanceSkillsMergeRequestsEventsGetOutput>({
