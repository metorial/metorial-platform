...
export type DashboardInstanceSkillGroupsGetOutput = {
  object: 'skill.group';
  id: string;
...
export let mapDashboardInstanceSkillGroupsGetOutput =
  mtMap.object<DashboardInstanceSkillGroupsGetOutput>({
