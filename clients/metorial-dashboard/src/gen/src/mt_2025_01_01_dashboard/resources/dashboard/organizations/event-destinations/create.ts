...
export type DashboardOrganizationsEventDestinationsCreateOutput = {
...
export let mapDashboardOrganizationsEventDestinationsCreateOutput =
  mtMap.object<DashboardOrganizationsEventDestinationsCreateOutput>({
...
export type DashboardOrganizationsEventDestinationsCreateBody = {
  name: string;
...
export let mapDashboardOrganizationsEventDestinationsCreateBody =
  mtMap.object<DashboardOrganizationsEventDestinationsCreateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    type: mtMap.objectField('type', mtMap.passthrough()),
    webhook: mtMap.objectField(
