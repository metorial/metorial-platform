...
export type DashboardInstanceIntegrationsInstanceGroupsDeleteOutput = {
...
export let mapDashboardInstanceIntegrationsInstanceGroupsDeleteOutput =
  mtMap.object<DashboardInstanceIntegrationsInstanceGroupsDeleteOutput>({
