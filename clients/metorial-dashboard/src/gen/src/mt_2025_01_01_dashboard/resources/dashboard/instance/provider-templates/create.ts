...
export type DashboardInstanceProviderTemplatesCreateOutput = {
...
export let mapDashboardInstanceProviderTemplatesCreateOutput =
  mtMap.object<DashboardInstanceProviderTemplatesCreateOutput>({
...
export type DashboardInstanceProviderTemplatesCreateBody = {
  name: string;
...
export let mapDashboardInstanceProviderTemplatesCreateBody = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
      name: mtMap.objectField('name', mtMap.passthrough()),
