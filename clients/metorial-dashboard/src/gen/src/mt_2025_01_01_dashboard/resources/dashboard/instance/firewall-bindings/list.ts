...
export type DashboardInstanceFirewallBindingsListOutput = {
  items: {
...
export let mapDashboardInstanceFirewallBindingsListOutput =
  mtMap.object<DashboardInstanceFirewallBindingsListOutput>({
...
export type DashboardInstanceFirewallBindingsListQuery = {
...
export let mapDashboardInstanceFirewallBindingsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
