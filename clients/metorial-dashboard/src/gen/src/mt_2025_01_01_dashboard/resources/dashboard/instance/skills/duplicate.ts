...
export type DashboardInstanceSkillsDuplicateOutput = {
  object: 'skill';
  id: string;
...
export let mapDashboardInstanceSkillsDuplicateOutput =
  mtMap.object<DashboardInstanceSkillsDuplicateOutput>({
...
export type DashboardInstanceSkillsDuplicateBody = {
  name: string;
...
export let mapDashboardInstanceSkillsDuplicateBody =
  mtMap.object<DashboardInstanceSkillsDuplicateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    clientName: mtMap.objectField('client_name', mtMap.passthrough()),
    clientDescription: mtMap.objectField(
