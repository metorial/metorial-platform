...
export type DashboardInstanceCustomServersVersionsGetOutput = {
...
export let mapDashboardInstanceCustomServersVersionsGetOutput =
  mtMap.object<DashboardInstanceCustomServersVersionsGetOutput>({
