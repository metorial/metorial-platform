...
export type DashboardInstanceChatInstancesListOutput = {
  items: {
...
export let mapDashboardInstanceChatInstancesListOutput =
  mtMap.object<DashboardInstanceChatInstancesListOutput>({
...
export type DashboardInstanceChatInstancesListQuery = {
...
export let mapDashboardInstanceChatInstancesListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
