...
export type DashboardInstanceSkillsItemsGetOutput = {
  object: 'skill.item';
  id: string;
...
export let mapDashboardInstanceSkillsItemsGetOutput =
  mtMap.object<DashboardInstanceSkillsItemsGetOutput>({
