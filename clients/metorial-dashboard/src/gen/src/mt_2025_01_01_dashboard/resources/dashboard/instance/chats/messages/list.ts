...
export type DashboardInstanceChatsMessagesListOutput = {
  items: {
    object: 'chat.message';
    id: string;
    chatId: string;
...
export let mapDashboardInstanceChatsMessagesListOutput =
  mtMap.object<DashboardInstanceChatsMessagesListOutput>({
...
export type DashboardInstanceChatsMessagesListQuery = {
...
export let mapDashboardInstanceChatsMessagesListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
