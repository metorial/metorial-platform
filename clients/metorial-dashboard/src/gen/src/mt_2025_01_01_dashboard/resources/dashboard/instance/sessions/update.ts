...
export type DashboardInstanceSessionsUpdateOutput = {
  object: 'session';
  id: string;
  name: string | null;
...
export let mapDashboardInstanceSessionsUpdateOutput =
  mtMap.object<DashboardInstanceSessionsUpdateOutput>({
...
export type DashboardInstanceSessionsUpdateBody = {
  name?: string | undefined;
  description?: string | undefined;
  metadata?: Record<string, any> | undefined;
};

export let mapDashboardInstanceSessionsUpdateBody =
  mtMap.object<DashboardInstanceSessionsUpdateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    metadata: mtMap.objectField('metadata', mtMap.passthrough())
  });
