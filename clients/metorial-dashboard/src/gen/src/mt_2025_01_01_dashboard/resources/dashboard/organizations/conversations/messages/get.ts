...
export type DashboardOrganizationsConversationsMessagesGetOutput = {
...
export let mapDashboardOrganizationsConversationsMessagesGetOutput =
  mtMap.object<DashboardOrganizationsConversationsMessagesGetOutput>({
