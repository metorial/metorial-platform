...
export type DashboardInstanceSkillsForkSyncsGetOutput = {
...
export let mapDashboardInstanceSkillsForkSyncsGetOutput =
  mtMap.object<DashboardInstanceSkillsForkSyncsGetOutput>({
