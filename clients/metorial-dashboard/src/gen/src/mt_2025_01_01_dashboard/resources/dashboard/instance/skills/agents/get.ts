...
export type DashboardInstanceSkillsAgentsGetOutput = {
  object: 'skill.agent';
  id: string;
  skillId: string;
  name: string;
...
export let mapDashboardInstanceSkillsAgentsGetOutput =
  mtMap.object<DashboardInstanceSkillsAgentsGetOutput>({
