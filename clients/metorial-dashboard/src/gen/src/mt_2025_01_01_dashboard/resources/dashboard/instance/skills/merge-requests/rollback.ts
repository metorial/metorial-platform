...
export type DashboardInstanceSkillsMergeRequestsRollbackOutput = {
...
export let mapDashboardInstanceSkillsMergeRequestsRollbackOutput =
  mtMap.object<DashboardInstanceSkillsMergeRequestsRollbackOutput>({
