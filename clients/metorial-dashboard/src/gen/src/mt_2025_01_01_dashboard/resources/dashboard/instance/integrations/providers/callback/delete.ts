...
export type DashboardInstanceIntegrationsProvidersCallbackDeleteOutput = {
  object: 'callback';
  id: string;
...
export let mapDashboardInstanceIntegrationsProvidersCallbackDeleteOutput =
  mtMap.object<DashboardInstanceIntegrationsProvidersCallbackDeleteOutput>({
