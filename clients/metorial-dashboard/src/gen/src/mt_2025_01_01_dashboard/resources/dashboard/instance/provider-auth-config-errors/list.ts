...
export type DashboardInstanceProviderAuthConfigErrorsListOutput = {
  items: {
...
export let mapDashboardInstanceProviderAuthConfigErrorsListOutput =
  mtMap.object<DashboardInstanceProviderAuthConfigErrorsListOutput>({
...
export type DashboardInstanceProviderAuthConfigErrorsListQuery = {
...
export let mapDashboardInstanceProviderAuthConfigErrorsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
