...
export type DashboardOrganizationsAuditLogStreamsDeleteOutput = {
...
export let mapDashboardOrganizationsAuditLogStreamsDeleteOutput =
  mtMap.object<DashboardOrganizationsAuditLogStreamsDeleteOutput>({
