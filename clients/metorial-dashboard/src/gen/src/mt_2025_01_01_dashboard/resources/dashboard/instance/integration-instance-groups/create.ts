...
export type DashboardInstanceIntegrationInstanceGroupsCreateOutput = {
...
export let mapDashboardInstanceIntegrationInstanceGroupsCreateBody =
  mtMap.object<DashboardInstanceIntegrationInstanceGroupsCreateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    metadata: mtMap.objectField('metadata', mtMap.passthrough()),
    providers: mtMap.objectField(
