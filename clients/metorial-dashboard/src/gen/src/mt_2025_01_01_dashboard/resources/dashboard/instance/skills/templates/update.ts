...
export type DashboardInstanceSkillsTemplatesUpdateOutput = {
...
export let mapDashboardInstanceSkillsTemplatesUpdateOutput =
  mtMap.object<DashboardInstanceSkillsTemplatesUpdateOutput>({
...
export type DashboardInstanceSkillsTemplatesUpdateBody = {
  name?: string | undefined;
  description?: string | null | undefined;
  metadata?: Record<string, any> | null | undefined;
};

export let mapDashboardInstanceSkillsTemplatesUpdateBody =
  mtMap.object<DashboardInstanceSkillsTemplatesUpdateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    metadata: mtMap.objectField('metadata', mtMap.passthrough())
  });
