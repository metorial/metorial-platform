...
export type DashboardInstanceSkillsParticipantsGetOutput = {
...
export let mapDashboardInstanceSkillsParticipantsGetOutput =
  mtMap.object<DashboardInstanceSkillsParticipantsGetOutput>({
