...
export type DashboardOrganizationsEventDeliveriesGetOutput = {
...
export let mapDashboardOrganizationsEventDeliveriesGetOutput =
  mtMap.object<DashboardOrganizationsEventDeliveriesGetOutput>({
