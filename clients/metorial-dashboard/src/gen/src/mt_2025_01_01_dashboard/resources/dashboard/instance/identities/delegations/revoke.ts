...
export type DashboardInstanceIdentitiesDelegationsRevokeOutput = {
...
export let mapDashboardInstanceIdentitiesDelegationsRevokeOutput =
  mtMap.object<DashboardInstanceIdentitiesDelegationsRevokeOutput>({
