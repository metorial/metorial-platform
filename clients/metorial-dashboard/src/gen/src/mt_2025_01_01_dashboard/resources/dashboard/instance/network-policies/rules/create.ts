...
export type DashboardInstanceNetworkPoliciesRulesCreateOutput = {
...
export let mapDashboardInstanceNetworkPoliciesRulesCreateOutput =
  mtMap.object<DashboardInstanceNetworkPoliciesRulesCreateOutput>({
...
export type DashboardInstanceNetworkPoliciesRulesCreateBody = {
  effect: 'allow' | 'deny';
  direction: 'ingress' | 'egress';
  cidrs: string[];
...
export let mapDashboardInstanceNetworkPoliciesRulesCreateBody =
  mtMap.object<DashboardInstanceNetworkPoliciesRulesCreateBody>({
    effect: mtMap.objectField('effect', mtMap.passthrough()),
    direction: mtMap.objectField('direction', mtMap.passthrough()),
    cidrs: mtMap.objectField('cidrs', mtMap.array(mtMap.passthrough())),
    description: mtMap.objectField('description', mtMap.passthrough()),
