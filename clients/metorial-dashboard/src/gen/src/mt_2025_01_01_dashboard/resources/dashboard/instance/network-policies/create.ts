...
export type DashboardInstanceNetworkPoliciesCreateOutput = {
...
export let mapDashboardInstanceNetworkPoliciesCreateOutput =
  mtMap.object<DashboardInstanceNetworkPoliciesCreateOutput>({
...
export type DashboardInstanceNetworkPoliciesCreateBody = {
  name: string;
...
export let mapDashboardInstanceNetworkPoliciesCreateBody =
  mtMap.object<DashboardInstanceNetworkPoliciesCreateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    rules: mtMap.objectField(
      'rules',
