...
export let mapDashboardInstanceIntegrationInstanceGroupsListOutput =
  mtMap.object<DashboardInstanceIntegrationInstanceGroupsListOutput>({
...
export type DashboardInstanceIntegrationInstanceGroupsListQuery = {
...
export let mapDashboardInstanceIntegrationInstanceGroupsListQuery = mtMap.union(
  [
    mtMap.unionOption(
      'object',
      mtMap.object({
