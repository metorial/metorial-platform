...
export type DashboardInstanceIntegrationsInstancesCreateOutput = {
...
export let mapDashboardInstanceIntegrationsInstancesCreateOutput =
  mtMap.object<DashboardInstanceIntegrationsInstancesCreateOutput>({
...
export type DashboardInstanceIntegrationsInstancesCreateBody = {
  integrationId: string;
  name: string;
...
export let mapDashboardInstanceIntegrationsInstancesCreateBody =
  mtMap.object<DashboardInstanceIntegrationsInstancesCreateBody>({
    integrationId: mtMap.objectField('integration_id', mtMap.passthrough()),
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    metadata: mtMap.objectField('metadata', mtMap.passthrough()),
