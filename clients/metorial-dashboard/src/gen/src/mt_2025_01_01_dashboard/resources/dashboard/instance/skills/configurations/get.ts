...
export type DashboardInstanceSkillsConfigurationsGetOutput = {
...
export let mapDashboardInstanceSkillsConfigurationsGetOutput =
  mtMap.object<DashboardInstanceSkillsConfigurationsGetOutput>({
