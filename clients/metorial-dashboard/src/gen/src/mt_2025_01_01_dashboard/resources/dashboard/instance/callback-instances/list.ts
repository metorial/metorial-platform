...
export type DashboardInstanceCallbackInstancesListOutput = {
  items: {
...
export let mapDashboardInstanceCallbackInstancesListOutput =
  mtMap.object<DashboardInstanceCallbackInstancesListOutput>({
...
export type DashboardInstanceCallbackInstancesListQuery = {
...
export let mapDashboardInstanceCallbackInstancesListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
