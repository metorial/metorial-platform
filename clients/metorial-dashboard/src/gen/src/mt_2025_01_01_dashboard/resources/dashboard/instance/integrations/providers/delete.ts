...
export type DashboardInstanceIntegrationsProvidersDeleteOutput = {
...
export let mapDashboardInstanceIntegrationsProvidersDeleteOutput =
  mtMap.object<DashboardInstanceIntegrationsProvidersDeleteOutput>({
