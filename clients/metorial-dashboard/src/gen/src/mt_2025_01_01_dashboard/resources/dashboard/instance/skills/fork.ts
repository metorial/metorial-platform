...
export type DashboardInstanceSkillsForkOutput = {
  object: 'skill';
  id: string;
...
export let mapDashboardInstanceSkillsForkOutput =
  mtMap.object<DashboardInstanceSkillsForkOutput>({
...
export type DashboardInstanceSkillsForkBody = {
  name: string;
...
export let mapDashboardInstanceSkillsForkBody =
  mtMap.object<DashboardInstanceSkillsForkBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    clientName: mtMap.objectField('client_name', mtMap.passthrough()),
    clientDescription: mtMap.objectField(
