...
export type DashboardInstanceSkillsTemplatesItemsCreateOutput = {
...
export let mapDashboardInstanceSkillsTemplatesItemsCreateOutput =
  mtMap.object<DashboardInstanceSkillsTemplatesItemsCreateOutput>({
...
export type DashboardInstanceSkillsTemplatesItemsCreateBody =
  | { type: 'provider'; providerId: string }
  | { type: 'integration'; integrationId: string };

export let mapDashboardInstanceSkillsTemplatesItemsCreateBody = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
      type: mtMap.objectField('type', mtMap.passthrough()),
