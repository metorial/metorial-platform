...
export type DashboardInstanceSkillTemplatesDeleteOutput = {
...
export let mapDashboardInstanceSkillTemplatesDeleteOutput =
  mtMap.object<DashboardInstanceSkillTemplatesDeleteOutput>({
