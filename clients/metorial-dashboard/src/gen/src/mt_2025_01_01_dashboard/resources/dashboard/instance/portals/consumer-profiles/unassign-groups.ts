...
export let mapDashboardInstancePortalsConsumerProfilesUnassignGroupsOutput =
  mtMap.object<DashboardInstancePortalsConsumerProfilesUnassignGroupsOutput>({
...
export type DashboardInstancePortalsConsumerProfilesUnassignGroupsBody = {
  groupIds: string[];
};

export let mapDashboardInstancePortalsConsumerProfilesUnassignGroupsBody =
  mtMap.object<DashboardInstancePortalsConsumerProfilesUnassignGroupsBody>({
