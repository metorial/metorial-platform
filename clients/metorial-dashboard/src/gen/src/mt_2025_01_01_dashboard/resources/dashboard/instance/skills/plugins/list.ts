...
export type DashboardInstanceSkillsPluginsListOutput = {
  items: {
    object: 'skill.plugin';
    id: string;
...
export let mapDashboardInstanceSkillsPluginsListOutput =
  mtMap.object<DashboardInstanceSkillsPluginsListOutput>({
...
export type DashboardInstanceSkillsPluginsListQuery = {
...
export let mapDashboardInstanceSkillsPluginsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
