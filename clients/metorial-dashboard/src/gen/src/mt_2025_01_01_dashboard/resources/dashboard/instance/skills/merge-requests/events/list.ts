...
export type DashboardInstanceSkillsMergeRequestsEventsListOutput = {
  items: {
...
export let mapDashboardInstanceSkillsMergeRequestsEventsListOutput =
  mtMap.object<DashboardInstanceSkillsMergeRequestsEventsListOutput>({
...
export type DashboardInstanceSkillsMergeRequestsEventsListQuery = {
...
export let mapDashboardInstanceSkillsMergeRequestsEventsListQuery = mtMap.union(
  [
    mtMap.unionOption(
      'object',
      mtMap.object({
