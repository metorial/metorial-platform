...
export type DashboardInstanceChatInstancesProviderGetOutput = {
...
export let mapDashboardInstanceChatInstancesProviderGetOutput =
  mtMap.object<DashboardInstanceChatInstancesProviderGetOutput>({
