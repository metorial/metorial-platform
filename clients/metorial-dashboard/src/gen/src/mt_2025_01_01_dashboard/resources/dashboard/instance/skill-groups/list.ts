...
export type DashboardInstanceSkillGroupsListOutput = {
  items: {
    object: 'skill.group';
    id: string;
...
export let mapDashboardInstanceSkillGroupsListOutput =
  mtMap.object<DashboardInstanceSkillGroupsListOutput>({
...
export type DashboardInstanceSkillGroupsListQuery = {
...
export let mapDashboardInstanceSkillGroupsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
