...
export type DashboardInstanceSkillsPluginsGetOutput = {
  object: 'skill.plugin';
  id: string;
...
export let mapDashboardInstanceSkillsPluginsGetOutput =
  mtMap.object<DashboardInstanceSkillsPluginsGetOutput>({
