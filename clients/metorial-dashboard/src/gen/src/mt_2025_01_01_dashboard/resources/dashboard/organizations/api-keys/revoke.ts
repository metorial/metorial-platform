...
export type DashboardOrganizationsApiKeysRevokeOutput = {
...
export let mapDashboardOrganizationsApiKeysRevokeOutput =
  mtMap.object<DashboardOrganizationsApiKeysRevokeOutput>({
