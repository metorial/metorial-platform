...
export type DashboardInstanceSkillTemplatesItemsListOutput = {
  items: {
...
export let mapDashboardInstanceSkillTemplatesItemsListOutput =
  mtMap.object<DashboardInstanceSkillTemplatesItemsListOutput>({
...
export type DashboardInstanceSkillTemplatesItemsListQuery = {
...
export let mapDashboardInstanceSkillTemplatesItemsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
