...
export type DashboardInstanceSkillsMarketplacesArchiveOutput = {
...
export let mapDashboardInstanceSkillsMarketplacesArchiveOutput =
  mtMap.object<DashboardInstanceSkillsMarketplacesArchiveOutput>({
