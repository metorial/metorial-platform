...
export type DashboardInstanceChatInstancesProviderSetOutput = {
...
export let mapDashboardInstanceChatInstancesProviderSetOutput =
  mtMap.object<DashboardInstanceChatInstancesProviderSetOutput>({
...
export type DashboardInstanceChatInstancesProviderSetBody = {
  providerId: string;
...
export let mapDashboardInstanceChatInstancesProviderSetBody =
  mtMap.object<DashboardInstanceChatInstancesProviderSetBody>({
    providerId: mtMap.objectField('provider_id', mtMap.passthrough()),
