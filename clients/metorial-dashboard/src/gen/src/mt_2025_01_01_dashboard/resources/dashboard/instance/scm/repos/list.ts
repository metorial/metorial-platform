...
export type DashboardInstanceScmReposListOutput = {
  items: {
...
export let mapDashboardInstanceScmReposListOutput =
  mtMap.object<DashboardInstanceScmReposListOutput>({
...
export type DashboardInstanceScmReposListQuery = {
...
export let mapDashboardInstanceScmReposListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
