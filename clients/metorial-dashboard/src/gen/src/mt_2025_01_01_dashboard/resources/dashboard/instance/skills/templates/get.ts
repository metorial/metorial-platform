...
export type DashboardInstanceSkillsTemplatesGetOutput = {
...
export let mapDashboardInstanceSkillsTemplatesGetOutput =
  mtMap.object<DashboardInstanceSkillsTemplatesGetOutput>({
