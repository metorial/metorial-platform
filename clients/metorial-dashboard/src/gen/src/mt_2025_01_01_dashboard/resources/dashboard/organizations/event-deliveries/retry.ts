...
export type DashboardOrganizationsEventDeliveriesRetryOutput = {
...
export let mapDashboardOrganizationsEventDeliveriesRetryOutput =
  mtMap.object<DashboardOrganizationsEventDeliveriesRetryOutput>({
