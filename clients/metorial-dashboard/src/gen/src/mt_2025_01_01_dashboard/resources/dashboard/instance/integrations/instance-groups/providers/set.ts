...
export type DashboardInstanceIntegrationsInstanceGroupsProvidersSetOutput = {
...
export let mapDashboardInstanceIntegrationsInstanceGroupsProvidersSetOutput =
  mtMap.object<DashboardInstanceIntegrationsInstanceGroupsProvidersSetOutput>({
...
export type DashboardInstanceIntegrationsInstanceGroupsProvidersSetBody = {
  toolFilters?:
    | (
        | { type: 'tool_keys'; keys: string[] }
        | { type: 'tool_regex'; pattern: string }
...
export let mapDashboardInstanceIntegrationsInstanceGroupsProvidersSetBody =
  mtMap.object<DashboardInstanceIntegrationsInstanceGroupsProvidersSetBody>({
