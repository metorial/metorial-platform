...
export type DashboardOrganizationsEventDestinationsArchiveOutput = {
...
export let mapDashboardOrganizationsEventDestinationsArchiveOutput =
  mtMap.object<DashboardOrganizationsEventDestinationsArchiveOutput>({
