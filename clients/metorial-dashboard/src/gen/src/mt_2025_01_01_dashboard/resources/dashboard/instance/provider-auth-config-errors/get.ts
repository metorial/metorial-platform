...
export type DashboardInstanceProviderAuthConfigErrorsGetOutput = {
...
export let mapDashboardInstanceProviderAuthConfigErrorsGetOutput =
  mtMap.object<DashboardInstanceProviderAuthConfigErrorsGetOutput>({
