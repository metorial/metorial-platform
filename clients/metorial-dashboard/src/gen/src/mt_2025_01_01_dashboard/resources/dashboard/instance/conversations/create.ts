...
export type DashboardInstanceConversationsCreateOutput = {
...
export let mapDashboardInstanceConversationsCreateOutput =
  mtMap.object<DashboardInstanceConversationsCreateOutput>({
