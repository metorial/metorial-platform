...
export type DashboardInstanceSkillsAgentsDeleteOutput = {
  object: 'skill.agent';
  id: string;
  skillId: string;
  name: string;
...
export let mapDashboardInstanceSkillsAgentsDeleteOutput =
  mtMap.object<DashboardInstanceSkillsAgentsDeleteOutput>({
