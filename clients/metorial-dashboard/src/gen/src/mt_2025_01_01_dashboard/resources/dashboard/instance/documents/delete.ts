...
export type DashboardInstanceDocumentsDeleteOutput = {
  object: 'document';
  id: string;
...
export let mapDashboardInstanceDocumentsDeleteOutput =
  mtMap.object<DashboardInstanceDocumentsDeleteOutput>({
