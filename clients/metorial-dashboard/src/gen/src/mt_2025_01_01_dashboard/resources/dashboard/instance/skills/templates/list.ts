...
export type DashboardInstanceSkillsTemplatesListOutput = {
  items: {
...
export let mapDashboardInstanceSkillsTemplatesListOutput =
  mtMap.object<DashboardInstanceSkillsTemplatesListOutput>({
...
export type DashboardInstanceSkillsTemplatesListQuery = {
...
export let mapDashboardInstanceSkillsTemplatesListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
