...
export type DashboardOrganizationsAuditLogStreamsResumeOutput = {
...
export let mapDashboardOrganizationsAuditLogStreamsResumeOutput =
  mtMap.object<DashboardOrganizationsAuditLogStreamsResumeOutput>({
