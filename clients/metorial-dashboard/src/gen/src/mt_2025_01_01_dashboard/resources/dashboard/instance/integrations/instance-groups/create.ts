...
export type DashboardInstanceIntegrationsInstanceGroupsCreateOutput = {
...
export let mapDashboardInstanceIntegrationsInstanceGroupsCreateOutput =
  mtMap.object<DashboardInstanceIntegrationsInstanceGroupsCreateOutput>({
...
export type DashboardInstanceIntegrationsInstanceGroupsCreateBody = {
  name: string;
...
export let mapDashboardInstanceIntegrationsInstanceGroupsCreateBody =
  mtMap.object<DashboardInstanceIntegrationsInstanceGroupsCreateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    metadata: mtMap.objectField('metadata', mtMap.passthrough()),
    providers: mtMap.objectField(
