...
export type DashboardOrganizationsConversationsMessagesListOutput = {
  items: {
...
export let mapDashboardOrganizationsConversationsMessagesListOutput =
  mtMap.object<DashboardOrganizationsConversationsMessagesListOutput>({
...
export type DashboardOrganizationsConversationsMessagesListQuery = {
...
export let mapDashboardOrganizationsConversationsMessagesListQuery =
  mtMap.union([
    mtMap.unionOption(
      'object',
      mtMap.object({
