...
export type DashboardInstanceIntegrationsProvidersListOutput = {
  items: {
...
export let mapDashboardInstanceIntegrationsProvidersListOutput =
  mtMap.object<DashboardInstanceIntegrationsProvidersListOutput>({
...
export type DashboardInstanceIntegrationsProvidersListQuery = {
...
export let mapDashboardInstanceIntegrationsProvidersListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
