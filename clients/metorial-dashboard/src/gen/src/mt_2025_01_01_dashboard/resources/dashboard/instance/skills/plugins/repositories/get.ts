...
export type DashboardInstanceSkillsPluginsRepositoriesGetOutput = {
...
export let mapDashboardInstanceSkillsPluginsRepositoriesGetOutput =
  mtMap.object<DashboardInstanceSkillsPluginsRepositoriesGetOutput>({
