...
export type DashboardInstanceMonitorAlertsListOutput = {
  items: {
...
export let mapDashboardInstanceMonitorAlertsListOutput =
  mtMap.object<DashboardInstanceMonitorAlertsListOutput>({
...
export type DashboardInstanceMonitorAlertsListQuery = {
...
export let mapDashboardInstanceMonitorAlertsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
