...
export type DashboardInstanceSkillsMarketplacesListOutput = {
  items: ({
...
export let mapDashboardInstanceSkillsMarketplacesListOutput =
  mtMap.object<DashboardInstanceSkillsMarketplacesListOutput>({
...
export type DashboardInstanceSkillsMarketplacesListQuery = {
...
export let mapDashboardInstanceSkillsMarketplacesListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
