...
export type DashboardOrganizationsEventDestinationsPingOutput = {
...
export let mapDashboardOrganizationsEventDestinationsPingOutput =
  mtMap.object<DashboardOrganizationsEventDestinationsPingOutput>({
