...
export type DashboardInstanceChatsMessagesUpdateOutput = {
  object: 'chat.message';
  id: string;
  chatId: string;
  channelId: string;
...
export let mapDashboardInstanceChatsMessagesUpdateOutput =
  mtMap.object<DashboardInstanceChatsMessagesUpdateOutput>({
...
export type DashboardInstanceChatsMessagesUpdateBody = {
  channelId: string;
  parts: (
...
export let mapDashboardInstanceChatsMessagesUpdateBody =
  mtMap.object<DashboardInstanceChatsMessagesUpdateBody>({
    channelId: mtMap.objectField('channel_id', mtMap.passthrough()),
