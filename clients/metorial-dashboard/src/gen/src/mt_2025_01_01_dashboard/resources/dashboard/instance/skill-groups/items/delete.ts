...
export type DashboardInstanceSkillGroupsItemsDeleteOutput = {
...
export let mapDashboardInstanceSkillGroupsItemsDeleteOutput =
  mtMap.object<DashboardInstanceSkillGroupsItemsDeleteOutput>({
