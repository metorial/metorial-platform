...
export type DashboardInstanceChatConnectionsCreateOutput = {
...
export let mapDashboardInstanceChatConnectionsCreateOutput =
  mtMap.object<DashboardInstanceChatConnectionsCreateOutput>({
...
export type DashboardInstanceChatConnectionsCreateBody = {
  name: string;
...
export let mapDashboardInstanceChatConnectionsCreateBody =
  mtMap.object<DashboardInstanceChatConnectionsCreateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    metadata: mtMap.objectField('metadata', mtMap.passthrough()),
