...
export type DashboardInstanceDocumentsUpdateOutput = {
  object: 'document';
  id: string;
...
export let mapDashboardInstanceDocumentsUpdateOutput =
  mtMap.object<DashboardInstanceDocumentsUpdateOutput>({
...
export type DashboardInstanceDocumentsUpdateBody = {
  title?: string | undefined;
  content?: string | undefined;
};

export let mapDashboardInstanceDocumentsUpdateBody =
  mtMap.object<DashboardInstanceDocumentsUpdateBody>({
    title: mtMap.objectField('title', mtMap.passthrough()),
    content: mtMap.objectField('content', mtMap.passthrough())
  });
