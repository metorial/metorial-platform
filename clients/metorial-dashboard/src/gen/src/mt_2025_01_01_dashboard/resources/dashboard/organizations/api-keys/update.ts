...
export type DashboardOrganizationsApiKeysUpdateOutput = {
...
export let mapDashboardOrganizationsApiKeysUpdateOutput =
  mtMap.object<DashboardOrganizationsApiKeysUpdateOutput>({
...
export type DashboardOrganizationsApiKeysUpdateBody = {
...
export let mapDashboardOrganizationsApiKeysUpdateBody =
  mtMap.object<DashboardOrganizationsApiKeysUpdateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    expiresAt: mtMap.objectField('expires_at', mtMap.date()),
