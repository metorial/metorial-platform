...
export let mapDashboardInstanceIntegrationInstanceGroupProvidersListOutput =
  mtMap.object<DashboardInstanceIntegrationInstanceGroupProvidersListOutput>({
...
export type DashboardInstanceIntegrationInstanceGroupProvidersListQuery = {
...
export let mapDashboardInstanceIntegrationInstanceGroupProvidersListQuery =
  mtMap.union([
    mtMap.unionOption(
      'object',
      mtMap.object({
