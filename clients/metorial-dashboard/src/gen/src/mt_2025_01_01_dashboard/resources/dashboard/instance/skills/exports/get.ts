...
export type DashboardInstanceSkillsExportsGetOutput = {
  object: 'skill.export';
  id: string;
...
export let mapDashboardInstanceSkillsExportsGetOutput =
  mtMap.object<DashboardInstanceSkillsExportsGetOutput>({
