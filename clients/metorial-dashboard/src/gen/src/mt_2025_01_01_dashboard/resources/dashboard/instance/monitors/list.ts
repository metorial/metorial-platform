...
export type DashboardInstanceMonitorsListOutput = {
  items: {
    object: 'monitor';
    id: string;
    name: string;
...
export let mapDashboardInstanceMonitorsListOutput =
  mtMap.object<DashboardInstanceMonitorsListOutput>({
...
export type DashboardInstanceMonitorsListQuery = {
...
export let mapDashboardInstanceMonitorsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
