...
export type DashboardInstanceCustomProvidersCommitsGetOutput = {
...
export let mapDashboardInstanceCustomProvidersCommitsGetOutput =
  mtMap.object<DashboardInstanceCustomProvidersCommitsGetOutput>({
