...
export type DashboardInstanceSkillsItemsCreateOutput = {
  object: 'skill.item';
  id: string;
...
export let mapDashboardInstanceSkillsItemsCreateOutput =
  mtMap.object<DashboardInstanceSkillsItemsCreateOutput>({
...
export type DashboardInstanceSkillsItemsCreateBody =
  | { type: 'provider'; providerId: string }
  | { type: 'integration'; integrationId: string };

export let mapDashboardInstanceSkillsItemsCreateBody = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
      type: mtMap.objectField('type', mtMap.passthrough()),
