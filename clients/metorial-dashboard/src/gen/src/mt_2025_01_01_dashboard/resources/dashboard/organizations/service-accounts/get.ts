...
export type DashboardOrganizationsServiceAccountsGetOutput = {
...
export let mapDashboardOrganizationsServiceAccountsGetOutput =
  mtMap.object<DashboardOrganizationsServiceAccountsGetOutput>({
