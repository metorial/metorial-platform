...
export type DashboardInstanceSkillsItemsDeleteOutput = {
  object: 'skill.item';
  id: string;
...
export let mapDashboardInstanceSkillsItemsDeleteOutput =
  mtMap.object<DashboardInstanceSkillsItemsDeleteOutput>({
