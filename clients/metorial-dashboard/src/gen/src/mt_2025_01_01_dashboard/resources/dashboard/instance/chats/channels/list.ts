...
export type DashboardInstanceChatsChannelsListOutput = {
  items: {
    object: 'chat.channel';
    id: string;
    chatId: string;
...
export let mapDashboardInstanceChatsChannelsListOutput =
  mtMap.object<DashboardInstanceChatsChannelsListOutput>({
...
export type DashboardInstanceChatsChannelsListQuery = {
...
export let mapDashboardInstanceChatsChannelsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
