...
export let mapDashboardInstanceIntegrationInstanceProvidersListOutput =
  mtMap.object<DashboardInstanceIntegrationInstanceProvidersListOutput>({
...
export type DashboardInstanceIntegrationInstanceProvidersListQuery = {
...
export let mapDashboardInstanceIntegrationInstanceProvidersListQuery =
  mtMap.union([
    mtMap.unionOption(
      'object',
      mtMap.object({
