...
export let mapDashboardUsageTimelineOutput = mtMap.object<DashboardUsageTimelineOutput>({
...
export let mapDashboardUsageTimelineQuery = mtMap.object<DashboardUsageTimelineQuery>({
