...
export type DashboardInstanceNetworkPoliciesGetOutput = {
...
export let mapDashboardInstanceNetworkPoliciesGetOutput =
  mtMap.object<DashboardInstanceNetworkPoliciesGetOutput>({
