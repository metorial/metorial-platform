...
export type DashboardInstanceSkillTemplatesListOutput = {
  items: {
...
export let mapDashboardInstanceSkillTemplatesListOutput =
  mtMap.object<DashboardInstanceSkillTemplatesListOutput>({
...
export type DashboardInstanceSkillTemplatesListQuery = {
...
export let mapDashboardInstanceSkillTemplatesListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
