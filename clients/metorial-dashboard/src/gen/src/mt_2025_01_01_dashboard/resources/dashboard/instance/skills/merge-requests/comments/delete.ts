...
export type DashboardInstanceSkillsMergeRequestsCommentsDeleteOutput = {
...
export let mapDashboardInstanceSkillsMergeRequestsCommentsDeleteOutput =
  mtMap.object<DashboardInstanceSkillsMergeRequestsCommentsDeleteOutput>({
