...
export type DashboardInstanceSkillsVersionsSnapshotGetOutput = {
...
export let mapDashboardInstanceSkillsVersionsSnapshotGetOutput =
  mtMap.object<DashboardInstanceSkillsVersionsSnapshotGetOutput>({
