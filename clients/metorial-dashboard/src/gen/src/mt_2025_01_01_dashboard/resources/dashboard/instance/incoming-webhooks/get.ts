...
export type DashboardInstanceIncomingWebhooksGetOutput = {
...
export let mapDashboardInstanceIncomingWebhooksGetOutput =
  mtMap.object<DashboardInstanceIncomingWebhooksGetOutput>({
