...
export type DashboardOrganizationsOauthAppsGetOutput = {
...
export let mapDashboardOrganizationsOauthAppsGetOutput =
  mtMap.object<DashboardOrganizationsOauthAppsGetOutput>({
