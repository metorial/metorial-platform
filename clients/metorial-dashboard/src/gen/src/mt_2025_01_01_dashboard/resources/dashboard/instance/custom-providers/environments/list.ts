...
export type DashboardInstanceCustomProvidersEnvironmentsListOutput = {
  items: {
...
export let mapDashboardInstanceCustomProvidersEnvironmentsListOutput =
  mtMap.object<DashboardInstanceCustomProvidersEnvironmentsListOutput>({
...
export type DashboardInstanceCustomProvidersEnvironmentsListQuery = {
