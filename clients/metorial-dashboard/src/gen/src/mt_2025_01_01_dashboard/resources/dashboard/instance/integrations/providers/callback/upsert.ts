...
export type DashboardInstanceIntegrationsProvidersCallbackUpsertOutput = {
  object: 'callback';
  id: string;
...
export let mapDashboardInstanceIntegrationsProvidersCallbackUpsertOutput =
  mtMap.object<DashboardInstanceIntegrationsProvidersCallbackUpsertOutput>({
...
export type DashboardInstanceIntegrationsProvidersCallbackUpsertBody = {
...
export let mapDashboardInstanceIntegrationsProvidersCallbackUpsertBody =
  mtMap.object<DashboardInstanceIntegrationsProvidersCallbackUpsertBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    metadata: mtMap.objectField('metadata', mtMap.passthrough()),
    pollIntervalSecondsOverride: mtMap.objectField(
