...
export type DashboardInstanceMagicMcpServersSessionCreateOutput = {
  object: 'session';
  id: string;
...
export let mapDashboardInstanceMagicMcpServersSessionCreateOutput =
  mtMap.object<DashboardInstanceMagicMcpServersSessionCreateOutput>({
