...
export type DashboardInstanceSkillsMarketplacesRepositoriesDeleteOutput = {
...
export let mapDashboardInstanceSkillsMarketplacesRepositoriesDeleteOutput =
  mtMap.object<DashboardInstanceSkillsMarketplacesRepositoriesDeleteOutput>({
