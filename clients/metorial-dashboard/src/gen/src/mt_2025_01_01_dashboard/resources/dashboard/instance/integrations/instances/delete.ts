...
export type DashboardInstanceIntegrationsInstancesDeleteOutput = {
...
export let mapDashboardInstanceIntegrationsInstancesDeleteOutput =
  mtMap.object<DashboardInstanceIntegrationsInstancesDeleteOutput>({
