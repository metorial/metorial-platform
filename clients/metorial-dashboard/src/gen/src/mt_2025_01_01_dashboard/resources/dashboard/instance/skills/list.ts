...
export type DashboardInstanceSkillsListOutput = {
  items: {
    object: 'skill';
    id: string;
...
export let mapDashboardInstanceSkillsListOutput =
  mtMap.object<DashboardInstanceSkillsListOutput>({
...
export type DashboardInstanceSkillsListQuery = {
...
export let mapDashboardInstanceSkillsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
