...
export type DashboardInstanceIntegrationsInstancesCreateSessionOutput = {
  object: 'session';
  id: string;
...
export let mapDashboardInstanceIntegrationsInstancesCreateSessionOutput =
  mtMap.object<DashboardInstanceIntegrationsInstancesCreateSessionOutput>({
...
export type DashboardInstanceIntegrationsInstancesCreateSessionBody = {
  name?: string | undefined;
  description?: string | undefined;
  metadata?: Record<string, any> | undefined;
};

export let mapDashboardInstanceIntegrationsInstancesCreateSessionBody =
  mtMap.object<DashboardInstanceIntegrationsInstancesCreateSessionBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    metadata: mtMap.objectField('metadata', mtMap.passthrough())
  });
