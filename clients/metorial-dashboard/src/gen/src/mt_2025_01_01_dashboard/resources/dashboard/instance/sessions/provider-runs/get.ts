...
export type DashboardInstanceSessionsProviderRunsGetOutput = {
...
export let mapDashboardInstanceSessionsProviderRunsGetOutput =
  mtMap.object<DashboardInstanceSessionsProviderRunsGetOutput>({
