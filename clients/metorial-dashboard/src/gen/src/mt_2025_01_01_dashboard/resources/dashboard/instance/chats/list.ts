...
export type DashboardInstanceChatsListOutput = {
  items: {
    object: 'chat';
    id: string;
...
export let mapDashboardInstanceChatsListOutput =
  mtMap.object<DashboardInstanceChatsListOutput>({
...
export type DashboardInstanceChatsListQuery = {
...
export let mapDashboardInstanceChatsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
