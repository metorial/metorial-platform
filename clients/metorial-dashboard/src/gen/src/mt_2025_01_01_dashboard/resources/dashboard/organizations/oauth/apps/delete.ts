...
export type DashboardOrganizationsOauthAppsDeleteOutput = {
...
export let mapDashboardOrganizationsOauthAppsDeleteOutput =
  mtMap.object<DashboardOrganizationsOauthAppsDeleteOutput>({
