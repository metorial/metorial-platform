...
export type DashboardInstanceProviderToolsGetOutput = {
...
export let mapDashboardInstanceProviderToolsGetOutput =
  mtMap.object<DashboardInstanceProviderToolsGetOutput>({
