...
export type DashboardInstanceSkillsMarketplacesPluginsRemoveOutput = {
...
export let mapDashboardInstanceSkillsMarketplacesPluginsRemoveOutput =
  mtMap.object<DashboardInstanceSkillsMarketplacesPluginsRemoveOutput>({
