...
export type DashboardInstanceDocumentsVersionsListOutput = {
  items: {
...
export let mapDashboardInstanceDocumentsVersionsListOutput =
  mtMap.object<DashboardInstanceDocumentsVersionsListOutput>({
...
export type DashboardInstanceDocumentsVersionsListQuery = {
...
export let mapDashboardInstanceDocumentsVersionsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
