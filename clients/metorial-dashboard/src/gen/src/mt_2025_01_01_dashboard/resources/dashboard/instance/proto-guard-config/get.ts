...
export type DashboardInstanceProtoGuardConfigGetOutput = {
...
export let mapDashboardInstanceProtoGuardConfigGetOutput =
  mtMap.object<DashboardInstanceProtoGuardConfigGetOutput>({
