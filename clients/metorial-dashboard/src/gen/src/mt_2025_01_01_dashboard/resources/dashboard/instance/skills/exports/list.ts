...
export type DashboardInstanceSkillsExportsListOutput = {
  items: {
    object: 'skill.export';
    id: string;
...
export let mapDashboardInstanceSkillsExportsListOutput =
  mtMap.object<DashboardInstanceSkillsExportsListOutput>({
...
export type DashboardInstanceSkillsExportsListQuery = {
...
export let mapDashboardInstanceSkillsExportsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
