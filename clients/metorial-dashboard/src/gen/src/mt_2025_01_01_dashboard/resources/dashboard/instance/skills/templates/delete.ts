...
export type DashboardInstanceSkillsTemplatesDeleteOutput = {
...
export let mapDashboardInstanceSkillsTemplatesDeleteOutput =
  mtMap.object<DashboardInstanceSkillsTemplatesDeleteOutput>({
