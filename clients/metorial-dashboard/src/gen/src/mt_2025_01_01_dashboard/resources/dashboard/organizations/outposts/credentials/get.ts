...
export type DashboardOrganizationsOutpostsCredentialsGetOutput = {
...
export let mapDashboardOrganizationsOutpostsCredentialsGetOutput =
  mtMap.object<DashboardOrganizationsOutpostsCredentialsGetOutput>({
