...
export type DashboardInstanceSkillsMergeRequestsCreateOutput = {
...
export let mapDashboardInstanceSkillsMergeRequestsCreateOutput =
  mtMap.object<DashboardInstanceSkillsMergeRequestsCreateOutput>({
...
export type DashboardInstanceSkillsMergeRequestsCreateBody = {
  sourceSkillId: string;
...
export let mapDashboardInstanceSkillsMergeRequestsCreateBody =
  mtMap.object<DashboardInstanceSkillsMergeRequestsCreateBody>({
    sourceSkillId: mtMap.objectField('source_skill_id', mtMap.passthrough()),
    targetSkillId: mtMap.objectField('target_skill_id', mtMap.passthrough()),
    title: mtMap.objectField('title', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough())
