...
export type DashboardInstanceNetworksListOutput = {
  items: {
    object: 'network';
    id: string;
    name: string;
...
export let mapDashboardInstanceNetworksListOutput =
  mtMap.object<DashboardInstanceNetworksListOutput>({
...
export type DashboardInstanceNetworksListQuery = {
...
export let mapDashboardInstanceNetworksListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
