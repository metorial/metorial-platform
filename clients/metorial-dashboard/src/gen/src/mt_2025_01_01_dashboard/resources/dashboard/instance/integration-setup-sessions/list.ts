...
export let mapDashboardInstanceIntegrationSetupSessionsListOutput =
  mtMap.object<DashboardInstanceIntegrationSetupSessionsListOutput>({
...
export type DashboardInstanceIntegrationSetupSessionsListQuery = {
...
export let mapDashboardInstanceIntegrationSetupSessionsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
