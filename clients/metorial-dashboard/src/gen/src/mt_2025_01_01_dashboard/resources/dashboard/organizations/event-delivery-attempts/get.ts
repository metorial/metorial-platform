...
export type DashboardOrganizationsEventDeliveryAttemptsGetOutput = {
...
export let mapDashboardOrganizationsEventDeliveryAttemptsGetOutput =
  mtMap.object<DashboardOrganizationsEventDeliveryAttemptsGetOutput>({
