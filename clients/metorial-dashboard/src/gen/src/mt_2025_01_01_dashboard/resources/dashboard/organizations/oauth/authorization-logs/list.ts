...
export type DashboardOrganizationsOauthAuthorizationLogsListOutput = {
  items: {
...
export let mapDashboardOrganizationsOauthAuthorizationLogsListOutput =
  mtMap.object<DashboardOrganizationsOauthAuthorizationLogsListOutput>({
...
export type DashboardOrganizationsOauthAuthorizationLogsListQuery = {
