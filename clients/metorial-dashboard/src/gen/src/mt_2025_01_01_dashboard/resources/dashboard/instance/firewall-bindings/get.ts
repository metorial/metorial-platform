...
export type DashboardInstanceFirewallBindingsGetOutput = {
...
export let mapDashboardInstanceFirewallBindingsGetOutput =
  mtMap.object<DashboardInstanceFirewallBindingsGetOutput>({
