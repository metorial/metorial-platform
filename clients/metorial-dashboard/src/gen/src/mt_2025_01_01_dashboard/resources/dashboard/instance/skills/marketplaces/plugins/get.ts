...
export type DashboardInstanceSkillsMarketplacesPluginsGetOutput = {
...
export let mapDashboardInstanceSkillsMarketplacesPluginsGetOutput =
  mtMap.object<DashboardInstanceSkillsMarketplacesPluginsGetOutput>({
