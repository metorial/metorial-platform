...
export type DashboardInstanceChatsMessagesDeleteOutput = {
  object: 'chat.message';
  id: string;
  chatId: string;
  channelId: string;
...
export let mapDashboardInstanceChatsMessagesDeleteOutput =
  mtMap.object<DashboardInstanceChatsMessagesDeleteOutput>({
...
export type DashboardInstanceChatsMessagesDeleteQuery = { channelId: string };

export let mapDashboardInstanceChatsMessagesDeleteQuery =
  mtMap.object<DashboardInstanceChatsMessagesDeleteQuery>({
    channelId: mtMap.objectField('channel_id', mtMap.passthrough())
  });
