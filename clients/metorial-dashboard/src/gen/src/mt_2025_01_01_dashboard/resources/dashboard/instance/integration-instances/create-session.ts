...
export type DashboardInstanceIntegrationInstancesCreateSessionOutput = {
  object: 'session';
  id: string;
...
export let mapDashboardInstanceIntegrationInstancesCreateSessionOutput =
  mtMap.object<DashboardInstanceIntegrationInstancesCreateSessionOutput>({
...
export type DashboardInstanceIntegrationInstancesCreateSessionBody = {
  name?: string | undefined;
  description?: string | undefined;
  metadata?: Record<string, any> | undefined;
};

export let mapDashboardInstanceIntegrationInstancesCreateSessionBody =
  mtMap.object<DashboardInstanceIntegrationInstancesCreateSessionBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    metadata: mtMap.objectField('metadata', mtMap.passthrough())
  });
