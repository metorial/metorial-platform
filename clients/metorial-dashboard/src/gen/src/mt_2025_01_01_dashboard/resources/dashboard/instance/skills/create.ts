...
export type DashboardInstanceSkillsCreateOutput = {
  object: 'skill';
  id: string;
...
export let mapDashboardInstanceSkillsCreateOutput =
  mtMap.object<DashboardInstanceSkillsCreateOutput>({
...
export type DashboardInstanceSkillsCreateBody = {
  name: string;
...
export let mapDashboardInstanceSkillsCreateBody =
  mtMap.object<DashboardInstanceSkillsCreateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    metadata: mtMap.objectField('metadata', mtMap.passthrough()),
    clientName: mtMap.objectField('client_name', mtMap.passthrough()),
