...
export type DashboardInstanceSkillTemplatesUpdateOutput = {
...
export let mapDashboardInstanceSkillTemplatesUpdateOutput =
  mtMap.object<DashboardInstanceSkillTemplatesUpdateOutput>({
...
export type DashboardInstanceSkillTemplatesUpdateBody = {
  name?: string | undefined;
  description?: string | null | undefined;
  metadata?: Record<string, any> | null | undefined;
};

export let mapDashboardInstanceSkillTemplatesUpdateBody =
  mtMap.object<DashboardInstanceSkillTemplatesUpdateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    metadata: mtMap.objectField('metadata', mtMap.passthrough())
  });
