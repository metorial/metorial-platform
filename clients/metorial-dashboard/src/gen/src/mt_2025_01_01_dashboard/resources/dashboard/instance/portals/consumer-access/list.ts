...
export type DashboardInstancePortalsConsumerAccessListOutput = {
  items: {
...
export let mapDashboardInstancePortalsConsumerAccessListOutput =
  mtMap.object<DashboardInstancePortalsConsumerAccessListOutput>({
...
export type DashboardInstancePortalsConsumerAccessListQuery = {
  ...
  serverDeploymentTemplateId?: string | string[] | undefined;
  type?:
    | 'magic_mcp_group'
    | 'server_deployment_template'
    | ('magic_mcp_group' | 'server_deployment_template')[]
    | undefined;
};

export let mapDashboardInstancePortalsConsumerAccessListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
