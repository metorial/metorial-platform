...
export type DashboardInstanceIntegrationSetupSessionsCreateOutput = {
...
export let mapDashboardInstanceIntegrationSetupSessionsCreateBody =
  mtMap.object<DashboardInstanceIntegrationSetupSessionsCreateBody>({
    integrationId: mtMap.objectField('integration_id', mtMap.passthrough()),
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    metadata: mtMap.objectField('metadata', mtMap.passthrough()),
