...
export type DashboardInstanceSkillsForkSyncsCreateOutput = {
...
export let mapDashboardInstanceSkillsForkSyncsCreateOutput =
  mtMap.object<DashboardInstanceSkillsForkSyncsCreateOutput>({
...
export type DashboardInstanceSkillsForkSyncsCreateBody = { skillId: string };

export let mapDashboardInstanceSkillsForkSyncsCreateBody =
  mtMap.object<DashboardInstanceSkillsForkSyncsCreateBody>({
