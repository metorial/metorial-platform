...
export type DashboardInstanceProvidersTriggersGetOutput = {
...
export let mapDashboardInstanceProvidersTriggersGetOutput =
  mtMap.object<DashboardInstanceProvidersTriggersGetOutput>({
