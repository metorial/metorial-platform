...
export type DashboardInstanceIntegrationsInstanceGroupsUpdateOutput = {
...
export let mapDashboardInstanceIntegrationsInstanceGroupsUpdateOutput =
  mtMap.object<DashboardInstanceIntegrationsInstanceGroupsUpdateOutput>({
...
export type DashboardInstanceIntegrationsInstanceGroupsUpdateBody = {
...
export let mapDashboardInstanceIntegrationsInstanceGroupsUpdateBody =
  mtMap.object<DashboardInstanceIntegrationsInstanceGroupsUpdateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    metadata: mtMap.objectField('metadata', mtMap.passthrough()),
    providers: mtMap.objectField(
