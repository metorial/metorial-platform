...
export type DashboardInstanceIntegrationInstanceGroupsUpdateOutput = {
...
export let mapDashboardInstanceIntegrationInstanceGroupsUpdateBody =
  mtMap.object<DashboardInstanceIntegrationInstanceGroupsUpdateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    metadata: mtMap.objectField('metadata', mtMap.passthrough()),
    providers: mtMap.objectField(
