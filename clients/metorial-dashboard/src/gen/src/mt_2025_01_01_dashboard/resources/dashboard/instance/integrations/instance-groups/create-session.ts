...
export type DashboardInstanceIntegrationsInstanceGroupsCreateSessionOutput = {
  object: 'session';
  id: string;
...
export let mapDashboardInstanceIntegrationsInstanceGroupsCreateSessionOutput =
  mtMap.object<DashboardInstanceIntegrationsInstanceGroupsCreateSessionOutput>({
...
export type DashboardInstanceIntegrationsInstanceGroupsCreateSessionBody = {
  name?: string | undefined;
  description?: string | undefined;
  metadata?: Record<string, any> | undefined;
};

export let mapDashboardInstanceIntegrationsInstanceGroupsCreateSessionBody =
  mtMap.object<DashboardInstanceIntegrationsInstanceGroupsCreateSessionBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    metadata: mtMap.objectField('metadata', mtMap.passthrough())
  });
