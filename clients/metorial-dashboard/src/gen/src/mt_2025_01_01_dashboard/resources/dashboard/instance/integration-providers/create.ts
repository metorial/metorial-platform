...
export type DashboardInstanceIntegrationProvidersCreateOutput = {
...
export let mapDashboardInstanceIntegrationProvidersCreateBody =
  mtMap.object<DashboardInstanceIntegrationProvidersCreateBody>({
    integrationId: mtMap.objectField('integration_id', mtMap.passthrough()),
    providerId: mtMap.objectField('provider_id', mtMap.passthrough()),
