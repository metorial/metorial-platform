...
export type DashboardInstanceCallbacksInstancesSendTestEventOutput = {
...
export let mapDashboardInstanceCallbacksInstancesSendTestEventOutput =
  mtMap.object<DashboardInstanceCallbacksInstancesSendTestEventOutput>({
...
export let mapDashboardInstanceCallbacksInstancesSendTestEventBody =
  mtMap.object<DashboardInstanceCallbacksInstancesSendTestEventBody>({
