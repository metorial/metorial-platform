...
export type DashboardInstanceSkillsMarketplacesGetOutput = {
...
export let mapDashboardInstanceSkillsMarketplacesGetOutput =
  mtMap.object<DashboardInstanceSkillsMarketplacesGetOutput>({
