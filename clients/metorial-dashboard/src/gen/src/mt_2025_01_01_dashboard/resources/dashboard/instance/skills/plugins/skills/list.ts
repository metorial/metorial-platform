...
export type DashboardInstanceSkillsPluginsSkillsListOutput = {
  items: {
...
export let mapDashboardInstanceSkillsPluginsSkillsListOutput =
  mtMap.object<DashboardInstanceSkillsPluginsSkillsListOutput>({
...
export type DashboardInstanceSkillsPluginsSkillsListQuery = {
...
export let mapDashboardInstanceSkillsPluginsSkillsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
