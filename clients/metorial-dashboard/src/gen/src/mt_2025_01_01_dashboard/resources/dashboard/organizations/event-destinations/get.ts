...
export type DashboardOrganizationsEventDestinationsGetOutput = {
...
export let mapDashboardOrganizationsEventDestinationsGetOutput =
  mtMap.object<DashboardOrganizationsEventDestinationsGetOutput>({
