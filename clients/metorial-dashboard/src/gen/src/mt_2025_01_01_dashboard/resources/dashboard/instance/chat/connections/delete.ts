...
export type DashboardInstanceChatConnectionsDeleteOutput = {
...
export let mapDashboardInstanceChatConnectionsDeleteOutput =
  mtMap.object<DashboardInstanceChatConnectionsDeleteOutput>({
