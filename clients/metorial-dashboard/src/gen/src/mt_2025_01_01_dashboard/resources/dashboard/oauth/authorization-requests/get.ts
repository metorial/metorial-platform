...
export type DashboardOauthAuthorizationRequestsGetOutput = {
...
export let mapDashboardOauthAuthorizationRequestsGetOutput =
  mtMap.object<DashboardOauthAuthorizationRequestsGetOutput>({
