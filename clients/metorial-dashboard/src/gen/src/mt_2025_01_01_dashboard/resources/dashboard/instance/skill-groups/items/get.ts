...
export type DashboardInstanceSkillGroupsItemsGetOutput = {
...
export let mapDashboardInstanceSkillGroupsItemsGetOutput =
  mtMap.object<DashboardInstanceSkillGroupsItemsGetOutput>({
