...
export type DashboardInstanceSkillsTemplatesItemsDeleteOutput = {
...
export let mapDashboardInstanceSkillsTemplatesItemsDeleteOutput =
  mtMap.object<DashboardInstanceSkillsTemplatesItemsDeleteOutput>({
