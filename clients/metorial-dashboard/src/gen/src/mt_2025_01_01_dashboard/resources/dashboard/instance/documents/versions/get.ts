...
export type DashboardInstanceDocumentsVersionsGetOutput = {
...
export let mapDashboardInstanceDocumentsVersionsGetOutput =
  mtMap.object<DashboardInstanceDocumentsVersionsGetOutput>({
