...
export type DashboardInstanceStoresItemsListOutput = {
  items: {
    object: 'store.item';
    id: string;
...
export let mapDashboardInstanceStoresItemsListOutput =
  mtMap.object<DashboardInstanceStoresItemsListOutput>({
...
export type DashboardInstanceStoresItemsListQuery = {
...
export let mapDashboardInstanceStoresItemsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
