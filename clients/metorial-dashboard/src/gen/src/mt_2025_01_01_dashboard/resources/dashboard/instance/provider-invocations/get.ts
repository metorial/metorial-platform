...
export type DashboardInstanceProviderInvocationsGetOutput = {
...
export let mapDashboardInstanceProviderInvocationsGetOutput =
  mtMap.object<DashboardInstanceProviderInvocationsGetOutput>({
