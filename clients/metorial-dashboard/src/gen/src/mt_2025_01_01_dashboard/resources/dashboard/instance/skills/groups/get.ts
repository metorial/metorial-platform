...
export type DashboardInstanceSkillsGroupsGetOutput = {
  object: 'skill.group';
  id: string;
...
export let mapDashboardInstanceSkillsGroupsGetOutput =
  mtMap.object<DashboardInstanceSkillsGroupsGetOutput>({
