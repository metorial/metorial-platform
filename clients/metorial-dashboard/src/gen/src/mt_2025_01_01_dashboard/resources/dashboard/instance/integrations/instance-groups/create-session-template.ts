...
export type DashboardInstanceIntegrationsInstanceGroupsCreateSessionTemplateOutput =
  {
...
export let mapDashboardInstanceIntegrationsInstanceGroupsCreateSessionTemplateOutput =
  mtMap.object<DashboardInstanceIntegrationsInstanceGroupsCreateSessionTemplateOutput>(
    {
...
export type DashboardInstanceIntegrationsInstanceGroupsCreateSessionTemplateBody =
  {
...
export let mapDashboardInstanceIntegrationsInstanceGroupsCreateSessionTemplateBody =
  mtMap.object<DashboardInstanceIntegrationsInstanceGroupsCreateSessionTemplateBody>(
    {
      name: mtMap.objectField('name', mtMap.passthrough()),
      description: mtMap.objectField('description', mtMap.passthrough()),
      metadata: mtMap.objectField('metadata', mtMap.passthrough())
