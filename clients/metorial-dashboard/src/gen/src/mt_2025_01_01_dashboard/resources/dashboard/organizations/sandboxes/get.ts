...
export type DashboardOrganizationsSandboxesGetOutput = {
...
export let mapDashboardOrganizationsSandboxesGetOutput =
  mtMap.object<DashboardOrganizationsSandboxesGetOutput>({
