...
export type DashboardInstanceSkillGroupsItemsCreateOutput = {
...
export let mapDashboardInstanceSkillGroupsItemsCreateOutput =
  mtMap.object<DashboardInstanceSkillGroupsItemsCreateOutput>({
