...
export type DashboardInstanceSkillsPluginsSkillsGetOutput = {
...
export let mapDashboardInstanceSkillsPluginsSkillsGetOutput =
  mtMap.object<DashboardInstanceSkillsPluginsSkillsGetOutput>({
