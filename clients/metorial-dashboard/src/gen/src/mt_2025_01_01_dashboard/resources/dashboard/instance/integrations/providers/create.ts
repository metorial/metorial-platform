...
export type DashboardInstanceIntegrationsProvidersCreateOutput = {
...
export let mapDashboardInstanceIntegrationsProvidersCreateOutput =
  mtMap.object<DashboardInstanceIntegrationsProvidersCreateOutput>({
...
export type DashboardInstanceIntegrationsProvidersCreateBody = {
  integrationId: string;
  providerId: string;
...
export let mapDashboardInstanceIntegrationsProvidersCreateBody =
  mtMap.object<DashboardInstanceIntegrationsProvidersCreateBody>({
    integrationId: mtMap.objectField('integration_id', mtMap.passthrough()),
    providerId: mtMap.objectField('provider_id', mtMap.passthrough()),
