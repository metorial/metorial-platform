...
export type DashboardInstanceMonitorAlertsViewedOutput = {
...
export let mapDashboardInstanceMonitorAlertsViewedOutput =
  mtMap.object<DashboardInstanceMonitorAlertsViewedOutput>({
