...
export type DashboardInstanceSkillsPluginsSkillsRemoveOutput = {
...
export let mapDashboardInstanceSkillsPluginsSkillsRemoveOutput =
  mtMap.object<DashboardInstanceSkillsPluginsSkillsRemoveOutput>({
