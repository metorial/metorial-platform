...
export type DashboardInstanceWebhookRegistrationsDeleteOutput = {
...
export let mapDashboardInstanceWebhookRegistrationsDeleteOutput =
  mtMap.object<DashboardInstanceWebhookRegistrationsDeleteOutput>({
