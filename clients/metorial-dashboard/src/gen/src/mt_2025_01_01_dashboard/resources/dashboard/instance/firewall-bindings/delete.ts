...
export type DashboardInstanceFirewallBindingsDeleteOutput = {
...
export let mapDashboardInstanceFirewallBindingsDeleteOutput =
  mtMap.object<DashboardInstanceFirewallBindingsDeleteOutput>({
