...
export type DashboardInstanceIdentitiesDelegationRequestsGetOutput = {
...
export let mapDashboardInstanceIdentitiesDelegationRequestsGetOutput =
  mtMap.object<DashboardInstanceIdentitiesDelegationRequestsGetOutput>({
...
export type DashboardInstanceIdentitiesDelegationRequestsGetQuery = {
  allowDeleted?: boolean | undefined;
};

export let mapDashboardInstanceIdentitiesDelegationRequestsGetQuery =
  mtMap.object<DashboardInstanceIdentitiesDelegationRequestsGetQuery>({
