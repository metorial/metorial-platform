...
export type DashboardInstanceSkillsTemplatesCreateOutput = {
...
export let mapDashboardInstanceSkillsTemplatesCreateOutput =
  mtMap.object<DashboardInstanceSkillsTemplatesCreateOutput>({
...
export type DashboardInstanceSkillsTemplatesCreateBody = {
  name: string;
...
export let mapDashboardInstanceSkillsTemplatesCreateBody =
  mtMap.object<DashboardInstanceSkillsTemplatesCreateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    metadata: mtMap.objectField('metadata', mtMap.passthrough()),
