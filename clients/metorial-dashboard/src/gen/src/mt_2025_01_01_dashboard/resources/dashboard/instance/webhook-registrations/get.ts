...
export type DashboardInstanceWebhookRegistrationsGetOutput = {
...
export let mapDashboardInstanceWebhookRegistrationsGetOutput =
  mtMap.object<DashboardInstanceWebhookRegistrationsGetOutput>({
