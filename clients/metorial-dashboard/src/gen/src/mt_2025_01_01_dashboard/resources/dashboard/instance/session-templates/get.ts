...
export type DashboardInstanceSessionTemplatesGetOutput = {
...
export let mapDashboardInstanceSessionTemplatesGetOutput =
  mtMap.object<DashboardInstanceSessionTemplatesGetOutput>({
