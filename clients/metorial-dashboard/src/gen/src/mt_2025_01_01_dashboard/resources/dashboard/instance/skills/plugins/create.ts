...
export type DashboardInstanceSkillsPluginsCreateOutput = {
  object: 'skill.plugin';
  id: string;
...
export let mapDashboardInstanceSkillsPluginsCreateOutput =
  mtMap.object<DashboardInstanceSkillsPluginsCreateOutput>({
...
export type DashboardInstanceSkillsPluginsCreateBody = {
  name: string;
...
export let mapDashboardInstanceSkillsPluginsCreateBody =
  mtMap.object<DashboardInstanceSkillsPluginsCreateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    longDescription: mtMap.objectField('long_description', mtMap.passthrough()),
    category: mtMap.objectField('category', mtMap.passthrough()),
