...
export type DashboardInstanceChatInstancesProviderAuthenticatedUserOutput = {
...
export let mapDashboardInstanceChatInstancesProviderAuthenticatedUserOutput =
  mtMap.object<DashboardInstanceChatInstancesProviderAuthenticatedUserOutput>({
