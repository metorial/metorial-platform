...
export type DashboardInstanceSkillsPluginsArchiveOutput = {
  object: 'skill.plugin';
  id: string;
...
export let mapDashboardInstanceSkillsPluginsArchiveOutput =
  mtMap.object<DashboardInstanceSkillsPluginsArchiveOutput>({
