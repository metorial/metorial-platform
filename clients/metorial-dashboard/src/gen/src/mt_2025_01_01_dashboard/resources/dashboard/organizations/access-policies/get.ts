...
export type DashboardOrganizationsAccessPoliciesGetOutput = {
...
export let mapDashboardOrganizationsAccessPoliciesGetOutput =
  mtMap.object<DashboardOrganizationsAccessPoliciesGetOutput>({
