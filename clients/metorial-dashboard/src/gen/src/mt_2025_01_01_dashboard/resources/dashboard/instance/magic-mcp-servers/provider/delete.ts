...
export type DashboardInstanceMagicMcpServersProviderDeleteOutput = {
...
export let mapDashboardInstanceMagicMcpServersProviderDeleteOutput =
  mtMap.object<DashboardInstanceMagicMcpServersProviderDeleteOutput>({
