...
export type DashboardInstanceIntegrationsSetupSessionsGetOutput = {
...
export let mapDashboardInstanceIntegrationsSetupSessionsGetOutput =
  mtMap.object<DashboardInstanceIntegrationsSetupSessionsGetOutput>({
