...
export type DashboardInstanceWebhooksDestinationsEventsListOutput = {
  items: {
...
export let mapDashboardInstanceWebhooksDestinationsEventsListOutput =
  mtMap.object<DashboardInstanceWebhooksDestinationsEventsListOutput>({
...
export type DashboardInstanceWebhooksDestinationsEventsListQuery = {
...
export let mapDashboardInstanceWebhooksDestinationsEventsListQuery =
  mtMap.union([
    mtMap.unionOption(
      'object',
      mtMap.object({
