...
export let mapDashboardInstanceIntegrationProvidersListOutput =
  mtMap.object<DashboardInstanceIntegrationProvidersListOutput>({
...
export type DashboardInstanceIntegrationProvidersListQuery = {
...
export let mapDashboardInstanceIntegrationProvidersListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
