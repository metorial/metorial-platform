...
export type DashboardInstanceSkillsUpdateOutput = {
  object: 'skill';
  id: string;
...
export let mapDashboardInstanceSkillsUpdateOutput =
  mtMap.object<DashboardInstanceSkillsUpdateOutput>({
...
export type DashboardInstanceSkillsUpdateBody = {
...
export let mapDashboardInstanceSkillsUpdateBody =
  mtMap.object<DashboardInstanceSkillsUpdateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    clientName: mtMap.objectField('client_name', mtMap.passthrough()),
    clientDescription: mtMap.objectField(
