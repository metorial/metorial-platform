...
export type DashboardInstanceSkillsPluginsRepositoriesDeleteOutput = {
...
export let mapDashboardInstanceSkillsPluginsRepositoriesDeleteOutput =
  mtMap.object<DashboardInstanceSkillsPluginsRepositoriesDeleteOutput>({
