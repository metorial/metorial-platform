...
export type DashboardInstanceSkillsItemsListOutput = {
  items: {
    object: 'skill.item';
    id: string;
...
export let mapDashboardInstanceSkillsItemsListOutput =
  mtMap.object<DashboardInstanceSkillsItemsListOutput>({
...
export type DashboardInstanceSkillsItemsListQuery = {
...
export let mapDashboardInstanceSkillsItemsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
