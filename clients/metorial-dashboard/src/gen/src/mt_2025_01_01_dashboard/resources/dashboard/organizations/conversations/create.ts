...
export type DashboardOrganizationsConversationsCreateOutput = {
...
export let mapDashboardOrganizationsConversationsCreateOutput =
  mtMap.object<DashboardOrganizationsConversationsCreateOutput>({
...
export type DashboardOrganizationsConversationsCreateBody = {
  assistantId: string;
  title?: string | undefined;
};

export let mapDashboardOrganizationsConversationsCreateBody =
  mtMap.object<DashboardOrganizationsConversationsCreateBody>({
    assistantId: mtMap.objectField('assistant_id', mtMap.passthrough()),
    title: mtMap.objectField('title', mtMap.passthrough())
  });
