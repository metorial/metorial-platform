...
export type DashboardInstancePortalsListingsDeleteOutput = {
...
export let mapDashboardInstancePortalsListingsDeleteOutput =
  mtMap.object<DashboardInstancePortalsListingsDeleteOutput>({
