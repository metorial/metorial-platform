...
export type DashboardInstanceIntegrationsInstanceGroupsGetOutput = {
...
export let mapDashboardInstanceIntegrationsInstanceGroupsGetOutput =
  mtMap.object<DashboardInstanceIntegrationsInstanceGroupsGetOutput>({
