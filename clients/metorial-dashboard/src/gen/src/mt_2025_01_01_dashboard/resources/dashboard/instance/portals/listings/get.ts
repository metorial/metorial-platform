...
export type DashboardInstancePortalsListingsGetOutput = {
...
export let mapDashboardInstancePortalsListingsGetOutput =
  mtMap.object<DashboardInstancePortalsListingsGetOutput>({
