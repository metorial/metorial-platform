...
export type DashboardInstanceSkillsTemplatesItemsGetOutput = {
...
export let mapDashboardInstanceSkillsTemplatesItemsGetOutput =
  mtMap.object<DashboardInstanceSkillsTemplatesItemsGetOutput>({
