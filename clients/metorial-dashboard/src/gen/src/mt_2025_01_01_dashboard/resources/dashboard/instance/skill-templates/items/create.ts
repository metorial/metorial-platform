...
export type DashboardInstanceSkillTemplatesItemsCreateOutput = {
...
export let mapDashboardInstanceSkillTemplatesItemsCreateOutput =
  mtMap.object<DashboardInstanceSkillTemplatesItemsCreateOutput>({
...
export type DashboardInstanceSkillTemplatesItemsCreateBody =
  | { type: 'provider'; providerId: string }
  | { type: 'integration'; integrationId: string };

export let mapDashboardInstanceSkillTemplatesItemsCreateBody = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
      type: mtMap.objectField('type', mtMap.passthrough()),
