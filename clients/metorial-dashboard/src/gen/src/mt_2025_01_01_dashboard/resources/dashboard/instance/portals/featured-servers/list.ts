...
export type DashboardInstancePortalsFeaturedServersListOutput = {
  items: ({
...
export let mapDashboardInstancePortalsFeaturedServersListOutput =
  mtMap.object<DashboardInstancePortalsFeaturedServersListOutput>({
...
export type DashboardInstancePortalsFeaturedServersListQuery = {
...
export let mapDashboardInstancePortalsFeaturedServersListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
