...
export type DashboardInstanceSkillsMergeRequestsCommentsListOutput = {
  items: {
...
export let mapDashboardInstanceSkillsMergeRequestsCommentsListOutput =
  mtMap.object<DashboardInstanceSkillsMergeRequestsCommentsListOutput>({
...
export type DashboardInstanceSkillsMergeRequestsCommentsListQuery = {
...
export let mapDashboardInstanceSkillsMergeRequestsCommentsListQuery =
  mtMap.union([
    mtMap.unionOption(
      'object',
      mtMap.object({
