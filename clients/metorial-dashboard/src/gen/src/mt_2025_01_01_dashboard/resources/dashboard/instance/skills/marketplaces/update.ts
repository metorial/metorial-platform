...
export type DashboardInstanceSkillsMarketplacesUpdateOutput = {
...
export let mapDashboardInstanceSkillsMarketplacesUpdateOutput =
  mtMap.object<DashboardInstanceSkillsMarketplacesUpdateOutput>({
...
export type DashboardInstanceSkillsMarketplacesUpdateBody = {
...
export let mapDashboardInstanceSkillsMarketplacesUpdateBody =
  mtMap.object<DashboardInstanceSkillsMarketplacesUpdateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
