...
export type DashboardInstanceSkillTemplatesItemsDeleteOutput = {
...
export let mapDashboardInstanceSkillTemplatesItemsDeleteOutput =
  mtMap.object<DashboardInstanceSkillTemplatesItemsDeleteOutput>({
