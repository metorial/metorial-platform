...
export type DashboardInstancePortalsListingsCreateOutput = {
...
export let mapDashboardInstancePortalsListingsCreateOutput =
  mtMap.object<DashboardInstancePortalsListingsCreateOutput>({
...
export type DashboardInstancePortalsListingsCreateBody = {
...
export let mapDashboardInstancePortalsListingsCreateBody =
  mtMap.object<DashboardInstancePortalsListingsCreateBody>({
    name: mtMap.objectField('name', mtMap.passthrough()),
    description: mtMap.objectField('description', mtMap.passthrough()),
    readme: mtMap.objectField('readme', mtMap.passthrough()),
    access: mtMap.objectField(
