...
export type DashboardInstanceIntegrationsProvidersCallbackGetOutput = {
  object: 'callback';
  id: string;
...
export let mapDashboardInstanceIntegrationsProvidersCallbackGetOutput =
  mtMap.object<DashboardInstanceIntegrationsProvidersCallbackGetOutput>({
