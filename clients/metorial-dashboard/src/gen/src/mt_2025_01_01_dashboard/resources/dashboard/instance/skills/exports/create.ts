...
export type DashboardInstanceSkillsExportsCreateOutput = {
  object: 'skill.export';
  id: string;
...
export let mapDashboardInstanceSkillsExportsCreateOutput =
  mtMap.object<DashboardInstanceSkillsExportsCreateOutput>({
...
export type DashboardInstanceSkillsExportsCreateBody = {
  target: 'skill' | 'plugin' | 'marketplace';
...
export let mapDashboardInstanceSkillsExportsCreateBody =
  mtMap.object<DashboardInstanceSkillsExportsCreateBody>({
    target: mtMap.objectField('target', mtMap.passthrough()),
