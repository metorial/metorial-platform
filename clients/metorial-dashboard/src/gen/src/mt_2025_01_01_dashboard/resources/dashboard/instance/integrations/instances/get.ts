...
export type DashboardInstanceIntegrationsInstancesGetOutput = {
...
export let mapDashboardInstanceIntegrationsInstancesGetOutput =
  mtMap.object<DashboardInstanceIntegrationsInstancesGetOutput>({
