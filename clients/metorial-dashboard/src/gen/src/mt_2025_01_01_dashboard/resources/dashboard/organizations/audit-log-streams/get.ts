...
export type DashboardOrganizationsAuditLogStreamsGetOutput = {
...
export let mapDashboardOrganizationsAuditLogStreamsGetOutput =
  mtMap.object<DashboardOrganizationsAuditLogStreamsGetOutput>({
