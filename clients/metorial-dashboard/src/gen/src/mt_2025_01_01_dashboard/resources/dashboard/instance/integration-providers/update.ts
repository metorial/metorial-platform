...
export type DashboardInstanceIntegrationProvidersUpdateOutput = {
...
export let mapDashboardInstanceIntegrationProvidersUpdateBody =
  mtMap.object<DashboardInstanceIntegrationProvidersUpdateBody>({
