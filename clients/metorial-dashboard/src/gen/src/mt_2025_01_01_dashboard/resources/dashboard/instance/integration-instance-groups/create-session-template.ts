...
export type DashboardInstanceIntegrationInstanceGroupsCreateSessionTemplateOutput =
  {
...
export let mapDashboardInstanceIntegrationInstanceGroupsCreateSessionTemplateOutput =
  mtMap.object<DashboardInstanceIntegrationInstanceGroupsCreateSessionTemplateOutput>(
    {
...
export type DashboardInstanceIntegrationInstanceGroupsCreateSessionTemplateBody =
  {
...
export let mapDashboardInstanceIntegrationInstanceGroupsCreateSessionTemplateBody =
  mtMap.object<DashboardInstanceIntegrationInstanceGroupsCreateSessionTemplateBody>(
    {
      name: mtMap.objectField('name', mtMap.passthrough()),
      description: mtMap.objectField('description', mtMap.passthrough()),
      metadata: mtMap.objectField('metadata', mtMap.passthrough())
