...
export type DashboardInstanceCustomServersVersionsCreateOutput = {
...
export let mapDashboardInstanceCustomServersVersionsCreateOutput =
  mtMap.object<DashboardInstanceCustomServersVersionsCreateOutput>({
