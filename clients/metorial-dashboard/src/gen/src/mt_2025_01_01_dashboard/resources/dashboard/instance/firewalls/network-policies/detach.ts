...
export type DashboardInstanceFirewallsNetworkPoliciesDetachOutput = {
...
export let mapDashboardInstanceFirewallsNetworkPoliciesDetachOutput =
  mtMap.object<DashboardInstanceFirewallsNetworkPoliciesDetachOutput>({
