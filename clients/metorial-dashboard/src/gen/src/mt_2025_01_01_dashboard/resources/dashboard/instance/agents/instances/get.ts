...
export type DashboardInstanceAgentsInstancesGetOutput = {
...
export let mapDashboardInstanceAgentsInstancesGetOutput =
  mtMap.object<DashboardInstanceAgentsInstancesGetOutput>({
