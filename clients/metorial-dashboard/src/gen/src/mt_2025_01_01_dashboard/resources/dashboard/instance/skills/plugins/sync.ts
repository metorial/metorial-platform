...
export type DashboardInstanceSkillsPluginsSyncOutput = {
  object: 'skill.plugin';
  id: string;
...
export let mapDashboardInstanceSkillsPluginsSyncOutput =
  mtMap.object<DashboardInstanceSkillsPluginsSyncOutput>({
...
export type DashboardInstanceSkillsPluginsSyncBody = {};

export let mapDashboardInstanceSkillsPluginsSyncBody =
  mtMap.object<DashboardInstanceSkillsPluginsSyncBody>({});
