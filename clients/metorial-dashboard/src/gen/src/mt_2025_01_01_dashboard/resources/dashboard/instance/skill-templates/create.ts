...
export type DashboardInstanceSkillTemplatesCreateOutput = {
...
export let mapDashboardInstanceSkillTemplatesCreateOutput =
  mtMap.object<DashboardInstanceSkillTemplatesCreateOutput>({
...
export type DashboardInstanceSkillTemplatesCreateBody = {
  name: string;
