...
export type DashboardInstanceIntegrationInstanceGroupProvidersSetOutput = {
...
export let mapDashboardInstanceIntegrationInstanceGroupProvidersSetBody =
  mtMap.object<DashboardInstanceIntegrationInstanceGroupProvidersSetBody>({
