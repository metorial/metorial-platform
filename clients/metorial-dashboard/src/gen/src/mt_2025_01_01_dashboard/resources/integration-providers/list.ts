...
export let mapIntegrationProvidersListOutput =
  mtMap.object<IntegrationProvidersListOutput>({
...
export type IntegrationProvidersListQuery = {
...
export let mapIntegrationProvidersListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
