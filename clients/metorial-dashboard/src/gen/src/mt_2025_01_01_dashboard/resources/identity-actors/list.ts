...
export let mapIdentityActorsListOutput = mtMap.object<IdentityActorsListOutput>(
  {
...
export type IdentityActorsListQuery = {
...
export let mapIdentityActorsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
