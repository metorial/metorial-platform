...
export type ProviderSpecificationChangeNotificationsGetOutput = {
...
export let mapProviderSpecificationChangeNotificationsGetOutput =
  mtMap.object<ProviderSpecificationChangeNotificationsGetOutput>({
