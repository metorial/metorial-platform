...
export type ConversationsMessagesListOutput = {
  items: {
...
export let mapConversationsMessagesListOutput =
  mtMap.object<ConversationsMessagesListOutput>({
...
export let mapConversationsMessagesListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
