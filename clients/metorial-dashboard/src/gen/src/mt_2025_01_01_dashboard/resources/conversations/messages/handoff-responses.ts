...
export type ConversationsMessagesHandoffResponsesOutput = {
...
export let mapConversationsMessagesHandoffResponsesOutput =
  mtMap.object<ConversationsMessagesHandoffResponsesOutput>({
...
export type ConversationsMessagesHandoffResponsesBody = {
  responses: { toolCallId: string; output: any }[];
};

export let mapConversationsMessagesHandoffResponsesBody =
  mtMap.object<ConversationsMessagesHandoffResponsesBody>({
