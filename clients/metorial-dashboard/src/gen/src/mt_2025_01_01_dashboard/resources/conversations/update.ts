...
export type ConversationsUpdateOutput = {
...
export let mapConversationsUpdateOutput =
  mtMap.object<ConversationsUpdateOutput>({
...
export type ConversationsUpdateBody = { title?: string | undefined };

export let mapConversationsUpdateBody = mtMap.object<ConversationsUpdateBody>({
  title: mtMap.objectField('title', mtMap.passthrough())
});
