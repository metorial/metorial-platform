 ...
 */
export class MetorialDashboardInstanceCustomServersRemoteServersNotificationsEndpoint {
  ...
  list(
    ...
    let path = `dashboard/instances/${instanceId}/custom-servers/remote-servers/${remoteServerId}/notifications`;
  ...
  get(
    ...
    let path = `dashboard/instances/${instanceId}/custom-servers/remote-servers/${remoteServerId}/notifications/${remoteServerNotificationId}`;
