 ...
 */
export class MetorialDashboardInstanceSessionsErrorGroupsEndpoint {
  ...
  list(
    ...
    let path = `dashboard/instances/${instanceId}/sessions/${sessionId}/error-groups`;
  ...
  get(
    ...
    let path = `dashboard/instances/${instanceId}/sessions/${sessionId}/error-groups/${sessionErrorGroupId}`;
