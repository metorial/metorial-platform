 ...
 */
export class MetorialDashboardInstancePortalsEndpoint {
  ...
  list(
    ...
    let path = `dashboard/instances/${instanceId}/portals`;
  ...
  get(
    ...
    let path = `dashboard/instances/${instanceId}/portals/${portalId}`;
