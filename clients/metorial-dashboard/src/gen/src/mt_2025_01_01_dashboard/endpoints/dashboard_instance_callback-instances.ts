 ...
 */
export class MetorialDashboardInstanceCallbackInstancesEndpoint {
  ...
  list(
    ...
    let path = `dashboard/instances/${instanceId}/callback-instances`;
  ...
  get(
    ...
    let path = `dashboard/instances/${instanceId}/callback-instances/${callbackInstanceId}`;
