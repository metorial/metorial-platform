 ...
 */
export class MetorialChatInstancesProviderEndpoint {
  ...
  get(
    ...
    let path = `chat/instances/${chatInstanceId}/provider`;
  ...
  authenticatedUser(
    ...
    let path = `chat/instances/${chatInstanceId}/provider/authenticated-user`;
