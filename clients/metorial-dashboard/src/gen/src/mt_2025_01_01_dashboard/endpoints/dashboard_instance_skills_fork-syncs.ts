 ...
 */
export class MetorialDashboardInstanceSkillsForkSyncsEndpoint {
  ...
  create(
    ...
    let path = `dashboard/instances/${instanceId}/skill-fork-syncs`;
  ...
  get(
    ...
    let path = `dashboard/instances/${instanceId}/skill-fork-syncs/${skillForkSyncId}`;
