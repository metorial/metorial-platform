 ...
 */
export class MetorialManagementInstanceSessionTemplatesEndpoint {
  ...
  list(
    ...
    let path = `instances/${instanceId}/session-templates`;
  ...
  listTools(
    ...
    let path = `instances/${instanceId}/session-templates/${sessionTemplateId}/tools`;
