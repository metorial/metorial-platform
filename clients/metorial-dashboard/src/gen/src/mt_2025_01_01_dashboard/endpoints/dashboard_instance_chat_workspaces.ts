 ...
 */
export class MetorialDashboardInstanceChatWorkspacesEndpoint {
  ...
  list(
    ...
    let path = `dashboard/instances/${instanceId}/chat/workspaces`;
  ...
  get(
    ...
    let path = `dashboard/instances/${instanceId}/chat/workspaces/${chatWorkspaceId}`;
