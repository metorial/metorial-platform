 ...
 */
export class MetorialDashboardInstanceIncomingWebhooksEndpoint {
  ...
  list(
    ...
    let path = `dashboard/instances/${instanceId}/incoming-webhooks`;
  ...
  get(
    ...
    let path = `dashboard/instances/${instanceId}/incoming-webhooks/${incomingWebhookId}`;
