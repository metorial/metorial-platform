 ...
 */
export class MetorialManagementOrganizationEventDeliveriesEndpoint {
  ...
  list(
    ...
    let path = 'organization/event-deliveries';
  ...
  get(
    ...
    let path = `organization/event-deliveries/${eventDeliveryId}`;
  ...
  retry(
    ...
    let path = `organization/event-deliveries/${eventDeliveryId}/retry`;
