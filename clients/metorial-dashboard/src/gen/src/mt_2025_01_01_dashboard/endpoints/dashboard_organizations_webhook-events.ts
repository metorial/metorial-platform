...
import {
  ...
  type DashboardOrganizationsWebhookEventsListOutput
} from '../resources';
 ...
 */
export class MetorialDashboardOrganizationsWebhookEventsEndpoint {
   ...
   * @returns DashboardOrganizationsWebhookEventsListOutput
   * @see https://metorial.com/api
   * @see https://metorial.com/docs
   */
  list(
  ...
  ): Promise<DashboardOrganizationsWebhookEventsListOutput> {
    let path = `dashboard/organizations/${organizationId}/webhook-events`;
