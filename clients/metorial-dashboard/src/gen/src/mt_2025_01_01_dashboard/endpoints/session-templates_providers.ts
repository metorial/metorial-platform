 ...
 */
export class MetorialSessionTemplatesProvidersEndpoint {
  ...
  list(
    ...
    let path = `session-templates/${sessionTemplateId}/providers`;
  ...
  get(
    ...
    let path = `session-templates/${sessionTemplateId}/providers/${sessionTemplateProviderId}`;
