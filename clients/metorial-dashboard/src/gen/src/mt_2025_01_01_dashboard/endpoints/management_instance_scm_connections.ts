 ...
 */
export class MetorialManagementInstanceScmConnectionsEndpoint {
  ...
  list(
    ...
    let path = `instances/${instanceId}/scm/connections`;
  ...
  get(
    ...
    let path = `instances/${instanceId}/scm/connections/${scmConnectionId}`;
