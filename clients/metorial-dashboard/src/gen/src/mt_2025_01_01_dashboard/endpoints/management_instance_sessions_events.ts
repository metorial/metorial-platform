 ...
 */
export class MetorialManagementInstanceSessionsEventsEndpoint {
  ...
  list(
    ...
    let path = `instances/${instanceId}/session-events`;
  ...
  get(
    ...
    let path = `instances/${instanceId}/session-events/${sessionEventId}`;
