 ...
 */
export class MetorialSkillsPluginsRepositoriesEndpoint {
  ...
  list(
    ...
    let path = `skill-plugins/${skillPluginId}/repositories`;
  ...
  get(
    ...
    let path = `skill-plugins/${skillPluginId}/repositories/${skillPluginRepositoryId}`;
