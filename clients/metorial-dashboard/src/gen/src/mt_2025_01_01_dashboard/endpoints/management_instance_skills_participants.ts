 ...
 */
export class MetorialManagementInstanceSkillsParticipantsEndpoint {
  ...
  list(
    ...
    let path = `instances/${instanceId}/skills/${skillId}/participants`;
  ...
  get(
    ...
    let path = `instances/${instanceId}/skills/${skillId}/participants/${skillParticipantId}`;
