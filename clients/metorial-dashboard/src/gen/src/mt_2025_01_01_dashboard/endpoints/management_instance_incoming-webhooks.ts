 ...
 */
export class MetorialManagementInstanceIncomingWebhooksEndpoint {
  ...
  list(
    ...
    let path = `instances/${instanceId}/incoming-webhooks`;
  ...
  get(
    ...
    let path = `instances/${instanceId}/incoming-webhooks/${incomingWebhookId}`;
