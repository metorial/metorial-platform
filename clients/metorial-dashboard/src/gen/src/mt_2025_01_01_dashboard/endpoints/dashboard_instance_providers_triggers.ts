 ...
 */
export class MetorialDashboardInstanceProvidersTriggersEndpoint {
  ...
  list(
    ...
    let path = `dashboard/instances/${instanceId}/provider-triggers`;
  ...
  get(
    ...
    let path = `dashboard/instances/${instanceId}/provider-triggers/${providerTriggerId}`;
