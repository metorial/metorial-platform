 ...
 */
export class MetorialProviderAuthConfigErrorsEndpoint {
  ...
  list(
    ...
    let path = 'provider-auth-config-errors';
  ...
  get(
    ...
    let path = `provider-auth-config-errors/${providerAuthConfigErrorId}`;
