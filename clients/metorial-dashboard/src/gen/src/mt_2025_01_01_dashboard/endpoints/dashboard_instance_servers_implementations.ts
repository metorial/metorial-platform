 ...
 */
export class MetorialDashboardInstanceServersImplementationsEndpoint extends BaseMetorialEndpoint<any> {
  ...
  list(
    ...
    let path = `dashboard/instances/${instanceId}/server-implementations`;
    return this._get({
      path,
  ...
  get(
    ...
    let path = `dashboard/instances/${instanceId}/server-implementations/${serverImplementationId}`;
    return this._get({
      path
