 ...
 */
export class MetorialDashboardInstanceChatEventsEndpoint {
  ...
  list(
    ...
    let path = `dashboard/instances/${instanceId}/chat/events`;
  ...
  get(
    ...
    let path = `dashboard/instances/${instanceId}/chat/events/${chatEventId}`;
