 ...
 */
export class MetorialManagementInstanceCustomServersRemoteServersNotificationsEndpoint {
  ...
  list(
    ...
    let path = `instances/${instanceId}/custom-servers/remote-servers/${remoteServerId}/notifications`;
  ...
  get(
    ...
    let path = `instances/${instanceId}/custom-servers/remote-servers/${remoteServerId}/notifications/${remoteServerNotificationId}`;
