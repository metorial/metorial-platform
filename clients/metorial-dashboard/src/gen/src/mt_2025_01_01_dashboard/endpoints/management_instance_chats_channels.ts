 ...
 */
export class MetorialManagementInstanceChatsChannelsEndpoint {
  ...
  list(
    ...
    let path = `instances/${instanceId}/chats/${chatId}/channels`;
  ...
  get(
    ...
    let path = `instances/${instanceId}/chats/${chatId}/channels/${channelId}`;
