 ...
 */
export class MetorialDashboardInstanceSkillsExportsEndpoint {
  ...
  list(
    ...
    let path = `dashboard/instances/${instanceId}/skill-exports`;
  ...
  get(
    ...
    let path = `dashboard/instances/${instanceId}/skill-exports/${skillExportId}`;
