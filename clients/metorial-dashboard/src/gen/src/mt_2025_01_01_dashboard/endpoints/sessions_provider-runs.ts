 ...
 */
export class MetorialSessionsProviderRunsEndpoint {
  ...
  list(
    ...
    let path = `sessions/${sessionId}/provider-runs`;
  ...
  get(
    ...
    let path = `sessions/${sessionId}/provider-runs/${providerRunId}`;
  ...
  getLogs(
    ...
    let path = `sessions/${sessionId}/provider-runs/${providerRunId}/logs`;
