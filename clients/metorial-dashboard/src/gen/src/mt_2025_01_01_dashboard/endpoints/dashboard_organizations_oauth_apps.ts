 ...
 */
export class MetorialDashboardOrganizationsOauthAppsEndpoint {
  ...
  list(
    ...
    let path = `dashboard/organizations/${organizationId}/oauth/apps`;
  ...
  get(
    ...
    let path = `dashboard/organizations/${organizationId}/oauth/apps/${oauthApplicationId}`;
