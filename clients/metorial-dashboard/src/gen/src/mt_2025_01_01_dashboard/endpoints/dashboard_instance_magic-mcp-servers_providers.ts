 ...
 */
export class MetorialDashboardInstanceMagicMcpServersProvidersEndpoint {
  ...
  list(
    ...
    let path = `dashboard/instances/${instanceId}/magic-mcp-servers/${magicMcpServerId}/providers`;
  ...
  get(
    ...
    let path = `dashboard/instances/${instanceId}/magic-mcp-servers/${magicMcpServerId}/providers/${integrationInstanceProviderId}`;
  ...
  update(
    ...
    let path = `dashboard/instances/${instanceId}/magic-mcp-servers/${magicMcpServerId}/providers/${integrationProviderId}`;
