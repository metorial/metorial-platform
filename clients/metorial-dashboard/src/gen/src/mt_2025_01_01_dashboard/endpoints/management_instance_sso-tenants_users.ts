 ...
 */
export class MetorialManagementInstanceSsoTenantsUsersEndpoint {
  ...
  list(
    ...
    let path = `instances/${instanceId}/sso-users`;
  ...
  get(
    ...
    let path = `instances/${instanceId}/sso-users/${ssoUserId}`;
