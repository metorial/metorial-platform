 ...
 */
export class MetorialDashboardInstanceIntegrationsProvidersCallbackEndpoint {
  ...
  get(
    ...
    let path = `dashboard/instances/${instanceId}/integration-providers/${integrationProviderId}/callback`;
  ...
  getConfigSchema(
    ...
    let path = `dashboard/instances/${instanceId}/integration-providers/${integrationProviderId}/callback/config-schema`;
