 ...
 */
export class MetorialManagementOrganizationEventDestinationListenersEndpoint {
  ...
  list(
    ...
    let path = 'organization/event-destination-listeners';
  ...
  get(
    ...
    let path = `organization/event-destination-listeners/${eventDestinationListenerId}`;
