 ...
 */
export class MetorialDashboardInstanceStoresItemsEndpoint {
  ...
  modify(
    ...
    let path = `dashboard/instances/${instanceId}/stores/${storeId}/items`;
  ...
  get(
    ...
    let path = `dashboard/instances/${instanceId}/stores/${storeId}/items/${itemId}`;
