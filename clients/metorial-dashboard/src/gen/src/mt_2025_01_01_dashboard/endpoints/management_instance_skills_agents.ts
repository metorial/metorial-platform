 ...
 */
export class MetorialManagementInstanceSkillsAgentsEndpoint {
  ...
  create(
    ...
    let path = `instances/${instanceId}/skills/${skillId}/agents`;
  ...
  get(
    ...
    let path = `instances/${instanceId}/skills/${skillId}/agents/${skillAgentId}`;
