 ...
 */
export class MetorialDashboardInstanceSkillsItemsEndpoint {
  ...
  list(
    ...
    let path = `dashboard/instances/${instanceId}/skills/${skillId}/items`;
  ...
  get(
    ...
    let path = `dashboard/instances/${instanceId}/skills/${skillId}/items/${skillItemId}`;
