 ...
 */
export class MetorialManagementInstanceCallbackInstancesEndpoint {
  ...
  list(
    ...
    let path = `instances/${instanceId}/callback-instances`;
  ...
  get(
    ...
    let path = `instances/${instanceId}/callback-instances/${callbackInstanceId}`;
