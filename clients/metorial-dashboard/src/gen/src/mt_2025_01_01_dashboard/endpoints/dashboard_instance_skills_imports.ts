 ...
 */
export class MetorialDashboardInstanceSkillsImportsEndpoint {
  ...
  list(
    ...
    let path = `dashboard/instances/${instanceId}/skill-imports`;
  ...
  get(
    ...
    let path = `dashboard/instances/${instanceId}/skill-imports/${skillImportId}`;
