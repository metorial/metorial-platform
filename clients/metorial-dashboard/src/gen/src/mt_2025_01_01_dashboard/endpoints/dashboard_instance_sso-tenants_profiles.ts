 ...
 */
export class MetorialDashboardInstanceSsoTenantsProfilesEndpoint {
  ...
  list(
    ...
    let path = `dashboard/instances/${instanceId}/sso-profiles`;
  ...
  get(
    ...
    let path = `dashboard/instances/${instanceId}/sso-profiles/${ssoProfileId}`;
