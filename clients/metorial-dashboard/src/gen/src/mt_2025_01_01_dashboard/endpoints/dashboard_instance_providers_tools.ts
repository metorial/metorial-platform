 ...
 */
export class MetorialDashboardInstanceProvidersToolsEndpoint {
  ...
  list(
    ...
    let path = `dashboard/instances/${instanceId}/providers/${providerId}/tools`;
    ...
    return this._get(request).transform(mapDashboardInstanceProvidersToolsListOutput);
  }
  ...
  get(
    ...
    let path = `dashboard/instances/${instanceId}/providers/${providerId}/tools/${providerToolId}`;
    ...
    return this._get(request).transform(mapDashboardInstanceProvidersToolsGetOutput);
  }
}
