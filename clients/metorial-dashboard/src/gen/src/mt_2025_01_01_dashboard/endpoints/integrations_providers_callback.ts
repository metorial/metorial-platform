 ...
 */
export class MetorialIntegrationsProvidersCallbackEndpoint {
  ...
  get(
    ...
    let path = `integration-providers/${integrationProviderId}/callback`;
  ...
  getConfigSchema(
    ...
    let path = `integration-providers/${integrationProviderId}/callback/config-schema`;
