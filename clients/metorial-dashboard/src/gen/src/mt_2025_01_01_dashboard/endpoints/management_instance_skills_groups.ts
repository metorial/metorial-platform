 ...
 */
export class MetorialManagementInstanceSkillsGroupsEndpoint {
  ...
  list(
    ...
    let path = `instances/${instanceId}/skill-groups`;
  ...
  get(
    ...
    let path = `instances/${instanceId}/skill-groups/${skillGroupId}`;
