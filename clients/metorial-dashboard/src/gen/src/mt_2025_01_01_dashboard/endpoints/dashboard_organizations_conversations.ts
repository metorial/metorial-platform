 ...
 */
export class MetorialDashboardOrganizationsConversationsEndpoint {
  ...
  list(
    ...
    let path = `dashboard/organizations/${organizationId}/instances/${instanceId}/conversations`;
  ...
  get(
    ...
    let path = `dashboard/organizations/${organizationId}/instances/${instanceId}/conversations/${assistantConversationId}`;
