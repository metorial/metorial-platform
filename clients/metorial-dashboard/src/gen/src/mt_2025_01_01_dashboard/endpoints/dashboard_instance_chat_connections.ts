 ...
 */
export class MetorialDashboardInstanceChatConnectionsEndpoint {
  ...
  list(
    ...
    let path = `dashboard/instances/${instanceId}/chat/connections`;
  ...
  get(
    ...
    let path = `dashboard/instances/${instanceId}/chat/connections/${chatConnectionId}`;
