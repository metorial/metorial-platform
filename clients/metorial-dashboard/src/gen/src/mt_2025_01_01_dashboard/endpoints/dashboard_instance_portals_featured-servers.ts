 ...
 */
export class MetorialDashboardInstancePortalsFeaturedServersEndpoint {
  ...
  list(
    ...
    let path = `dashboard/instances/${instanceId}/portals/${portalId}/featured-servers`;
  ...
  get(
    ...
    let path = `dashboard/instances/${instanceId}/portals/${portalId}/featured-servers/${serverListingId}`;
  ...
  addListing(
    ...
    let path = `dashboard/instances/${instanceId}/portals/${portalId}/featured-servers/add-listing`;
  ...
  removeListing(
    ...
    let path = `dashboard/instances/${instanceId}/portals/${portalId}/featured-servers/remove-listing`;
