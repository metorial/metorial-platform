 ...
 */
export class MetorialDashboardInstanceMagicMcpServersProviderEndpoint {
  ...
  list(
    ...
    let path = `dashboard/instances/${instanceId}/magic-mcp-servers/${magicMcpServerId}/provider`;
  ...
  get(
    ...
    let path = `dashboard/instances/${instanceId}/magic-mcp-servers/${magicMcpServerId}/provider/${magicMcpServerProviderId}`;
