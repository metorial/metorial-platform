 ...
 */
export class MetorialDashboardInstanceChatInstancesProviderEndpoint {
  ...
  get(
    ...
    let path = `dashboard/instances/${instanceId}/chat/instances/${chatInstanceId}/provider`;
  ...
  authenticatedUser(
    ...
    let path = `dashboard/instances/${instanceId}/chat/instances/${chatInstanceId}/provider/authenticated-user`;
