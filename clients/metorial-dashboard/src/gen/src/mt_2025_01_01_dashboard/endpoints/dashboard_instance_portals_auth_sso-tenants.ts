 ...
 */
export class MetorialDashboardInstancePortalsAuthSsoTenantsEndpoint {
  ...
  list(
    ...
    let path = `dashboard/instances/${instanceId}/portals/${portalId}/auth/sso-tenants`;
  ...
  setup(
    ...
    let path = `dashboard/instances/${instanceId}/portals/${portalId}/auth/sso-tenants/${ssoTenantId}/setup`;
