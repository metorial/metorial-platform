 ...
 */
export class MetorialManagementInstanceWebhooksEventsEndpoint {
  ...
  list(
    ...
    let path = `instances/${instanceId}/webhook-events`;
  ...
  get(
    ...
    let path = `instances/${instanceId}/webhook-events/${webhookEventId}`;
