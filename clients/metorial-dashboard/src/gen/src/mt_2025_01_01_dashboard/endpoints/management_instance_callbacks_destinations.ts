 ...
 */
export class MetorialManagementInstanceCallbacksDestinationsEndpoint {
  ...
  list(
    ...
    let path = `instances/${instanceId}/callback-destinations`;
  ...
  get(
    ...
    let path = `instances/${instanceId}/callback-destinations/${callbackDestinationId}`;
  ...
  rotateSigningSecret(
    ...
    let path = `instances/${instanceId}/callback-destinations/${callbackDestinationId}/security/signing-secret/rotate`;
