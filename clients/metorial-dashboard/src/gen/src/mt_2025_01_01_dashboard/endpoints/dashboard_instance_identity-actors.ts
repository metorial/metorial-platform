 ...
 */
export class MetorialDashboardInstanceIdentityActorsEndpoint {
  ...
  list(
    ...
    let path = `dashboard/instances/${instanceId}/identity-actors`;
  ...
  get(
    ...
    let path = `dashboard/instances/${instanceId}/identity-actors/${identityActorId}`;
