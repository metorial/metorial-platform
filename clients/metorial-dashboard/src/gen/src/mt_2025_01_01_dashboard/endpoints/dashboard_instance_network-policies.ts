 ...
 */
export class MetorialDashboardInstanceNetworkPoliciesEndpoint {
  ...
  list(
    ...
    let path = `dashboard/instances/${instanceId}/network-policies`;
  ...
  get(
    ...
    let path = `dashboard/instances/${instanceId}/network-policies/${networkPolicyId}`;
