 ...
 */
export class MetorialProviderAuthConfigEventsEndpoint {
  ...
  list(
    ...
    let path = 'provider-auth-config-events';
  ...
  get(
    ...
    let path = `provider-auth-config-events/${providerAuthConfigEventId}`;
