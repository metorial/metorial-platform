 ...
 */
export class MetorialManagementOrganizationServiceAccountsEndpoint {
  ...
  list(
    ...
    let path = 'organization/service-accounts';
  ...
  get(
    ...
    let path = `organization/service-accounts/${serviceAccountId}`;
