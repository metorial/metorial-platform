 ...
 */
export class MetorialDashboardOrganizationsAssistantsEndpoint {
  ...
  list(
    ...
    let path = `dashboard/organizations/${organizationId}/instances/${instanceId}/assistants`;
  ...
  get(
    ...
    let path = `dashboard/organizations/${organizationId}/instances/${instanceId}/assistants/${assistantId}`;
