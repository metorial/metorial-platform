 ...
 */
export class MetorialDocumentsParticipantsEndpoint {
  ...
  list(
    ...
    let path = `documents/${documentId}/participants`;
  ...
  get(
    ...
    let path = `documents/${documentId}/participants/${documentParticipantId}`;
