 ...
 */
export class MetorialDashboardInstanceProtoGuardAlertsEndpoint {
  ...
  list(
    ...
    let path = `dashboard/instances/${instanceId}/protoguard-alerts`;
  ...
  get(
    ...
    let path = `dashboard/instances/${instanceId}/protoguard-alerts/${protoGuardAlertId}`;
