 ...
 */
export class MetorialManagementInstanceProviderListingsEndpoint {
  ...
  list(
    ...
    let path = `instances/${instanceId}/provider-listings`;
    ...
    return this._get(request).transform(mapDashboardInstanceProviderListingsListOutput);
  }
  ...
  get(
    ...
    let path = `instances/${instanceId}/provider-listings/${providerListingId}`;
    ...
    return this._get(request).transform(mapDashboardInstanceProviderListingsGetOutput);
  }
}
