 ...
 */
export class MetorialManagementInstanceProviderCollectionsEndpoint {
  ...
  list(
    ...
    let path = `instances/${instanceId}/provider-collections`;
  ...
  get(
    ...
    let path = `instances/${instanceId}/provider-collections/${providerCollectionId}`;
