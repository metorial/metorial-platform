 ...
 */
export class MetorialDashboardInstanceWebhooksDestinationsEventsEndpoint {
  ...
  list(
    ...
    let path = `dashboard/instances/${instanceId}/webhook-destinations/${webhookDestinationId}/events`;
