 ...
 */
export class MetorialManagementInstanceScmReposEndpoint {
  ...
  list(
    ...
    let path = `instances/${instanceId}/scm/repos`;
  ...
  get(
    ...
    let path = `instances/${instanceId}/scm/repos/${scmRepositoryId}`;
  ...
  preview(
    ...
    let path = `instances/${instanceId}/scm/repos/preview`;
