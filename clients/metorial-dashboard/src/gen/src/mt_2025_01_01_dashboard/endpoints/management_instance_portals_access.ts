 ...
 */
export class MetorialManagementInstancePortalsAccessEndpoint {
  ...
  list(
    ...
    let path = `instances/${instanceId}/portals/${portalId}/access`;
  ...
  get(
    ...
    let path = `instances/${instanceId}/portals/${portalId}/access/${accessId}`;
