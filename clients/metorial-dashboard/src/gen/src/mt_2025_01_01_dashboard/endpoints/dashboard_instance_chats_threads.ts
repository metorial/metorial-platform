 ...
 */
export class MetorialDashboardInstanceChatsThreadsEndpoint {
  ...
  list(
    ...
    let path = `dashboard/instances/${instanceId}/chats/${chatId}/threads`;
  ...
  get(
    ...
    let path = `dashboard/instances/${instanceId}/chats/${chatId}/threads/${threadId}`;
