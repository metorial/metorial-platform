 ...
 */
export class MetorialDashboardInstanceMonitorsEndpoint {
  ...
  list(
    ...
    let path = `dashboard/instances/${instanceId}/monitors`;
  ...
  get(
    ...
    let path = `dashboard/instances/${instanceId}/monitors/${monitorId}`;
