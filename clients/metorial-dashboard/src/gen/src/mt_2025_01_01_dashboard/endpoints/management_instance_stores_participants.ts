 ...
 */
export class MetorialManagementInstanceStoresParticipantsEndpoint {
  ...
  list(
    ...
    let path = `instances/${instanceId}/stores/${storeId}/participants`;
  ...
  get(
    ...
    let path = `instances/${instanceId}/stores/${storeId}/participants/${storeParticipantId}`;
