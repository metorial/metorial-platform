 ...
 */
export class MetorialDashboardInstanceCallbacksEventsEndpoint {
  ...
  list(
    ...
    let path = `dashboard/instances/${instanceId}/callbacks-events`;
  ...
  get(
    ...
    let path = `dashboard/instances/${instanceId}/callbacks-events/${eventId}`;
