 ...
 */
export class MetorialManagementInstanceCallbackEventsEndpoint {
  ...
  list(
    ...
    let path = `instances/${instanceId}/callback-events`;
  ...
  get(
    ...
    let path = `instances/${instanceId}/callback-events/${callbackEventId}`;
