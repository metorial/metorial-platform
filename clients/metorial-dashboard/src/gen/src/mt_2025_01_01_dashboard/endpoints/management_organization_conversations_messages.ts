 ...
 */
export class MetorialManagementOrganizationConversationsMessagesEndpoint {
  ...
  list(
    ...
    let path = `organization/instances/${instanceId}/conversations/${assistantConversationId}/messages`;
  ...
  get(
    ...
    let path = `organization/instances/${instanceId}/conversations/${assistantConversationId}/messages/${assistantMessageId}`;
