 ...
 */
export class MetorialDashboardInstanceSkillsMergeRequestsPlanEndpoint {
  ...
  get(
    ...
    let path = `dashboard/instances/${instanceId}/skill-merge-requests/${skillMergeRequestId}/plan`;
