 ...
 */
export class MetorialPortalsConsumerProfilesEndpoint {
  ...
  get(
    ...
    let path = `portals/${portalId}/consumer-profile/${consumerProfileId}`;
  ...
  assignGroups(
    ...
    let path = `portals/${portalId}/consumer-profile/${consumerProfileId}/assign-groups`;
  ...
  removeFromGroups(
    ...
    let path = `portals/${portalId}/consumer-profile/${consumerProfileId}/remove-from-group`;
