 ...
 */
export class MetorialManagementInstanceSkillsVersionsEndpoint {
  ...
  list(
    ...
    let path = `instances/${instanceId}/skills/${skillId}/versions`;
  ...
  get(
    ...
    let path = `instances/${instanceId}/skills/${skillId}/versions/${skillVersionId}`;
