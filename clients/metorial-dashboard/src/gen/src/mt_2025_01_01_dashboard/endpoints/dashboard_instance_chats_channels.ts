 ...
 */
export class MetorialDashboardInstanceChatsChannelsEndpoint {
  ...
  list(
    ...
    let path = `dashboard/instances/${instanceId}/chats/${chatId}/channels`;
  ...
  get(
    ...
    let path = `dashboard/instances/${instanceId}/chats/${chatId}/channels/${channelId}`;
