 ...
 */
export class MetorialManagementInstancePortalsConsumerServerRequestsEndpoint {
  ...
  list(
    ...
    let path = `instances/${instanceId}/portals/${portalId}/consumer-server-requests`;
  ...
  get(
    ...
    let path = `instances/${instanceId}/portals/${portalId}/consumer-server-requests/${consumerServerRequestId}`;
  ...
  accept(
    ...
    let path = `instances/${instanceId}/portals/${portalId}/consumer-server-requests/${consumerServerRequestId}/accept`;
  ...
  reject(
    ...
    let path = `instances/${instanceId}/portals/${portalId}/consumer-server-requests/${consumerServerRequestId}/reject`;
