 ...
 */
export class MetorialChatsChannelsMembersEndpoint {
  ...
  list(
    ...
    let path = `chats/${chatId}/channels/${channelId}/members`;
  ...
  get(
    ...
    let path = `chats/${chatId}/channels/${channelId}/members/${userId}`;
