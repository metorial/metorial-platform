 ...
 */
export class MetorialManagementInstanceIntegrationsEndpoint {
  ...
  list(
    ...
    let path = `instances/${instanceId}/integrations`;
  ...
  get(
    ...
    let path = `instances/${instanceId}/integrations/${integrationId}`;
