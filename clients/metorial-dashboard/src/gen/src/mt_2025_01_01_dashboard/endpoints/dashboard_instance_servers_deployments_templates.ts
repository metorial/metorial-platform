 ...
 */
export class MetorialDashboardInstanceServersDeploymentsTemplatesEndpoint {
  ...
  list(
    ...
    let path = `dashboard/instances/${instanceId}/server-deployment-template`;
  ...
  get(
    ...
    let path = `dashboard/instances/${instanceId}/server-deployment-template/${serverDeploymentTemplateId}`;
