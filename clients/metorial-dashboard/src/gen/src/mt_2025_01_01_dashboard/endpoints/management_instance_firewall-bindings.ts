 ...
 */
export class MetorialManagementInstanceFirewallBindingsEndpoint {
  ...
  list(
    ...
    let path = `instances/${instanceId}/firewall-bindings`;
  ...
  get(
    ...
    let path = `instances/${instanceId}/firewall-bindings/${firewallBindingId}`;
