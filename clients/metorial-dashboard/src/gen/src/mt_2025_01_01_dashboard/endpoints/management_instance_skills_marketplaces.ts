 ...
 */
export class MetorialManagementInstanceSkillsMarketplacesEndpoint {
  ...
  list(
    ...
    let path = `instances/${instanceId}/skill-marketplaces`;
  ...
  get(
    ...
    let path = `instances/${instanceId}/skill-marketplaces/${skillMarketplaceId}`;
  ...
  getEditorUrl(
    ...
    let path = `instances/${instanceId}/skill-marketplaces/${skillMarketplaceId}/editor-url`;
