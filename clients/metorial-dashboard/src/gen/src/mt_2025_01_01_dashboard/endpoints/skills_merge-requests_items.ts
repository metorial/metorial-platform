 ...
 */
export class MetorialSkillsMergeRequestsItemsEndpoint {
  ...
  resolve(
    ...
    let path = `skill-merge-requests/${skillMergeRequestId}/items/${itemId}`;
  ...
  bulkResolve(
    ...
    let path = `skill-merge-requests/${skillMergeRequestId}/items`;
