 ...
 */
export class MetorialManagementInstanceWebhooksDestinationsEndpoint {
  ...
  list(
    ...
    let path = `instances/${instanceId}/webhook-destinations`;
  ...
  get(
    ...
    let path = `instances/${instanceId}/webhook-destinations/${webhookDestinationId}`;
  ...
  rotateSigningSecret(
    ...
    let path = `instances/${instanceId}/webhook-destinations/${webhookDestinationId}/security/signing-secret/rotate`;
