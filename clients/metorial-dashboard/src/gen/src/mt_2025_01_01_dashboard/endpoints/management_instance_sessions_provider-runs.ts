 ...
 */
export class MetorialManagementInstanceSessionsProviderRunsEndpoint {
  ...
  list(
    ...
    let path = `instances/${instanceId}/sessions/${sessionId}/provider-runs`;
  ...
  get(
    ...
    let path = `instances/${instanceId}/sessions/${sessionId}/provider-runs/${providerRunId}`;
  ...
  getLogs(
    ...
    let path = `instances/${instanceId}/sessions/${sessionId}/provider-runs/${providerRunId}/logs`;
