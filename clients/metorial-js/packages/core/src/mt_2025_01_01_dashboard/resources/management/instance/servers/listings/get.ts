...
export type ManagementInstanceServersListingsGetOutput = {
  id: string;
...
export let mapManagementInstanceServersListingsGetOutput =
  mtMap.object<ManagementInstanceServersListingsGetOutput>({
