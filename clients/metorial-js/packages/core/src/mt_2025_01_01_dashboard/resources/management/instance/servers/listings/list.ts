...
export type ManagementInstanceServersListingsListOutput = {
  items: {
    id: string;
...
export let mapManagementInstanceServersListingsListOutput =
  mtMap.object<ManagementInstanceServersListingsListOutput>({
...
export type ManagementInstanceServersListingsListQuery = {
...
export let mapManagementInstanceServersListingsListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
