...
export type DashboardFilesListOutput = {
  items: {
    id: string;
...
export let mapDashboardFilesListOutput = mtMap.object<DashboardFilesListOutput>(
  {
...
export type DashboardFilesListQuery = {
...
export let mapDashboardFilesListQuery = mtMap.union([
  mtMap.unionOption(
    'object',
    mtMap.object({
