...
export type DashboardInstanceServersListingsGetOutput = {
  id: string;
...
export let mapDashboardInstanceServersListingsGetOutput =
  mtMap.object<DashboardInstanceServersListingsGetOutput>({
