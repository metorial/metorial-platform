 ...
 */
export class MetorialManagementInstanceServersListingsCategoriesEndpoint extends BaseMetorialEndpoint<any> {
  ...
  list(
    ...
    return this._get({
      path: ['instances', instanceId, 'server-listing-categories'],
