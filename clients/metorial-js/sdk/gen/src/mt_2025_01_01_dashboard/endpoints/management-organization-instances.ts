...
export class MetorialManagementOrganizationInstancesEndpoint extends BaseMetorialEndpoint<any> {
   ...
   * @see https://metorial.com/docs
   */
  list(query?: DashboardOrganizationsInstancesListQuery) {
    return this._get({
   ...
   * @see https://metorial.com/docs
   */
  create(body: DashboardOrganizationsInstancesCreateBody) {
    return this._post({
      path: ['organization', 'instances'],
   ...
   * @see https://metorial.com/docs
   */
  update(instanceId: string, body: DashboardOrganizationsInstancesUpdateBody) {
    return this._post({
      path: ['organization', 'instances', instanceId],
