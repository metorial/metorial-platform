 ...
 */
export class MetorialManagementInstanceSessionsServerSessionsEndpoint extends BaseMetorialEndpoint<any> {
  ...
  list(
    ...
    let path = `instances/${instanceId}/sessions/${sessionId}/server-sessions`;
    return this._get({
      path,
  ...
  get(
    ...
    let path = `instances/${instanceId}/sessions/${sessionId}/server-sessions/${serverSessionId}`;
    return this._get({
      path
