...
describe('Sidebar Environment Variables', () => {
  ...
  describe('Authentication', () => {
    ...
    it('should properly render bearer token input', () => {
      ...
      rerender(
        <TooltipProvider>
          <Sidebar {...defaultProps} bearerToken="new_token" transportType="sse" />
        </TooltipProvider>
      );
  ...
  describe('Key Editing', () => {
    ...
    it('should maintain order during key editing', () => {
      ...
      const lastCall = setEnv.mock.calls[setEnv.mock.calls.length - 1][0] as Record<
        string,
        string
      >;
  ...
  describe('Configuration Operations', () => {
    ...
    it('should update MCP server proxy address', () => {
      ...
      const proxyAddressInput = screen.getByTestId('MCP_PROXY_FULL_ADDRESS-input');
    ...
    it('should update max total timeout', () => {
      ...
      const maxTotalTimeoutInput = screen.getByTestId('MCP_REQUEST_MAX_TOTAL_TIMEOUT-input');
    ...
    it('should maintain configuration state after multiple updates', () => {
      ...
      rerender(
        <TooltipProvider>
          <Sidebar {...defaultProps} config={updatedConfig} setConfig={setConfig} />
        </TooltipProvider>
      );
