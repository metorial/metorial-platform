import { MagicMcpGroupsListQuery } from '@metorial/consumer-sdk/src/gen/src/mt_2025_01_01_dashboard';
...
export let magicMcpGroupsLoader = createLoader({
  name: 'magicMcpGroups',
  parents: [],
  fetch: (i: {} & MagicMcpGroupsListQuery) => withSdk(sdk => sdk.magicMcp.groups.list(i)),
  mutators: {}
});
