...
let MagicMcpGroupServersTable = ({
  instance,
  servers,
  removeServersMutator,
  onServerRemoved
}: {
  instance: ReturnType<typeof useCurrentInstance>;
  servers: ReturnType<typeof useMagicMcpServers>;
  removeServersMutator: {
    isLoading: boolean;
    input: { magicMcpServerIds?: string[] } | null;
    mutate: (input: { magicMcpServerIds: string[] }) => Promise<[any, any]>;
  };
...
export let MagicMcpGroupOverviewPage = () => {
  ...
  return renderWithLoader({ group })(({ group }) => (
    <>
      ...
      >
        <MagicMcpGroupServersTable
          instance={instance}
          servers={servers}
          removeServersMutator={removeServersMutator}
          onServerRemoved={() => serversOuter.refetch()}
        />
      </Box>
