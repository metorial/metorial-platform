  ...
  let onViewDetails = (trigger: ProviderTrigger) => {
    ...
    showModal(({ dialogProps }) => (
      <Dialog.Wrapper {...dialogProps} width={840}>
        <Dialog.Title>{trigger.name}</Dialog.Title>
        {trigger.description && (
          <Dialog.Description>
            <ReactMarkdown
              components={{
          ...
          <InfoCard>
            ...
            <InfoList>
              {trigger.invocation.type === 'polling' ? (
                <InfoListItem>
                  Polling trigger with an interval of {trigger.invocation.intervalSeconds}{' '}
                  seconds.
                </InfoListItem>
              ) : (
                <>
                  <InfoListItem>
                    Auto-registration: {trigger.invocation.autoRegistration.status}
                  </InfoListItem>
                  <InfoListItem>
                    Auto-unregistration: {trigger.invocation.autoUnregistration.status}
                  </InfoListItem>
                </>
              )}
            </InfoList>
