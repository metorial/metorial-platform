...
import { useCurrentInstance, useCustomProviders } from '@metorial/state';
...
export let CustomProvidersTable = (
  ...
  let customServers = useCustomProviders(instance.data?.id, {
    ...query,
    order: 'desc'
  });
    ...
    <>
      ...
      {renderWithPagination(customServers)(customServers => {
        ...
        return (
          <>
            <Table
              headers={['Provider', 'Status', 'Version', 'Created']}
