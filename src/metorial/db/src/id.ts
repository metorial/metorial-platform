...
export let ID = createIdGenerator({
  ...
  organizationConfigType: idType.sorted('oct'),
  organizationConfig: idType.sorted('ocf'),
  organizationLayoutType: idType.sorted('olt'),
  ...
  resourceTenant: idType.sorted('crg_tn_'),
  resourceGroup: idType.sorted('crg_en_'),
  resourceActor: idType.sorted('crg_ta_'),
  cargoSyncMetorialOwnedRecord: idType.sorted('csmor'),
  cargoSyncRecord: idType.sorted('csrec'),
  cargoSyncRun: idType.sorted('csrun'),
  ...
  magicMcpEndpoint: idType.sorted('mgep'),
  ...
  consumerIntegrationSession: idType.sorted('cois'),
