...
import { subspaceSessionEventPresenter } from '@metorial/presenters';
      ...
      .query(
        ...
        Paginator.validate(
          v.object({
            ...
            created_at: dateFilterValidator('session event creation time'),
            updated_at: dateFilterValidator('session event last update time')
          })
        )
      )
      .do(async ctx => {
