...
export let oauthCallbackApp = createHono().get('/:oauthIdentifier', async c => {
  ...
  if (tenant.slateTenantId) destUrl.searchParams.set('slates_tenant_id', tenant.slateTenantId);
