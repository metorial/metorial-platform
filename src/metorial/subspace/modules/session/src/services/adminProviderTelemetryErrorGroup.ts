...
import type { AdminProviderTelemetryErrorGroupListInput } from '../lib/adminProviderTelemetryErrorGroups';
...
let resolveAdminProviderTelemetryScope = async (
...
class adminProviderTelemetryErrorGroupServiceImpl {
  async listErrorGroups(input: AdminProviderTelemetryErrorGroupListInput) {
...
export let adminProviderTelemetryErrorGroupService = Service.create(
  'adminProviderTelemetryErrorGroup',
  () => new adminProviderTelemetryErrorGroupServiceImpl()
).build();
