...
export type CargoSkillImport = Awaited<ReturnType<typeof cargo.skillImport.get>>;
export type CargoSkillImportList = Awaited<ReturnType<typeof cargo.skillImport.list>>;
