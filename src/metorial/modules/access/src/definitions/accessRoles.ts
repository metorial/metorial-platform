...
export let consumerOperationsReadRoles = ['consumer#instance.operations:read'] as const;
export let consumerIdentityReadRoles = ['consumer#instance.identity:read'] as const;
