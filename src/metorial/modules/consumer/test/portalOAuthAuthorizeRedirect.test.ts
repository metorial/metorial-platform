...
vi.mock('../src/services/consumerOAuth/_helpers', () => ({
...
vi.mock('../src/services/consumerOAuth/client', () => ({
  consumerOAuthClientService: {}
}));

import { portalService } from '../src/services/portal';
import { consumerOAuthAuthorizationService } from '../src/services/consumerOAuth/authorization';
