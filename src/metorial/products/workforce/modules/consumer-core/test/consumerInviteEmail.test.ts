...
describe('consumer invite email', () => {
  ...
  it('links to the portal namespace instead of the configured host template', async () => {
    ...
    let { getPrimaryPortalUrl } = await import('@metorial/portal-url');
