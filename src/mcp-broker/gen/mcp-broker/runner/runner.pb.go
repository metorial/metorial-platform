...
const file_runner_proto_rawDesc = "" +
	...
	"\fStreamMcpRun\x12\x19.broker.runner.RunRequest\x1a\x1a.broker.runner.RunResponse(\x010\x01BFZDgithub.com/metorial/metorial/mcp-broker/gen/mcp-broker/runner;runnerb\x06proto3"
