import type { JsonValue, Path, WireBatch, WireDelta, WireMessage, WireOperation } from './types';
...
export let normalizeBatch = <T extends JsonValue>(message: WireMessage<T>): WireBatch | null => {
