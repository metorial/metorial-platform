...
var file_runner_proto_depIdxs = []int32{
	...
	11, // 20: broker.runner.McpRunner.StreamMcpRun:input_type -> broker.runner.RunRequest
	15, // 21: broker.runner.McpRunner.StreamMcpRun:output_type -> broker.runner.RunResponse
