...
const (
	...
	McpWorkerBroker_GetManagerInfo_FullMethodName = "/broker.workerBroker.McpWorkerBroker/GetManagerInfo"
)
...
type McpWorkerBrokerClient interface {
	...
	GetManagerInfo(ctx context.Context, in *GetManagerInfoRequest, opts ...grpc.CallOption) (*GetManagerInfoResponse, error)
}
...
func (c *mcpWorkerBrokerClient) GetManagerInfo(ctx context.Context, in *GetManagerInfoRequest, opts ...grpc.CallOption) (*GetManagerInfoResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetManagerInfoResponse)
	err := c.cc.Invoke(ctx, McpWorkerBroker_GetManagerInfo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type McpWorkerBrokerServer interface {
	...
	GetManagerInfo(context.Context, *GetManagerInfoRequest) (*GetManagerInfoResponse, error)
...
func (UnimplementedMcpWorkerBrokerServer) GetManagerInfo(context.Context, *GetManagerInfoRequest) (*GetManagerInfoResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetManagerInfo not implemented")
}
...
func _McpWorkerBroker_GetManagerInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetManagerInfoRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(McpWorkerBrokerServer).GetManagerInfo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: McpWorkerBroker_GetManagerInfo_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(McpWorkerBrokerServer).GetManagerInfo(ctx, req.(*GetManagerInfoRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var McpWorkerBroker_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _McpWorkerBroker_GetManagerInfo_Handler,
		},
	},
