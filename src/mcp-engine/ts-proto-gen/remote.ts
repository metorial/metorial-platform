...
export const McpRemoteService = {
  getRemoteInfo: {
    path: "/broker.remote.McpRemote/GetRemoteInfo",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: RemoteInfoRequest): Buffer => Buffer.from(RemoteInfoRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): RemoteInfoRequest => RemoteInfoRequest.decode(value),
    responseSerialize: (value: RemoteInfoResponse): Buffer => Buffer.from(RemoteInfoResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): RemoteInfoResponse => RemoteInfoResponse.decode(value),
  },
  streamMcpRun: {
...
export interface McpRemoteServer extends UntypedServiceImplementation {
  getRemoteInfo: handleUnaryCall<RemoteInfoRequest, RemoteInfoResponse>;
...
export interface McpRemoteClient extends Client {
  getRemoteInfo(
    ...
    callback: (error: ServiceError | null, response: RemoteInfoResponse) => void,
  ): ClientUnaryCall;
  getRemoteInfo(
    request: RemoteInfoRequest,
    metadata: Metadata,
