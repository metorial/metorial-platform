    ...
    <Dialog.Wrapper {...dialogProps} width={840}>
      ...
      <Flex direction="column" gap={12} style={{ paddingBottom: 28 }}>
        ...
        <InfoCard>
          ...
          <InfoList>
            {p.trigger.invocation.type === 'polling' ? (
              <InfoListItem>
                Polling trigger with an interval of {p.trigger.invocation.intervalSeconds}{' '}
                seconds.
              </InfoListItem>
            ) : (
              <>
                <InfoListItem>
                  Auto-registration: {p.trigger.invocation.autoRegistration.status}
                </InfoListItem>
                <InfoListItem>
                  Auto-unregistration: {p.trigger.invocation.autoUnregistration.status}
                </InfoListItem>
              </>
            )}
          </InfoList>
