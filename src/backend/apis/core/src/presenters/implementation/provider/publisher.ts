...
export let v1PublisherPresenter = Presenter.create(publisherType)
  ...
  .schema(
    v.object({
      object: v.literal('provider.publisher', { description: "String representing the object's type" }),
      id: v.string({ name: 'id', description: 'Unique publisher identifier', examples: ['pub_9hJkLmNpQrStUvWx'] }),
      ...
      image_url: v.nullable(
        v.string({ name: 'image_url', description: 'URL of the publisher logo', examples: ['https://cdn.metorial.com/images/acme.png'] })
      ),
