...
export let v1SessionConnectionPresenter = Presenter.create(sessionConnectionType)
  ...
  .schema(
    v.object({
      object: v.literal('session.session_connection', { description: "String representing the object's type" }),
      ...
      mcp: v.object(
        {
          ...
          client: v.nullable(
            v.object(
              {
                object: v.literal('session.session_connection.client', { description: "String representing the object's type" }),
          ...
          server: v.nullable(
            v.object(
              {
                object: v.literal('session.session_connection.server', { description: "String representing the object's type" }),
