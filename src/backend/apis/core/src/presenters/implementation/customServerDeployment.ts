...
export let v1CustomServerDeploymentPresenter = Presenter.create(customServerDeploymentType)
  ...
  .schema(
    v.object({
      object: v.literal('custom_server.deployment', { description: "String representing the object's type" }),
      ...
      steps: v.array(
        v.object({
          object: v.literal('custom_server.deployment.step', { description: "String representing the object's type" }),
