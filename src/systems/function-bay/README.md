...
```bash
npm install @metorial-platform-systems/function-bay-client
yarn add @metorial-platform-systems/function-bay-client
bun add @metorial-platform-systems/function-bay-client
```
